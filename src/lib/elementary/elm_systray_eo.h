 ...
 * @ingroup Elm_Systray
 */
ELM_API void elm_obj_systray_id_set(Eo *obj, const char *id);
 ...
 * @ingroup Elm_Systray
 */
ELM_API const char *elm_obj_systray_id_get(const Eo *obj);
 ...
 * @ingroup Elm_Systray
 */
ELM_API void elm_obj_systray_category_set(Eo *obj, Elm_Systray_Category cat);
 ...
 * @ingroup Elm_Systray
 */
ELM_API Elm_Systray_Category elm_obj_systray_category_get(const Eo *obj);
 ...
 * @ingroup Elm_Systray
 */
ELM_API void elm_obj_systray_icon_theme_path_set(Eo *obj, const char *icon_theme_path);
 ...
 * @ingroup Elm_Systray
 */
ELM_API const char *elm_obj_systray_icon_theme_path_get(const Eo *obj);
 ...
 * @ingroup Elm_Systray
 */
ELM_API void elm_obj_systray_menu_set(Eo *obj, const Efl_Object *menu);
 ...
 * @ingroup Elm_Systray
 */
ELM_API const Efl_Object *elm_obj_systray_menu_get(const Eo *obj);
 ...
 * @ingroup Elm_Systray
 */
ELM_API void elm_obj_systray_att_icon_name_set(Eo *obj, const char *att_icon_name);
 ...
 * @ingroup Elm_Systray
 */
ELM_API const char *elm_obj_systray_att_icon_name_get(const Eo *obj);
 ...
 * @ingroup Elm_Systray
 */
ELM_API void elm_obj_systray_status_set(Eo *obj, Elm_Systray_Status st);
 ...
 * @ingroup Elm_Systray
 */
ELM_API Elm_Systray_Status elm_obj_systray_status_get(const Eo *obj);
 ...
 * @ingroup Elm_Systray
 */
ELM_API void elm_obj_systray_icon_name_set(Eo *obj, const char *icon_name);
 ...
 * @ingroup Elm_Systray
 */
ELM_API const char *elm_obj_systray_icon_name_get(const Eo *obj);
 ...
 * @ingroup Elm_Systray
 */
ELM_API void elm_obj_systray_title_set(Eo *obj, const char *title);
 ...
 * @ingroup Elm_Systray
 */
ELM_API const char *elm_obj_systray_title_get(const Eo *obj);
 ...
 * @ingroup Elm_Systray
 */
ELM_API Eina_Bool elm_obj_systray_register(Eo *obj);
