 ...
 * @ingroup Elm_Bg
 */
ELEMENTARY_API Evas_Object                 *elm_bg_add(Evas_Object *parent);
 ...
 * @ingroup Elm_Bg
 */
ELEMENTARY_API void                         elm_bg_color_set(Evas_Object *obj, int r, int g, int b);
 ...
 * @ingroup Elm_Bg
 */
ELEMENTARY_API void                         elm_bg_color_get(const Evas_Object *obj, int *r, int *g, int *b);
 ...
 */
ELEMENTARY_API Eina_Bool elm_bg_file_set(Eo *obj, const char *file, const char *group);
 ...
 */
ELEMENTARY_API void elm_bg_file_get(const Eo *obj, const char **file, const char **group);
...
/**
  ...
  * @ingroup Elm_Bg
  */
ELEMENTARY_API void elm_bg_option_set(Evas_Object *obj, Elm_Bg_Option option);
...
/**
  ...
  * @ingroup Elm_Bg
  */
ELEMENTARY_API Elm_Bg_Option elm_bg_option_get(const Evas_Object *obj);
...
/**
  ...
  */
ELEMENTARY_API void elm_bg_load_size_set(Evas_Object *obj, int w, int h);
