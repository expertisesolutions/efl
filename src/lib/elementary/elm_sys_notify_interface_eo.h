...
ELM_API_WEAK const Efl_Class *elm_sys_notify_interface_interface_get(void);
 ...
 * @ingroup Elm_Sys_Notify_Interface
 */
ELM_API_WEAK void elm_obj_sys_notify_interface_send(const Eo *obj, unsigned int replaces_id, const char *icon, const char *summary, const char *body, Elm_Sys_Notify_Urgency urgency, int timeout, Elm_Sys_Notify_Send_Cb cb, const void *cb_data);
 ...
 * @ingroup Elm_Sys_Notify_Interface
 */
ELM_API_WEAK void elm_obj_sys_notify_interface_simple_send(const Eo *obj, const char *icon, const char *summary, const char *body);
 ...
 * @ingroup Elm_Sys_Notify_Interface
 */
ELM_API_WEAK void elm_obj_sys_notify_interface_close(const Eo *obj, unsigned int id);
