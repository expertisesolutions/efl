 ...
 * @ingroup Elm_Table
 */
ELM_API_WEAK void elm_obj_table_homogeneous_set(Eo *obj, Eina_Bool homogeneous);
 ...
 * @ingroup Elm_Table
 */
ELM_API_WEAK Eina_Bool elm_obj_table_homogeneous_get(const Eo *obj);
 ...
 * @ingroup Elm_Table
 */
ELM_API_WEAK void elm_obj_table_padding_set(Eo *obj, int horizontal, int vertical);
 ...
 * @ingroup Elm_Table
 */
ELM_API_WEAK void elm_obj_table_padding_get(const Eo *obj, int *horizontal, int *vertical);
 ...
 * @ingroup Elm_Table
 */
ELM_API_WEAK void elm_obj_table_align_set(Eo *obj, double horizontal, double vertical);
 ...
 * @ingroup Elm_Table
 */
ELM_API_WEAK void elm_obj_table_align_get(const Eo *obj, double *horizontal, double *vertical);
 ...
 * @ingroup Elm_Table
 */
ELM_API_WEAK void elm_obj_table_clear(Eo *obj, Eina_Bool clear);
 ...
 * @ingroup Elm_Table
 */
ELM_API_WEAK Efl_Canvas_Object *elm_obj_table_child_get(const Eo *obj, int col, int row);
 ...
 * @ingroup Elm_Table
 */
ELM_API_WEAK void elm_obj_table_pack_set(Eo *obj, Efl_Canvas_Object *subobj, int column, int row, int colspan, int rowspan);
 ...
 * @ingroup Elm_Table
 */
ELM_API_WEAK void elm_obj_table_pack_get(Eo *obj, Efl_Canvas_Object *subobj, int *column, int *row, int *colspan, int *rowspan);
 ...
 * @ingroup Elm_Table
 */
ELM_API_WEAK void elm_obj_table_unpack(Eo *obj, Efl_Canvas_Object *subobj);
 ...
 * @ingroup Elm_Table
 */
ELM_API_WEAK void elm_obj_table_pack(Eo *obj, Efl_Canvas_Object *subobj, int column, int row, int colspan, int rowspan);
