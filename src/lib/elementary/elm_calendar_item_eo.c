...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_calendar_item_day_number_set, EFL_FUNC_CALL(i), int i);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_calendar_item_day_number_get, int, 0);
