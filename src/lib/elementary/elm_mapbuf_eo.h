...
ELM_API ELM_API_WEAK const Efl_Class *elm_mapbuf_class_get(void);
 ...
 * @ingroup Elm_Mapbuf
 */
ELM_API void elm_private_mapbuf_auto_set(Eo *obj, Eina_Bool on);
 ...
 * @ingroup Elm_Mapbuf
 */
ELM_API Eina_Bool elm_private_mapbuf_auto_get(const Eo *obj);
 ...
 * @ingroup Elm_Mapbuf
 */
ELM_API void elm_private_mapbuf_smooth_set(Eo *obj, Eina_Bool smooth);
 ...
 * @ingroup Elm_Mapbuf
 */
ELM_API Eina_Bool elm_private_mapbuf_smooth_get(const Eo *obj);
 ...
 * @ingroup Elm_Mapbuf
 */
ELM_API void elm_private_mapbuf_alpha_set(Eo *obj, Eina_Bool alpha);
 ...
 * @ingroup Elm_Mapbuf
 */
ELM_API Eina_Bool elm_private_mapbuf_alpha_get(const Eo *obj);
 ...
 * @ingroup Elm_Mapbuf
 */
ELM_API void elm_private_mapbuf_enabled_set(Eo *obj, Eina_Bool enabled);
 ...
 * @ingroup Elm_Mapbuf
 */
ELM_API Eina_Bool elm_private_mapbuf_enabled_get(const Eo *obj);
 ...
 * @ingroup Elm_Mapbuf
 */
ELM_API void elm_private_mapbuf_point_color_set(Eo *obj, int idx, int r, int g, int b, int a);
 ...
 * @ingroup Elm_Mapbuf
 */
ELM_API void elm_private_mapbuf_point_color_get(const Eo *obj, int idx, int *r, int *g, int *b, int *a);
