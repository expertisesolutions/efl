...
Elm_Code_Parser *ELM_CODE_PARSER_STANDARD_SYNTAX = NULL;
Elm_Code_Parser *ELM_CODE_PARSER_STANDARD_DIFF = NULL;
Elm_Code_Parser *ELM_CODE_PARSER_STANDARD_TODO = NULL;
#endif
