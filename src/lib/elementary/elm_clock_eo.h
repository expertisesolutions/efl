...
ELM_API ELM_API_WEAK const Efl_Class *elm_clock_class_get(void);
 ...
 * @ingroup Elm_Clock
 */
ELM_API void elm_obj_clock_show_am_pm_set(Eo *obj, Eina_Bool am_pm);
 ...
 * @ingroup Elm_Clock
 */
ELM_API Eina_Bool elm_obj_clock_show_am_pm_get(const Eo *obj);
 ...
 * @ingroup Elm_Clock
 */
ELM_API void elm_obj_clock_first_interval_set(Eo *obj, double interval);
 ...
 * @ingroup Elm_Clock
 */
ELM_API double elm_obj_clock_first_interval_get(const Eo *obj);
 ...
 * @ingroup Elm_Clock
 */
ELM_API void elm_obj_clock_show_seconds_set(Eo *obj, Eina_Bool seconds);
 ...
 * @ingroup Elm_Clock
 */
ELM_API Eina_Bool elm_obj_clock_show_seconds_get(const Eo *obj);
 ...
 * @ingroup Elm_Clock
 */
ELM_API void elm_obj_clock_edit_set(Eo *obj, Eina_Bool edit);
 ...
 * @ingroup Elm_Clock
 */
ELM_API Eina_Bool elm_obj_clock_edit_get(const Eo *obj);
 ...
 * @ingroup Elm_Clock
 */
ELM_API void elm_obj_clock_pause_set(Eo *obj, Eina_Bool paused);
 ...
 * @ingroup Elm_Clock
 */
ELM_API Eina_Bool elm_obj_clock_pause_get(const Eo *obj);
 ...
 * @ingroup Elm_Clock
 */
ELM_API void elm_obj_clock_time_set(Eo *obj, int hrs, int min, int sec);
 ...
 * @ingroup Elm_Clock
 */
ELM_API void elm_obj_clock_time_get(const Eo *obj, int *hrs, int *min, int *sec);
 ...
 * @ingroup Elm_Clock
 */
ELM_API void elm_obj_clock_edit_mode_set(Eo *obj, Elm_Clock_Edit_Mode digedit);
