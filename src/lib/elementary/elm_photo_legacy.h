 ...
 * @ingroup Elm_Photo
 */
ELEMENTARY_API Evas_Object *elm_photo_add(Evas_Object *parent);
 ...
 */
ELEMENTARY_API Eina_Bool elm_photo_file_set(Eo *obj, const char *file);
 ...
 * @ingroup Elm_Photo
 */
ELEMENTARY_API void elm_photo_editable_set(Evas_Object *obj, Eina_Bool set);
 ...
 * @ingroup Elm_Photo
 */
ELEMENTARY_API Eina_Bool elm_photo_editable_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Photo
 */
ELEMENTARY_API void elm_photo_fill_inside_set(Evas_Object *obj, Eina_Bool fill);
 ...
 * @ingroup Elm_Photo
 */
ELEMENTARY_API Eina_Bool elm_photo_fill_inside_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Photo
 */
ELEMENTARY_API void elm_photo_aspect_fixed_set(Evas_Object *obj, Eina_Bool fixed);
 ...
 * @ingroup Elm_Photo
 */
ELEMENTARY_API Eina_Bool elm_photo_aspect_fixed_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Photo
 */
ELEMENTARY_API void elm_photo_size_set(Evas_Object *obj, int size);
 ...
 * @ingroup Elm_Photo
 */
ELEMENTARY_API int elm_photo_size_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Photo
 */
ELEMENTARY_API void elm_photo_thumb_set(Evas_Object *obj, const char *file, const char *group);
