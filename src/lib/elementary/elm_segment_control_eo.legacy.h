 ...
 */
ELEMENTARY_API int elm_segment_control_item_count_get(const Elm_Segment_Control *obj);
 ...
 * @ingroup Elm_Segment_Control_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_segment_control_item_selected_get(const Elm_Segment_Control *obj);
 ...
 * @ingroup Elm_Segment_Control_Group
 */
ELEMENTARY_API const char *elm_segment_control_item_label_get(const Elm_Segment_Control *obj, int idx);
 ...
 * @ingroup Elm_Segment_Control_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_segment_control_item_insert_at(Elm_Segment_Control *obj, Efl_Canvas_Object *icon, const char *label, int idx);
 ...
 * @ingroup Elm_Segment_Control_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_segment_control_item_get(const Elm_Segment_Control *obj, int idx);
 ...
 * @ingroup Elm_Segment_Control_Group
 */
ELEMENTARY_API void elm_segment_control_item_del_at(Elm_Segment_Control *obj, int idx);
 ...
 * @ingroup Elm_Segment_Control_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_segment_control_item_add(Elm_Segment_Control *obj, Efl_Canvas_Object *icon, const char *label);
 ...
 * @ingroup Elm_Segment_Control_Group
 */
ELEMENTARY_API Efl_Canvas_Object *elm_segment_control_item_icon_get(const Elm_Segment_Control *obj, int idx);
