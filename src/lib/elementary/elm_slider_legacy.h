 ...
 * @ingroup Elm_Slider
 */
ELEMENTARY_API Evas_Object                 *elm_slider_add(Evas_Object *parent);
 ...
 * @ingroup Elm_Slider
 */
ELEMENTARY_API void elm_slider_horizontal_set(Evas_Object *obj, Eina_Bool horizontal);

/** Get the orientation of a given slider widget.
 *
 * @ingroup Elm_Slider
 */
ELEMENTARY_API Eina_Bool elm_slider_horizontal_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Slider
 */
ELEMENTARY_API void elm_slider_value_set(Evas_Object *obj, double val);
 ...
 * @ingroup Elm_Slider
 */
ELEMENTARY_API double elm_slider_value_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Slider
 */
ELEMENTARY_API void elm_slider_inverted_set(Evas_Object *obj, Eina_Bool inverted);
 ...
 * @ingroup Elm_Slider
 */
ELEMENTARY_API Eina_Bool elm_slider_inverted_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Slider
 */
ELEMENTARY_API void elm_slider_span_size_set(Evas_Object *obj, Evas_Coord size);
 ...
 * @ingroup Elm_Slider
 */
ELEMENTARY_API Evas_Coord elm_slider_span_size_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Slider
 */
ELEMENTARY_API void elm_slider_unit_format_set(Evas_Object *obj, const char *units);
 ...
 * @ingroup Elm_Slider
 */
ELEMENTARY_API const char *elm_slider_unit_format_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Slider
 */
ELEMENTARY_API void elm_slider_units_format_function_set(Evas_Object *obj, slider_func_type func, slider_freefunc_type free_func);
 ...
 * @ingroup Elm_Slider
 */
ELEMENTARY_API void elm_slider_min_max_set(Evas_Object *obj, double min, double max);
 ...
 * @ingroup Elm_Slider
 */
ELEMENTARY_API void elm_slider_min_max_get(const Evas_Object *obj, double *min, double *max);
 ...
 * @since 1.18
 */
ELEMENTARY_API void elm_slider_range_enabled_set(Evas_Object *obj, Eina_Bool enable);
 ...
 * @since 1.18
 */
ELEMENTARY_API Eina_Bool elm_slider_range_enabled_get(const Evas_Object *obj);
 ...
 * @since 1.18
 */
ELEMENTARY_API void elm_slider_range_set(Evas_Object *obj, double from, double to);
 ...
 * @since 1.18
 */
ELEMENTARY_API void elm_slider_range_get(const Evas_Object *obj, double *from, double *to);
 ...
 * @ingroup Elm_Slider
 */
 ELEMENTARY_API void elm_slider_indicator_format_set(Evas_Object *obj, const char *indicator);
  ...
  * @ingroup Elm_Slider
  */
 ELEMENTARY_API const char *elm_slider_indicator_format_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Slider
 */
ELEMENTARY_API void elm_slider_indicator_format_function_set(Evas_Object *obj, slider_func_type func, slider_freefunc_type free_func);
 ...
 * @ingroup Elm_Slider
 */
ELEMENTARY_API void elm_slider_indicator_show_on_focus_set(Evas_Object *obj, Eina_Bool flag);
 ...
 * @ingroup Elm_Slider
 */
ELEMENTARY_API Eina_Bool elm_slider_indicator_show_on_focus_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Slider
 */
ELEMENTARY_API void elm_slider_indicator_show_set(Evas_Object *obj, Eina_Bool show);
 ...
 * @ingroup Elm_Slider
 */
ELEMENTARY_API Eina_Bool elm_slider_indicator_show_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Slider
 */
ELEMENTARY_API void elm_slider_indicator_visible_mode_set(Evas_Object *obj, Elm_Slider_Indicator_Visible_Mode indicator_visible_mode);
 ...
 * @ingroup Elm_Slider
 */
ELEMENTARY_API Elm_Slider_Indicator_Visible_Mode elm_slider_indicator_visible_mode_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Slider
 */
ELEMENTARY_API double elm_slider_step_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Slider
 */
ELEMENTARY_API void elm_slider_step_set(Evas_Object *obj, double step);
