 ...
 * @since 1.8
 */
ELEMENTARY_API Elm_Prefs_Data *elm_prefs_data_new(const char *data_file,
                                        const char *key,
                                        Eet_File_Mode mode);
 ...
 * @since 1.8
 */
ELEMENTARY_API Eina_Bool       elm_prefs_data_version_set(Elm_Prefs_Data *prefs_data,
 ...
 * @since 1.8
 */
ELEMENTARY_API unsigned int    elm_prefs_data_version_get(const Elm_Prefs_Data *prefs_data);
 ...
 * @since 1.8
 */
ELEMENTARY_API Elm_Prefs_Data *elm_prefs_data_ref(Elm_Prefs_Data *prefs_data);
 ...
 * @since 1.8
 */
ELEMENTARY_API void            elm_prefs_data_unref(Elm_Prefs_Data *prefs_data);
 ...
 * @since 1.8
 */
ELEMENTARY_API Eina_Bool       elm_prefs_data_value_set(Elm_Prefs_Data *prefs_data,
                                              const char *path,
 ...
 * @since 1.8
 */
ELEMENTARY_API Eina_Bool       elm_prefs_data_value_get(const Elm_Prefs_Data *prefs_data,
                                              const char *path,
 ...
 * @since 1.8
 */
ELEMENTARY_API Eina_Bool       elm_prefs_data_event_callback_add(Elm_Prefs_Data *prefs_data,
                                                       Elm_Prefs_Data_Event_Type type,
 ...
 * @since 1.8
 */
ELEMENTARY_API Eina_Bool       elm_prefs_data_event_callback_del(Elm_Prefs_Data *prefs_data,
                                                       Elm_Prefs_Data_Event_Type type,
                                                       Elm_Prefs_Data_Event_Cb cb,
                                                       const void *cb_data);
 ...
 * @since 1.8
 */
ELEMENTARY_API void      elm_prefs_data_autosave_set(Elm_Prefs_Data *prefs_data,
                                           Eina_Bool autosave);
 ...
 * @since 1.8
 */
ELEMENTARY_API Eina_Bool elm_prefs_data_autosave_get(const Elm_Prefs_Data *prefs_data);
 ...
 * @since 1.8
 */
ELEMENTARY_API Eina_Bool elm_prefs_data_save(const Elm_Prefs_Data *prefs_data,
                                   const char *file,
                                   const char *key);
