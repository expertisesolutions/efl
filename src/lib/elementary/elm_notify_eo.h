...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_NOTIFY_EVENT_BLOCK_CLICKED;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_NOTIFY_EVENT_TIMEOUT;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_NOTIFY_EVENT_DISMISSED;
