 ...
 * @ingroup Elm_Notify
 */
ELM_API_WEAK void elm_obj_notify_align_set(Eo *obj, double horizontal, double vertical);
 ...
 * @ingroup Elm_Notify
 */
ELM_API_WEAK void elm_obj_notify_align_get(const Eo *obj, double *horizontal, double *vertical);
 ...
 * @ingroup Elm_Notify
 */
ELM_API_WEAK void elm_obj_notify_allow_events_set(Eo *obj, Eina_Bool allow);
 ...
 * @ingroup Elm_Notify
 */
ELM_API_WEAK Eina_Bool elm_obj_notify_allow_events_get(const Eo *obj);
 ...
 * @ingroup Elm_Notify
 */
ELM_API_WEAK void elm_obj_notify_timeout_set(Eo *obj, double timeout);
 ...
 * @ingroup Elm_Notify
 */
ELM_API_WEAK double elm_obj_notify_timeout_get(const Eo *obj);
 ...
 * @ingroup Elm_Notify
 */
ELM_API_WEAK void elm_obj_notify_dismiss(Eo *obj);
