 ...
 */
ELEMENTARY_API void      elm_object_scroll_hold_push(Evas_Object *obj);
 ...
 * @ingroup Elm_Scrollhints
 */
ELEMENTARY_API void      elm_object_scroll_hold_pop(Evas_Object *obj);
 ...
 * @ingroup Elm_Scrollhints
 */
ELEMENTARY_API int       elm_object_scroll_hold_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Scrollhints
 */
ELEMENTARY_API void      elm_object_scroll_freeze_push(Evas_Object *obj);
 ...
 * @ingroup Elm_Scrollhints
 */
ELEMENTARY_API void      elm_object_scroll_freeze_pop(Evas_Object *obj);
 ...
 * @ingroup Elm_Scrollhints
 */
ELEMENTARY_API int       elm_object_scroll_freeze_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Scrollhints
 */
ELEMENTARY_API void      elm_object_scroll_lock_x_set(Evas_Object *obj, Eina_Bool lock);
 ...
 * @ingroup Elm_Scrollhints
 */
ELEMENTARY_API void      elm_object_scroll_lock_y_set(Evas_Object *obj, Eina_Bool lock);
 ...
 * @ingroup Elm_Scrollhints
 */
ELEMENTARY_API Eina_Bool elm_object_scroll_lock_x_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Scrollhints
 */
ELEMENTARY_API Eina_Bool elm_object_scroll_lock_y_get(const Evas_Object *obj);
 ...
 * @ingroup Scrollitem
 */
ELEMENTARY_API void      elm_object_scroll_item_loop_enabled_set(Evas_Object *obj, Eina_Bool enable);
 ...
 * @ingroup Scrollitem
 */
ELEMENTARY_API Eina_Bool elm_object_scroll_item_loop_enabled_get(const Evas_Object *obj);
