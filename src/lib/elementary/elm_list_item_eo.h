...
ELM_API_WEAK const Efl_Class *elm_list_item_class_get(void);
 ...
 * @ingroup Elm_List_Item
 */
ELM_API_WEAK void elm_obj_list_item_separator_set(Eo *obj, Eina_Bool setting);
 ...
 * @ingroup Elm_List_Item
 */
ELM_API_WEAK Eina_Bool elm_obj_list_item_separator_get(const Eo *obj);
 ...
 * @ingroup Elm_List_Item
 */
ELM_API_WEAK void elm_obj_list_item_selected_set(Eo *obj, Eina_Bool selected);
 ...
 * @ingroup Elm_List_Item
 */
ELM_API_WEAK Eina_Bool elm_obj_list_item_selected_get(const Eo *obj);
 ...
 * @ingroup Elm_List_Item
 */
ELM_API_WEAK Efl_Canvas_Object *elm_obj_list_item_object_get(const Eo *obj);
 ...
 * @ingroup Elm_List_Item
 */
ELM_API_WEAK Elm_Widget_Item *elm_obj_list_item_prev_get(const Eo *obj);
 ...
 * @ingroup Elm_List_Item
 */
ELM_API_WEAK Elm_Widget_Item *elm_obj_list_item_next_get(const Eo *obj);
 ...
 * @ingroup Elm_List_Item
 */
ELM_API_WEAK void elm_obj_list_item_show(Eo *obj);
 ...
 * @ingroup Elm_List_Item
 */
ELM_API_WEAK void elm_obj_list_item_bring_in(Eo *obj);
