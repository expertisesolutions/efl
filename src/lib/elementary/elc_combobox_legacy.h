 ...
 */
ELEMENTARY_API Evas_Object                 *elm_combobox_add(Evas_Object *parent);
 ...
 */
ELEMENTARY_API Eina_Bool elm_combobox_expanded_get(const Elm_Combobox *obj);
 ...
 * @ingroup Elm_Combobox_Group
 */
ELEMENTARY_API void elm_combobox_hover_begin(Elm_Combobox *obj);
 ...
 * @ingroup Elm_Combobox_Group
 */
ELEMENTARY_API void elm_combobox_hover_end(Elm_Combobox *obj);
