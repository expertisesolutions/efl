 ...
 */
ELEMENTARY_API void elm_widget_resize_object_set(Efl_Ui_Widget *obj, Efl_Canvas_Object *sobj);
 ...
 * @ingroup Elm_Widget_Group
 */
ELEMENTARY_API void elm_widget_disabled_set(Efl_Ui_Widget *obj, Eina_Bool disabled);
 ...
 * @ingroup Elm_Widget_Group
 */
ELEMENTARY_API Eina_Bool elm_widget_disabled_get(const Efl_Ui_Widget *obj);
 ...
 * @ingroup Elm_Widget_Group
 */
ELEMENTARY_API Eina_Error elm_widget_style_set(Efl_Ui_Widget *obj, const char *style);
 ...
 * @ingroup Elm_Widget_Group
 */
ELEMENTARY_API const char *elm_widget_style_get(const Efl_Ui_Widget *obj);
 ...
 * @ingroup Elm_Widget_Group
 */
ELEMENTARY_API void elm_widget_can_focus_set(Efl_Ui_Widget *obj, Eina_Bool can_focus);
 ...
 * @ingroup Elm_Widget_Group
 */
ELEMENTARY_API Eina_Bool elm_widget_can_focus_get(const Efl_Ui_Widget *obj);
 ...
 * @ingroup Elm_Widget_Group
 */
ELEMENTARY_API void elm_widget_parent_set(Efl_Ui_Widget *obj, Efl_Ui_Widget *parent);
 ...
 * @ingroup Elm_Widget_Group
 */
ELEMENTARY_API Efl_Ui_Widget *elm_widget_parent_get(const Efl_Ui_Widget *obj);
 ...
 * @ingroup Elm_Widget_Group
 */
ELEMENTARY_API Eina_Bool elm_widget_sub_object_add(Efl_Ui_Widget *obj, Efl_Canvas_Object *sub_obj);
 ...
 * @ingroup Elm_Widget_Group
 */
ELEMENTARY_API Eina_Bool elm_widget_sub_object_del(Efl_Ui_Widget *obj, Efl_Canvas_Object *sub_obj);
 ...
 * @ingroup Elm_Widget_Group
 */
ELEMENTARY_API Eina_Error elm_widget_theme_apply(Efl_Ui_Widget *obj);
 ...
 * @ingroup Elm_Widget_Group
 */
ELEMENTARY_API Eina_Rect elm_widget_focus_region_get(const Efl_Ui_Widget *obj);
 ...
 * @ingroup Elm_Widget_Group
 */
ELEMENTARY_API Eina_Rect elm_widget_focus_highlight_geometry_get(const Efl_Ui_Widget *obj);
 ...
 * @ingroup Elm_Widget_Group
 */
ELEMENTARY_API Eina_Bool elm_widget_focus_state_apply(Efl_Ui_Widget *obj, Efl_Ui_Widget_Focus_State current_state, Efl_Ui_Widget_Focus_State *configured_state, Efl_Ui_Widget *redirect);
