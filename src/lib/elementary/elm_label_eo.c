...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_label_wrap_width_set, EFL_FUNC_CALL(w), int w);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_label_wrap_width_get, int, 0);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_label_slide_speed_set, EFL_FUNC_CALL(speed), double speed);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_label_slide_speed_get, double, 0);

void _elm_label_slide_mode_set(Eo *obj, Elm_Label_Data *pd, Elm_Label_Slide_Mode mode);

ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_label_slide_mode_set, EFL_FUNC_CALL(mode), Elm_Label_Slide_Mode mode);

Elm_Label_Slide_Mode _elm_label_slide_mode_get(const Eo *obj, Elm_Label_Data *pd);

ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_label_slide_mode_get, Elm_Label_Slide_Mode, 0);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_label_slide_duration_set, EFL_FUNC_CALL(duration), double duration);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_label_slide_duration_get, double, 0);

void _elm_label_line_wrap_set(Eo *obj, Elm_Label_Data *pd, Elm_Wrap_Type wrap);

ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_label_line_wrap_set, EFL_FUNC_CALL(wrap), Elm_Wrap_Type wrap);

Elm_Wrap_Type _elm_label_line_wrap_get(const Eo *obj, Elm_Label_Data *pd);

ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_label_line_wrap_get, Elm_Wrap_Type, 0);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_label_ellipsis_set, EFL_FUNC_CALL(ellipsis), Eina_Bool ellipsis);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_label_ellipsis_get, Eina_Bool, 0);

void _elm_label_slide_go(Eo *obj, Elm_Label_Data *pd);

ELM_API_WEAK EFL_VOID_FUNC_BODY(elm_obj_label_slide_go);
