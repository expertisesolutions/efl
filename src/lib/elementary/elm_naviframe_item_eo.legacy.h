 ...
 */
ELEMENTARY_API void elm_naviframe_item_pop_to(Elm_Naviframe_Item *obj);
 ...
 * @ingroup Elm_Naviframe_Item_Group
 */
ELEMENTARY_API Eina_Bool elm_naviframe_item_title_enabled_get(const Elm_Naviframe_Item *obj);
 ...
 * @ingroup Elm_Naviframe_Item_Group
 */
ELEMENTARY_API void elm_naviframe_item_title_enabled_set(Elm_Naviframe_Item *obj, Eina_Bool enable, Eina_Bool transition);
 ...
 * @ingroup Elm_Naviframe_Item_Group
 */
ELEMENTARY_API void elm_naviframe_item_promote(Elm_Naviframe_Item *obj);
 ...
 * @ingroup Elm_Naviframe_Item_Group
 */
ELEMENTARY_API void elm_naviframe_item_pop_cb_set(Elm_Naviframe_Item *obj, Elm_Naviframe_Item_Pop_Cb func, void *data);
