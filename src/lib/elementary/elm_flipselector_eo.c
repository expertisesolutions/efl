...
ELM_API EFL_FUNC_BODY_CONST(elm_obj_flipselector_items_get, const Eina_List *, NULL);

Elm_Widget_Item *_elm_flipselector_first_item_get(const Eo *obj, Elm_Flipselector_Data *pd);

ELM_API EFL_FUNC_BODY_CONST(elm_obj_flipselector_first_item_get, Elm_Widget_Item *, NULL);

Elm_Widget_Item *_elm_flipselector_last_item_get(const Eo *obj, Elm_Flipselector_Data *pd);

ELM_API EFL_FUNC_BODY_CONST(elm_obj_flipselector_last_item_get, Elm_Widget_Item *, NULL);

Elm_Widget_Item *_elm_flipselector_selected_item_get(const Eo *obj, Elm_Flipselector_Data *pd);

ELM_API EFL_FUNC_BODY_CONST(elm_obj_flipselector_selected_item_get, Elm_Widget_Item *, NULL);
...
ELM_API EFL_VOID_FUNC_BODYV(elm_obj_flipselector_first_interval_set, EFL_FUNC_CALL(interval), double interval);
...
ELM_API EFL_FUNC_BODY_CONST(elm_obj_flipselector_first_interval_get, double, 0);
...
ELM_API EFL_FUNC_BODYV(elm_obj_flipselector_item_prepend, Elm_Widget_Item *, NULL, EFL_FUNC_CALL(label, func, data), const char *label, Evas_Smart_Cb func, void *data);

void _elm_flipselector_flip_next(Eo *obj, Elm_Flipselector_Data *pd);

ELM_API EFL_VOID_FUNC_BODY(elm_obj_flipselector_flip_next);
...
ELM_API EFL_FUNC_BODYV(elm_obj_flipselector_item_append, Elm_Widget_Item *, NULL, EFL_FUNC_CALL(label, func, data), const char *label, Evas_Smart_Cb func, const void *data);

void _elm_flipselector_flip_prev(Eo *obj, Elm_Flipselector_Data *pd);

ELM_API EFL_VOID_FUNC_BODY(elm_obj_flipselector_flip_prev);
