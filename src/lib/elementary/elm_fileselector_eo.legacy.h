 ...
 */
ELEMENTARY_API void elm_fileselector_buttons_ok_cancel_set(Elm_Fileselector *obj, Eina_Bool visible);
 ...
 * @ingroup Elm_Fileselector_Group
 */
ELEMENTARY_API Eina_Bool elm_fileselector_buttons_ok_cancel_get(const Elm_Fileselector *obj);
