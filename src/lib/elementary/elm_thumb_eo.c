ELM_API_WEAK const Efl_Event_Description _ELM_THUMB_EVENT_GENERATE_ERROR =
   EFL_EVENT_DESCRIPTION("generate,error");
ELM_API_WEAK const Efl_Event_Description _ELM_THUMB_EVENT_GENERATE_START =
   EFL_EVENT_DESCRIPTION("generate,start");
ELM_API_WEAK const Efl_Event_Description _ELM_THUMB_EVENT_GENERATE_STOP =
   EFL_EVENT_DESCRIPTION("generate,stop");
ELM_API_WEAK const Efl_Event_Description _ELM_THUMB_EVENT_LOAD_ERROR =
   EFL_EVENT_DESCRIPTION("load,error");
ELM_API_WEAK const Efl_Event_Description _ELM_THUMB_EVENT_PRESS =
