...
ELEMENTARY_API void elm_code_line_free(Elm_Code_Line *line);
 ...
 * @ingroup Content
 */
ELEMENTARY_API void elm_code_line_split_at(Elm_Code_Line *line, unsigned int position);
 ...
 * @ingroup Content
 */
ELEMENTARY_API void elm_code_line_merge_up(Elm_Code_Line *line);
 ...
 * @ingroup Content
 */
ELEMENTARY_API void elm_code_line_merge_down(Elm_Code_Line *line);
...
ELEMENTARY_API void elm_code_line_status_set(Elm_Code_Line *line, Elm_Code_Status_Type status);

ELEMENTARY_API void elm_code_line_status_text_set(Elm_Code_Line *line, const char *text);

ELEMENTARY_API void elm_code_line_status_clear(Elm_Code_Line *line);

ELEMENTARY_API void elm_code_line_token_add(Elm_Code_Line *line, int start, int end, int lines, Elm_Code_Token_Type type);

ELEMENTARY_API void elm_code_line_tokens_clear(Elm_Code_Line *line);

ELEMENTARY_API unsigned int elm_code_line_scope_get(Elm_Code_Line *line);

ELEMENTARY_API Eina_Bool elm_code_line_contains_widget_cursor(Elm_Code_Line *line);
