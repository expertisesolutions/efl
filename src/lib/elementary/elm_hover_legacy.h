 ...
 * @ingroup Elm_Hover
 */
ELEMENTARY_API Evas_Object *elm_hover_add(Evas_Object *parent);
 ...
 * @ingroup Elm_Hover
 */
ELEMENTARY_API void         elm_hover_parent_set(Evas_Object *obj, Evas_Object *parent);
 ...
 * @ingroup Elm_Hover
 */
ELEMENTARY_API Evas_Object *elm_hover_parent_get(const Evas_Object *obj);
