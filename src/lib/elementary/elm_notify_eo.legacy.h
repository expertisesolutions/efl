 ...
 */
ELEMENTARY_API void elm_notify_align_set(Elm_Notify *obj, double horizontal, double vertical);
 ...
 * @ingroup Elm_Notify_Group
 */
ELEMENTARY_API void elm_notify_align_get(const Elm_Notify *obj, double *horizontal, double *vertical);
 ...
 * @ingroup Elm_Notify_Group
 */
ELEMENTARY_API void elm_notify_allow_events_set(Elm_Notify *obj, Eina_Bool allow);
 ...
 * @ingroup Elm_Notify_Group
 */
ELEMENTARY_API Eina_Bool elm_notify_allow_events_get(const Elm_Notify *obj);
 ...
 * @ingroup Elm_Notify_Group
 */
ELEMENTARY_API void elm_notify_timeout_set(Elm_Notify *obj, double timeout);
 ...
 * @ingroup Elm_Notify_Group
 */
ELEMENTARY_API double elm_notify_timeout_get(const Elm_Notify *obj);
 ...
 * @ingroup Elm_Notify_Group
 */
ELEMENTARY_API void elm_notify_dismiss(Elm_Notify *obj);
