 ...
 * @ingroup Elm_Actionslider
 */
ELM_API_WEAK void elm_obj_actionslider_indicator_pos_set(Eo *obj, Elm_Actionslider_Pos pos);
 ...
 * @ingroup Elm_Actionslider
 */
ELM_API_WEAK Elm_Actionslider_Pos elm_obj_actionslider_indicator_pos_get(const Eo *obj);
 ...
 * @ingroup Elm_Actionslider
 */
ELM_API_WEAK void elm_obj_actionslider_magnet_pos_set(Eo *obj, Elm_Actionslider_Pos pos);
 ...
 * @ingroup Elm_Actionslider
 */
ELM_API_WEAK Elm_Actionslider_Pos elm_obj_actionslider_magnet_pos_get(const Eo *obj);
 ...
 * @ingroup Elm_Actionslider
 */
ELM_API_WEAK void elm_obj_actionslider_enabled_pos_set(Eo *obj, Elm_Actionslider_Pos pos);
 ...
 * @ingroup Elm_Actionslider
 */
ELM_API_WEAK Elm_Actionslider_Pos elm_obj_actionslider_enabled_pos_get(const Eo *obj);
 ...
 * @ingroup Elm_Actionslider
 */
ELM_API_WEAK const char *elm_obj_actionslider_selected_label_get(const Eo *obj);
