 ...
 * @ingroup Elm_Image
 */
ELEMENTARY_API Evas_Object     *elm_image_add(Evas_Object *parent);
 ...
 * @ingroup Elm_Image
 */
ELEMENTARY_API Eina_Bool        elm_image_file_set(Evas_Object *obj, const char *file, const char *group);
...
evas image cache if this is a normal image file not eet file.
 */
ELEMENTARY_API void elm_image_file_get(const Eo *obj, const char **file, const char **group);
 ...
 * @ingroup Elm_Image
 */
ELEMENTARY_API void             elm_image_prescale_set(Evas_Object *obj, int size);
 ...
 * @ingroup Elm_Image
 */
ELEMENTARY_API int              elm_image_prescale_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Image
 */
ELEMENTARY_API Eina_Bool        elm_image_mmap_set(Evas_Object *obj, const Eina_File *file, const char *group);
 ...
 * @ingroup Elm_Image
 */
ELEMENTARY_API void elm_image_smooth_set(Evas_Object *obj, Eina_Bool smooth);
 ...
 * @ingroup Elm_Image
 */
ELEMENTARY_API Eina_Bool elm_image_smooth_get(const Evas_Object *obj);
 ...
 */
ELEMENTARY_API void             elm_image_animated_play_set(Evas_Object *obj, Eina_Bool play);
 ...
 * @since 1.7
 */
ELEMENTARY_API Eina_Bool        elm_image_animated_play_get(const Evas_Object *obj);
 ...
 */
ELEMENTARY_API void             elm_image_animated_set(Evas_Object *obj, Eina_Bool anim);
 ...
 *
 */
ELEMENTARY_API Eina_Bool        elm_image_animated_get(const Evas_Object *obj);
 ...
 *
 */
ELEMENTARY_API Eina_Bool        elm_image_animated_available_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Image
 */
ELEMENTARY_API void elm_image_editable_set(Evas_Object *obj, Eina_Bool set);
 ...
 * @ingroup Elm_Image
 */
ELEMENTARY_API Eina_Bool elm_image_editable_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Image
 */
ELEMENTARY_API Eina_Bool elm_image_memfile_set(Evas_Object *obj, const void *img, size_t size, const char *format, const char *key);
 ...
 * @ingroup Elm_Image
 */
ELEMENTARY_API void elm_image_fill_outside_set(Evas_Object *obj, Eina_Bool fill_outside);
 ...
 * @ingroup Elm_Image
 */
ELEMENTARY_API Eina_Bool elm_image_fill_outside_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Image
 */
ELEMENTARY_API void elm_image_preload_disabled_set(Evas_Object *obj, Eina_Bool disabled);
 ...
 * @ingroup Elm_Image
 */
ELEMENTARY_API void elm_image_orient_set(Evas_Object *obj, Elm_Image_Orient orient);
 ...
 * @ingroup Elm_Image
 */
ELEMENTARY_API Elm_Image_Orient elm_image_orient_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Image
 */
ELEMENTARY_API Evas_Object *elm_image_object_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Image
 */
ELEMENTARY_API void elm_image_object_size_get(const Evas_Object *obj, int *w, int *h);
 ...
 * @ingroup Elm_Image
 */
ELEMENTARY_API void elm_image_resizable_set(Evas_Object *obj, Eina_Bool up, Eina_Bool down);
 ...
 * @ingroup Elm_Image
 */
ELEMENTARY_API void elm_image_resizable_get(const Evas_Object *obj, Eina_Bool *up, Eina_Bool *down);
 ...
 * @ingroup Elm_Image
 */
ELEMENTARY_API void elm_image_no_scale_set(Evas_Object *obj, Eina_Bool no_scale);
 ...
 * @ingroup Elm_Image
 */
ELEMENTARY_API Eina_Bool elm_image_no_scale_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Image
 */
ELEMENTARY_API void elm_image_aspect_fixed_set(Evas_Object *obj, Eina_Bool fixed);
 ...
 * @ingroup Elm_Image
 */
ELEMENTARY_API Eina_Bool elm_image_aspect_fixed_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Image
 */
ELEMENTARY_API void elm_image_async_open_set(Evas_Object *obj, Eina_Bool async);
