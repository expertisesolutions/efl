 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API Evas_Object          *elm_win_add(Evas_Object *parent, const char *name, Elm_Win_Type type);
 ...
 * @since 1.13
 */
ELEMENTARY_API Evas_Object          *elm_win_fake_add(Ecore_Evas *ee);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API Evas_Object          *elm_win_util_standard_add(const char *name, const char *title);
 ...
 * @since 1.13
 */
ELEMENTARY_API Evas_Object          *elm_win_util_dialog_add(Evas_Object *parent, const char *name, const char *title);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_autodel_set(Evas_Object *obj, Eina_Bool autodel);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API Eina_Bool elm_win_autodel_get(const Evas_Object *obj);
 ...
 * @since 1.8
 */
ELEMENTARY_API void                  elm_win_floating_mode_set(Evas_Object *obj, Eina_Bool floating);
 ...
 * @since 1.8
 */
ELEMENTARY_API Eina_Bool             elm_win_floating_mode_get(const Evas_Object *obj);
 ...
 * @since 1.7
 */
ELEMENTARY_API void                  elm_win_norender_push(Evas_Object *obj);
 ...
 * @since 1.7
 */
ELEMENTARY_API void                  elm_win_norender_pop(Evas_Object *obj);
 ...
 * @since 1.7
 */
ELEMENTARY_API int                   elm_win_norender_get(const Evas_Object *obj);
 ...
 * @since 1.7
 */
ELEMENTARY_API void                  elm_win_render(Evas_Object *obj);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API Ecore_Wl2_Window *elm_win_wl_window_get(const Evas_Object *obj);
 ...
 * @since 1.16
 */
ELEMENTARY_API Ecore_Win32_Window *elm_win_win32_window_get(const Evas_Object *obj);
 ...
 * @since 1.9
 */
ELEMENTARY_API void                  elm_win_wm_rotation_preferred_rotation_set(Evas_Object *obj, int rotation);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_resize_object_add(Evas_Object *obj, Evas_Object *subobj);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_resize_object_del(Evas_Object *obj, Evas_Object *subobj);

/** Get the Ecore_X_Window of an Evas_Object.
 *
 * @ingroup Elm_Win
 */
ELEMENTARY_API Ecore_X_Window elm_win_xwindow_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API Ecore_Cocoa_Window *elm_win_cocoa_window_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void *elm_win_trap_data_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_override_set(Evas_Object *obj, Eina_Bool override);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API Eina_Bool elm_win_override_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_lower(Evas_Object *obj);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_quickpanel_set(Evas_Object *obj, Eina_Bool quickpanel);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API Eina_Bool elm_win_quickpanel_get(const Evas_Object *obj);
/**
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_quickpanel_zone_set(Evas_Object *obj, int zone);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API int elm_win_quickpanel_zone_get(const Evas_Object *obj);
/**
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_quickpanel_priority_major_set(Evas_Object *obj, int priority);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API int elm_win_quickpanel_priority_major_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_quickpanel_priority_minor_set(Evas_Object *obj, int priority);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API int elm_win_quickpanel_priority_minor_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_indicator_mode_set(Evas_Object *obj, Elm_Win_Indicator_Mode mode);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API Elm_Win_Indicator_Mode elm_win_indicator_mode_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_indicator_opacity_set(Evas_Object *obj, Elm_Win_Indicator_Opacity_Mode mode);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API Elm_Win_Indicator_Opacity_Mode elm_win_indicator_opacity_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_keyboard_win_set(Evas_Object *obj, Eina_Bool is_keyboard);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API Eina_Bool elm_win_keyboard_win_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_conformant_set(Evas_Object *obj, Eina_Bool conformant);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API Eina_Bool elm_win_conformant_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_wm_rotation_manual_rotation_done_set(Evas_Object *obj, Eina_Bool set);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API Eina_Bool elm_win_wm_rotation_manual_rotation_done_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_wm_rotation_manual_rotation_done(Evas_Object *obj);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_rotation_set(Evas_Object *obj, int rotation);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API int elm_win_rotation_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_rotation_with_resize_set(Evas_Object *obj, int rotation);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API Eina_Bool elm_win_wm_rotation_supported_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API int elm_win_wm_rotation_preferred_rotation_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_screen_position_get(const Evas_Object *obj, int *x, int *y);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_screen_size_get(const Evas_Object *obj, int *x, int *y, int *w, int *h);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_screen_dpi_get(const Evas_Object *obj, int *xdpi, int *ydpi);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_icon_name_set(Evas_Object *obj, const char *icon_name);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API const char *elm_win_icon_name_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_withdrawn_set(Evas_Object *obj, Eina_Bool withdrawn);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API Eina_Bool elm_win_withdrawn_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_urgent_set(Evas_Object *obj, Eina_Bool urgent);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API Eina_Bool elm_win_urgent_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_demand_attention_set(Evas_Object *obj, Eina_Bool demand_attention);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API Eina_Bool elm_win_demand_attention_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_modal_set(Evas_Object *obj, Eina_Bool modal);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API Eina_Bool elm_win_modal_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_shaped_set(Evas_Object *obj, Eina_Bool shaped);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API Eina_Bool elm_win_shaped_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_title_set(Evas_Object *obj, const char *title);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API const char *elm_win_title_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_size_base_set(Evas_Object *obj, int w, int h);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_size_base_get(const Evas_Object *obj, int *w, int *h);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_size_step_set(Evas_Object *obj, int w, int h);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_size_step_get(const Evas_Object *obj, int *w, int *h);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_illume_command_send(Evas_Object *obj, Elm_Illume_Command command, void *params);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_profile_set(Evas_Object *obj, const char *profile);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API const char *elm_win_profile_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_layer_set(Evas_Object *obj, int layer);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API int elm_win_layer_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API Evas_Object *elm_win_inlined_image_object_get(const Evas_Object *obj);
 ...
 * @deprecated
 */
ELEMENTARY_API void elm_win_fake_canvas_set(Evas_Object *obj, Ecore_Evas *oee) EINA_DEPRECATED;
 ...
 */
ELEMENTARY_API Ecore_Window          elm_win_window_id_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API Evas_Object *elm_win_main_menu_get(Evas_Object *obj);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_keyboard_mode_set(Elm_Win *obj, Elm_Win_Keyboard_Mode mode);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API Elm_Win_Keyboard_Mode elm_win_keyboard_mode_get(const Elm_Win *obj);
 ...
 */
ELEMENTARY_API void elm_win_aspect_set(Elm_Win *obj, double aspect);
 ...
 * by height.
 */
ELEMENTARY_API double elm_win_aspect_get(const Elm_Win *obj);
 ...
 */
ELEMENTARY_API Eina_Bool elm_win_keygrab_set(Elm_Win *obj, const char *key, Evas_Modifier_Mask modifiers, Evas_Modifier_Mask not_modifiers, int priority, Elm_Win_Keygrab_Mode grab_mode);
 ...
 * @return @c true on success, @c false otherwise
 */
ELEMENTARY_API Eina_Bool elm_win_keygrab_unset(Elm_Win *obj, const char *key, Evas_Modifier_Mask modifiers, Evas_Modifier_Mask not_modifiers);
 ...
 * @since 1.20
 */
ELEMENTARY_API Evas_Object *elm_win_get(Evas_Object *obj);
 ...
 * @ingroup Efl_Ui_Win
 */
ELEMENTARY_API Eina_Bool elm_win_socket_listen(Elm_Win *obj, const char *svcname, int svcnum, Eina_Bool svcsys);
 ...
 * @ingroup Efl_Ui_Win
 */
ELEMENTARY_API Eina_Bool elm_win_focus_get(const Elm_Win *obj);
 ...
 * @ingroup Efl_Ui_Win
 */
ELEMENTARY_API void elm_win_raise(Elm_Win *obj);
 ...
 * @ingroup Efl_Ui_Win
 */
ELEMENTARY_API void elm_win_available_profiles_set(Elm_Win *obj, const char **profiles, unsigned int count);
 ...
 * @ingroup Efl_Ui_Win
 */
ELEMENTARY_API Eina_Bool elm_win_available_profiles_get(const Elm_Win *obj, char ***profiles, unsigned int *count);
 ...
 * @ingroup Efl_Ui_Win
 */
ELEMENTARY_API void elm_win_wm_rotation_available_rotations_set(Elm_Win *obj, const int *rotations, unsigned int count);
 ...
 * @ingroup Efl_Ui_Win
 */
ELEMENTARY_API Eina_Bool elm_win_wm_rotation_available_rotations_get(const Elm_Win *obj, int **rotations, unsigned int *count);
 ...
 */
ELEMENTARY_API void elm_win_screen_constrain_set(Evas_Object *obj, Eina_Bool constrain);
 ...
 * @ingroup Elm_Win_Group
 */
ELEMENTARY_API Eina_Bool elm_win_screen_constrain_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win_Group
 */
ELEMENTARY_API void elm_win_prop_focus_skip_set(Evas_Object *obj, Eina_Bool skip);
 ...
 * @ingroup Elm_Win_Group
 */
ELEMENTARY_API void elm_win_autohide_set(Evas_Object *obj, Eina_Bool autohide);
 ...
 * @ingroup Elm_Win_Group
 */
ELEMENTARY_API Eina_Bool elm_win_autohide_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win_Group
 */
ELEMENTARY_API void elm_win_icon_object_set(Evas_Object *obj, Evas_Object *icon);
 ...
 * @ingroup Elm_Win_Group
 */
ELEMENTARY_API const Evas_Object *elm_win_icon_object_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win_Group
 */
ELEMENTARY_API void elm_win_iconified_set(Evas_Object *obj, Eina_Bool iconified);
 ...
 * @ingroup Elm_Win_Group
 */
ELEMENTARY_API Eina_Bool elm_win_iconified_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win_Group
 */
ELEMENTARY_API void elm_win_maximized_set(Evas_Object *obj, Eina_Bool maximized);
 ...
 * @ingroup Elm_Win_Group
 */
ELEMENTARY_API Eina_Bool elm_win_maximized_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win_Group
 */
ELEMENTARY_API void elm_win_fullscreen_set(Evas_Object *obj, Eina_Bool fullscreen);
 ...
 * @ingroup Elm_Win_Group
 */
ELEMENTARY_API Eina_Bool elm_win_fullscreen_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win_Group
 */
ELEMENTARY_API void elm_win_sticky_set(Evas_Object *obj, Eina_Bool sticky);
 ...
 * @ingroup Elm_Win_Group
 */
ELEMENTARY_API Eina_Bool elm_win_sticky_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win_Group
 */
ELEMENTARY_API void elm_win_noblank_set(Evas_Object *obj, Eina_Bool noblank);
 ...
 * @ingroup Elm_Win_Group
 */
ELEMENTARY_API Eina_Bool elm_win_noblank_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win_Group
 */
ELEMENTARY_API void elm_win_borderless_set(Evas_Object *obj, Eina_Bool borderless);
 ...
 * @ingroup Elm_Win_Group
 */
ELEMENTARY_API Eina_Bool elm_win_borderless_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win_Group
 */
ELEMENTARY_API void elm_win_role_set(Evas_Object *obj, const char *role);
 ...
 * @ingroup Elm_Win_Group
 */
ELEMENTARY_API const char *elm_win_role_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win_Group
 */
ELEMENTARY_API const char *elm_win_name_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win_Group
 */
ELEMENTARY_API Elm_Win_Type elm_win_type_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win_Group
 */
ELEMENTARY_API const char *elm_win_accel_preference_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win_Group
 */
ELEMENTARY_API void elm_win_alpha_set(Evas_Object *obj, Eina_Bool alpha);
 ...
 * @ingroup Elm_Win_Group
 */
ELEMENTARY_API Eina_Bool elm_win_alpha_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Win_Group
 */
ELEMENTARY_API void elm_win_activate(Evas_Object *obj);
 ...
 * @ingroup Elm_Win_Group
 */
ELEMENTARY_API void elm_win_center(Evas_Object *obj, Eina_Bool h, Eina_Bool v);
 ...
 * @ingroup Elm_Win_Group
 */
ELEMENTARY_API Eina_Bool elm_win_move_resize_start(Evas_Object *obj, Elm_Win_Move_Resize_Mode mode);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_focus_highlight_animate_set(Elm_Win *obj, Eina_Bool animate);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API Eina_Bool elm_win_focus_highlight_animate_get(const Elm_Win *obj);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API void elm_win_focus_highlight_enabled_set(Elm_Win *obj, Eina_Bool enabled);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API Eina_Bool elm_win_focus_highlight_enabled_get(const Elm_Win *obj);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API Eina_Bool elm_win_focus_highlight_style_set(Elm_Win *obj, const char *style);
 ...
 * @ingroup Elm_Win
 */
ELEMENTARY_API const char *elm_win_focus_highlight_style_get(const Elm_Win *obj);
