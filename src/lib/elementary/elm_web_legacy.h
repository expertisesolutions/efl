 ...
 * @ingroup Elm_Web
 */
ELEMENTARY_API Evas_Object      *elm_web_add(Evas_Object *parent);
 ...
 * @ingroup Elm_Web
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool         elm_web_uri_set(Evas_Object *obj, const char *uri);
 ...
 * @ingroup Elm_Web
 */
EINA_DEPRECATED ELEMENTARY_API const char       *elm_web_uri_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Web
 */
ELEMENTARY_API void elm_web_zoom_mode_set(Evas_Object *obj, Elm_Web_Zoom_Mode mode);
 ...
 * @ingroup Elm_Web
 */
ELEMENTARY_API Elm_Web_Zoom_Mode elm_web_zoom_mode_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Web
 */
ELEMENTARY_API void elm_web_zoom_set(Evas_Object *obj, double zoom);
 ...
 * @ingroup Elm_Web
 */
ELEMENTARY_API double elm_web_zoom_get(const Evas_Object *obj);
