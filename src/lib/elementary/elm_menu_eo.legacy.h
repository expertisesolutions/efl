 ...
 */
ELEMENTARY_API Elm_Widget_Item *elm_menu_selected_item_get(const Elm_Menu *obj);
 ...
 * @ingroup Elm_Menu_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_menu_first_item_get(const Elm_Menu *obj);
 ...
 * @ingroup Elm_Menu_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_menu_last_item_get(const Elm_Menu *obj);
 ...
 * @ingroup Elm_Menu_Group
 */
ELEMENTARY_API const Eina_List *elm_menu_items_get(const Elm_Menu *obj);
 ...
 * @ingroup Elm_Menu_Group
 */
ELEMENTARY_API void elm_menu_move(Elm_Menu *obj, int x, int y);
 ...
 * @ingroup Elm_Menu_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_menu_item_add(Elm_Menu *obj, Elm_Widget_Item *parent, const char *icon, const char *label, Evas_Smart_Cb func, const void *data);
 ...
 * @ingroup Elm_Menu_Group
 */
ELEMENTARY_API void elm_menu_open(Elm_Menu *obj);
 ...
 * @ingroup Elm_Menu_Group
 */
ELEMENTARY_API void elm_menu_close(Elm_Menu *obj);
 ...
 * @ingroup Elm_Menu_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_menu_item_separator_add(Elm_Menu *obj, Elm_Widget_Item *parent);
