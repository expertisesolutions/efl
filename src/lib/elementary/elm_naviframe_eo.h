...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_NAVIFRAME_EVENT_TRANSITION_FINISHED;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_NAVIFRAME_EVENT_TITLE_TRANSITION_FINISHED;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_NAVIFRAME_EVENT_TITLE_CLICKED;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_NAVIFRAME_EVENT_ITEM_ACTIVATED;
