 ...
 */
ELEMENTARY_API void elm_slideshow_item_show(Elm_Slideshow_Item *obj);
 ...
 * @ingroup Elm_Slideshow_Item_Group
 */
ELEMENTARY_API Efl_Canvas_Object *elm_slideshow_item_object_get(const Elm_Slideshow_Item *obj);
