 ...
 */
ELEMENTARY_API Eina_Bool elm_glview_resize_policy_set(Elm_Glview *obj, Elm_GLView_Resize_Policy policy);
 ...
 * @ingroup Elm_Glview_Group
 */
ELEMENTARY_API Eina_Bool elm_glview_render_policy_set(Elm_Glview *obj, Elm_GLView_Render_Policy policy);
 ...
 * @ingroup Elm_Glview_Group
 */
ELEMENTARY_API Eina_Bool elm_glview_mode_set(Elm_Glview *obj, Elm_GLView_Mode mode);
 ...
 * @ingroup Elm_Glview_Group
 */
ELEMENTARY_API Evas_GL_API *elm_glview_gl_api_get(const Elm_Glview *obj);
 ...
 * @ingroup Elm_Glview_Group
 */
ELEMENTARY_API Evas_GL *elm_glview_evas_gl_get(const Elm_Glview *obj);
 ...
 * @ingroup Elm_Glview_Group
 */
ELEMENTARY_API int elm_glview_rotation_get(const Elm_Glview *obj);
