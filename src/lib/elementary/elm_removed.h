 ...
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_toggle_add(Evas_Object *parent);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_toggle_label_set(Evas_Object *obj, const char *label);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API const char  *elm_toggle_label_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_toggle_icon_set(Evas_Object *obj, Evas_Object *icon);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_toggle_icon_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_toggle_icon_unset(Evas_Object *obj);
 ...
 * instead.
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_toggle_states_labels_set(Evas_Object *obj, const char *onlabel, const char *offlabel);
 ...
 * instead.
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_toggle_states_labels_get(const Evas_Object *obj, const char **onlabel, const char **offlabel);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_toggle_state_set(Evas_Object *obj, Eina_Bool state);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool    elm_toggle_state_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_toggle_state_pointer_set(Evas_Object *obj, Eina_Bool *statep);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API const char *elm_engine_current_get(void);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void       elm_finger_size_all_set(Evas_Coord size);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void   elm_scale_all_set(double scale);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void             elm_font_overlay_all_apply(void);
 ...
 * @ingroup Elm_Caches
 */
EINA_DEPRECATED ELEMENTARY_API void      elm_cache_flush_interval_all_set(int size);
 ...
 * @ingroup Elm_Caches
 */
EINA_DEPRECATED ELEMENTARY_API void      elm_cache_flush_enabled_all_set(Eina_Bool enabled);
 ...
 * @ingroup Elm_Caches
 */
EINA_DEPRECATED ELEMENTARY_API void      elm_font_cache_all_set(int size);
 ...
 * @ingroup Elm_Caches
 */
EINA_DEPRECATED ELEMENTARY_API void      elm_image_cache_all_set(int size);
 ...
 * @ingroup Elm_Caches
 */
EINA_DEPRECATED ELEMENTARY_API void      elm_edje_file_cache_all_set(int size);
 ...
 * @ingroup Elm_Caches
 */
EINA_DEPRECATED ELEMENTARY_API void      elm_edje_collection_cache_all_set(int size);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void        elm_profile_all_set(const char *profile);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_scroll_bounce_enabled_all_set(Eina_Bool enabled);
 ...
 * @ingroup Elm_Scrolling
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_scroll_bounce_friction_all_set(double friction);
 ...
 * @ingroup Elm_Scrolling
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_scroll_page_scroll_friction_all_set(double friction);
 ...
 * @ingroup Elm_Scrolling
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_scroll_bring_in_scroll_friction_all_set(double friction);
 ...
 * @ingroup Elm_Scrolling
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_scroll_zoom_friction_all_set(double friction);
 ...
 * @ingroup Elm_Scrolling
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_scroll_thumbscroll_enabled_all_set(Eina_Bool enabled);
 ...
 * @ingroup Elm_Scrolling
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_scroll_thumbscroll_threshold_all_set(unsigned int threshold);
 ...
 * @ingroup Elm_Scrolling
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_scroll_thumbscroll_momentum_threshold_all_set(double threshold);
 ...
 * @ingroup Elm_Scrolling
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_scroll_thumbscroll_friction_all_set(double friction);
 ...
 * @ingroup Elm_Scrolling
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_scroll_thumbscroll_border_friction_all_set(double friction);
 ...
 * @ingroup Elm_Scrolling
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_scroll_thumbscroll_sensitivity_friction_all_set(double friction);

EINA_DEPRECATED ELEMENTARY_API void          elm_gen_clear(Evas_Object *obj);
EINA_DEPRECATED ELEMENTARY_API void          elm_gen_item_selected_set(Elm_Gen_Item *it, Eina_Bool selected);
EINA_DEPRECATED ELEMENTARY_API Eina_Bool     elm_gen_item_selected_get(const Elm_Gen_Item *it);
EINA_DEPRECATED ELEMENTARY_API void          elm_gen_always_select_mode_set(Evas_Object *obj, Eina_Bool always_select);
EINA_DEPRECATED ELEMENTARY_API Eina_Bool     elm_gen_always_select_mode_get(const Evas_Object *obj);
EINA_DEPRECATED ELEMENTARY_API void          elm_gen_no_select_mode_set(Evas_Object *obj, Eina_Bool no_select);
EINA_DEPRECATED ELEMENTARY_API Eina_Bool     elm_gen_no_select_mode_get(const Evas_Object *obj);
EINA_DEPRECATED ELEMENTARY_API void          elm_gen_bounce_set(Evas_Object *obj, Eina_Bool h_bounce, Eina_Bool v_bounce);
EINA_DEPRECATED ELEMENTARY_API void          elm_gen_bounce_get(const Evas_Object *obj, Eina_Bool *h_bounce, Eina_Bool *v_bounce);
EINA_DEPRECATED ELEMENTARY_API void          elm_gen_page_relative_set(Evas_Object *obj, double h_pagerel, double v_pagerel);
EINA_DEPRECATED ELEMENTARY_API void          elm_gen_page_relative_get(const Evas_Object *obj, double *h_pagerel, double *v_pagerel);

EINA_DEPRECATED ELEMENTARY_API void          elm_gen_page_size_set(Evas_Object *obj, Evas_Coord h_pagesize, Evas_Coord v_pagesize);
EINA_DEPRECATED ELEMENTARY_API void          elm_gen_current_page_get(const Evas_Object *obj, int *h_pagenumber, int *v_pagenumber);
EINA_DEPRECATED ELEMENTARY_API void          elm_gen_last_page_get(const Evas_Object *obj, int *h_pagenumber, int *v_pagenumber);
EINA_DEPRECATED ELEMENTARY_API void          elm_gen_page_show(const Evas_Object *obj, int h_pagenumber, int v_pagenumber);
EINA_DEPRECATED ELEMENTARY_API void          elm_gen_page_bring_in(const Evas_Object *obj, int h_pagenumber, int v_pagenumber);
EINA_DEPRECATED ELEMENTARY_API Elm_Gen_Item *elm_gen_first_item_get(const Evas_Object *obj);
EINA_DEPRECATED ELEMENTARY_API Elm_Gen_Item *elm_gen_last_item_get(const Evas_Object *obj);
EINA_DEPRECATED ELEMENTARY_API Elm_Gen_Item *elm_gen_item_next_get(const Elm_Gen_Item *it);
EINA_DEPRECATED ELEMENTARY_API Elm_Gen_Item *elm_gen_item_prev_get(const Elm_Gen_Item *it);
EINA_DEPRECATED ELEMENTARY_API Evas_Object  *elm_gen_item_widget_get(const Elm_Gen_Item *it);
 ...
 * @deprecated use elm_object_text_set() instead.
 */
EINA_DEPRECATED ELEMENTARY_API void        elm_anchorblock_text_set(Evas_Object *obj, const char *text);
 ...
 * @deprecated use elm_object_text_set() instead.
 */
EINA_DEPRECATED ELEMENTARY_API const char *elm_anchorblock_text_get(const Evas_Object *obj);
 ...
 * @deprecated use elm_object_text_set() instead.
 */
EINA_DEPRECATED ELEMENTARY_API void        elm_anchorview_text_set(Evas_Object *obj, const char *text);
 ...
 * @deprecated use elm_object_text_set() instead.
 */
EINA_DEPRECATED ELEMENTARY_API const char *elm_anchorview_text_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool                    elm_ctxpopup_item_disabled_get(const Elm_Object_Item *it);
 ...
 * @ingroup Elm_Ctxpopup
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_ctxpopup_item_disabled_set(Elm_Object_Item *it, Eina_Bool disabled);
 ...
 * @ingroup Elm_Ctxpopup
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_ctxpopup_item_icon_get(const Elm_Object_Item *it);
 ...
 * @ingroup Elm_Ctxpopup
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_ctxpopup_item_icon_set(Elm_Object_Item *it, Evas_Object *icon);
 ...
 * @ingroup Elm_Ctxpopup
 */
EINA_DEPRECATED ELEMENTARY_API const char  *elm_ctxpopup_item_label_get(const Elm_Object_Item *it);
 ...
 * @ingroup Elm_Ctxpopup
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_ctxpopup_item_label_set(Elm_Object_Item *it, const char *label);
 ...
 * @ingroup Elm_Ctxpopup
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_ctxpopup_content_set(Evas_Object *obj, Evas_Object *content);
 ...
 * @ingroup Elm_Ctxpopup
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_ctxpopup_content_unset(Evas_Object *obj);
 ...
 * @ingroup Elm_Ctxpopup
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_ctxpopup_item_del(Elm_Object_Item *it);
 ...
 * @deprecated use elm_object_text_set() instead.
 */
EINA_DEPRECATED ELEMENTARY_API void        elm_fileselector_button_label_set(Evas_Object *obj, const char *label);
 ...
 * @deprecated use elm_object_text_set() instead.
 */
EINA_DEPRECATED ELEMENTARY_API const char *elm_fileselector_button_label_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                        elm_fileselector_button_icon_set(Evas_Object *obj, Evas_Object *icon);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object                *elm_fileselector_button_icon_get(const Evas_Object *obj);
 ...
 * @see elm_fileselector_button_icon_set()
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object                *elm_fileselector_button_icon_unset(Evas_Object *obj);
 ...
 * @deprecated use elm_object_text_set() instead.
 */
EINA_DEPRECATED ELEMENTARY_API void        elm_fileselector_entry_button_label_set(Evas_Object *obj, const char *label);
 ...
 * @deprecated use elm_object_text_set() instead.
 */
EINA_DEPRECATED ELEMENTARY_API const char *elm_fileselector_entry_button_label_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                        elm_fileselector_entry_button_icon_set(Evas_Object *obj, Evas_Object *icon);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object                *elm_fileselector_entry_button_icon_get(const Evas_Object *obj);
 ...
 * @see elm_fileselector_entry_button_icon_set()
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object                *elm_fileselector_entry_button_icon_unset(Evas_Object *obj);
 ...
 * @deprecated Use elm_object_part_content_set() instead
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_hover_content_set(Evas_Object *obj, const char *swallow, Evas_Object *content);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_hover_content_get(const Evas_Object *obj, const char *swallow);
 ...
 * @see elm_object_part_content_set()
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_hover_content_unset(Evas_Object *obj, const char *swallow);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_hoversel_label_set(Evas_Object *obj, const char *label);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API const char  *elm_hoversel_label_get(const Evas_Object *obj);
 ...
 * @deprecated Use elm_object_item_part_content_set() instead
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_hoversel_icon_set(Evas_Object *obj, Evas_Object *icon);
 ...
 * @deprecated Use elm_object_item_part_content_get() instead
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_hoversel_icon_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_hoversel_icon_unset(Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void        *elm_hoversel_item_data_get(const Elm_Object_Item *it);
 ...
 * @deprecated Use elm_object_item_text_get() instead
 */
EINA_DEPRECATED ELEMENTARY_API const char  *elm_hoversel_item_label_get(const Elm_Object_Item *it);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_hoversel_item_del_cb_set(Elm_Object_Item *it, Evas_Smart_Cb func);
 ...
 * @see elm_hoversel_item_add()
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_hoversel_item_del(Elm_Object_Item *it);
 ...
 * @deprecated use elm_object_text_set() instead.
 */
EINA_DEPRECATED ELEMENTARY_API void        elm_actionslider_labels_set(Evas_Object *obj, const char *left_label, const char *center_label, const char *right_label);
 ...
 * @deprecated use elm_object_text_set() instead.
 */
EINA_DEPRECATED ELEMENTARY_API void        elm_actionslider_labels_get(const Evas_Object *obj, const char **left_label, const char **center_label, const char **right_label);
 ...
 * @deprecated use elm_object_text_set() instead.
 */
EINA_DEPRECATED ELEMENTARY_API void        elm_actionslider_indicator_label_set(Evas_Object *obj, const char *label);
 ...
 * @deprecated use elm_object_text_get() instead.
 */
EINA_DEPRECATED ELEMENTARY_API const char *elm_actionslider_indicator_label_get(Evas_Object *obj);
...
EINA_DEPRECATED ELEMENTARY_API void         elm_bg_overlay_set(Evas_Object *obj, Evas_Object *overlay);
 ...
 * @ingroup Elm_Bg
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_bg_overlay_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Bg
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_bg_overlay_unset(Evas_Object *obj);
 ...
 * @deprecated use elm_object_text_set() instead.
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_bubble_label_set(Evas_Object *obj, const char *label);
 ...
 * @deprecated use elm_object_text_get() instead.
 */
EINA_DEPRECATED ELEMENTARY_API const char  *elm_bubble_label_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_bubble_info_set(Evas_Object *obj, const char *info);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API const char  *elm_bubble_info_get(const Evas_Object *obj);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_bubble_content_set(Evas_Object *obj, Evas_Object *content);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_bubble_content_get(const Evas_Object *obj);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_bubble_content_unset(Evas_Object *obj);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_bubble_icon_set(Evas_Object *obj, Evas_Object *icon);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_bubble_icon_get(const Evas_Object *obj);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_bubble_icon_unset(Evas_Object *obj);
 ...
 * @deprecated use elm_object_text_set() instead.
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_button_label_set(Evas_Object *obj, const char *label);
 ...
 * @deprecated use elm_object_text_set() instead.
 */
EINA_DEPRECATED ELEMENTARY_API const char  *elm_button_label_get(const Evas_Object *obj);
 ...
 * @deprecated use elm_object_part_content_set() instead.
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_button_icon_set(Evas_Object *obj, Evas_Object *icon);
 ...
 * @deprecated use elm_object_part_content_get() instead
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_button_icon_get(const Evas_Object *obj);
 ...
 * @deprecated use elm_object_part_content_unset() instead.
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_button_icon_unset(Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void elm_calendar_text_saturday_color_set(Evas_Object *obj, int pos);
 ...
 * @ingroup Elm_Calendar
 */
EINA_DEPRECATED ELEMENTARY_API void elm_calendar_text_sunday_color_set(Evas_Object *obj, int pos);
 ...
 * @ingroup Elm_Calendar
 */
EINA_DEPRECATED ELEMENTARY_API void elm_calendar_text_weekday_color_set(Evas_Object *obj, int pos);
 ...
 * @deprecated use elm_object_text_set() instead.
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_check_label_set(Evas_Object *obj, const char *label);
 ...
 * @deprecated use elm_object_text_get() instead.
 */
EINA_DEPRECATED ELEMENTARY_API const char  *elm_check_label_get(const Evas_Object *obj);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_check_icon_set(Evas_Object *obj, Evas_Object *icon);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_check_icon_get(const Evas_Object *obj);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_check_icon_unset(Evas_Object *obj);
...
EINA_DEPRECATED ELEMENTARY_API void         elm_check_states_labels_set(Evas_Object *obj, const char *ontext, const char *offtext);
EINA_DEPRECATED ELEMENTARY_API void         elm_check_states_labels_get(const Evas_Object *obj, const char **ontext, const char **offtext);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_conformant_content_set(Evas_Object *obj, Evas_Object *content);
 ...
 * @ingroup Elm_Conformant
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_conformant_content_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Conformant
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_conformant_content_unset(Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API int    elm_diskselector_side_label_lenght_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Diskselector
 */
EINA_DEPRECATED ELEMENTARY_API void   elm_diskselector_side_label_lenght_set(Evas_Object *obj, int len);
 ...
 * @ingroup Elm_Diskselector
 */
EINA_DEPRECATED ELEMENTARY_API void                  *elm_diskselector_item_data_get(const Elm_Object_Item *it);
 ...
 * @ingroup Elm_Diskselector
 */
EINA_DEPRECATED ELEMENTARY_API void                   elm_diskselector_item_icon_set(Elm_Object_Item *it, Evas_Object *icon);
 ...
 * @ingroup Elm_Diskselector
 */
ELEMENTARY_API Evas_Object           *elm_diskselector_item_icon_get(const Elm_Object_Item *it);
 ...
 * @ingroup Elm_Diskselector
 */
EINA_DEPRECATED ELEMENTARY_API void                   elm_diskselector_item_label_set(Elm_Object_Item *it, const char *label);
 ...
 * @ingroup Elm_Diskselector
 */
EINA_DEPRECATED ELEMENTARY_API const char            *elm_diskselector_item_label_get(const Elm_Object_Item *it);
 ...
 * @ingroup Elm_Diskselector
 */
EINA_DEPRECATED ELEMENTARY_API void                   elm_diskselector_item_del_cb_set(Elm_Object_Item *it, Evas_Smart_Cb func);
 ...
 * @ingroup Elm_Diskselector
 */
EINA_DEPRECATED ELEMENTARY_API void                   elm_diskselector_item_del(Elm_Object_Item *it);
 ...
 * @ingroup Elm_Diskselector
 */
EINA_DEPRECATED ELEMENTARY_API void                   elm_diskselector_item_tooltip_text_set(Elm_Object_Item *it, const char *text);
 ...
 * @ingroup Elm_Diskselector
 */
EINA_DEPRECATED ELEMENTARY_API void                   elm_diskselector_item_tooltip_content_cb_set(Elm_Object_Item *it, Elm_Tooltip_Item_Content_Cb func, const void *data, Evas_Smart_Cb del_cb);
 ...
 * @ingroup Elm_Diskselector
 */
EINA_DEPRECATED ELEMENTARY_API void                   elm_diskselector_item_tooltip_unset(Elm_Object_Item *it);
 ...
 * @ingroup Elm_Diskselector
 */
EINA_DEPRECATED ELEMENTARY_API void                   elm_diskselector_item_tooltip_style_set(Elm_Object_Item *it, const char *style);
 ...
 * @ingroup Elm_Diskselector
 */
EINA_DEPRECATED ELEMENTARY_API const char            *elm_diskselector_item_tooltip_style_get(const Elm_Object_Item *it);
 ...
 * @ingroup Elm_Diskselector
 */
EINA_DEPRECATED ELEMENTARY_API void                   elm_diskselector_item_cursor_set(Elm_Object_Item *it, const char *cursor);
 ...
 * @ingroup Elm_Diskselector
 */
EINA_DEPRECATED ELEMENTARY_API const char            *elm_diskselector_item_cursor_get(const Elm_Object_Item *it);
 ...
 * @ingroup Elm_Diskselector
 */
EINA_DEPRECATED ELEMENTARY_API void                   elm_diskselector_item_cursor_unset(Elm_Object_Item *it);
 ...
 * @ingroup Elm_Diskselector
 */
EINA_DEPRECATED ELEMENTARY_API void                   elm_diskselector_item_cursor_style_set(Elm_Object_Item *it, const char *style);
 ...
 * @ingroup Elm_Diskselector
 */
EINA_DEPRECATED ELEMENTARY_API const char            *elm_diskselector_item_cursor_style_get(const Elm_Object_Item *it);
 ...
 * @ingroup Elm_Diskselector
 */
EINA_DEPRECATED ELEMENTARY_API void                   elm_diskselector_item_cursor_engine_only_set(Elm_Object_Item *it, Eina_Bool engine_only);
 ...
 * @ingroup Elm_Diskselector
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool              elm_diskselector_item_cursor_engine_only_get(const Elm_Object_Item *it);

EINA_DEPRECATED ELEMENTARY_API void         elm_factory_content_set(Evas_Object *obj, Evas_Object *content);
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_factory_content_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API const char *elm_flipselector_item_label_get(const Elm_Object_Item *it);
 ...
 * @ingroup Elm_Flipselector
 */
EINA_DEPRECATED ELEMENTARY_API void        elm_flipselector_item_label_set(Elm_Object_Item *it, const char *label);
 ...
 * @ingroup Elm_Flipselector
 */
EINA_DEPRECATED ELEMENTARY_API void       elm_flipselector_item_del(Elm_Object_Item *it);
 ...
 * @ingroup Elm_Flipselector
 */
EINA_DEPRECATED ELEMENTARY_API void                        elm_flipselector_interval_set(Evas_Object *obj, double interval);
 ...
 * @ingroup Elm_Flipselector
 */
EINA_DEPRECATED ELEMENTARY_API double                      elm_flipselector_interval_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Focus
 */
EINA_DEPRECATED ELEMENTARY_API void elm_object_focus(Evas_Object *obj);
 ...
 * @ingroup Elm_Focus
 */
EINA_DEPRECATED ELEMENTARY_API void                 elm_object_focus_cycle(Evas_Object *obj, Elm_Focus_Direction dir);
 ...
 * @ingroup Elm_Focus
 */
EINA_DEPRECATED ELEMENTARY_API void elm_object_unfocus(Evas_Object *obj);
 ...
 * @ingroup Elm_Focus
 */
EINA_DEPRECATED ELEMENTARY_API void                 elm_object_focus_direction_go(Evas_Object *obj, int x, int y);
 ...
 * @deprecated use elm_object_text_set() instead.
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_frame_label_set(Evas_Object *obj, const char *label);
 ...
 * @deprecated use elm_object_text_get() instead.
 */
EINA_DEPRECATED ELEMENTARY_API const char  *elm_frame_label_get(const Evas_Object *obj);
 ...
 * @deprecated use elm_object_content_set() instead.
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_frame_content_set(Evas_Object *obj, Evas_Object *content);
 ...
 * @deprecated use elm_object_content_get() instead.
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_frame_content_get(const Evas_Object *obj);
 ...
 * @deprecated use elm_object_content_unset() instead.
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_frame_content_unset(Evas_Object *obj);

EINA_DEPRECATED ELEMENTARY_API void          elm_genlist_horizontal_mode_set(Evas_Object *obj, Elm_List_Mode mode);
EINA_DEPRECATED ELEMENTARY_API Elm_List_Mode elm_genlist_horizontal_mode_get(const Evas_Object *obj);
EINA_DEPRECATED ELEMENTARY_API void          elm_genlist_item_icons_orphan(Elm_Object_Item *it);
/**
 ...
 * @ingroup Elm_Genlist
 */
EINA_DEPRECATED ELEMENTARY_API void                          elm_genlist_horizontal_set(Evas_Object *obj, Elm_List_Mode mode);
 ...
 * @ingroup Elm_Genlist
 */
EINA_DEPRECATED ELEMENTARY_API Elm_List_Mode                 elm_genlist_horizontal_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Genlist
 */
EINA_DEPRECATED ELEMENTARY_API void                         *elm_genlist_item_data_get(const Elm_Object_Item *it);
 ...
 * @ingroup Elm_Genlist
 */
EINA_DEPRECATED ELEMENTARY_API void                          elm_genlist_item_data_set(Elm_Object_Item *it, const void *data);
 ...
 * @ingroup Elm_Genlist
 */
EINA_DEPRECATED ELEMENTARY_API void                          elm_genlist_item_disabled_set(Elm_Object_Item *it, Eina_Bool disabled);
 ...
 * @ingroup Elm_Genlist
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool                     elm_genlist_item_disabled_get(const Elm_Object_Item *it);
 ...
 * @ingroup Elm_Genlist
 */
EINA_DEPRECATED ELEMENTARY_API void                          elm_genlist_item_del(Elm_Object_Item *it);
 ...
 * @ingroup Elm_Genlist
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object                  *elm_genlist_item_genlist_get(const Elm_Object_Item *it);
 ...
 * @ingroup Elm_Genlist
 */
EINA_DEPRECATED ELEMENTARY_API const char                   *elm_genlist_mode_item_style_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Genlist
 */
EINA_DEPRECATED ELEMENTARY_API void                          elm_genlist_mode_item_style_set(Evas_Object *obj, const char *style);
 ...
 * @ingroup Elm_Genlist
 */
EINA_DEPRECATED ELEMENTARY_API Elm_Genlist_Item_Type        elm_genlist_item_flags_get(const Elm_Object_Item *it);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                          elm_genlist_item_contents_orphan(Elm_Object_Item *it);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void *elm_index_item_data_get(const Elm_Object_Item *item);
 ...
 * @deprecated Use elm_object_item_data_set() instead
 */
EINA_DEPRECATED ELEMENTARY_API void  elm_index_item_data_set(Elm_Object_Item *it, const void *data);
 ...
 * @deprecated Use elm_object_item_del_cb_set() instead
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_index_item_del_cb_set(Elm_Object_Item *it, Evas_Smart_Cb func);
 ...
 * @deprecated Use elm_object_item_del() instead
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_index_item_del(Evas_Object *obj, Elm_Object_Item *item);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void        elm_label_label_set(Evas_Object *obj, const char *label);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API const char *elm_label_label_get(const Evas_Object *obj);
...
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_list_item_base_get(const Elm_Object_Item *it);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_mapbuf_content_set(Evas_Object *obj, Evas_Object *content);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_mapbuf_content_get(const Evas_Object *obj);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_mapbuf_content_unset(Evas_Object *obj);
 ...
 * @deprecated Use elm_object_item_text_set() instead
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_menu_item_label_set(Elm_Object_Item *it, const char *label);
 ...
 * @deprecated Use elm_object_item_text_get() instead
 */
EINA_DEPRECATED ELEMENTARY_API const char  *elm_menu_item_label_get(const Elm_Object_Item *it);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool    elm_menu_item_object_content_set(Elm_Object_Item *it, Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_menu_item_object_content_get(const Elm_Object_Item *it);
 ...
 * @deprecated Use elm_object_item_disabled_set() instead
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_menu_item_disabled_set(Elm_Object_Item *it, Eina_Bool disabled);
 ...
 * @deprecated Use elm_object_item_disabled_get() instead
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool    elm_menu_item_disabled_get(const Elm_Object_Item *it);
 ...
 * @deprecated Use elm_object_item_data_get() instead
 */
EINA_DEPRECATED ELEMENTARY_API void        *elm_menu_item_data_get(const Elm_Object_Item *it);
 ...
 * @deprecated Use elm_object_item_del_cb_set() instead
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_menu_item_del_cb_set(Elm_Object_Item *it, Evas_Smart_Cb func);
 ...
 * @deprecated Use elm_object_item_data_set() instead
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_menu_item_data_set(Elm_Object_Item *it, const void *data);
 ...
 * @see elm_menu_item_add()
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_menu_item_del(Elm_Object_Item *it);
 ...
 * @deprecated Use elm_object_item_widget_get() instead
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object                 *elm_menu_item_menu_get(const Elm_Object_Item *it);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_menu_item_object_icon_name_set(Elm_Object_Item *it, const char *icon);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API const char                  *elm_menu_item_object_icon_name_get(const Elm_Object_Item *it);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_notify_content_set(Evas_Object *obj, Evas_Object *content);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_notify_content_unset(Evas_Object *obj);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_notify_content_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_object_text_part_set(Evas_Object *obj, const char *part, const char *label);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API const char  *elm_object_text_part_get(const Evas_Object *obj, const char *part);
 ...
 * @deprecated Use elm_object_part_content_set instead.
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_object_content_part_set(Evas_Object *obj, const char *part, Evas_Object *content);
 ...
 * @deprecated Use elm_object_part_content_get instead.
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_object_content_part_get(const Evas_Object *obj, const char *part);
 ...
 * @deprecated Use elm_object_part_content_unset instead.
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_object_content_part_unset(Evas_Object *obj, const char *part);
 ...
 * @deprecated Use elm_object_item_part_content_set instead.
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_object_item_content_part_set(Elm_Object_Item *it, const char *part, Evas_Object *content);
 ...
 * @deprecated Use elm_object_item_part_content_get instead.
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object                 *elm_object_item_content_part_get(const Elm_Object_Item *it, const char *part);
 ...
 * @deprecated Use elm_object_item_part_content_unset instead.
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_object_item_content_part_unset(Elm_Object_Item *it, const char *part);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API const char  *elm_object_item_text_part_get(const Elm_Object_Item *it, const char *part);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_object_item_text_part_set(Elm_Object_Item *it, const char *part, const char *label);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_panel_content_set(Evas_Object *obj, Evas_Object *content);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_panel_content_get(const Evas_Object *obj);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_panel_content_unset(Evas_Object *obj);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_panes_content_left_set(Evas_Object *obj, Evas_Object *content);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_panes_content_right_set(Evas_Object *obj, Evas_Object *content);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_panes_content_left_get(const Evas_Object *obj);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_panes_content_right_get(const Evas_Object *obj);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_panes_content_left_unset(Evas_Object *obj);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_panes_content_right_unset(Evas_Object *obj);
/**
 ...
 * @deprecated use elm_object_text_set() instead.
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_progressbar_label_set(Evas_Object *obj, const char *label);
 ...
 * @deprecated use elm_object_text_set() instead.
 */
EINA_DEPRECATED ELEMENTARY_API const char  *elm_progressbar_label_get(const Evas_Object *obj);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_progressbar_icon_set(Evas_Object *obj, Evas_Object *icon);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_progressbar_icon_get(const Evas_Object *obj);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_progressbar_icon_unset(Evas_Object *obj);
 ...
 * @deprecated use elm_object_text_set() instead.
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_radio_label_set(Evas_Object *obj, const char *label);
 ...
 * @deprecated use elm_object_text_set() instead.
 */
EINA_DEPRECATED ELEMENTARY_API const char  *elm_radio_label_get(const Evas_Object *obj);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_radio_icon_set(Evas_Object *obj, Evas_Object *icon);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_radio_icon_get(const Evas_Object *obj);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_radio_icon_unset(Evas_Object *obj);
 ...
 * @deprecated use elm_object_text_set() instead.
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_slider_label_set(Evas_Object *obj, const char *label);
 ...
 * @deprecated use elm_object_text_get() instead.
 */
EINA_DEPRECATED ELEMENTARY_API const char  *elm_slider_label_get(const Evas_Object *obj);
 ...
 * @deprecated use elm_object_part_content_set() instead.
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_slider_icon_set(Evas_Object *obj, Evas_Object *icon);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_slider_icon_unset(Evas_Object *obj);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_slider_icon_get(const Evas_Object *obj);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_slider_end_set(Evas_Object *obj, Evas_Object *end);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_slider_end_unset(Evas_Object *obj);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_slider_end_get(const Evas_Object *obj);
 ...
 * @deprecated use elm_object_item_data_get() instead
 */
EINA_DEPRECATED ELEMENTARY_API void *elm_slideshow_item_data_get(const Elm_Object_Item *it);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_slideshow_item_del(Elm_Object_Item *it);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_slideshow_show(Elm_Object_Item *it);
 ...
 * @deprecated use elm_object_item_widget_get() instead.
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_toolbar_item_toolbar_get(const Elm_Object_Item *it);
 ...
 * @deprecated use elm_object_item_text_get() instead.
 */
EINA_DEPRECATED ELEMENTARY_API const char  *elm_toolbar_item_label_get(const Elm_Object_Item *it);
 ...
 * @deprecated use elm_object_item_text_set() instead
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_toolbar_item_label_set(Elm_Object_Item *it, const char *label);
 ...
 * @deprecated use elm_object_item_data_get() instead.
 */
EINA_DEPRECATED ELEMENTARY_API void        *elm_toolbar_item_data_get(const Elm_Object_Item *it);
 ...
 * @deprecated use elm_object_item_data_set() instead.
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_toolbar_item_data_set(Elm_Object_Item *it, const void *data);
 ...
 * @deprecated use elm_object_item_disabled_get() instead.
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool    elm_toolbar_item_disabled_get(const Elm_Object_Item *it);
 ...
 * @deprecated use elm_object_item_disabled_set() instead.
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_toolbar_item_disabled_set(Elm_Object_Item *it, Eina_Bool disabled);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_toolbar_orientation_set(Evas_Object *obj, Eina_Bool vertical);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool    elm_toolbar_orientation_get(const Evas_Object *obj);
 ...
 * @deprecated Use elm_object_item_del_cb_set() instead
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_toolbar_item_del_cb_set(Elm_Object_Item *it, Evas_Smart_Cb func);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_toolbar_item_del(Elm_Object_Item *it);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_toolbar_item_tooltip_content_cb_set(Elm_Object_Item *it, Elm_Tooltip_Item_Content_Cb func, const void *data, Evas_Smart_Cb del_cb);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_toolbar_item_tooltip_unset(Elm_Object_Item *it);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_toolbar_item_tooltip_style_set(Elm_Object_Item *it, const char *style);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API const char                  *elm_toolbar_item_tooltip_style_get(const Elm_Object_Item *it);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_toolbar_item_cursor_set(Elm_Object_Item *it, const char *cursor);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API const char                  *elm_toolbar_item_cursor_get(const Elm_Object_Item *it);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_toolbar_item_cursor_unset(Elm_Object_Item *it);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_toolbar_item_cursor_style_set(Elm_Object_Item *it, const char *style);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API const char                  *elm_toolbar_item_cursor_style_get(const Elm_Object_Item *it);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_toolbar_item_cursor_engine_only_set(Elm_Object_Item *it, Eina_Bool engine_only);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool                    elm_toolbar_item_cursor_engine_only_get(const Elm_Object_Item *it);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void elm_player_video_set(Evas_Object *player, Evas_Object *video);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void              elm_segment_control_item_label_set(Elm_Object_Item *it, const char *label);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void              elm_segment_control_item_icon_set(Elm_Object_Item *it, Evas_Object *icon);
 ...
 * @deprecated Use elm_object_item_del() instead
 */
EINA_DEPRECATED ELEMENTARY_API void              elm_segment_control_item_del(Elm_Object_Item *it);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API const char                *elm_multibuttonentry_label_get(const Evas_Object *obj);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                       elm_multibuttonentry_label_set(Evas_Object *obj, const char *label);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API const char                *elm_multibuttonentry_item_label_get(const Elm_Object_Item *it);
 ...
 * @deprecated Use elm_object_item_text_set() instead
 */
EINA_DEPRECATED ELEMENTARY_API void                       elm_multibuttonentry_item_label_set(Elm_Object_Item *it, const char *str);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                       elm_multibuttonentry_item_del(Elm_Object_Item *it);
 ...
 * @deprecated Use elm_object_item_del() instead
 */
EINA_DEPRECATED ELEMENTARY_API void             elm_naviframe_item_del(Elm_Object_Item *it);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_list_item_disabled_set(Elm_Object_Item *it, Eina_Bool disabled);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool                    elm_list_item_disabled_get(const Elm_Object_Item *it);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool                    elm_list_item_tooltip_window_mode_set(Elm_Object_Item *it, Eina_Bool disable);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool                    elm_list_item_tooltip_window_mode_get(const Elm_Object_Item *it);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_list_item_del_cb_set(Elm_Object_Item *it, Evas_Smart_Cb func);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                        *elm_list_item_data_get(const Elm_Object_Item *it);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object                 *elm_list_item_icon_get(const Elm_Object_Item *it);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_list_item_icon_set(Elm_Object_Item *it, Evas_Object *icon);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object                 *elm_list_item_end_get(const Elm_Object_Item *it);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_list_item_end_set(Elm_Object_Item *it, Evas_Object *end);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API const char                  *elm_list_item_label_get(const Elm_Object_Item *it);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_list_item_label_set(Elm_Object_Item *it, const char *text);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_list_item_tooltip_text_set(Elm_Object_Item *it, const char *text);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_list_item_tooltip_content_cb_set(Elm_Object_Item *it, Elm_Tooltip_Item_Content_Cb func, const void *data, Evas_Smart_Cb del_cb);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_list_item_tooltip_unset(Elm_Object_Item *it);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_list_item_tooltip_style_set(Elm_Object_Item *it, const char *style);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API const char                  *elm_list_item_tooltip_style_get(const Elm_Object_Item *it);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_list_item_cursor_set(Elm_Object_Item *it, const char *cursor);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API const char                  *elm_list_item_cursor_get(const Elm_Object_Item *it);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_list_item_cursor_unset(Elm_Object_Item *it);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_list_item_cursor_style_set(Elm_Object_Item *it, const char *style);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API const char                  *elm_list_item_cursor_style_get(const Elm_Object_Item *it);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool                    elm_list_item_cursor_engine_only_get(const Elm_Object_Item *it);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_list_item_del(Elm_Object_Item *it);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void               elm_entry_icon_set(Evas_Object *obj, Evas_Object *icon);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object       *elm_entry_icon_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object       *elm_entry_icon_unset(Evas_Object *obj);
 ...
 * @see elm_entry_icon_set
 */
EINA_DEPRECATED ELEMENTARY_API void               elm_entry_end_set(Evas_Object *obj, Evas_Object *end);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object       *elm_entry_end_get(const Evas_Object *obj);
 ...
 * @see elm_entry_icon_set()
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object       *elm_entry_end_unset(Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_map_utils_rotate_coord(const Evas_Object *obj, const Evas_Coord x, const Evas_Coord y, const Evas_Coord cx, const Evas_Coord cy, const double degree, Evas_Coord *xx, Evas_Coord *yy);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_map_canvas_to_geo_convert(const Evas_Object *obj, const Evas_Coord x, const Evas_Coord y, double *lon, double *lat);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_map_geo_region_get(const Evas_Object *obj, double *lon, double *lat);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_map_geo_region_bring_in(Evas_Object *obj, double lon, double lat);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_map_geo_region_show(Evas_Object *obj, double lon, double lat);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_map_source_zoom_min_set(Evas_Object *obj, int zoom);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API int                   elm_map_source_zoom_min_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_map_source_zoom_max_set(Evas_Object *obj, int zoom);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API int                   elm_map_source_zoom_max_get(const Evas_Object *obj);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API const char          **elm_map_source_names_get(const Evas_Object *obj);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_map_source_name_set(Evas_Object *obj, const char *source_name);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API const char           *elm_map_source_name_get(const Evas_Object *obj);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_map_route_source_set(Evas_Object *obj, Elm_Map_Route_Sources source);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Elm_Map_Route_Sources elm_map_route_source_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_map_max_marker_per_group_set(Evas_Object *obj, int max);
 ...
 * @deprecated Use Elm_Map_Overlay instead
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_map_paused_markers_set(Evas_Object *obj, Eina_Bool paused);
 ...
 * @deprecated Use Elm_Map_Overlay instead
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool             elm_map_paused_markers_get(const Evas_Object *obj);
 ...
 * @deprecated Use Elm_Map_Overlay instead
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_map_bubbles_close(Evas_Object *obj);
 ...
 * @deprecated Use Elm_Map_Overlay instead
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_map_group_class_style_set(Elm_Map_Group_Class *clas, const char *style);
 ...
 * @deprecated Use Elm_Map_Overlay instead
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_map_group_class_icon_cb_set(Elm_Map_Group_Class *clas, Elm_Map_Group_Icon_Get_Func icon_get);
 ...
 * @deprecated Use Elm_Map_Overlay instead
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_map_group_class_data_set(Elm_Map_Group_Class *clas, void *data);
 ...
 * @deprecated Use Elm_Map_Overlay instead
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_map_group_class_zoom_displayed_set(Elm_Map_Group_Class *clas, int zoom);
 ...
 * @deprecated Use Elm_Map_Overlay instead
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_map_group_class_zoom_grouped_set(Elm_Map_Group_Class *clas, int zoom);
 ...
 * @deprecated Use Elm_Map_Overlay instead
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_map_group_class_hide_set(Evas_Object *obj, Elm_Map_Group_Class *clas, Eina_Bool hide);
 ...
 * @deprecated Use Elm_Map_Overlay instead
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_map_marker_class_style_set(Elm_Map_Marker_Class *clas, const char *style);
 ...
 * @deprecated Use Elm_Map_Overlay instead
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_map_marker_class_icon_cb_set(Elm_Map_Marker_Class *clas, Elm_Map_Marker_Icon_Get_Func icon_get);
 ...
 * @deprecated Use Elm_Map_Overlay instead
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_map_marker_class_get_cb_set(Elm_Map_Marker_Class *clas, Elm_Map_Marker_Get_Func get);
 ...
 * @deprecated Use Elm_Map_Overlay instead
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_map_marker_class_del_cb_set(Elm_Map_Marker_Class *clas, Elm_Map_Marker_Del_Func del);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_map_route_color_set(Elm_Map_Route *route, int r, int g, int b, int a);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_map_route_color_get(const Elm_Map_Route *route, int *r, int *g, int *b, int *a);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_map_name_remove(Elm_Map_Name *name);
 ...
 * @deprecated Use elm_object_item_widget_get() instead
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object                  *elm_gengrid_item_gengrid_get(const Elm_Object_Item *it);
 ...
 * @deprecated Use elm_object_item_data_get() instead
 */
EINA_DEPRECATED ELEMENTARY_API void                         *elm_gengrid_item_data_get(const Elm_Object_Item *it);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                          elm_gengrid_item_data_set(Elm_Object_Item *it, const void *data);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                          elm_gengrid_item_disabled_set(Elm_Object_Item *it, Eina_Bool disabled);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool                     elm_gengrid_item_disabled_get(const Elm_Object_Item *it);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                          elm_gengrid_item_del(Elm_Object_Item *it);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                          elm_gengrid_item_item_class_set(Elm_Object_Item *it, const Elm_Gengrid_Item_Class *gic);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Elm_Object_Item             *elm_gengrid_item_direct_sorted_insert(Evas_Object *obj, const Elm_Gengrid_Item_Class *gic, const void *data, Eina_Compare_Cb comp, Evas_Smart_Cb func, const void *func_data);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void               elm_entry_text_filter_append(Evas_Object *obj, Elm_Entry_Filter_Cb func, void *data);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void               elm_entry_text_filter_prepend(Evas_Object *obj, Elm_Entry_Filter_Cb func, void *data);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void               elm_entry_text_filter_remove(Evas_Object *obj, Elm_Entry_Filter_Cb func, void *data);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                 elm_flip_content_front_set(Evas_Object *obj, Evas_Object *content);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                 elm_flip_content_back_set(Evas_Object *obj, Evas_Object *content);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object         *elm_flip_content_front_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object         *elm_flip_content_back_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object         *elm_flip_content_front_unset(Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object         *elm_flip_content_back_unset(Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool            elm_flip_front_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                        elm_label_fontsize_set(Evas_Object *obj, int fontsize);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                        elm_label_text_color_set(Evas_Object *obj, unsigned int r, unsigned int g, unsigned int b, unsigned int a);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                        elm_label_text_align_set(Evas_Object *obj, const char *alignmode);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                        elm_label_background_color_set(Evas_Object *obj, unsigned int r, unsigned int g, unsigned int b, unsigned int a);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                        elm_label_wrap_height_set(Evas_Object *obj, Evas_Coord h);
 ...
 * @deprecated This function should not be used because of wrong concept.
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Coord                  elm_label_wrap_height_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void      elm_all_flush(void);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                 elm_video_uri_set(Evas_Object *video, const char *uri);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                   elm_photocam_region_get(const Evas_Object *obj, int *x, int *y, int *w, int *h);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void		    elm_photocam_gesture_set(Evas_Object *obj, Eina_Bool gesture);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool		    elm_photocam_gesture_get(const Evas_Object *obj);
 ...
 *             instead.
 */
EINA_DEPRECATED ELEMENTARY_API double       elm_route_lon_min_get(Evas_Object *obj);
EINA_DEPRECATED ELEMENTARY_API double       elm_route_lat_min_get(Evas_Object *obj);
EINA_DEPRECATED ELEMENTARY_API double       elm_route_lon_max_get(Evas_Object *obj);
EINA_DEPRECATED ELEMENTARY_API double       elm_route_lat_max_get(Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API double      elm_tooltip_delay_get(void);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool   elm_tooltip_delay_set(double delay);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void elm_bubble_corner_set(Evas_Object *obj, const char *corner);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API const char *elm_bubble_corner_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                 elm_calendar_day_selection_enabled_set(Evas_Object *obj, Eina_Bool enabled);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool            elm_calendar_day_selection_enabled_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API int       elm_font_cache_get(void);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void      elm_font_cache_set(int size);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API int       elm_image_cache_get(void);
EINA_DEPRECATED ELEMENTARY_API int       elm_cache_image_cache_size_get(void);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void      elm_image_cache_set(int size);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API int       elm_edje_file_cache_get(void);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void      elm_edje_file_cache_set(int size);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API int       elm_edje_collection_cache_get(void);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void      elm_edje_collection_cache_set(int size);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool         elm_web_history_enable_get(const Evas_Object *obj);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void              elm_web_history_enable_set(Evas_Object *obj, Eina_Bool enable);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Elm_Object_Item             *elm_menu_item_add_object(Evas_Object *obj, Elm_Object_Item *parent, Evas_Object *subobj, Evas_Smart_Cb func, const void *data);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_notify_repeat_events_set(Evas_Object *obj, Eina_Bool repeat);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool                    elm_notify_repeat_events_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void        elm_object_cursor_engine_only_set(Evas_Object *obj, Eina_Bool engine_only);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool   elm_object_cursor_engine_only_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_index_item_go(Evas_Object *obj, int level);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_index_active_set(Evas_Object *obj, Eina_Bool active);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool             elm_index_active_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Elm_Object_Item      *elm_index_item_append_relative(Evas_Object *obj, const char *letter, const void *item, const Elm_Object_Item *relative);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Elm_Object_Item      *elm_index_item_prepend_relative(Evas_Object *obj, const char *letter, const void *item, const Elm_Object_Item *relative);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_win_transparent_set(Evas_Object *obj, Eina_Bool transparent);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool             elm_win_transparent_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void             elm_theme_all_set(const char *theme);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object                 *elm_conformant_content_area_get(const Evas_Object *obj);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void             elm_image_scale_set(Evas_Object *obj, Eina_Bool scale_up, Eina_Bool scale_down);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void             elm_image_scale_get(const Evas_Object *obj, Eina_Bool *scale_up, Eina_Bool *scale_down);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_icon_scale_set(Evas_Object *obj, Eina_Bool scale_up, Eina_Bool scale_down);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_icon_scale_get(const Evas_Object *obj, Eina_Bool *scale_up, Eina_Bool *scale_down);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                  elm_icon_preload_set(Evas_Object *obj, Eina_Bool disable);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Elm_Object_Item      *elm_index_item_selected_get(const Evas_Object *obj, int level);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API int                        elm_multibuttonentry_shrink_mode_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                       elm_multibuttonentry_shrink_mode_set(Evas_Object *obj, int shrink_mode);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API const char                *elm_multibuttonentry_guide_text_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                       elm_multibuttonentry_guide_text_set(Evas_Object *obj, const char *guidetext);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                 elm_object_tree_unfocusable_set(Evas_Object *obj, Eina_Bool tree_unfocusable);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool            elm_object_tree_unfocusable_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void elm_genlist_item_top_bring_in(Elm_Object_Item *it);
 ...
 * @deprecated elm_genlist_item_bring_in()
 */
EINA_DEPRECATED ELEMENTARY_API void elm_genlist_item_middle_bring_in(Elm_Object_Item *it);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                          elm_genlist_item_top_show(Elm_Object_Item *it);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                          elm_genlist_item_middle_show(Elm_Object_Item *it);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                   elm_diskselector_round_set(Evas_Object *obj, Eina_Bool round);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                          elm_gengrid_always_select_mode_set(Evas_Object *obj, Eina_Bool always_select);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool                     elm_gengrid_always_select_mode_get(const Evas_Object *obj);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                          elm_gengrid_no_select_mode_set(Evas_Object *obj, Eina_Bool no_select);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool                     elm_gengrid_no_select_mode_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API int                    elm_diskselector_side_label_length_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                   elm_diskselector_side_label_length_set(Evas_Object *obj, int len);
 ...
 * @ingroup Elm_Toolbar
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_toolbar_always_select_mode_set(Evas_Object *obj, Eina_Bool always_select);
 ...
 * @ingroup Elm_Toolbar
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool                    elm_toolbar_always_select_mode_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Toolbar
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_toolbar_no_select_mode_set(Evas_Object *obj, Eina_Bool no_select);
 ...
 * @ingroup Elm_Toolbar
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool                    elm_toolbar_no_select_mode_get(const Evas_Object *obj);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void              elm_clock_interval_set(Evas_Object *obj, double interval);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API double            elm_clock_interval_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void              elm_clock_digit_edit_set(Evas_Object *obj, Elm_Clock_Edit_Mode digedit);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Elm_Clock_Edit_Mode elm_clock_digit_edit_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool         elm_web_backward_possible(Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool         elm_web_forward_possible(Evas_Object *obj);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool         elm_web_navigate_possible(Evas_Object *obj, int steps);
 ...
 * @deprecated use elm_object_content_set() instead
 */
EINA_DEPRECATED ELEMENTARY_API void         elm_scroller_content_set(Evas_Object *obj, Evas_Object *child);
 ...
 * @deprecated use elm_object_content_get() instead.
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_scroller_content_get(const Evas_Object *obj);
 ...
 * @deprecated use elm_object_content_unset() instead.
 */
EINA_DEPRECATED ELEMENTARY_API Evas_Object *elm_scroller_content_unset(Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_toolbar_mode_shrink_set(Evas_Object *obj, Elm_Toolbar_Shrink_Mode shrink_mode);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Elm_Toolbar_Shrink_Mode      elm_toolbar_mode_shrink_get(const Evas_Object *obj);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_toolbar_item_tooltip_text_set(Elm_Object_Item *it, const char *text);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                         elm_list_always_select_mode_set(Evas_Object *obj, Eina_Bool always_select);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool                    elm_list_always_select_mode_get(const Evas_Object *obj);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API const Evas_Object            *elm_genlist_item_object_get(const Elm_Object_Item *it);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                          elm_genlist_always_select_mode_set(Evas_Object *obj, Eina_Bool always_select);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool                     elm_genlist_always_select_mode_get(const Evas_Object *obj);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API void                          elm_genlist_no_select_mode_set(Evas_Object *obj, Eina_Bool no_select);
 ...
 *
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool                     elm_genlist_no_select_mode_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                          elm_genlist_compress_mode_set(Evas_Object *obj, Eina_Bool compress);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                          elm_genlist_item_display_only_set(Elm_Object_Item *it, Eina_Bool display_only);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool                     elm_genlist_item_display_only_get(const Elm_Object_Item *it);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool                     elm_genlist_compress_mode_get(const Evas_Object *obj);
 ...
 * @deprecated elm_genlist_mode_set(obj, ELM_LIST_COMPRESS)
 */
EINA_DEPRECATED ELEMENTARY_API void                          elm_genlist_height_for_width_mode_set(Evas_Object *obj, Eina_Bool height_for_width);
 ...
 * @deprecated elm_genlist_mode_set(obj, ELM_LIST_COMPRESS)
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool                     elm_genlist_height_for_width_mode_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                          elm_genlist_item_mode_set(Elm_Object_Item *it, const char *mode_type, Eina_Bool mode_set);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API const char                   *elm_genlist_mode_type_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API const Elm_Object_Item       *elm_genlist_mode_item_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void               elm_genlist_edit_mode_set(Evas_Object *obj, Eina_Bool edit_mode);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API Eina_Bool          elm_genlist_edit_mode_get(const Evas_Object *obj);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void elm_win_teamwork_uri_preload(Efl_Ui_Win *obj, const char *uri);
 ...
 * @deprecated This is a possibly security issue and is non-portable outside enlightenment and there is no code to detect if it exists and even works, so better not to have this
 */
EINA_DEPRECATED ELEMENTARY_API void elm_win_teamwork_uri_show(Efl_Ui_Win *obj, const char *uri);
 ...
 * @deprecated This is a possibly security issue and is non-portable outside enlightenment and there is no code to detect if it exists and even works, so better not to have this
 */
EINA_DEPRECATED ELEMENTARY_API void elm_win_teamwork_uri_hide(Efl_Ui_Win *obj);
 ...
 * @deprecated This is a possibly security issue and is non-portable outside enlightenment and there is no code to detect if it exists and even works, so better not to have this
 */
EINA_DEPRECATED ELEMENTARY_API void elm_win_teamwork_uri_open(Efl_Ui_Win *obj, const char *uri);
