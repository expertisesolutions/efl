 ...
 * @ingroup Elm_Panel
 */
ELM_API_WEAK void elm_obj_panel_orient_set(Eo *obj, Elm_Panel_Orient orient);
 ...
 * @ingroup Elm_Panel
 */
ELM_API_WEAK Elm_Panel_Orient elm_obj_panel_orient_get(const Eo *obj);
 ...
 * @ingroup Elm_Panel
 */
ELM_API_WEAK void elm_obj_panel_hidden_set(Eo *obj, Eina_Bool hidden);
 ...
 * @ingroup Elm_Panel
 */
ELM_API_WEAK Eina_Bool elm_obj_panel_hidden_get(const Eo *obj);
 ...
 * @ingroup Elm_Panel
 */
ELM_API_WEAK void elm_obj_panel_scrollable_set(Eo *obj, Eina_Bool scrollable);
 ...
 * @ingroup Elm_Panel
 */
ELM_API_WEAK Eina_Bool elm_obj_panel_scrollable_get(const Eo *obj);
 ...
 * @ingroup Elm_Panel
 */
ELM_API_WEAK void elm_obj_panel_scrollable_content_size_set(Eo *obj, double ratio);
 ...
 * @ingroup Elm_Panel
 */
ELM_API_WEAK double elm_obj_panel_scrollable_content_size_get(const Eo *obj);

/** Toggle the hidden state of the panel from code
 *
 * @ingroup Elm_Panel
 */
ELM_API_WEAK void elm_obj_panel_toggle(Eo *obj);
