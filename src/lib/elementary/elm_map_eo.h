 ...
 * @ingroup Elm_Map
 */
ELM_API_WEAK void elm_obj_map_zoom_min_set(Eo *obj, int zoom);
 ...
 * @ingroup Elm_Map
 */
ELM_API_WEAK int elm_obj_map_zoom_min_get(const Eo *obj);
 ...
 * @ingroup Elm_Map
 */
ELM_API_WEAK void elm_obj_map_rotate_set(Eo *obj, double degree, int cx, int cy);
 ...
 * @ingroup Elm_Map
 */
ELM_API_WEAK void elm_obj_map_rotate_get(const Eo *obj, double *degree, int *cx, int *cy);
 ...
 * @ingroup Elm_Map
 */
ELM_API_WEAK void elm_obj_map_user_agent_set(Eo *obj, const char *user_agent);
 ...
 * @ingroup Elm_Map
 */
ELM_API_WEAK const char *elm_obj_map_user_agent_get(const Eo *obj);
 ...
 * @ingroup Elm_Map
 */
ELM_API_WEAK void elm_obj_map_zoom_max_set(Eo *obj, int zoom);
 ...
 * @ingroup Elm_Map
 */
ELM_API_WEAK int elm_obj_map_zoom_max_get(const Eo *obj);
 ...
 * @ingroup Elm_Map
 */
ELM_API_WEAK void elm_obj_map_region_get(const Eo *obj, double *lon, double *lat);
 ...
 * @ingroup Elm_Map
 */
ELM_API_WEAK Eina_List *elm_obj_map_overlays_get(const Eo *obj);
 ...
 * @ingroup Elm_Map
 */
ELM_API_WEAK void elm_obj_map_tile_load_status_get(const Eo *obj, int *try_num, int *finish_num);
 ...
 * @ingroup Elm_Map
 */
ELM_API_WEAK void elm_obj_map_source_set(Eo *obj, Elm_Map_Source_Type type, const char *source_name);
 ...
 * @ingroup Elm_Map
 */
ELM_API_WEAK const char *elm_obj_map_source_get(const Eo *obj, Elm_Map_Source_Type type);
 ...
 * @ingroup Elm_Map
 */
ELM_API_WEAK Elm_Map_Route *elm_obj_map_route_add(Eo *obj, Elm_Map_Route_Type type, Elm_Map_Route_Method method, double flon, double flat, double tlon, double tlat, Elm_Map_Route_Cb route_cb, void *data);
 ...
 * @ingroup Elm_Map
 */
ELM_API_WEAK Efl_Canvas_Object *elm_obj_map_track_add(Eo *obj, void *emap);
 ...
 * @ingroup Elm_Map
 */
ELM_API_WEAK void elm_obj_map_region_to_canvas_convert(const Eo *obj, double lon, double lat, int *x, int *y);
 ...
 * @ingroup Elm_Map
 */
ELM_API_WEAK Elm_Map_Overlay *elm_obj_map_overlay_circle_add(Eo *obj, double lon, double lat, double radius);
 ...
 * @ingroup Elm_Map
 */
ELM_API_WEAK Elm_Map_Overlay *elm_obj_map_overlay_class_add(Eo *obj);
 ...
 * @ingroup Elm_Map
 */
ELM_API_WEAK Elm_Map_Overlay *elm_obj_map_overlay_bubble_add(Eo *obj);
 ...
 * @ingroup Elm_Map
 */
ELM_API_WEAK const char **elm_obj_map_sources_get(const Eo *obj, Elm_Map_Source_Type type);
 ...
 * @ingroup Elm_Map
 */
ELM_API_WEAK Elm_Map_Overlay *elm_obj_map_overlay_polygon_add(Eo *obj);
 ...
 * @ingroup Elm_Map
 */
ELM_API_WEAK Elm_Map_Overlay *elm_obj_map_overlay_line_add(Eo *obj, double flon, double flat, double tlon, double tlat);
 ...
 * @ingroup Elm_Map
 */
ELM_API_WEAK void elm_obj_map_region_show(Eo *obj, double lon, double lat);
 ...
 * @ingroup Elm_Map
 */
ELM_API_WEAK Elm_Map_Name *elm_obj_map_name_add(const Eo *obj, const char *address, double lon, double lat, Elm_Map_Name_Cb name_cb, void *data);
 ...
 * @ingroup Elm_Map
 */
ELM_API_WEAK void elm_obj_map_name_search(const Eo *obj, const char *address, Elm_Map_Name_List_Cb name_cb, void *data);
 ...
 * @ingroup Elm_Map
 */
ELM_API_WEAK void elm_obj_map_region_bring_in(Eo *obj, double lon, double lat);
 ...
 * @ingroup Elm_Map
 */
ELM_API_WEAK void elm_obj_map_region_zoom_bring_in(Eo *obj, int zoom, double lon, double lat);
 ...
 * @ingroup Elm_Map
 */
ELM_API_WEAK void elm_obj_map_track_remove(Eo *obj, Efl_Canvas_Object *route);
 ...
 * @ingroup Elm_Map
 */
ELM_API_WEAK Elm_Map_Overlay *elm_obj_map_overlay_route_add(Eo *obj, const Elm_Map_Route *route);
 ...
 * @ingroup Elm_Map
 */
ELM_API_WEAK Elm_Map_Overlay *elm_obj_map_overlay_scale_add(Eo *obj, int x, int y);
 ...
 * @ingroup Elm_Map
 */
ELM_API_WEAK Elm_Map_Overlay *elm_obj_map_overlay_add(Eo *obj, double lon, double lat);
 ...
 * @ingroup Elm_Map
 */
ELM_API_WEAK void elm_obj_map_canvas_to_region_convert(const Eo *obj, int x, int y, double *lon, double *lat);
