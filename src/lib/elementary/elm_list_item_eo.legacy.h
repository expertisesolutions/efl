 ...
 */
ELEMENTARY_API void elm_list_item_separator_set(Elm_List_Item *obj, Eina_Bool setting);
 ...
 * @ingroup Elm_List_Item_Group
 */
ELEMENTARY_API Eina_Bool elm_list_item_separator_get(const Elm_List_Item *obj);
 ...
 * @ingroup Elm_List_Item_Group
 */
ELEMENTARY_API void elm_list_item_selected_set(Elm_List_Item *obj, Eina_Bool selected);
 ...
 * @ingroup Elm_List_Item_Group
 */
ELEMENTARY_API Eina_Bool elm_list_item_selected_get(const Elm_List_Item *obj);
 ...
 * @ingroup Elm_List_Item_Group
 */
ELEMENTARY_API Efl_Canvas_Object *elm_list_item_object_get(const Elm_List_Item *obj);
 ...
 * @ingroup Elm_List_Item_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_list_item_prev(const Elm_List_Item *obj);
 ...
 * @ingroup Elm_List_Item_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_list_item_next(const Elm_List_Item *obj);
 ...
 * @ingroup Elm_List_Item_Group
 */
ELEMENTARY_API void elm_list_item_show(Elm_List_Item *obj);
 ...
 * @ingroup Elm_List_Item_Group
 */
ELEMENTARY_API void elm_list_item_bring_in(Elm_List_Item *obj);
