...
ELM_API EFL_FUNC_BODY_CONST(elm_obj_menu_selected_item_get, Elm_Widget_Item *, NULL);

Elm_Widget_Item *_elm_menu_first_item_get(const Eo *obj, Elm_Menu_Data *pd);

ELM_API EFL_FUNC_BODY_CONST(elm_obj_menu_first_item_get, Elm_Widget_Item *, NULL);

Elm_Widget_Item *_elm_menu_last_item_get(const Eo *obj, Elm_Menu_Data *pd);

ELM_API EFL_FUNC_BODY_CONST(elm_obj_menu_last_item_get, Elm_Widget_Item *, NULL);

const Eina_List *_elm_menu_items_get(const Eo *obj, Elm_Menu_Data *pd);

ELM_API EFL_FUNC_BODY_CONST(elm_obj_menu_items_get, const Eina_List *, NULL);

void _elm_menu_relative_move(Eo *obj, Elm_Menu_Data *pd, int x, int y);

ELM_API EFL_VOID_FUNC_BODYV(elm_obj_menu_relative_move, EFL_FUNC_CALL(x, y), int x, int y);
...
ELM_API EFL_FUNC_BODYV(elm_obj_menu_item_add, Elm_Widget_Item *, NULL, EFL_FUNC_CALL(parent, icon, label, func, data), Elm_Widget_Item *parent, const char *icon, const char *label, Evas_Smart_Cb func, const void *data);

void _elm_menu_open(Eo *obj, Elm_Menu_Data *pd);

ELM_API EFL_VOID_FUNC_BODY(elm_obj_menu_open);

void _elm_menu_close(Eo *obj, Elm_Menu_Data *pd);

ELM_API EFL_VOID_FUNC_BODY(elm_obj_menu_close);

Elm_Widget_Item *_elm_menu_item_separator_add(Eo *obj, Elm_Menu_Data *pd, Elm_Widget_Item *parent);

ELM_API EFL_FUNC_BODYV(elm_obj_menu_item_separator_add, Elm_Widget_Item *, NULL, EFL_FUNC_CALL(parent), Elm_Widget_Item *parent);
