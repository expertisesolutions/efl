 ...
 */
ELEMENTARY_API Evas_Object *elm_gesture_layer_add(Evas_Object *parent);
 ...
 * @ingroup Elm_Gesture_Layer
 */
ELEMENTARY_API void elm_gesture_layer_tap_longpress_cb_add(Evas_Object *obj, Elm_Gesture_State state, Elm_Gesture_Event_Cb cb, void *data);
 ...
 * @ingroup Elm_Gesture_Layer
 */
ELEMENTARY_API void elm_gesture_layer_tap_longpress_cb_del(Evas_Object *obj, Elm_Gesture_State state, Elm_Gesture_Event_Cb cb, void *data);
