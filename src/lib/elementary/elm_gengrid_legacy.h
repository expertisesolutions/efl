 ...
 * @ingroup Elm_Gengrid
 */
ELEMENTARY_API Evas_Object                  *elm_gengrid_add(Evas_Object *parent);
 ...
 * @since 1.8
 */
ELEMENTARY_API Elm_Object_Item *elm_gengrid_nth_item_get(const Evas_Object *obj, unsigned int nth);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API void                          elm_gengrid_page_show(const Evas_Object *obj, int h_pagenumber, int v_pagenumber);
 ...
 * @ingroup Elm_Gengrid
 */
EINA_DEPRECATED ELEMENTARY_API void          elm_gengrid_scroller_policy_set(Evas_Object *obj, Elm_Scroller_Policy policy_h, Elm_Scroller_Policy policy_v);
 ...
 * @ingroup Elm_Gengrid
 */
EINA_DEPRECATED ELEMENTARY_API void          elm_gengrid_scroller_policy_get(const Evas_Object *obj, Elm_Scroller_Policy *policy_h, Elm_Scroller_Policy *policy_v);
 ...
 * @ingroup Elm_Gengrid
 */
EINA_DEPRECATED ELEMENTARY_API void          elm_gengrid_bounce_set(Evas_Object *obj, Eina_Bool h_bounce, Eina_Bool v_bounce);
 ...
 * @ingroup Elm_Gengrid
 */
EINA_DEPRECATED ELEMENTARY_API void          elm_gengrid_bounce_get(const Evas_Object *obj, Eina_Bool *h_bounce, Eina_Bool *v_bounce);
 ...
 * @see elm_scroller_page_bring_in()
 */
EINA_DEPRECATED ELEMENTARY_API void          elm_gengrid_current_page_get(const Evas_Object *obj, int *h_pagenumber, int *v_pagenumber);
 ...
 * @see elm_scroller_page_bring_in()
 */
EINA_DEPRECATED ELEMENTARY_API void          elm_gengrid_last_page_get(const Evas_Object *obj, int *h_pagenumber, int *v_pagenumber);
 ...
 * @see elm_scroller_page_show()
 */
EINA_DEPRECATED ELEMENTARY_API void          elm_gengrid_page_bring_in(const Evas_Object *obj, int h_pagenumber, int v_pagenumber);
 ...
 * @ingroup Elm_Gengrid
 */
ELEMENTARY_API void elm_gengrid_page_size_set(Evas_Object *obj, int h_pagesize, int v_pagesize);
 ...
 * @ingroup Elm_Gengrid
 */
ELEMENTARY_API void elm_gengrid_page_relative_set(Evas_Object *obj, double h_pagerel, double v_pagerel);
 ...
 * @ingroup Elm_Gengrid
 */
ELEMENTARY_API void elm_gengrid_page_relative_get(const Evas_Object *obj, double *h_pagerel, double *v_pagerel);
 ...
 * @ingroup Elm_Gengrid
 */
ELEMENTARY_API void elm_gengrid_wheel_disabled_set(Evas_Object *obj, Eina_Bool disabled);
 ...
 * @ingroup Elm_Gengrid
 */
ELEMENTARY_API Eina_Bool elm_gengrid_wheel_disabled_get(const Evas_Object *obj);
