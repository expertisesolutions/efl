...
ELM_API_WEAK EFL_FUNC_BODYV(elm_obj_web_text_matches_highlight_set, Eina_Bool, 0, EFL_FUNC_CALL(highlight), Eina_Bool highlight);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_web_text_matches_highlight_get, Eina_Bool, 0);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_web_useragent_set, EFL_FUNC_CALL(user_agent), const char *user_agent);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_web_useragent_get, const char *, NULL);
...
ELM_API_WEAK EFL_FUNC_BODYV(elm_obj_web_url_set, Eina_Bool, 0, EFL_FUNC_CALL(url), const char *url);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_web_url_get, const char *, NULL);
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_web_bg_color_set, EFL_FUNC_CALL(r, g, b, a), int r, int g, int b, int a);
ELM_API_WEAK EFL_VOID_FUNC_BODYV_CONST(elm_obj_web_bg_color_get, EFL_FUNC_CALL(r, g, b, a), int *r, int *g, int *b, int *a);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_web_inwin_mode_set, EFL_FUNC_CALL(value), Eina_Bool value);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_web_inwin_mode_get, Eina_Bool, 0);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_web_tab_propagate_set, EFL_FUNC_CALL(propagate), Eina_Bool propagate);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_web_tab_propagate_get, Eina_Bool, 0);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_web_history_enabled_set, EFL_FUNC_CALL(enable), Eina_Bool enable);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_web_history_enabled_get, Eina_Bool, 0);
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_web_console_message_hook_set, EFL_FUNC_CALL(func, data), Elm_Web_Console_Message func, void *data);
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_web_window_create_hook_set, EFL_FUNC_CALL(func, data), Elm_Web_Window_Open func, void *data);
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_web_dialog_file_selector_hook_set, EFL_FUNC_CALL(func, data), Elm_Web_Dialog_File_Selector func, void *data);
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_web_dialog_confirm_hook_set, EFL_FUNC_CALL(func, data), Elm_Web_Dialog_Confirm func, void *data);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_web_popup_selected_set, EFL_FUNC_CALL(idx), int idx);
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_web_dialog_prompt_hook_set, EFL_FUNC_CALL(func, data), Elm_Web_Dialog_Prompt func, void *data);
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_web_dialog_alert_hook_set, EFL_FUNC_CALL(func, data), Elm_Web_Dialog_Alert func, void *data);
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_web_forward_possible_get, Eina_Bool, 0);
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_web_webkit_view_get, Efl_Canvas_Object *, NULL);
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_web_back_possible_get, Eina_Bool, 0);
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_web_load_progress_get, double, 0);
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_web_selection_get, char *, NULL);
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_web_title_get, Eina_Stringshare *, NULL);
ELM_API_WEAK EFL_FUNC_BODYV(elm_obj_web_navigate, Eina_Bool, 0, EFL_FUNC_CALL(steps), int steps);
ELM_API_WEAK EFL_FUNC_BODY(elm_obj_web_back, Eina_Bool, 0);
ELM_API_WEAK EFL_FUNC_BODYV(elm_obj_web_html_string_load, Eina_Bool, 0, EFL_FUNC_CALL(html, base_url, unreachable_url), const char *html, const char *base_url, const char *unreachable_url);
ELM_API_WEAK EFL_FUNC_BODYV_CONST(elm_obj_web_text_search, Eina_Bool, 0, EFL_FUNC_CALL(string, case_sensitive, forward, wrap), const char *string, Eina_Bool case_sensitive, Eina_Bool forward, Eina_Bool wrap);
ELM_API_WEAK EFL_FUNC_BODY(elm_obj_web_popup_destroy, Eina_Bool, 0);
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_web_region_show, EFL_FUNC_CALL(x, y, w, h), int x, int y, int w, int h);
ELM_API_WEAK EFL_FUNC_BODY(elm_obj_web_forward, Eina_Bool, 0);
ELM_API_WEAK EFL_FUNC_BODYV(elm_obj_web_text_matches_mark, unsigned int, 0, EFL_FUNC_CALL(string, case_sensitive, highlight, limit), const char *string, Eina_Bool case_sensitive, Eina_Bool highlight, unsigned int limit);
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_web_region_bring_in, EFL_FUNC_CALL(x, y, w, h), int x, int y, int w, int h);
ELM_API_WEAK EFL_FUNC_BODY(elm_obj_web_stop, Eina_Bool, 0);
ELM_API_WEAK EFL_FUNC_BODYV(elm_obj_web_navigate_possible_get, Eina_Bool, 0, EFL_FUNC_CALL(steps), int steps);
ELM_API_WEAK EFL_FUNC_BODY(elm_obj_web_reload_full, Eina_Bool, 0);
ELM_API_WEAK EFL_FUNC_BODY(elm_obj_web_text_matches_unmark_all, Eina_Bool, 0);
ELM_API_WEAK EFL_FUNC_BODY(elm_obj_web_reload, Eina_Bool, 0);
