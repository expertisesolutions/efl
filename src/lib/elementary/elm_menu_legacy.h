 ...
 * @ingroup Elm_Menu
 */
ELEMENTARY_API Evas_Object                 *elm_menu_add(Evas_Object *parent);
 ...
 * @ingroup Elm_Menu
 */
ELEMENTARY_API void                         elm_menu_parent_set(Evas_Object *obj, Evas_Object *parent);
 ...
 * @ingroup Elm_Menu
 */
ELEMENTARY_API Evas_Object                 *elm_menu_parent_get(const Evas_Object *obj);
