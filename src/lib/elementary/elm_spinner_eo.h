...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_SPINNER_EVENT_CHANGED;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_SPINNER_EVENT_DELAY_CHANGED;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_SPINNER_EVENT_SPINNER_DRAG_START;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_SPINNER_EVENT_SPINNER_DRAG_STOP;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_SPINNER_EVENT_MIN_REACHED;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_SPINNER_EVENT_MAX_REACHED;
