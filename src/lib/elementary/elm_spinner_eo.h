 ...
 * @ingroup Elm_Spinner
 */
ELM_API_WEAK void elm_obj_spinner_wrap_set(Eo *obj, Eina_Bool wrap);
 ...
 * @ingroup Elm_Spinner
 */
ELM_API_WEAK Eina_Bool elm_obj_spinner_wrap_get(const Eo *obj);
 ...
 * @ingroup Elm_Spinner
 */
ELM_API_WEAK void elm_obj_spinner_interval_set(Eo *obj, double interval);
 ...
 * @ingroup Elm_Spinner
 */
ELM_API_WEAK double elm_obj_spinner_interval_get(const Eo *obj);
 ...
 * @ingroup Elm_Spinner
 */
ELM_API_WEAK void elm_obj_spinner_round_set(Eo *obj, int rnd);
 ...
 * @ingroup Elm_Spinner
 */
ELM_API_WEAK int elm_obj_spinner_round_get(const Eo *obj);
 ...
 * @ingroup Elm_Spinner
 */
ELM_API_WEAK void elm_obj_spinner_editable_set(Eo *obj, Eina_Bool editable);
 ...
 * @ingroup Elm_Spinner
 */
ELM_API_WEAK Eina_Bool elm_obj_spinner_editable_get(const Eo *obj);
 ...
 * @ingroup Elm_Spinner
 */
ELM_API_WEAK void elm_obj_spinner_base_set(Eo *obj, double base);
 ...
 * @ingroup Elm_Spinner
 */
ELM_API_WEAK double elm_obj_spinner_base_get(const Eo *obj);
 ...
 * @ingroup Elm_Spinner
 */
ELM_API_WEAK void elm_obj_spinner_label_format_set(Eo *obj, const char *fmt);
 ...
 * @ingroup Elm_Spinner
 */
ELM_API_WEAK const char *elm_obj_spinner_label_format_get(const Eo *obj);
 ...
 * @ingroup Elm_Spinner
 */
ELM_API_WEAK void elm_obj_spinner_special_value_add(Eo *obj, double value, const char *label);
