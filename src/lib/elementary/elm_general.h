 ...
 * @since 1.12
 */
ELEMENTARY_API extern int ELM_EVENT_PROCESS_BACKGROUND;
 ...
 * @since 1.12
 */
ELEMENTARY_API extern int ELM_EVENT_PROCESS_FOREGROUND;
...
extern ELEMENTARY_API double _elm_startup_time;
 ...
 * @ingroup Elm_General
 */
ELEMENTARY_API void      elm_run(void);
 ...
 * @ingroup Elm_General
 */
ELEMENTARY_API void      elm_exit(void);

/**
 * Exposed symbol used only by macros and should not be used by apps
 */
ELEMENTARY_API void      elm_quicklaunch_mode_set(Eina_Bool ql_on);

/**
 * Exposed symbol used only by macros and should not be used by apps
 */
ELEMENTARY_API Eina_Bool elm_quicklaunch_mode_get(void);

/**
 * Exposed symbol used only by macros and should not be used by apps
 */
ELEMENTARY_API int       elm_quicklaunch_init(int argc, char **argv);

/**
 * Exposed symbol used only by macros and should not be used by apps
 */
ELEMENTARY_API int       elm_quicklaunch_sub_init(int argc, char **argv);

/**
 * Exposed symbol used only by macros and should not be used by apps
 */
ELEMENTARY_API int       elm_quicklaunch_sub_shutdown(void);

/**
 * Exposed symbol used only by macros and should not be used by apps
 */
ELEMENTARY_API int       elm_quicklaunch_shutdown(void);

/**
 * Exposed symbol used only by macros and should not be used by apps
 */
ELEMENTARY_API void      elm_quicklaunch_seed(void);

/**
 * Exposed symbol used only by macros and should not be used by apps
 */
ELEMENTARY_API Eina_Bool elm_quicklaunch_prepare(int argc, char **argv, const char *cwd);

/**
 * Exposed symbol used only by macros and should not be used by apps
 */
ELEMENTARY_API Eina_Bool efl_quicklaunch_prepare(int argc, char **argv, const char *cwd);

/**
 * Exposed symbol used only by macros and should not be used by apps
 */
ELEMENTARY_API int elm_quicklaunch_fork(int argc, char **argv, char *cwd, void (*postfork_func) (void *data), void *postfork_data);

/**
 * Exposed symbol used only by macros and should not be used by apps
 */
ELEMENTARY_API void      elm_quicklaunch_cleanup(void);

/**
 * Exposed symbol used only by macros and should not be used by apps
 */
ELEMENTARY_API int       elm_quicklaunch_fallback(int argc, char **argv);

/**
 * Exposed symbol used only by macros and should not be used by apps
 */
ELEMENTARY_API char     *elm_quicklaunch_exe_path_get(const char *exe, const char *cwd);
 ...
 * @ingroup Elm_General
 */
ELEMENTARY_API Eina_Bool elm_policy_set(unsigned int policy, int value);
 ...
 * @ingroup Elm_General
 */
ELEMENTARY_API int       elm_policy_get(unsigned int policy);
 ...
 * @ingroup Elm_General
 */
ELEMENTARY_API void      elm_language_set(const char *lang);
 ...
 * @since 1.12
 */
ELEMENTARY_API Elm_Process_State  elm_process_state_get(void);
