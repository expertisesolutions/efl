 ...
 */
ELEMENTARY_API void elm_table_homogeneous_set(Elm_Table *obj, Eina_Bool homogeneous);
 ...
 * @ingroup Elm_Table_Group
 */
ELEMENTARY_API Eina_Bool elm_table_homogeneous_get(const Elm_Table *obj);
 ...
 * @ingroup Elm_Table_Group
 */
ELEMENTARY_API void elm_table_padding_set(Elm_Table *obj, int horizontal, int vertical);
 ...
 * @ingroup Elm_Table_Group
 */
ELEMENTARY_API void elm_table_padding_get(const Elm_Table *obj, int *horizontal, int *vertical);
 ...
 * @ingroup Elm_Table_Group
 */
ELEMENTARY_API void elm_table_align_set(Elm_Table *obj, double horizontal, double vertical);
 ...
 * @ingroup Elm_Table_Group
 */
ELEMENTARY_API void elm_table_align_get(const Elm_Table *obj, double *horizontal, double *vertical);
 ...
 * @ingroup Elm_Table_Group
 */
ELEMENTARY_API void elm_table_clear(Elm_Table *obj, Eina_Bool clear);
 ...
 * @ingroup Elm_Table_Group
 */
ELEMENTARY_API Efl_Canvas_Object *elm_table_child_get(const Elm_Table *obj, int col, int row);
 ...
 * @ingroup Elm_Table_Group
 */
ELEMENTARY_API void elm_table_unpack(Elm_Table *obj, Efl_Canvas_Object *subobj);
 ...
 * @ingroup Elm_Table_Group
 */
ELEMENTARY_API void elm_table_pack(Elm_Table *obj, Efl_Canvas_Object *subobj, int column, int row, int colspan, int rowspan);
