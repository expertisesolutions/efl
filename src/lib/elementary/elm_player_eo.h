...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_PLAYER_EVENT_FORWARD_CLICKED;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_PLAYER_EVENT_INFO_CLICKED;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_PLAYER_EVENT_NEXT_CLICKED;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_PLAYER_EVENT_PAUSE_CLICKED;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_PLAYER_EVENT_PLAY_CLICKED;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_PLAYER_EVENT_PREV_CLICKED;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_PLAYER_EVENT_REWIND_CLICKED;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_PLAYER_EVENT_QUALITY_CLICKED;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_PLAYER_EVENT_EJECT_CLICKED;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_PLAYER_EVENT_VOLUME_CLICKED;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_PLAYER_EVENT_MUTE_CLICKED;
