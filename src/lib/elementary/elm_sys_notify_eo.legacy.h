 ...
 */
ELEMENTARY_API Eina_Bool elm_sys_notify_servers_set(Elm_Sys_Notify *obj, Elm_Sys_Notify_Server servers);
 ...
 * @ingroup Elm_Sys_Notify_Group
 */
ELEMENTARY_API Elm_Sys_Notify_Server elm_sys_notify_servers_get(const Elm_Sys_Notify *obj);
 ...
 * @ingroup Elm_Sys_Notify_Group
 */
ELEMENTARY_API Elm_Sys_Notify *elm_sys_notify_singleton_get(void);
