 ...
 * @ingroup Elm_Entry
 */
ELEMENTARY_API Evas_Object       *elm_entry_add(Evas_Object *parent);
 ...
 * @ingroup Elm_Entry
 */
ELEMENTARY_API void               elm_entry_entry_set(Evas_Object *obj, const char *entry);
 ...
 * @ingroup Elm_Entry
 */
ELEMENTARY_API const char        *elm_entry_entry_get(const Evas_Object *obj);
 ...
 */
ELEMENTARY_API Eina_Bool          elm_entry_file_set(Evas_Object *obj, const char *file, Elm_Text_Format format);
 ...
 */
ELEMENTARY_API void               elm_entry_file_get(const Evas_Object *obj, const char **file, Elm_Text_Format *format);
 ...
 * @ingroup Elm_Entry
 */
ELEMENTARY_API void elm_entry_calc_force(Evas_Object *obj);
