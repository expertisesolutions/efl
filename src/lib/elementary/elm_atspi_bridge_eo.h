...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_ATSPI_BRIDGE_EVENT_CONNECTED;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_ATSPI_BRIDGE_EVENT_DISCONNECTED;
