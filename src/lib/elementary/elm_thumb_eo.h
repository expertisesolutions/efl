...
ELM_API_WEAK const Efl_Class *elm_thumb_class_get(void);

ELM_API_WEAK extern const Efl_Event_Description _ELM_THUMB_EVENT_GENERATE_ERROR;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_THUMB_EVENT_GENERATE_START;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_THUMB_EVENT_GENERATE_STOP;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_THUMB_EVENT_LOAD_ERROR;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_THUMB_EVENT_PRESS;
