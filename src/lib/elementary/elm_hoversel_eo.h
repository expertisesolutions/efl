...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_HOVERSEL_EVENT_DISMISSED;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_HOVERSEL_EVENT_EXPANDED;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_HOVERSEL_EVENT_ITEM_FOCUSED;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_HOVERSEL_EVENT_ITEM_UNFOCUSED;
