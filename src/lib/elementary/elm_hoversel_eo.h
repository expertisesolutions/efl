 ...
 * @ingroup Elm_Hoversel
 */
ELM_API_WEAK void elm_obj_hoversel_horizontal_set(Eo *obj, Eina_Bool horizontal);
 ...
 * @ingroup Elm_Hoversel
 */
ELM_API_WEAK Eina_Bool elm_obj_hoversel_horizontal_get(const Eo *obj);
 ...
 * @ingroup Elm_Hoversel
 */
ELM_API_WEAK void elm_obj_hoversel_hover_parent_set(Eo *obj, Efl_Canvas_Object *parent);
 ...
 * @ingroup Elm_Hoversel
 */
ELM_API_WEAK Efl_Canvas_Object *elm_obj_hoversel_hover_parent_get(const Eo *obj);
 ...
 * @ingroup Elm_Hoversel
 */
ELM_API_WEAK Eina_Bool elm_obj_hoversel_expanded_get(const Eo *obj);
 ...
 * @ingroup Elm_Hoversel
 */
ELM_API_WEAK const Eina_List *elm_obj_hoversel_items_get(const Eo *obj);
 ...
 * @ingroup Elm_Hoversel
 */
ELM_API_WEAK void elm_obj_hoversel_auto_update_set(Eo *obj, Eina_Bool auto_update);
 ...
 * @ingroup Elm_Hoversel
 */
ELM_API_WEAK Eina_Bool elm_obj_hoversel_auto_update_get(const Eo *obj);
 ...
 * @ingroup Elm_Hoversel
 */
ELM_API_WEAK void elm_obj_hoversel_hover_begin(Eo *obj);
 ...
 * @ingroup Elm_Hoversel
 */
ELM_API_WEAK void elm_obj_hoversel_clear(Eo *obj);
 ...
 * @ingroup Elm_Hoversel
 */
ELM_API_WEAK void elm_obj_hoversel_hover_end(Eo *obj);
 ...
 * @ingroup Elm_Hoversel
 */
ELM_API_WEAK Elm_Widget_Item *elm_obj_hoversel_item_add(Eo *obj, const char *label, const char *icon_file, Elm_Icon_Type icon_type, Evas_Smart_Cb func, const void *data);
