 ...
 * @ingroup Elm_Gesture_Layer
 */
ELM_API_WEAK void elm_obj_gesture_layer_zoom_step_set(Eo *obj, double step);
 ...
 * @ingroup Elm_Gesture_Layer
 */
ELM_API_WEAK double elm_obj_gesture_layer_zoom_step_get(const Eo *obj);
 ...
 * @ingroup Elm_Gesture_Layer
 */
ELM_API_WEAK void elm_obj_gesture_layer_tap_finger_size_set(Eo *obj, int sz);
 ...
 * @ingroup Elm_Gesture_Layer
 */
ELM_API_WEAK int elm_obj_gesture_layer_tap_finger_size_get(const Eo *obj);
 ...
 * @ingroup Elm_Gesture_Layer
 */
ELM_API_WEAK void elm_obj_gesture_layer_hold_events_set(Eo *obj, Eina_Bool hold_events);
 ...
 * @ingroup Elm_Gesture_Layer
 */
ELM_API_WEAK Eina_Bool elm_obj_gesture_layer_hold_events_get(const Eo *obj);
 ...
 * @ingroup Elm_Gesture_Layer
 */
ELM_API_WEAK void elm_obj_gesture_layer_rotate_step_set(Eo *obj, double step);
 ...
 * @ingroup Elm_Gesture_Layer
 */
ELM_API_WEAK double elm_obj_gesture_layer_rotate_step_get(const Eo *obj);
 ...
 * @ingroup Elm_Gesture_Layer
 */
ELM_API_WEAK void elm_obj_gesture_layer_cb_set(Eo *obj, Elm_Gesture_Type idx, Elm_Gesture_State cb_type, Elm_Gesture_Event_Cb cb, void *data);
 ...
 * @ingroup Elm_Gesture_Layer
 */
ELM_API_WEAK Eina_Bool elm_obj_gesture_layer_attach(Eo *obj, Efl_Canvas_Object *target);
 ...
 * @ingroup Elm_Gesture_Layer
 */
ELM_API_WEAK void elm_obj_gesture_layer_cb_del(Eo *obj, Elm_Gesture_Type idx, Elm_Gesture_State cb_type, Elm_Gesture_Event_Cb cb, void *data);
 ...
 * @ingroup Elm_Gesture_Layer
 */
ELM_API_WEAK void elm_obj_gesture_layer_cb_add(Eo *obj, Elm_Gesture_Type idx, Elm_Gesture_State cb_type, Elm_Gesture_Event_Cb cb, void *data);
