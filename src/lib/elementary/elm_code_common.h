...
ELEMENTARY_API extern const Efl_Event_Description ELM_CODE_EVENT_LINE_LOAD_DONE;
/** Event that marks a file load has been completed */
ELEMENTARY_API extern const Efl_Event_Description ELM_CODE_EVENT_FILE_LOAD_DONE;
