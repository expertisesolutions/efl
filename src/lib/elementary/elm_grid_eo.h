...
ELM_API_WEAK const Efl_Class *elm_grid_class_get(void);
 ...
 * @ingroup Elm_Grid
 */
ELM_API_WEAK void elm_obj_grid_size_set(Eo *obj, int w, int h);
 ...
 * @ingroup Elm_Grid
 */
ELM_API_WEAK void elm_obj_grid_size_get(const Eo *obj, int *w, int *h);
 ...
 * @ingroup Elm_Grid
 */
ELM_API_WEAK Eina_List *elm_obj_grid_children_get(const Eo *obj) EINA_WARN_UNUSED_RESULT;
 ...
 * @ingroup Elm_Grid
 */
ELM_API_WEAK void elm_obj_grid_clear(Eo *obj, Eina_Bool clear);
 ...
 * @ingroup Elm_Grid
 */
ELM_API_WEAK void elm_obj_grid_unpack(Eo *obj, Efl_Canvas_Object *subobj);
 ...
 * @ingroup Elm_Grid
 */
ELM_API_WEAK void elm_obj_grid_pack(Eo *obj, Efl_Canvas_Object *subobj, int x, int y, int w, int h);
