 ...
 * @ingroup Elm_Flip
 */
ELEMENTARY_API void elm_flip_interaction_direction_hitsize_set(Elm_Flip *obj, Elm_Flip_Direction dir, double hitsize);
 ...
 * @ingroup Elm_Flip
 */
ELEMENTARY_API double elm_flip_interaction_direction_hitsize_get(Elm_Flip *obj, Elm_Flip_Direction dir);
 ...
 * @ingroup Elm_Flip
 */
ELEMENTARY_API void elm_flip_interaction_direction_enabled_set(Elm_Flip *obj, Elm_Flip_Direction dir, Eina_Bool enabled);
 ...
 * @ingroup Elm_Flip
 */
ELEMENTARY_API Eina_Bool elm_flip_interaction_direction_enabled_get(Elm_Flip *obj, Elm_Flip_Direction dir);
 ...
 * @ingroup Elm_Flip
 */
ELEMENTARY_API Evas_Object *elm_flip_add(Evas_Object *parent);
 ...
 * @ingroup Elm_Flip
 */
ELEMENTARY_API void                 elm_flip_perspective_set(Evas_Object *obj, Evas_Coord foc, Evas_Coord x, Evas_Coord y);
