 ...
 * @ingroup Elm_Fileselector
 */
ELM_API_WEAK void elm_obj_fileselector_buttons_ok_cancel_set(Eo *obj, Eina_Bool visible);
 ...
 * @ingroup Elm_Fileselector
 */
ELM_API_WEAK Eina_Bool elm_obj_fileselector_buttons_ok_cancel_get(const Eo *obj);
