...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_FILESELECTOR_EVENT_DONE;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_FILESELECTOR_EVENT_ACTIVATED;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_FILESELECTOR_EVENT_SELECTED_INVALID;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_FILESELECTOR_EVENT_DIRECTORY_OPEN;
