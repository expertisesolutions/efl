 ...
 */
ELEMENTARY_API void elm_popup_align_set(Elm_Popup *obj, double horizontal, double vertical);
 ...
 * @ingroup Elm_Popup_Group
 */
ELEMENTARY_API void elm_popup_align_get(const Elm_Popup *obj, double *horizontal, double *vertical);
 ...
 * @ingroup Elm_Popup_Group
 */
ELEMENTARY_API void elm_popup_allow_events_set(Elm_Popup *obj, Eina_Bool allow);
 ...
 * @ingroup Elm_Popup_Group
 */
ELEMENTARY_API Eina_Bool elm_popup_allow_events_get(const Elm_Popup *obj);
 ...
 * @ingroup Elm_Popup_Group
 */
ELEMENTARY_API void elm_popup_content_text_wrap_type_set(Elm_Popup *obj, Elm_Wrap_Type wrap);
 ...
 * @ingroup Elm_Popup_Group
 */
ELEMENTARY_API Elm_Wrap_Type elm_popup_content_text_wrap_type_get(const Elm_Popup *obj);
 ...
 * @ingroup Elm_Popup_Group
 */
ELEMENTARY_API void elm_popup_orient_set(Elm_Popup *obj, Elm_Popup_Orient orient);
 ...
 * @ingroup Elm_Popup_Group
 */
ELEMENTARY_API Elm_Popup_Orient elm_popup_orient_get(const Elm_Popup *obj);
 ...
 * @ingroup Elm_Popup_Group
 */
ELEMENTARY_API void elm_popup_timeout_set(Elm_Popup *obj, double timeout);
 ...
 * @ingroup Elm_Popup_Group
 */
ELEMENTARY_API double elm_popup_timeout_get(const Elm_Popup *obj);
 ...
 * @ingroup Elm_Popup_Group
 */
ELEMENTARY_API void elm_popup_scrollable_set(Elm_Popup *obj, Eina_Bool scroll);
 ...
 * @ingroup Elm_Popup_Group
 */
ELEMENTARY_API Eina_Bool elm_popup_scrollable_get(const Elm_Popup *obj);
 ...
 * @ingroup Elm_Popup_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_popup_item_append(Elm_Popup *obj, const char *label, Efl_Canvas_Object *icon, Evas_Smart_Cb func, const void *data);
 ...
 * @ingroup Elm_Popup_Group
 */
ELEMENTARY_API void elm_popup_dismiss(Elm_Popup *obj);
