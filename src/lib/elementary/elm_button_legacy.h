 ...
 * @ingroup Elm_Button
 */
ELEMENTARY_API Evas_Object                 *elm_button_add(Evas_Object *parent);
...
ELEMENTARY_API void                        elm_button_autorepeat_initial_timeout_set(Evas_Object *obj, double t);
...
ELEMENTARY_API double                      elm_button_autorepeat_initial_timeout_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Button
 */
ELEMENTARY_API void                        elm_button_autorepeat_gap_timeout_set(Evas_Object *obj, double t);
 ...
 * @ingroup Elm_Button
 */
ELEMENTARY_API double                      elm_button_autorepeat_gap_timeout_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Button
 */
ELEMENTARY_API void                        elm_button_autorepeat_set(Evas_Object *obj, Eina_Bool on);
 ...
 * @ingroup Elm_Button
 */
ELEMENTARY_API Eina_Bool                   elm_button_autorepeat_get(const Evas_Object *obj);
