 ...
 */
ELEMENTARY_API Eina_Bool elm_object_mirrored_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Mirroring
 */
ELEMENTARY_API void      elm_object_mirrored_set(Evas_Object *obj, Eina_Bool mirrored);
 ...
 * @ingroup Elm_Mirroring
 */
ELEMENTARY_API Eina_Bool elm_object_mirrored_automatic_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Mirroring
 */
ELEMENTARY_API void      elm_object_mirrored_automatic_set(Evas_Object *obj, Eina_Bool automatic);
