 ...
 * @since 1.14
 */
ELEMENTARY_API Evas_Object *elm_color_class_editor_add(Evas_Object *obj);
 ...
 * @since 1.14
 **/
ELEMENTARY_API void elm_color_class_translate_cb_set(Elm_Color_Class_Name_Cb cb);
 ...
 * @since 1.14
 **/
ELEMENTARY_API void elm_color_class_list_cb_set(Elm_Color_Class_List_Cb cb);
 ...
 * @since 1.14
 **/
ELEMENTARY_API Eina_List *elm_color_class_util_edje_file_list(Eina_File *f);
/** @} */
