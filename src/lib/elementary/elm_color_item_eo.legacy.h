 ...
 */
ELEMENTARY_API void elm_color_item_color_set(Elm_Color_Item *obj, int r, int g, int b, int a);
 ...
 * @ingroup Elm_Color_Item_Group
 */
ELEMENTARY_API void elm_color_item_color_get(const Elm_Color_Item *obj, int *r, int *g, int *b, int *a);
 ...
 * @ingroup Elm_Color_Item_Group
 */
ELEMENTARY_API void elm_color_item_selected_set(Elm_Color_Item *obj, Eina_Bool selected);
 ...
 * @ingroup Elm_Color_Item_Group
 */
ELEMENTARY_API Eina_Bool elm_color_item_selected_get(const Elm_Color_Item *obj);
