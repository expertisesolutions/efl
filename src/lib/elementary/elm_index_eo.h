 ...
 * @ingroup Elm_Index
 */
ELM_API void elm_obj_index_autohide_disabled_set(Eo *obj, Eina_Bool disabled);
 ...
 * @ingroup Elm_Index
 */
ELM_API Eina_Bool elm_obj_index_autohide_disabled_get(const Eo *obj);
 ...
 * @ingroup Elm_Index
 */
ELM_API void elm_obj_index_omit_enabled_set(Eo *obj, Eina_Bool enabled);
 ...
 * @ingroup Elm_Index
 */
ELM_API Eina_Bool elm_obj_index_omit_enabled_get(const Eo *obj);
 ...
 * @ingroup Elm_Index
 */
ELM_API void elm_obj_index_standard_priority_set(Eo *obj, int priority);
 ...
 * @ingroup Elm_Index
 */
ELM_API int elm_obj_index_standard_priority_get(const Eo *obj);
 ...
 * @ingroup Elm_Index
 */
ELM_API void elm_obj_index_delay_change_time_set(Eo *obj, double dtime);
 ...
 * @ingroup Elm_Index
 */
ELM_API double elm_obj_index_delay_change_time_get(const Eo *obj);
 ...
 * @ingroup Elm_Index
 */
ELM_API void elm_obj_index_indicator_disabled_set(Eo *obj, Eina_Bool disabled);
 ...
 * @ingroup Elm_Index
 */
ELM_API Eina_Bool elm_obj_index_indicator_disabled_get(const Eo *obj);
 ...
 * @ingroup Elm_Index
 */
ELM_API void elm_obj_index_item_level_set(Eo *obj, int level);
 ...
 * @ingroup Elm_Index
 */
ELM_API int elm_obj_index_item_level_get(const Eo *obj);
 ...
 * @ingroup Elm_Index
 */
ELM_API void elm_obj_index_level_go(Eo *obj, int level);
 ...
 * @ingroup Elm_Index
 */
ELM_API Elm_Widget_Item *elm_obj_index_item_prepend(Eo *obj, const char *letter, Evas_Smart_Cb func, const void *data);
 ...
 * @ingroup Elm_Index
 */
ELM_API void elm_obj_index_item_clear(Eo *obj);
 ...
 * @ingroup Elm_Index
 */
ELM_API Elm_Widget_Item *elm_obj_index_item_insert_after(Eo *obj, Elm_Widget_Item *after, const char *letter, Evas_Smart_Cb func, const void *data);
 ...
 * @ingroup Elm_Index
 */
ELM_API Elm_Widget_Item *elm_obj_index_item_find(Eo *obj, const void *data);
 ...
 * @ingroup Elm_Index
 */
ELM_API Elm_Widget_Item *elm_obj_index_item_insert_before(Eo *obj, Elm_Widget_Item *before, const char *letter, Evas_Smart_Cb func, const void *data);
 ...
 * @ingroup Elm_Index
 */
ELM_API Elm_Widget_Item *elm_obj_index_item_append(Eo *obj, const char *letter, Evas_Smart_Cb func, const void *data);
 ...
 * @ingroup Elm_Index
 */
ELM_API Elm_Widget_Item *elm_obj_index_selected_item_get(const Eo *obj, int level);
