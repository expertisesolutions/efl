 ...
 */
ELEMENTARY_API void elm_multibuttonentry_item_selected_set(Elm_Multibuttonentry_Item *obj, Eina_Bool selected);
 ...
 * @ingroup Elm_Multibuttonentry_Item_Group
 */
ELEMENTARY_API Eina_Bool elm_multibuttonentry_item_selected_get(const Elm_Multibuttonentry_Item *obj);
 ...
 * @ingroup Elm_Multibuttonentry_Item_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_multibuttonentry_item_prev_get(const Elm_Multibuttonentry_Item *obj);
 ...
 * @ingroup Elm_Multibuttonentry_Item_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_multibuttonentry_item_next_get(const Elm_Multibuttonentry_Item *obj);
