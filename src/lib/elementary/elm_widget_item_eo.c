...
ELM_API_WEAK EFL_FUNC_BODYV(elm_wdg_item_tooltip_window_mode_set, Eina_Bool, 0, EFL_FUNC_CALL(disable), Eina_Bool disable);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_wdg_item_tooltip_window_mode_get, Eina_Bool, 0);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_wdg_item_tooltip_style_set, EFL_FUNC_CALL(style), const char *style);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_wdg_item_tooltip_style_get, const char *, NULL);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_wdg_item_cursor_set, EFL_FUNC_CALL(cursor), const char *cursor);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_wdg_item_cursor_get, const char *, NULL);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_wdg_item_cursor_style_set, EFL_FUNC_CALL(style), const char *style);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_wdg_item_cursor_style_get, const char *, NULL);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_wdg_item_cursor_engine_only_set, EFL_FUNC_CALL(engine_only), Eina_Bool engine_only);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_wdg_item_cursor_engine_only_get, Eina_Bool, 0);

void _elm_widget_item_part_content_set(Eo *obj, Elm_Widget_Item_Data *pd, const char *part, Efl_Canvas_Object *content);

ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_wdg_item_part_content_set, EFL_FUNC_CALL(part, content), const char *part, Efl_Canvas_Object *content);

Efl_Canvas_Object *_elm_widget_item_part_content_get(const Eo *obj, Elm_Widget_Item_Data *pd, const char *part);

ELM_API_WEAK EFL_FUNC_BODYV_CONST(elm_wdg_item_part_content_get, Efl_Canvas_Object *, NULL, EFL_FUNC_CALL(part), const char *part);

void _elm_widget_item_part_text_set(Eo *obj, Elm_Widget_Item_Data *pd, const char *part, const char *label);

ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_wdg_item_part_text_set, EFL_FUNC_CALL(part, label), const char *part, const char *label);

const char *_elm_widget_item_part_text_get(const Eo *obj, Elm_Widget_Item_Data *pd, const char *part);

ELM_API_WEAK EFL_FUNC_BODYV_CONST(elm_wdg_item_part_text_get, const char *, NULL, EFL_FUNC_CALL(part), const char *part);

void _elm_widget_item_part_text_custom_set(Eo *obj, Elm_Widget_Item_Data *pd, const char *part, const char *label);

ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_wdg_item_part_text_custom_set, EFL_FUNC_CALL(part, label), const char *part, const char *label);

const char *_elm_widget_item_part_text_custom_get(const Eo *obj, Elm_Widget_Item_Data *pd, const char *part);

ELM_API_WEAK EFL_FUNC_BODYV_CONST(elm_wdg_item_part_text_custom_get, const char *, NULL, EFL_FUNC_CALL(part), const char *part);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_wdg_item_focus_set, EFL_FUNC_CALL(focused), Eina_Bool focused);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_wdg_item_focus_get, Eina_Bool, 0);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_wdg_item_style_set, EFL_FUNC_CALL(style), const char *style);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_wdg_item_style_get, const char *, NULL);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_wdg_item_disabled_set, EFL_FUNC_CALL(disable), Eina_Bool disable);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_wdg_item_disabled_get, Eina_Bool, 0);

const Eina_List *_elm_widget_item_access_order_get(Eo *obj, Elm_Widget_Item_Data *pd);

ELM_API_WEAK EFL_FUNC_BODY(elm_wdg_item_access_order_get, const Eina_List *, NULL);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV_FALLBACK(elm_wdg_item_access_order_set, _elm_wdg_item_access_order_set_ownership_fallback(objs);, EFL_FUNC_CALL(objs), Eina_List *objs);

Efl_Canvas_Object *_elm_widget_item_widget_get(const Eo *obj, Elm_Widget_Item_Data *pd);

ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_wdg_item_widget_get, Efl_Canvas_Object *, NULL);

void _elm_widget_item_pre_notify_del(Eo *obj, Elm_Widget_Item_Data *pd);

ELM_API_WEAK EFL_VOID_FUNC_BODY(elm_wdg_item_pre_notify_del);

void _elm_widget_item_tooltip_text_set(Eo *obj, Elm_Widget_Item_Data *pd, const char *text);

ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_wdg_item_tooltip_text_set, EFL_FUNC_CALL(text), const char *text);

void _elm_widget_item_tooltip_translatable_text_set(Eo *obj, Elm_Widget_Item_Data *pd, const char *text);

ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_wdg_item_tooltip_translatable_text_set, EFL_FUNC_CALL(text), const char *text);

void _elm_widget_item_tooltip_unset(Eo *obj, Elm_Widget_Item_Data *pd);

ELM_API_WEAK EFL_VOID_FUNC_BODY(elm_wdg_item_tooltip_unset);

void _elm_widget_item_cursor_unset(Eo *obj, Elm_Widget_Item_Data *pd);

ELM_API_WEAK EFL_VOID_FUNC_BODY(elm_wdg_item_cursor_unset);

Efl_Canvas_Object *_elm_widget_item_part_content_unset(Eo *obj, Elm_Widget_Item_Data *pd, const char *part);

ELM_API_WEAK EFL_FUNC_BODYV(elm_wdg_item_part_content_unset, Efl_Canvas_Object *, NULL, EFL_FUNC_CALL(part), const char *part);

void _elm_widget_item_part_text_custom_update(Eo *obj, Elm_Widget_Item_Data *pd);

ELM_API_WEAK EFL_VOID_FUNC_BODY(elm_wdg_item_part_text_custom_update);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_wdg_item_signal_callback_add, EFL_FUNC_CALL(emission, source, func, data), const char *emission, const char *source, Elm_Object_Item_Signal_Cb func, void *data);
...
ELM_API_WEAK EFL_FUNC_BODYV(elm_wdg_item_signal_callback_del, void *, NULL, EFL_FUNC_CALL(emission, source, func), const char *emission, const char *source, Elm_Object_Item_Signal_Cb func);

void _elm_widget_item_signal_emit(Eo *obj, Elm_Widget_Item_Data *pd, const char *emission, const char *source);

ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_wdg_item_signal_emit, EFL_FUNC_CALL(emission, source), const char *emission, const char *source);

void _elm_widget_item_access_info_set(Eo *obj, Elm_Widget_Item_Data *pd, const char *txt);

ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_wdg_item_access_info_set, EFL_FUNC_CALL(txt), const char *txt);

Efl_Canvas_Object *_elm_widget_item_access_object_get(const Eo *obj, Elm_Widget_Item_Data *pd);

ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_wdg_item_access_object_get, Efl_Canvas_Object *, NULL);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_wdg_item_domain_translatable_part_text_set, EFL_FUNC_CALL(part, domain, label), const char *part, const char *domain, const char *label);

const char *_elm_widget_item_translatable_part_text_get(const Eo *obj, Elm_Widget_Item_Data *pd, const char *part);

ELM_API_WEAK EFL_FUNC_BODYV_CONST(elm_wdg_item_translatable_part_text_get, const char *, NULL, EFL_FUNC_CALL(part), const char *part);

void _elm_widget_item_translate(Eo *obj, Elm_Widget_Item_Data *pd);

ELM_API_WEAK EFL_VOID_FUNC_BODY(elm_wdg_item_translate);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_wdg_item_domain_part_text_translatable_set, EFL_FUNC_CALL(part, domain, translatable), const char *part, const char *domain, Eina_Bool translatable);

Efl_Canvas_Object *_elm_widget_item_track(Eo *obj, Elm_Widget_Item_Data *pd);

ELM_API_WEAK EFL_FUNC_BODY(elm_wdg_item_track, Efl_Canvas_Object *, NULL);

void _elm_widget_item_untrack(Eo *obj, Elm_Widget_Item_Data *pd);

ELM_API_WEAK EFL_VOID_FUNC_BODY(elm_wdg_item_untrack);

int _elm_widget_item_track_get(const Eo *obj, Elm_Widget_Item_Data *pd);

ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_wdg_item_track_get, int, 0);

void _elm_widget_item_track_cancel(Eo *obj, Elm_Widget_Item_Data *pd);

ELM_API_WEAK EFL_VOID_FUNC_BODY(elm_wdg_item_track_cancel);

void _elm_widget_item_del_cb_set(Eo *obj, Elm_Widget_Item_Data *pd, Evas_Smart_Cb del_cb);

ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_wdg_item_del_cb_set, EFL_FUNC_CALL(del_cb), Evas_Smart_Cb del_cb);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_wdg_item_tooltip_content_cb_set, EFL_FUNC_CALL(func, data, del_cb), Elm_Tooltip_Item_Content_Cb func, const void *data, Evas_Smart_Cb del_cb);

Efl_Canvas_Object *_elm_widget_item_access_register(Eo *obj, Elm_Widget_Item_Data *pd);

ELM_API_WEAK EFL_FUNC_BODY(elm_wdg_item_access_register, Efl_Canvas_Object *, NULL);

void _elm_widget_item_access_unregister(Eo *obj, Elm_Widget_Item_Data *pd);

ELM_API_WEAK EFL_VOID_FUNC_BODY(elm_wdg_item_access_unregister);

void _elm_widget_item_access_order_unset(Eo *obj, Elm_Widget_Item_Data *pd);

ELM_API_WEAK EFL_VOID_FUNC_BODY(elm_wdg_item_access_order_unset);

void _elm_widget_item_disable(Eo *obj, Elm_Widget_Item_Data *pd);

ELM_API_WEAK EFL_VOID_FUNC_BODY(elm_wdg_item_disable);

void _elm_widget_item_del_pre(Eo *obj, Elm_Widget_Item_Data *pd);

ELM_API_WEAK EFL_VOID_FUNC_BODY(elm_wdg_item_del_pre);

Efl_Canvas_Object *_elm_widget_item_focus_next_object_get(const Eo *obj, Elm_Widget_Item_Data *pd, Elm_Focus_Direction dir);

ELM_API_WEAK EFL_FUNC_BODYV_CONST(elm_wdg_item_focus_next_object_get, Efl_Canvas_Object *, NULL, EFL_FUNC_CALL(dir), Elm_Focus_Direction dir);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_wdg_item_focus_next_object_set, EFL_FUNC_CALL(next, dir), Efl_Canvas_Object *next, Elm_Focus_Direction dir);

Elm_Widget_Item *_elm_widget_item_focus_next_item_get(const Eo *obj, Elm_Widget_Item_Data *pd, Elm_Focus_Direction dir);

ELM_API_WEAK EFL_FUNC_BODYV_CONST(elm_wdg_item_focus_next_item_get, Elm_Widget_Item *, NULL, EFL_FUNC_CALL(dir), Elm_Focus_Direction dir);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_wdg_item_focus_next_item_set, EFL_FUNC_CALL(next_item, dir), Elm_Widget_Item *next_item, Elm_Focus_Direction dir);
