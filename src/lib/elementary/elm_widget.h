 ...
 * // needed mark your calls with ELEMENTARY_API to make them "external api"
 * // calls.
 *
 * ELEMENTARY_API Evas_Object *
...
ELEMENTARY_API void             _elm_access_clear(Elm_Access_Info *ac);
ELEMENTARY_API void             _elm_access_text_set(Elm_Access_Info *ac, int type, const char *text);
ELEMENTARY_API void             _elm_access_callback_set(Elm_Access_Info *ac, int type, Elm_Access_Info_Cb func, const void *data);
ELEMENTARY_API char            *_elm_access_text_get(const Elm_Access_Info *ac, int type, const Evas_Object *obj); /* this is ok it actually returns a strduped string - it's meant to! */
ELEMENTARY_API void             _elm_access_read(Elm_Access_Info *ac, int type, const Evas_Object *obj);
ELEMENTARY_API void             _elm_access_say(const char *txt);
ELEMENTARY_API Elm_Access_Info *_elm_access_info_get(const Evas_Object *obj);
ELEMENTARY_API void             _elm_access_object_highlight(Evas_Object *obj);
ELEMENTARY_API void             _elm_access_object_unhighlight(Evas_Object *obj);
ELEMENTARY_API void             _elm_access_object_highlight_disable(Evas *e);
ELEMENTARY_API void             _elm_access_object_register(Evas_Object *obj, Evas_Object *hoverobj);
ELEMENTARY_API void             _elm_access_object_unregister(Evas_Object *obj, Evas_Object *hoverobj);
ELEMENTARY_API Eina_Bool        _elm_access_2nd_click_timeout(Evas_Object *obj);
ELEMENTARY_API void             _elm_access_highlight_set(Evas_Object* obj);
ELEMENTARY_API Evas_Object *    _elm_access_edje_object_part_object_register(Evas_Object *obj, const Evas_Object *partobj, const char* part);
ELEMENTARY_API void             _elm_access_edje_object_part_object_unregister(Evas_Object* obj, const Evas_Object *eobj, const char* part);
ELEMENTARY_API void             _elm_access_widget_item_register(Elm_Widget_Item_Data *item);
ELEMENTARY_API void             _elm_access_widget_item_unregister(Elm_Widget_Item_Data *item);
ELEMENTARY_API void             _elm_access_on_highlight_hook_set(Elm_Access_Info *ac, Elm_Access_On_Highlight_Cb func, void *data);
ELEMENTARY_API void             _elm_access_activate_callback_set(Elm_Access_Info *ac, Elm_Access_Activate_Cb func, void *data);
ELEMENTARY_API void             _elm_access_highlight_object_activate(Evas_Object *obj, Efl_Ui_Activate act);
ELEMENTARY_API void             _elm_access_highlight_cycle(Evas_Object *obj, Elm_Focus_Direction dir);

EINA_DEPRECATED ELEMENTARY_API Elm_Access_Info *_elm_access_object_get(const Evas_Object *obj);
...
ELEMENTARY_API Eina_Bool        elm_widget_api_check(int ver);
ELEMENTARY_API Eina_Bool        elm_widget_access(Evas_Object *obj, Eina_Bool is_access);
ELEMENTARY_API Eina_Error  elm_widget_theme(Evas_Object *obj);
ELEMENTARY_API void             elm_widget_theme_specific(Evas_Object *obj, Elm_Theme *th, Eina_Bool force);
ELEMENTARY_API void             elm_widget_on_show_region_hook_set(Evas_Object *obj, void *data, Elm_Widget_On_Show_Region_Cb func, Eina_Free_Cb data_free);
ELEMENTARY_API Eina_Bool        elm_widget_sub_object_parent_add(Evas_Object *sobj);
ELEMENTARY_API Eina_Bool        elm_widget_sub_object_add(Evas_Object *obj, Evas_Object *sobj);
ELEMENTARY_API Eina_Bool        elm_widget_sub_object_del(Evas_Object *obj, Evas_Object *sobj);
ELEMENTARY_API void             elm_widget_resize_object_set(Evas_Object *obj, Evas_Object *sobj);
ELEMENTARY_API void             elm_widget_hover_object_set(Evas_Object *obj, Evas_Object *sobj);
ELEMENTARY_API void             elm_widget_signal_emit(Evas_Object *obj, const char *emission, const char *source);
ELEMENTARY_API void             elm_widget_signal_callback_add(Evas_Object *obj, const char *emission, const char *source, Edje_Signal_Cb func, void *data);
ELEMENTARY_API void            *elm_widget_signal_callback_del(Evas_Object *obj, const char *emission, const char *source, Edje_Signal_Cb func);
ELEMENTARY_API void             elm_widget_can_focus_set(Evas_Object *obj, Eina_Bool can_focus);
ELEMENTARY_API Eina_Bool        elm_widget_can_focus_get(const Evas_Object *obj);
ELEMENTARY_API Eina_Bool        elm_widget_child_can_focus_get(const Evas_Object *obj);
ELEMENTARY_API Eina_List       *elm_widget_can_focus_child_list_get(const Evas_Object *obj);
ELEMENTARY_API void             elm_widget_tree_unfocusable_set(Evas_Object *obj, Eina_Bool tree_unfocusable);
ELEMENTARY_API Eina_Bool        elm_widget_tree_unfocusable_get(const Evas_Object *obj);
ELEMENTARY_API void             elm_widget_highlight_ignore_set(Evas_Object *obj, Eina_Bool ignore);
ELEMENTARY_API Eina_Bool        elm_widget_highlight_ignore_get(const Evas_Object *obj);
ELEMENTARY_API void             elm_widget_highlight_in_theme_set(Evas_Object *obj, Eina_Bool highlight);
ELEMENTARY_API Eina_Bool        elm_widget_highlight_in_theme_get(const Evas_Object *obj);
ELEMENTARY_API void             elm_widget_access_highlight_in_theme_set(Evas_Object *obj, Eina_Bool highlight);
ELEMENTARY_API Eina_Bool        elm_widget_access_highlight_in_theme_get(const Evas_Object *obj);
ELEMENTARY_API Eina_Bool        elm_widget_highlight_get(const Evas_Object *obj);
ELEMENTARY_API Eo              *elm_widget_top_get(const Eo *obj);
ELEMENTARY_API Eina_Bool        elm_widget_is(const Evas_Object *obj);
ELEMENTARY_API Evas_Object     *elm_widget_parent_widget_get(const Evas_Object *obj);
ELEMENTARY_API void             elm_widget_event_callback_add(Evas_Object *obj, Elm_Event_Cb func, const void *data);
ELEMENTARY_API void            *elm_widget_event_callback_del(Evas_Object *obj, Elm_Event_Cb func, const void *data);
ELEMENTARY_API Eina_Bool        elm_widget_focus_highlight_style_set(Evas_Object *obj, const char *style);
ELEMENTARY_API const char      *elm_widget_focus_highlight_style_get(const Evas_Object *obj);
ELEMENTARY_API void             elm_widget_parent_highlight_set(Evas_Object *obj, Eina_Bool highlighted);
ELEMENTARY_API void             elm_widget_focus_set(Evas_Object *obj, Eina_Bool focus);
ELEMENTARY_API Evas_Object     *elm_widget_parent_get(const Evas_Object *obj);
ELEMENTARY_API void             elm_widget_display_mode_set(Evas_Object *obj, Evas_Display_Mode dispmode);
ELEMENTARY_API Eina_Bool        elm_widget_focus_highlight_enabled_get(const Evas_Object *obj);
ELEMENTARY_API void             elm_widget_focus_highlight_focus_part_geometry_get(const Evas_Object *obj, Evas_Coord *x, Evas_Coord *y, Evas_Coord *w, Evas_Coord *h);
...
ELEMENTARY_API void             elm_widget_disabled_set(Evas_Object *obj, Eina_Bool disabled);
ELEMENTARY_API Eina_Bool        elm_widget_disabled_get(const Evas_Object *obj);
ELEMENTARY_API void             elm_widget_show_region_set(Evas_Object *obj, Eina_Rect sr, Eina_Bool forceshow);
ELEMENTARY_API Eina_Rect        elm_widget_show_region_get(const Evas_Object *obj);
ELEMENTARY_API Eina_Rect        elm_widget_focus_region_get(const Evas_Object *obj);
ELEMENTARY_API void             elm_widget_focus_region_show(Evas_Object *obj);
ELEMENTARY_API void             elm_widget_scroll_hold_push(Evas_Object *obj);
ELEMENTARY_API void             elm_widget_scroll_hold_pop(Evas_Object *obj);
ELEMENTARY_API int              elm_widget_scroll_hold_get(const Evas_Object *obj);
ELEMENTARY_API void             elm_widget_scroll_freeze_push(Evas_Object *obj);
ELEMENTARY_API void             elm_widget_scroll_freeze_pop(Evas_Object *obj);
ELEMENTARY_API int              elm_widget_scroll_freeze_get(const Evas_Object *obj);
ELEMENTARY_API void             elm_widget_theme_set(Evas_Object *obj, Elm_Theme *th);
ELEMENTARY_API Elm_Theme       *elm_widget_theme_get(const Evas_Object *obj);
ELEMENTARY_API Eina_Error  elm_widget_style_set(Evas_Object *obj, const char *style);
ELEMENTARY_API const char      *elm_widget_style_get(const Evas_Object *obj);
ELEMENTARY_API void             elm_widget_type_set(Evas_Object *obj, const char *type);
ELEMENTARY_API const char      *elm_widget_type_get(const Evas_Object *obj);
ELEMENTARY_API void             elm_widget_tooltip_add(Evas_Object *obj, Elm_Tooltip *tt);
ELEMENTARY_API void             elm_widget_tooltip_del(Evas_Object *obj, Elm_Tooltip *tt);
ELEMENTARY_API void             elm_widget_cursor_add(Evas_Object *obj, Elm_Cursor *cur);
ELEMENTARY_API void             elm_widget_cursor_del(Evas_Object *obj, Elm_Cursor *cur);
ELEMENTARY_API void             elm_widget_scroll_lock_set(Evas_Object *obj, Efl_Ui_Layout_Orientation block);
ELEMENTARY_API Efl_Ui_Layout_Orientation elm_widget_scroll_lock_get(const Evas_Object *obj);
ELEMENTARY_API int              elm_widget_scroll_child_locked_x_get(const Evas_Object *obj);
ELEMENTARY_API int              elm_widget_scroll_child_locked_y_get(const Evas_Object *obj);
ELEMENTARY_API Eina_Error  elm_widget_theme_object_set(Evas_Object *obj, Evas_Object *edj, const char *wname, const char *welement, const char *wstyle);
ELEMENTARY_API Eina_Bool        elm_widget_type_check(const Evas_Object *obj, const char *type, const char *func);
ELEMENTARY_API Evas_Object     *elm_widget_name_find(const Evas_Object *obj, const char *name, int recurse);
ELEMENTARY_API Eina_List       *elm_widget_stringlist_get(const char *str);
ELEMENTARY_API void             elm_widget_stringlist_free(Eina_List *list);
ELEMENTARY_API void             elm_widget_focus_mouse_up_handle(Evas_Object *obj);
ELEMENTARY_API void             elm_widget_activate(Evas_Object *obj, Efl_Ui_Activate act);
ELEMENTARY_API void             elm_widget_part_text_set(Evas_Object *obj, const char *part, const char *label);
ELEMENTARY_API const char      *elm_widget_part_text_get(const Evas_Object *obj, const char *part);
ELEMENTARY_API const char      *elm_widget_translatable_part_text_get(const Evas_Object *obj, const char *part);
ELEMENTARY_API void             elm_widget_domain_part_text_translatable_set(Evas_Object *obj, const char *part, const char *domain, Eina_Bool translatable);
ELEMENTARY_API void             elm_widget_content_part_set(Evas_Object *obj, const char *part, Evas_Object *content);
ELEMENTARY_API Evas_Object     *elm_widget_content_part_get(const Evas_Object *obj, const char *part);
ELEMENTARY_API Evas_Object     *elm_widget_content_part_unset(Evas_Object *obj, const char *part);
ELEMENTARY_API void             elm_widget_access_info_set(Evas_Object *obj, const char *txt);
ELEMENTARY_API const char      *elm_widget_access_info_get(const Evas_Object *obj);
ELEMENTARY_API Eina_Rect        elm_widget_focus_highlight_geometry_get(const Evas_Object *obj);
void                  _elm_widget_item_highlight_in_theme(Evas_Object *obj, Elm_Object_Item *it);
ELEMENTARY_API void             elm_widget_focus_region_show_mode_set(Evas_Object *obj, Elm_Focus_Region_Show_Mode mode);
ELEMENTARY_API Elm_Focus_Region_Show_Mode elm_widget_focus_region_show_mode_get(const Evas_Object *obj);
...
ELEMENTARY_API Eina_Bool        elm_widget_theme_klass_set(Evas_Object *obj, const char *name);
ELEMENTARY_API const char      *elm_widget_theme_klass_get(const Evas_Object *obj);
ELEMENTARY_API Eina_Bool        elm_widget_theme_element_set(Evas_Object *obj, const char *name);
ELEMENTARY_API const char      *elm_widget_theme_element_get(const Evas_Object *obj);
ELEMENTARY_API Eina_Bool        elm_widget_theme_style_set(Evas_Object *obj, const char *name);
ELEMENTARY_API const char      *elm_widget_theme_style_get(const Evas_Object *obj);
ELEMENTARY_API Eina_Error elm_widget_element_update(Evas_Object *obj, Evas_Object *component, const char *name);

/* debug function. don't use it unless you are tracking parenting issues */
ELEMENTARY_API void             elm_widget_tree_dump(const Evas_Object *top);
ELEMENTARY_API void             elm_widget_tree_dot_dump(const Evas_Object *top, FILE *output);
ELEMENTARY_API Eina_Bool        _elm_widget_onscreen_is(const Evas_Object *widget);
ELEMENTARY_API Eina_Bool        _elm_widget_item_onscreen_is(const Elm_Object_Item *item);
...
ELEMENTARY_API Eina_Bool elm_selection_selection_has_owner(Evas_Object *obj);

ELEMENTARY_API Eina_Bool _elm_layout_part_aliasing_eval(const Evas_Object *obj,
                                              const char **part,
                                              Eina_Bool is_text);
