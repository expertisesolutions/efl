 ...
 * @ingroup Syntax
 */
ELEMENTARY_API Elm_Code_Syntax *elm_code_syntax_for_mime_get(const char *mime);
 ...
 * @ingroup Syntax
 */
ELEMENTARY_API void elm_code_syntax_parse_line(Elm_Code_Syntax *syntax, Elm_Code_Line *line);
 ...
 * @ingroup Syntax
 */
ELEMENTARY_API void elm_code_syntax_parse_file(Elm_Code_Syntax *syntax, Elm_Code_File *file);
