 ...
 * @ingroup Elm_Icon
 */
ELEMENTARY_API Evas_Object          *elm_icon_add(Evas_Object *parent);
 ...
 * @ingroup Elm_Icon
 */
ELEMENTARY_API void elm_icon_thumb_set(Evas_Object *obj, const char *file, const char *group);
/**
...
ELEMENTARY_API void elm_icon_order_lookup_set(Evas_Object *obj EINA_UNUSED, Elm_Icon_Lookup_Order order EINA_UNUSED) EINA_DEPRECATED;
 ...
 * @ingroup Elm_Icon
 */
ELEMENTARY_API Elm_Icon_Lookup_Order elm_icon_order_lookup_get(const Evas_Object *obj EINA_UNUSED) EINA_DEPRECATED;
 ...
 * @ingroup Elm_Icon
 */
ELEMENTARY_API Eina_Bool elm_icon_standard_set(Evas_Object *obj, const char *name);
 ...
 * @ingroup Elm_Icon
 */
ELEMENTARY_API const char *elm_icon_standard_get(const Evas_Object *obj);
