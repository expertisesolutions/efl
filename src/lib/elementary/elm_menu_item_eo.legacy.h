 ...
 */
ELEMENTARY_API void elm_menu_item_icon_name_set(Elm_Menu_Item *obj, const char *icon);
 ...
 * @ingroup Elm_Menu_Item_Group
 */
ELEMENTARY_API const char *elm_menu_item_icon_name_get(const Elm_Menu_Item *obj);
 ...
 * @ingroup Elm_Menu_Item_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_menu_item_prev_get(const Elm_Menu_Item *obj);
 ...
 * @ingroup Elm_Menu_Item_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_menu_item_next_get(const Elm_Menu_Item *obj);
 ...
 * @ingroup Elm_Menu_Item_Group
 */
ELEMENTARY_API void elm_menu_item_selected_set(Elm_Menu_Item *obj, Eina_Bool selected);
 ...
 * @ingroup Elm_Menu_Item_Group
 */
ELEMENTARY_API Eina_Bool elm_menu_item_selected_get(const Elm_Menu_Item *obj);
 ...
 * @ingroup Elm_Menu_Item_Group
 */
ELEMENTARY_API unsigned int elm_menu_item_index_get(const Elm_Menu_Item *obj);
 ...
 * @ingroup Elm_Menu_Item_Group
 */
ELEMENTARY_API void elm_menu_item_subitems_clear(Elm_Menu_Item *obj);
 ...
 * @ingroup Elm_Menu_Item_Group
 */
ELEMENTARY_API const Eina_List *elm_menu_item_subitems_get(const Elm_Menu_Item *obj);
 ...
 * @ingroup Elm_Menu_Item_Group
 */
ELEMENTARY_API Eina_Bool elm_menu_item_is_separator(const Elm_Menu_Item *obj);
 ...
 * @ingroup Elm_Menu_Item_Group
 */
ELEMENTARY_API Efl_Canvas_Object *elm_menu_item_object_get(const Elm_Menu_Item *obj);
