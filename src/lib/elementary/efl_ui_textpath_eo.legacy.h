 ...
 * @ingroup Elm_Textpath_Group
 */
ELEMENTARY_API void elm_textpath_circular_set(Efl_Ui_Textpath *obj, double radius, double start_angle, Efl_Ui_Textpath_Direction direction);
 ...
 * @ingroup Elm_Textpath_Group
 */
ELEMENTARY_API void elm_textpath_slice_number_set(Efl_Ui_Textpath *obj, int slice_no);
 ...
 * @ingroup Elm_Textpath_Group
 */
ELEMENTARY_API int elm_textpath_slice_number_get(const Efl_Ui_Textpath *obj);
 ...
 * @ingroup Elm_Textpath_Group
 */
ELEMENTARY_API void elm_textpath_ellipsis_set(Efl_Ui_Textpath *obj, Eina_Bool ellipsis);
 ...
 * @ingroup Elm_Textpath_Group
 */
ELEMENTARY_API Eina_Bool elm_textpath_ellipsis_get(const Efl_Ui_Textpath *obj);
