 ...
 * @since 1.10
 */
ELEMENTARY_API Elm_Object_Item             *elm_object_focused_item_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Focus
 */
ELEMENTARY_API Elm_Object_Item *    elm_object_focus_next_item_get(const Evas_Object *obj, Elm_Focus_Direction dir);
 ...
 * @ingroup Elm_Focus
 */
ELEMENTARY_API void                 elm_object_focus_next_item_set(Evas_Object *obj, Elm_Object_Item *next_item, Elm_Focus_Direction dir);
