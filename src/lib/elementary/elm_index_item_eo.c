...
ELM_API EFL_VOID_FUNC_BODYV(elm_obj_index_item_selected_set, EFL_FUNC_CALL(selected), Eina_Bool selected);
...
ELM_API EFL_VOID_FUNC_BODYV(elm_obj_index_item_priority_set, EFL_FUNC_CALL(priority), int priority);

const char *_elm_index_item_letter_get(const Eo *obj, Elm_Index_Item_Data *pd);

ELM_API EFL_FUNC_BODY_CONST(elm_obj_index_item_letter_get, const char *, NULL);
