 ...
 * @ingroup Elm_Toolbar
 */
ELM_API_WEAK Elm_Widget_Item *elm_obj_toolbar_selected_item_get(const Eo *obj);
 ...
 * @ingroup Elm_Toolbar
 */
ELM_API_WEAK Elm_Widget_Item *elm_obj_toolbar_first_item_get(const Eo *obj);
 ...
 * @ingroup Elm_Toolbar
 */
ELM_API_WEAK Elm_Widget_Item *elm_obj_toolbar_last_item_get(const Eo *obj);
 ...
 * @ingroup Elm_Toolbar
 */
ELM_API_WEAK Eina_Iterator *elm_obj_toolbar_items_get(const Eo *obj) EINA_WARN_UNUSED_RESULT;
 ...
 * @ingroup Elm_Toolbar
 */
ELM_API_WEAK void elm_obj_toolbar_homogeneous_set(Eo *obj, Eina_Bool homogeneous);
 ...
 * @ingroup Elm_Toolbar
 */
ELM_API_WEAK Eina_Bool elm_obj_toolbar_homogeneous_get(const Eo *obj);
 ...
 * @ingroup Elm_Toolbar
 */
ELM_API_WEAK void elm_obj_toolbar_align_set(Eo *obj, double align);
 ...
 * @ingroup Elm_Toolbar
 */
ELM_API_WEAK double elm_obj_toolbar_align_get(const Eo *obj);
 ...
 * @ingroup Elm_Toolbar
 */
ELM_API_WEAK void elm_obj_toolbar_select_mode_set(Eo *obj, Elm_Object_Select_Mode mode);
 ...
 * @ingroup Elm_Toolbar
 */
ELM_API_WEAK Elm_Object_Select_Mode elm_obj_toolbar_select_mode_get(const Eo *obj);
 ...
 * @ingroup Elm_Toolbar
 */
ELM_API_WEAK void elm_obj_toolbar_icon_size_set(Eo *obj, int icon_size);
 ...
 * @ingroup Elm_Toolbar
 */
ELM_API_WEAK int elm_obj_toolbar_icon_size_get(const Eo *obj);
 ...
 * @ingroup Elm_Toolbar
 */
ELM_API_WEAK void elm_obj_toolbar_shrink_mode_set(Eo *obj, Elm_Toolbar_Shrink_Mode shrink_mode);
 ...
 * @ingroup Elm_Toolbar
 */
ELM_API_WEAK Elm_Toolbar_Shrink_Mode elm_obj_toolbar_shrink_mode_get(const Eo *obj);
 ...
 * @ingroup Elm_Toolbar
 */
ELM_API_WEAK void elm_obj_toolbar_menu_parent_set(Eo *obj, Efl_Canvas_Object *parent);
 ...
 * @ingroup Elm_Toolbar
 */
ELM_API_WEAK Efl_Canvas_Object *elm_obj_toolbar_menu_parent_get(const Eo *obj);
 ...
 * @ingroup Elm_Toolbar
 */
ELM_API_WEAK void elm_obj_toolbar_standard_priority_set(Eo *obj, int priority);
 ...
 * @ingroup Elm_Toolbar
 */
ELM_API_WEAK int elm_obj_toolbar_standard_priority_get(const Eo *obj);
 ...
 * @ingroup Elm_Toolbar
 */
ELM_API_WEAK Elm_Widget_Item *elm_obj_toolbar_more_item_get(const Eo *obj);
 ...
 * @ingroup Elm_Toolbar
 */
ELM_API_WEAK Elm_Widget_Item *elm_obj_toolbar_item_insert_before(Eo *obj, Elm_Widget_Item *before, const char *icon, const char *label, Evas_Smart_Cb func, const void *data);
 ...
 * @ingroup Elm_Toolbar
 */
ELM_API_WEAK Elm_Widget_Item *elm_obj_toolbar_item_insert_after(Eo *obj, Elm_Widget_Item *after, const char *icon, const char *label, Evas_Smart_Cb func, const void *data);
 ...
 * @ingroup Elm_Toolbar
 */
ELM_API_WEAK Elm_Widget_Item *elm_obj_toolbar_item_append(Eo *obj, const char *icon, const char *label, Evas_Smart_Cb func, const void *data);
 ...
 * @ingroup Elm_Toolbar
 */
ELM_API_WEAK unsigned int elm_obj_toolbar_items_count(const Eo *obj);
 ...
 * @ingroup Elm_Toolbar
 */
ELM_API_WEAK Elm_Widget_Item *elm_obj_toolbar_item_prepend(Eo *obj, const char *icon, const char *label, Evas_Smart_Cb func, const void *data);
 ...
 * @ingroup Elm_Toolbar
 */
ELM_API_WEAK Elm_Widget_Item *elm_obj_toolbar_item_find_by_label(const Eo *obj, const char *label);
