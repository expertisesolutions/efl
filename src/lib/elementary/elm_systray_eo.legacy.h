 ...
 */
ELEMENTARY_API void elm_systray_id_set(Elm_Systray *obj, const char *id);
 ...
 * @ingroup Elm_Systray_Group
 */
ELEMENTARY_API const char *elm_systray_id_get(const Elm_Systray *obj);
 ...
 * @ingroup Elm_Systray_Group
 */
ELEMENTARY_API void elm_systray_category_set(Elm_Systray *obj, Elm_Systray_Category cat);
 ...
 * @ingroup Elm_Systray_Group
 */
ELEMENTARY_API Elm_Systray_Category elm_systray_category_get(const Elm_Systray *obj);
 ...
 * @ingroup Elm_Systray_Group
 */
ELEMENTARY_API void elm_systray_icon_theme_path_set(Elm_Systray *obj, const char *icon_theme_path);
 ...
 * @ingroup Elm_Systray_Group
 */
ELEMENTARY_API const char *elm_systray_icon_theme_path_get(const Elm_Systray *obj);
 ...
 * @ingroup Elm_Systray_Group
 */
ELEMENTARY_API void elm_systray_menu_set(Elm_Systray *obj, const Efl_Object *menu);
 ...
 * @ingroup Elm_Systray_Group
 */
ELEMENTARY_API const Efl_Object *elm_systray_menu_get(const Elm_Systray *obj);
 ...
 * @ingroup Elm_Systray_Group
 */
ELEMENTARY_API void elm_systray_att_icon_name_set(Elm_Systray *obj, const char *att_icon_name);
 ...
 * @ingroup Elm_Systray_Group
 */
ELEMENTARY_API const char *elm_systray_att_icon_name_get(const Elm_Systray *obj);
 ...
 * @ingroup Elm_Systray_Group
 */
ELEMENTARY_API void elm_systray_status_set(Elm_Systray *obj, Elm_Systray_Status st);
 ...
 * @ingroup Elm_Systray_Group
 */
ELEMENTARY_API Elm_Systray_Status elm_systray_status_get(const Elm_Systray *obj);
 ...
 * @ingroup Elm_Systray_Group
 */
ELEMENTARY_API void elm_systray_icon_name_set(Elm_Systray *obj, const char *icon_name);
 ...
 * @ingroup Elm_Systray_Group
 */
ELEMENTARY_API const char *elm_systray_icon_name_get(const Elm_Systray *obj);
 ...
 * @ingroup Elm_Systray_Group
 */
ELEMENTARY_API void elm_systray_title_set(Elm_Systray *obj, const char *title);
 ...
 * @ingroup Elm_Systray_Group
 */
ELEMENTARY_API const char *elm_systray_title_get(const Elm_Systray *obj);
 ...
 * @ingroup Elm_Systray_Group
 */
ELEMENTARY_API Eina_Bool elm_systray_register(Elm_Systray *obj);
