 ...
 */
ELEMENTARY_API void elm_naviframe_item_style_set(Elm_Object_Item *obj, const char *style);
 ...
 * @ingroup Elm_Naviframe_Item
 */
ELEMENTARY_API const char *elm_naviframe_item_style_get(const Elm_Object_Item *obj);
