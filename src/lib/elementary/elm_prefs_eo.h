 ...
 * @ingroup Elm_Prefs
 */
ELM_API_WEAK Eina_Bool elm_obj_prefs_data_set(Eo *obj, Elm_Prefs_Data *data);
 ...
 * @ingroup Elm_Prefs
 */
ELM_API_WEAK Elm_Prefs_Data *elm_obj_prefs_data_get(const Eo *obj);
 ...
 * @ingroup Elm_Prefs
 */
ELM_API_WEAK void elm_obj_prefs_autosave_set(Eo *obj, Eina_Bool autosave);
 ...
 * @ingroup Elm_Prefs
 */
ELM_API_WEAK Eina_Bool elm_obj_prefs_autosave_get(const Eo *obj);
 ...
 * @ingroup Elm_Prefs
 */
ELM_API_WEAK void elm_obj_prefs_reset(Eo *obj, Elm_Prefs_Reset_Mode mode);
 ...
 * @ingroup Elm_Prefs
 */
ELM_API_WEAK Eina_Bool elm_obj_prefs_item_value_set(Eo *obj, const char *name, const Eina_Value *value);
 ...
 * @ingroup Elm_Prefs
 */
ELM_API_WEAK Eina_Bool elm_obj_prefs_item_value_get(const Eo *obj, const char *name, Eina_Value *value);
 ...
 * @ingroup Elm_Prefs
 */
ELM_API_WEAK const Efl_Canvas_Object *elm_obj_prefs_item_object_get(Eo *obj, const char *name);
 ...
 * @ingroup Elm_Prefs
 */
ELM_API_WEAK void elm_obj_prefs_item_disabled_set(Eo *obj, const char *name, Eina_Bool disabled);
 ...
 * @ingroup Elm_Prefs
 */
ELM_API_WEAK Eina_Bool elm_obj_prefs_item_disabled_get(const Eo *obj, const char *name);
 ...
 * @ingroup Elm_Prefs
 */
ELM_API_WEAK Eina_Bool elm_obj_prefs_item_swallow(Eo *obj, const char *name, Efl_Canvas_Object *child);
 ...
 * @ingroup Elm_Prefs
 */
ELM_API_WEAK void elm_obj_prefs_item_editable_set(Eo *obj, const char *name, Eina_Bool editable);
 ...
 * @ingroup Elm_Prefs
 */
ELM_API_WEAK Eina_Bool elm_obj_prefs_item_editable_get(const Eo *obj, const char *name);
 ...
 * @ingroup Elm_Prefs
 */
ELM_API_WEAK Efl_Canvas_Object *elm_obj_prefs_item_unswallow(Eo *obj, const char *name);
 ...
 * @ingroup Elm_Prefs
 */
ELM_API_WEAK void elm_obj_prefs_item_visible_set(Eo *obj, const char *name, Eina_Bool visible);
 ...
 * @ingroup Elm_Prefs
 */
ELM_API_WEAK Eina_Bool elm_obj_prefs_item_visible_get(const Eo *obj, const char *name);
