 ...
 */
ELEMENTARY_API void elm_code_widget_code_set(Elm_Code_Widget *obj, Elm_Code *code);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API Elm_Code *elm_code_widget_code_get(const Elm_Code_Widget *obj);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API void elm_code_widget_font_set(Elm_Code_Widget *obj, const char *name, int size);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API void elm_code_widget_font_get(const Elm_Code_Widget *obj, const char **name, int *size);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API unsigned int elm_code_widget_columns_get(const Elm_Code_Widget *obj);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API void elm_code_widget_gravity_set(Elm_Code_Widget *obj, double x, double y);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API void elm_code_widget_gravity_get(const Elm_Code_Widget *obj, double *x, double *y);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API void elm_code_widget_policy_set(Elm_Code_Widget *obj, Elm_Scroller_Policy policy_h, Elm_Scroller_Policy policy_v);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API void elm_code_widget_policy_get(const Elm_Code_Widget *obj, Elm_Scroller_Policy *policy_h, Elm_Scroller_Policy *policy_v);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API void elm_code_widget_tabstop_set(Elm_Code_Widget *obj, unsigned int tabstop);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API unsigned int elm_code_widget_tabstop_get(const Elm_Code_Widget *obj);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API void elm_code_widget_editable_set(Elm_Code_Widget *obj, Eina_Bool editable);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API Eina_Bool elm_code_widget_editable_get(const Elm_Code_Widget *obj);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API void elm_code_widget_line_numbers_set(Elm_Code_Widget *obj, Eina_Bool line_numbers);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API Eina_Bool elm_code_widget_line_numbers_get(const Elm_Code_Widget *obj);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API void elm_code_widget_line_width_marker_set(Elm_Code_Widget *obj, unsigned int line_width_marker);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API unsigned int elm_code_widget_line_width_marker_get(const Elm_Code_Widget *obj);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API void elm_code_widget_show_whitespace_set(Elm_Code_Widget *obj, Eina_Bool show_whitespace);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API Eina_Bool elm_code_widget_show_whitespace_get(const Elm_Code_Widget *obj);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API void elm_code_widget_alpha_set(Elm_Code_Widget *obj, int alpha);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API int elm_code_widget_alpha_get(const Elm_Code_Widget *obj);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API void elm_code_widget_syntax_enabled_set(Elm_Code_Widget *obj, Eina_Bool syntax_enabled);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API Eina_Bool elm_code_widget_syntax_enabled_get(const Elm_Code_Widget *obj);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API void elm_code_widget_tab_inserts_spaces_set(Elm_Code_Widget *obj, Eina_Bool tab_inserts_spaces);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API Eina_Bool elm_code_widget_tab_inserts_spaces_get(const Elm_Code_Widget *obj);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API void elm_code_widget_cursor_position_set(Elm_Code_Widget *obj, unsigned int row, unsigned int col);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API void elm_code_widget_cursor_position_get(const Elm_Code_Widget *obj, unsigned int *row, unsigned int *col);

/** Update and refresh theme for widget.
 *
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API void elm_code_widget_theme_refresh(Elm_Code_Widget *obj);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API void elm_code_widget_line_refresh(Elm_Code_Widget *obj, Elm_Code_Line *line);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API Eina_Bool elm_code_widget_line_visible_get(Elm_Code_Widget *obj, Elm_Code_Line *line);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API unsigned int elm_code_widget_lines_visible_get(Elm_Code_Widget *obj);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API Eina_Bool elm_code_widget_position_at_coordinates_get(Elm_Code_Widget *obj, int x, int y, unsigned int *row, int *col);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API Eina_Bool elm_code_widget_geometry_for_position_get(Elm_Code_Widget *obj, unsigned int row, int col, int *x, int *y, int *w, int *h);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API int elm_code_widget_text_left_gutter_width_get(Elm_Code_Widget *obj);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API char *elm_code_widget_text_between_positions_get(Elm_Code_Widget *obj, unsigned int start_line, unsigned int start_col, unsigned int end_line, unsigned int end_col);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API void elm_code_widget_text_at_cursor_insert(Elm_Code_Widget *obj, const char *text);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API unsigned int elm_code_widget_line_text_column_width_to_position(Elm_Code_Widget *obj, Elm_Code_Line *line, unsigned int position);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API unsigned int elm_code_widget_line_text_column_width_get(Elm_Code_Widget *obj, Elm_Code_Line *line);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API unsigned int elm_code_widget_line_text_position_for_column_get(Elm_Code_Widget *obj, Elm_Code_Line *line, unsigned int column);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API unsigned int elm_code_widget_text_tabwidth_at_column_get(Elm_Code_Widget *obj, unsigned int column);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API void elm_code_widget_line_status_toggle(Elm_Code_Widget *obj, Elm_Code_Line *line);

/** Undo last action
 *
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API void elm_code_widget_undo(Elm_Code_Widget *obj);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API Eina_Bool elm_code_widget_can_undo_get(Elm_Code_Widget *obj);

/** Redo last action
 *
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API void elm_code_widget_redo(Elm_Code_Widget *obj);
 ...
 * @ingroup Elm_Code_Widget_Group
 */
ELEMENTARY_API Eina_Bool elm_code_widget_can_redo_get(Elm_Code_Widget *obj);
