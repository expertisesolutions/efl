 ...
 */
ELEMENTARY_API void elm_frame_collapse_set(Efl_Ui_Frame *obj, Eina_Bool collapse);
 ...
 * @ingroup Elm_Frame_Group
 */
ELEMENTARY_API Eina_Bool elm_frame_collapse_get(const Efl_Ui_Frame *obj);
 ...
 * @ingroup Elm_Frame_Group
 */
ELEMENTARY_API void elm_frame_autocollapse_set(Efl_Ui_Frame *obj, Eina_Bool autocollapse);
 ...
 * @ingroup Elm_Frame_Group
 */
ELEMENTARY_API Eina_Bool elm_frame_autocollapse_get(const Efl_Ui_Frame *obj);
 ...
 * @ingroup Elm_Frame_Group
 */
ELEMENTARY_API void elm_frame_collapse_go(Efl_Ui_Frame *obj, Eina_Bool collapse);
