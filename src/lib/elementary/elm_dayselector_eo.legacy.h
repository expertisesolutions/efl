 ...
 */
ELEMENTARY_API void elm_dayselector_week_start_set(Elm_Dayselector *obj, Elm_Dayselector_Day day);
 ...
 * @ingroup Elm_Dayselector_Group
 */
ELEMENTARY_API Elm_Dayselector_Day elm_dayselector_week_start_get(const Elm_Dayselector *obj);
 ...
 * @ingroup Elm_Dayselector_Group
 */
ELEMENTARY_API void elm_dayselector_weekend_length_set(Elm_Dayselector *obj, unsigned int length);
 ...
 * @ingroup Elm_Dayselector_Group
 */
ELEMENTARY_API unsigned int elm_dayselector_weekend_length_get(const Elm_Dayselector *obj);
 ...
 * @ingroup Elm_Dayselector_Group
 */
ELEMENTARY_API void elm_dayselector_weekend_start_set(Elm_Dayselector *obj, Elm_Dayselector_Day day);
 ...
 * @ingroup Elm_Dayselector_Group
 */
ELEMENTARY_API Elm_Dayselector_Day elm_dayselector_weekend_start_get(const Elm_Dayselector *obj);
 ...
 * @ingroup Elm_Dayselector_Group
 */
ELEMENTARY_API void elm_dayselector_weekdays_names_set(Elm_Dayselector *obj, const char **weekdays);
 ...
 * @ingroup Elm_Dayselector_Group
 */
ELEMENTARY_API Eina_List *elm_dayselector_weekdays_names_get(const Elm_Dayselector *obj) EINA_WARN_UNUSED_RESULT;
 ...
 * @ingroup Elm_Dayselector_Group
 */
ELEMENTARY_API void elm_dayselector_day_selected_set(Elm_Dayselector *obj, Elm_Dayselector_Day day, Eina_Bool selected);
 ...
 * @ingroup Elm_Dayselector_Group
 */
ELEMENTARY_API Eina_Bool elm_dayselector_day_selected_get(const Elm_Dayselector *obj, Elm_Dayselector_Day day);
