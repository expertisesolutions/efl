...
ELM_API void elm_obj_combobox_hover_begin(Eo *obj);
ELM_API void elm_obj_combobox_hover_end(Eo *obj);
...
ELM_API EFL_FUNC_BODY_CONST(elm_obj_combobox_expanded_get, Eina_Bool, 0);
ELM_API EFL_VOID_FUNC_BODY(elm_obj_combobox_hover_begin);
ELM_API EFL_VOID_FUNC_BODY(elm_obj_combobox_hover_end);
