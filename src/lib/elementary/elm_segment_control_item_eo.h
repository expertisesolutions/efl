 ...
 * @ingroup Elm_Segment_Control_Item
 */
ELM_API int elm_obj_segment_control_item_index_get(const Eo *obj);
 ...
 * @ingroup Elm_Segment_Control_Item
 */
ELM_API Efl_Canvas_Object *elm_obj_segment_control_item_object_get(const Eo *obj);
 ...
 * @ingroup Elm_Segment_Control_Item
 */
ELM_API void elm_obj_segment_control_item_selected_set(Eo *obj, Eina_Bool selected);
