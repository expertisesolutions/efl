 ...
 */
ELEMENTARY_API void elm_colorselector_color_set(Elm_Colorselector *obj, int r, int g, int b, int a);
 ...
 * @ingroup Elm_Colorselector_Group
 */
ELEMENTARY_API void elm_colorselector_color_get(const Elm_Colorselector *obj, int *r, int *g, int *b, int *a);
 ...
 * @ingroup Elm_Colorselector_Group
 */
ELEMENTARY_API void elm_colorselector_palette_name_set(Elm_Colorselector *obj, const char *palette_name);
 ...
 * @ingroup Elm_Colorselector_Group
 */
ELEMENTARY_API const char *elm_colorselector_palette_name_get(const Elm_Colorselector *obj);
 ...
 * @ingroup Elm_Colorselector_Group
 */
ELEMENTARY_API void elm_colorselector_mode_set(Elm_Colorselector *obj, Elm_Colorselector_Mode mode);
 ...
 * @ingroup Elm_Colorselector_Group
 */
ELEMENTARY_API Elm_Colorselector_Mode elm_colorselector_mode_get(const Elm_Colorselector *obj);
 ...
 * @ingroup Elm_Colorselector_Group
 */
ELEMENTARY_API const Eina_List *elm_colorselector_palette_items_get(const Elm_Colorselector *obj);
 ...
 * @ingroup Elm_Colorselector_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_colorselector_palette_selected_item_get(const Elm_Colorselector *obj);
 ...
 * @ingroup Elm_Colorselector_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_colorselector_palette_color_add(Elm_Colorselector *obj, int r, int g, int b, int a);

/** Clear the palette items.
 *
 * @ingroup Elm_Colorselector_Group
 */
ELEMENTARY_API void elm_colorselector_palette_clear(Elm_Colorselector *obj);
