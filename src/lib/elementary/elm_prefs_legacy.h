 ...
 */
ELEMENTARY_API Eina_Bool elm_prefs_page_widget_common_add(Evas_Object *prefs, Evas_Object *obj);
 ...
 */
ELEMENTARY_API Eina_Bool elm_prefs_file_set(Eo *obj, const char *file, const char *page);
 ...
 */
ELEMENTARY_API Eina_Bool elm_prefs_file_get(const Eo *obj, const char **file, const char **page);
