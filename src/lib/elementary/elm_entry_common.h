 ...
 */
ELEMENTARY_API char              *elm_entry_markup_to_utf8(const char *s);
 ...
 * internally.
 */
ELEMENTARY_API char              *elm_entry_utf8_to_markup(const char *s);
 ...
 */
ELEMENTARY_API void elm_entry_filter_limit_size(void *data, Evas_Object *entry, char **text);
 ...
 * directly with elm_object_text_set()
 */
ELEMENTARY_API void                   elm_entry_filter_accept_set(void *data, Evas_Object *entry, char **text);
 ...
 * @since 1.8
 */
ELEMENTARY_API const char                  *elm_entry_context_menu_item_label_get(const Elm_Entry_Context_Menu_Item *item);
 ...
 * @since 1.8
 */
ELEMENTARY_API void                         elm_entry_context_menu_item_icon_get(const Elm_Entry_Context_Menu_Item *item, const char **icon_file, const char **icon_group, Elm_Icon_Type *icon_type);
