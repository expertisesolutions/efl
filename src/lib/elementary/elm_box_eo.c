...
ELM_API EFL_VOID_FUNC_BODYV(elm_obj_box_homogeneous_set, EFL_FUNC_CALL(homogeneous), Eina_Bool homogeneous);
...
ELM_API EFL_FUNC_BODY_CONST(elm_obj_box_homogeneous_get, Eina_Bool, 0);

void _elm_box_align_set(Eo *obj, Elm_Box_Data *pd, double horizontal, double vertical);

ELM_API EFL_VOID_FUNC_BODYV(elm_obj_box_align_set, EFL_FUNC_CALL(horizontal, vertical), double horizontal, double vertical);

void _elm_box_align_get(const Eo *obj, Elm_Box_Data *pd, double *horizontal, double *vertical);

ELM_API EFL_VOID_FUNC_BODYV_CONST(elm_obj_box_align_get, EFL_FUNC_CALL(horizontal, vertical), double *horizontal, double *vertical);
...
ELM_API EFL_VOID_FUNC_BODYV(elm_obj_box_horizontal_set, EFL_FUNC_CALL(horizontal), Eina_Bool horizontal);
...
ELM_API EFL_FUNC_BODY_CONST(elm_obj_box_horizontal_get, Eina_Bool, 0);

void _elm_box_padding_set(Eo *obj, Elm_Box_Data *pd, int horizontal, int vertical);

ELM_API EFL_VOID_FUNC_BODYV(elm_obj_box_padding_set, EFL_FUNC_CALL(horizontal, vertical), int horizontal, int vertical);

void _elm_box_padding_get(const Eo *obj, Elm_Box_Data *pd, int *horizontal, int *vertical);

ELM_API EFL_VOID_FUNC_BODYV_CONST(elm_obj_box_padding_get, EFL_FUNC_CALL(horizontal, vertical), int *horizontal, int *vertical);

Eina_List *_elm_box_children_get(const Eo *obj, Elm_Box_Data *pd);

ELM_API EFL_FUNC_BODY_CONST(elm_obj_box_children_get, Eina_List *, NULL);

void _elm_box_pack_end(Eo *obj, Elm_Box_Data *pd, Efl_Canvas_Object *subobj);

ELM_API EFL_VOID_FUNC_BODYV(elm_obj_box_pack_end, EFL_FUNC_CALL(subobj), Efl_Canvas_Object *subobj);

void _elm_box_unpack_all(Eo *obj, Elm_Box_Data *pd);

ELM_API EFL_VOID_FUNC_BODY(elm_obj_box_unpack_all);

void _elm_box_unpack(Eo *obj, Elm_Box_Data *pd, Efl_Canvas_Object *subobj);

ELM_API EFL_VOID_FUNC_BODYV(elm_obj_box_unpack, EFL_FUNC_CALL(subobj), Efl_Canvas_Object *subobj);

void _elm_box_pack_after(Eo *obj, Elm_Box_Data *pd, Efl_Canvas_Object *subobj, Efl_Canvas_Object *after);

ELM_API EFL_VOID_FUNC_BODYV(elm_obj_box_pack_after, EFL_FUNC_CALL(subobj, after), Efl_Canvas_Object *subobj, Efl_Canvas_Object *after);

void _elm_box_pack_start(Eo *obj, Elm_Box_Data *pd, Efl_Canvas_Object *subobj);

ELM_API EFL_VOID_FUNC_BODYV(elm_obj_box_pack_start, EFL_FUNC_CALL(subobj), Efl_Canvas_Object *subobj);

void _elm_box_recalculate(Eo *obj, Elm_Box_Data *pd);

ELM_API EFL_VOID_FUNC_BODY(elm_obj_box_recalculate);

void _elm_box_pack_before(Eo *obj, Elm_Box_Data *pd, Efl_Canvas_Object *subobj, Efl_Canvas_Object *before);

ELM_API EFL_VOID_FUNC_BODYV(elm_obj_box_pack_before, EFL_FUNC_CALL(subobj, before), Efl_Canvas_Object *subobj, Efl_Canvas_Object *before);

void _elm_box_clear(Eo *obj, Elm_Box_Data *pd);

ELM_API EFL_VOID_FUNC_BODY(elm_obj_box_clear);
