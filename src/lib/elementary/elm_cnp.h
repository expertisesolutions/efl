 ...
 * @since 1.20
 */
ELEMENTARY_API extern int ELM_CNP_EVENT_SELECTION_CHANGED;
 ...
 *
 */
ELEMENTARY_API Eina_Bool elm_cnp_selection_set(Evas_Object *obj, Elm_Sel_Type selection,
 ...
 * @ingroup CopyPaste
 */
ELEMENTARY_API Eina_Bool elm_cnp_selection_get(const Evas_Object *obj, Elm_Sel_Type selection,
                                     Elm_Sel_Format format,
 ...
 *
 */
ELEMENTARY_API Eina_Bool elm_object_cnp_selection_clear(Evas_Object *obj,
 ...
 * @since 1.7
 */
ELEMENTARY_API void elm_cnp_selection_loss_callback_set(Evas_Object *obj, Elm_Sel_Type selection, Elm_Selection_Loss_Cb func, const void *data);
 ...
 * @since 1.20
 */
ELEMENTARY_API Eina_Bool elm_cnp_clipboard_selection_has_owner(Evas_Object *win);
 ...
 * @since 1.8
 */
ELEMENTARY_API Eina_Bool elm_drop_target_add(Evas_Object *obj, Elm_Sel_Format format,
 ...
 * @since 1.8
 */
ELEMENTARY_API Eina_Bool elm_drop_target_del(Evas_Object *obj, Elm_Sel_Format format,
                                   Elm_Drag_State entercb, void *enterdata,
                                   Elm_Drag_State leavecb, void *leavedata,
                                   Elm_Drag_Pos poscb, void *posdata,
                                   Elm_Drop_Cb dropcb, void *dropdata);
 ...
 * @since 1.8
 */
ELEMENTARY_API Eina_Bool elm_drag_start(Evas_Object *obj, Elm_Sel_Format format,
 ...
 * @since 1.9
 */
ELEMENTARY_API Eina_Bool elm_drag_cancel(Evas_Object *obj);
 ...
 * @since 1.8
 */
ELEMENTARY_API Eina_Bool elm_drag_action_set(Evas_Object *obj, Elm_Xdnd_Action action);
 ...
 * @since 1.8
 */
ELEMENTARY_API Eina_Bool elm_drag_item_container_add(Evas_Object *obj, double tm_to_anim, double tm_to_drag, Elm_Xy_Item_Get_Cb itemgetcb, Elm_Item_Container_Data_Get_Cb data_get);
 ...
 * @since 1.8
 */
ELEMENTARY_API Eina_Bool elm_drag_item_container_del(Evas_Object *obj);
 ...
 * @since 1.8
 */
ELEMENTARY_API Eina_Bool elm_drop_item_container_add(Evas_Object *obj,
      Elm_Sel_Format format,
 ...
 * @since 1.8
 */
ELEMENTARY_API Eina_Bool elm_drop_item_container_del(Evas_Object *obj);
