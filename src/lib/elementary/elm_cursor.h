 ...
 * @ingroup Elm_Cursors
 */
ELEMENTARY_API Eina_Bool elm_object_cursor_set(Eo *obj, const char *cursor);
 ...
 * @ingroup Elm_Cursors
 */
ELEMENTARY_API const char *elm_object_cursor_get(const Eo *obj);
 ...
 * @ingroup Elm_Cursors
 */
ELEMENTARY_API Eina_Bool elm_object_cursor_style_set(Eo *obj, const char *style);
 ...
 * @ingroup Elm_Cursors
 */
ELEMENTARY_API const char *elm_object_cursor_style_get(const Eo *obj);
 ...
 * @ingroup Elm_Cursors
 */
ELEMENTARY_API Eina_Bool elm_object_cursor_theme_search_enabled_set(Eo *obj, Eina_Bool allow);
 ...
 * @ingroup Elm_Cursors
 */
ELEMENTARY_API Eina_Bool elm_object_cursor_theme_search_enabled_get(const Eo *obj);
 ...
 * @ingroup Elm_Cursors
 */
ELEMENTARY_API void elm_object_cursor_unset(Evas_Object *obj);
