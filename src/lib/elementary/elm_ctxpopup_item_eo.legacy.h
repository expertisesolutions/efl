 ...
 */
ELEMENTARY_API Elm_Widget_Item *elm_ctxpopup_item_prev_get(const Elm_Ctxpopup_Item *obj);
 ...
 * @ingroup Elm_Ctxpopup_Item_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_ctxpopup_item_next_get(const Elm_Ctxpopup_Item *obj);
 ...
 * @ingroup Elm_Ctxpopup_Item_Group
 */
ELEMENTARY_API void elm_ctxpopup_item_selected_set(Elm_Ctxpopup_Item *obj, Eina_Bool selected);
 ...
 * @ingroup Elm_Ctxpopup_Item_Group
 */
ELEMENTARY_API Eina_Bool elm_ctxpopup_item_selected_get(const Elm_Ctxpopup_Item *obj);
 ...
 * @ingroup Elm_Ctxpopup_Item_Group
 */
ELEMENTARY_API void elm_ctxpopup_item_init(Elm_Ctxpopup_Item *obj, Evas_Smart_Cb func, const void *data);
