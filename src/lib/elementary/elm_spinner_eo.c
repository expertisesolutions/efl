...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_spinner_wrap_set, EFL_FUNC_CALL(wrap), Eina_Bool wrap);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_spinner_wrap_get, Eina_Bool, 0);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_spinner_interval_set, EFL_FUNC_CALL(interval), double interval);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_spinner_interval_get, double, 0);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_spinner_round_set, EFL_FUNC_CALL(rnd), int rnd);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_spinner_round_get, int, 0);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_spinner_editable_set, EFL_FUNC_CALL(editable), Eina_Bool editable);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_spinner_editable_get, Eina_Bool, 0);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_spinner_base_set, EFL_FUNC_CALL(base), double base);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_spinner_base_get, double, 0);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_spinner_label_format_set, EFL_FUNC_CALL(fmt), const char *fmt);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_spinner_label_format_get, const char *, NULL);

void _elm_spinner_special_value_add(Eo *obj, Elm_Spinner_Data *pd, double value, const char *label);

ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_spinner_special_value_add, EFL_FUNC_CALL(value, label), double value, const char *label);
