 ...
 * @ingroup Elm_Thumb
 */
ELEMENTARY_API Evas_Object                *elm_thumb_add(Evas_Object *parent);
 ...
 */
ELEMENTARY_API void elm_thumb_file_set(Eo *obj, const char *file, const char *key);
 ...
 */
ELEMENTARY_API void elm_thumb_file_get(const Eo *obj, const char **file, const char **key);
 ...
 * @ingroup Elm_Thumb
 */
ELEMENTARY_API Eina_Bool elm_thumb_editable_set(Evas_Object *obj, Eina_Bool edit);
 ...
 * @ingroup Elm_Thumb
 */
ELEMENTARY_API Eina_Bool elm_thumb_editable_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Thumb
 */
ELEMENTARY_API void elm_thumb_compress_set(Evas_Object *obj, int compress);
 ...
 * @ingroup Elm_Thumb
 */
ELEMENTARY_API void elm_thumb_compress_get(const Evas_Object *obj, int *compress);
 ...
 * @ingroup Elm_Thumb
 */
ELEMENTARY_API void elm_thumb_format_set(Evas_Object *obj, Ethumb_Thumb_Format format);
 ...
 * @ingroup Elm_Thumb
 */
ELEMENTARY_API Ethumb_Thumb_Format elm_thumb_format_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Thumb
 */
ELEMENTARY_API void elm_thumb_animate_set(Evas_Object *obj, Elm_Thumb_Animation_Setting setting);
 ...
 * @ingroup Elm_Thumb
 */
ELEMENTARY_API Elm_Thumb_Animation_Setting elm_thumb_animate_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Thumb
 */
ELEMENTARY_API void elm_thumb_fdo_size_set(Evas_Object *obj, Ethumb_Thumb_FDO_Size size);
 ...
 * @ingroup Elm_Thumb
 */
ELEMENTARY_API Ethumb_Thumb_FDO_Size elm_thumb_fdo_size_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Thumb
 */
ELEMENTARY_API void elm_thumb_orientation_set(Evas_Object *obj, Ethumb_Thumb_Orientation orient);
 ...
 * @ingroup Elm_Thumb
 */
ELEMENTARY_API Ethumb_Thumb_Orientation elm_thumb_orientation_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Thumb
 */
ELEMENTARY_API void elm_thumb_aspect_set(Evas_Object *obj, Ethumb_Thumb_Aspect aspect);
 ...
 * @ingroup Elm_Thumb
 */
ELEMENTARY_API Ethumb_Thumb_Aspect elm_thumb_aspect_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Thumb
 */
ELEMENTARY_API void elm_thumb_quality_set(Evas_Object *obj, int quality);
 ...
 * @ingroup Elm_Thumb
 */
ELEMENTARY_API void elm_thumb_quality_get(const Evas_Object *obj, int *quality);
 ...
 * @ingroup Elm_Thumb
 */
ELEMENTARY_API void elm_thumb_size_set(Evas_Object *obj, int tw, int th);
 ...
 * @ingroup Elm_Thumb
 */
ELEMENTARY_API void elm_thumb_size_get(const Evas_Object *obj, int *tw, int *th);
 ...
 * @ingroup Elm_Thumb
 */
ELEMENTARY_API void elm_thumb_crop_align_set(Evas_Object *obj, double cropx, double cropy);
 ...
 * @ingroup Elm_Thumb
 */
ELEMENTARY_API void elm_thumb_crop_align_get(const Evas_Object *obj, double *cropx, double *cropy);
 ...
 * @ingroup Elm_Thumb
 */
ELEMENTARY_API void elm_thumb_path_get(const Evas_Object *obj, const char **file, const char **key);
 ...
 * @ingroup Elm_Thumb
 */
ELEMENTARY_API void elm_thumb_reload(Evas_Object *obj);
