 ...
 */
ELEMENTARY_API void elm_box_homogeneous_set(Elm_Box *obj, Eina_Bool homogeneous);
 ...
 * @ingroup Elm_Box_Group
 */
ELEMENTARY_API Eina_Bool elm_box_homogeneous_get(const Elm_Box *obj);
 ...
 * @ingroup Elm_Box_Group
 */
ELEMENTARY_API void elm_box_align_set(Elm_Box *obj, double horizontal, double vertical);
 ...
 * @ingroup Elm_Box_Group
 */
ELEMENTARY_API void elm_box_align_get(const Elm_Box *obj, double *horizontal, double *vertical);
 ...
 * @ingroup Elm_Box_Group
 */
ELEMENTARY_API void elm_box_horizontal_set(Elm_Box *obj, Eina_Bool horizontal);
 ...
 * @ingroup Elm_Box_Group
 */
ELEMENTARY_API Eina_Bool elm_box_horizontal_get(const Elm_Box *obj);
 ...
 * @ingroup Elm_Box_Group
 */
ELEMENTARY_API void elm_box_padding_set(Elm_Box *obj, int horizontal, int vertical);
 ...
 * @ingroup Elm_Box_Group
 */
ELEMENTARY_API void elm_box_padding_get(const Elm_Box *obj, int *horizontal, int *vertical);
 ...
 * @ingroup Elm_Box_Group
 */
ELEMENTARY_API Eina_List *elm_box_children_get(const Elm_Box *obj) EINA_WARN_UNUSED_RESULT;
 ...
 * @ingroup Elm_Box_Group
 */
ELEMENTARY_API void elm_box_pack_end(Elm_Box *obj, Efl_Canvas_Object *subobj);
 ...
 * @ingroup Elm_Box_Group
 */
ELEMENTARY_API void elm_box_unpack_all(Elm_Box *obj);
 ...
 * @ingroup Elm_Box_Group
 */
ELEMENTARY_API void elm_box_unpack(Elm_Box *obj, Efl_Canvas_Object *subobj);
 ...
 * @ingroup Elm_Box_Group
 */
ELEMENTARY_API void elm_box_pack_after(Elm_Box *obj, Efl_Canvas_Object *subobj, Efl_Canvas_Object *after);
 ...
 * @ingroup Elm_Box_Group
 */
ELEMENTARY_API void elm_box_pack_start(Elm_Box *obj, Efl_Canvas_Object *subobj);
 ...
 * @ingroup Elm_Box_Group
 */
ELEMENTARY_API void elm_box_recalculate(Elm_Box *obj);
 ...
 * @ingroup Elm_Box_Group
 */
ELEMENTARY_API void elm_box_pack_before(Elm_Box *obj, Efl_Canvas_Object *subobj, Efl_Canvas_Object *before);
 ...
 * @ingroup Elm_Box_Group
 */
ELEMENTARY_API void elm_box_clear(Elm_Box *obj);
