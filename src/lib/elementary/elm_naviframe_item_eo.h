...
ELM_API_WEAK const Efl_Class *elm_naviframe_item_class_get(void);
 ...
 * @ingroup Elm_Naviframe_Item
 */
ELM_API_WEAK void elm_obj_naviframe_item_pop_to(Eo *obj);
 ...
 * @ingroup Elm_Naviframe_Item
 */
ELM_API_WEAK Eina_Bool elm_obj_naviframe_item_title_enabled_get(const Eo *obj);
 ...
 * @ingroup Elm_Naviframe_Item
 */
ELM_API_WEAK void elm_obj_naviframe_item_title_enabled_set(Eo *obj, Eina_Bool enable, Eina_Bool transition);
 ...
 * @ingroup Elm_Naviframe_Item
 */
ELM_API_WEAK void elm_obj_naviframe_item_promote(Eo *obj);
 ...
 * @ingroup Elm_Naviframe_Item
 */
ELM_API_WEAK void elm_obj_naviframe_item_pop_cb_set(Eo *obj, Elm_Naviframe_Item_Pop_Cb func, void *data);
