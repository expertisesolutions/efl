 ...
 */
ELEMENTARY_API Evas_Object                 *elm_progressbar_add(Evas_Object *parent);
 ...
 * @ingroup Elm_Progressbar
 */
ELEMENTARY_API void elm_progressbar_span_size_set(Evas_Object *obj, Evas_Coord size);
 ...
 * @ingroup Elm_Progressbar
 */
ELEMENTARY_API Evas_Coord elm_progressbar_span_size_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Progressbar
 */
ELEMENTARY_API void elm_progressbar_value_set(Evas_Object *obj, double val);
 ...
 * @ingroup Elm_Progressbar
 */
ELEMENTARY_API double elm_progressbar_value_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Progressbar
 */
ELEMENTARY_API void elm_progressbar_inverted_set(Evas_Object *obj, Eina_Bool inverted);
 ...
 * @ingroup Elm_Progressbar
 */
ELEMENTARY_API Eina_Bool elm_progressbar_inverted_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Progressbar
 */
ELEMENTARY_API void elm_progressbar_horizontal_set(Evas_Object *obj, Eina_Bool horizontal);
 ...
 * @ingroup Elm_Progressbar
 */
ELEMENTARY_API Eina_Bool elm_progressbar_horizontal_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Progressbar
 */
ELEMENTARY_API void elm_progressbar_unit_format_set(Evas_Object *obj, const char *units);
 ...
 * @ingroup Elm_Progressbar
 */
ELEMENTARY_API const char *elm_progressbar_unit_format_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Progressbar
 */
ELEMENTARY_API void elm_progressbar_unit_format_function_set(Evas_Object *obj, progressbar_func_type func, progressbar_freefunc_type free_func);
 ...
 * @ingroup Elm_Progressbar
 */
ELEMENTARY_API void elm_progressbar_pulse_set(Evas_Object *obj, Eina_Bool pulse);
 ...
 * @ingroup Elm_Progressbar
 */
ELEMENTARY_API Eina_Bool elm_progressbar_pulse_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Progressbar
 */
ELEMENTARY_API void elm_progressbar_pulse(Evas_Object *obj, Eina_Bool state);
 ...
 * @ingroup Elm_Progressbar
 */
ELEMENTARY_API Eina_Bool elm_progressbar_is_pulsing_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Progressbar
 */
ELEMENTARY_API void elm_progressbar_part_value_set(Evas_Object *obj, const char *part, double val);
 ...
 * @ingroup Elm_Progressbar
 */
ELEMENTARY_API double elm_progressbar_part_value_get(const Evas_Object *obj, const char *part);
