 ...
 */
ELEMENTARY_API void elm_hover_target_set(Elm_Hover *obj, Efl_Canvas_Object *target);
 ...
 * @ingroup Elm_Hover_Group
 */
ELEMENTARY_API Efl_Canvas_Object *elm_hover_target_get(const Elm_Hover *obj);
 ...
 * @ingroup Elm_Hover_Group
 */
ELEMENTARY_API const char *elm_hover_best_content_location_get(const Elm_Hover *obj, Elm_Hover_Axis pref_axis);

/** Dismiss a hover object
 *
 * @ingroup Elm_Hover_Group
 */
ELEMENTARY_API void elm_hover_dismiss(Elm_Hover *obj);
