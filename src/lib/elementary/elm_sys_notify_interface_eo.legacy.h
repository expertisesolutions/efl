 ...
 */
ELEMENTARY_API void elm_sys_notify_interface_send(const Elm_Sys_Notify_Interface *obj, unsigned int replaces_id, const char *icon, const char *summary, const char *body, Elm_Sys_Notify_Urgency urgency, int timeout, Elm_Sys_Notify_Send_Cb cb, const void *cb_data);
 ...
 * @ingroup Elm_Sys_Notify_Interface_Group
 */
ELEMENTARY_API void elm_sys_notify_interface_simple_send(const Elm_Sys_Notify_Interface *obj, const char *icon, const char *summary, const char *body);
 ...
 * @ingroup Elm_Sys_Notify_Interface_Group
 */
ELEMENTARY_API void elm_sys_notify_interface_close(const Elm_Sys_Notify_Interface *obj, unsigned int id);
