 ...
 * @ingroup Elm_Layout
 */
ELEMENTARY_API Evas_Object                 *elm_layout_add(Evas_Object *parent);
 ...
 * @ingroup Elm_Layout
 */
ELEMENTARY_API Eina_Bool elm_layout_theme_set(Evas_Object *obj, const char *klass, const char *group, const char *style);
 ...
 */
ELEMENTARY_API const char *elm_layout_data_get(const Evas_Object *obj, const char *key);
 ...
 * @ingroup Elm_Layout
 */
ELEMENTARY_API void elm_layout_sizing_eval(Evas_Object *obj);
 ...
 * @ingroup Elm_Layout
 */
ELEMENTARY_API void elm_layout_sizing_restricted_eval(Evas_Object *obj, Eina_Bool width, Eina_Bool height);
 ...
 * @ingroup Elm_Layout
 */
ELEMENTARY_API void elm_layout_signal_callback_add(Evas_Object *obj, const char *emission, const char *source, Edje_Signal_Cb func, void *data);
 ...
 * @ingroup Elm_Layout
 */
ELEMENTARY_API void *elm_layout_signal_callback_del(Evas_Object *obj, const char *emission, const char *source, Edje_Signal_Cb func);
 ...
 * @ingroup Elm_Layout
 */
ELEMENTARY_API void elm_layout_signal_emit(Evas_Object *obj, const char *emission, const char *source);
 ...
 * @ingroup Elm_Layout
 */
ELEMENTARY_API Efl_Canvas_Object *elm_layout_edje_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Layout
 */
ELEMENTARY_API Eina_List                   *elm_layout_content_swallow_list_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Layout
 */
ELEMENTARY_API Eina_Bool                    elm_layout_content_set(Evas_Object *obj, const char *swallow, Evas_Object *content);
 ...
 * @ingroup Elm_Layout
 */
ELEMENTARY_API Evas_Object                 *elm_layout_content_get(const Evas_Object *obj, const char *swallow);
 ...
 * @ingroup Elm_Layout
 */
ELEMENTARY_API Evas_Object                 *elm_layout_content_unset(Evas_Object *obj, const char *swallow);
 ...
 */
ELEMENTARY_API Eina_Bool elm_layout_file_set(Eo *obj, const char *file, const char *group);
 ...
 * @since 1.14
 */
ELEMENTARY_API void elm_layout_file_get(Eo *obj, const char **file, const char **group);
 ...
 * @since 1.19
 */
ELEMENTARY_API Eina_Bool elm_layout_mmap_set(Eo *obj, const Eina_File *file, const char *group);
 ...
 * @since 1.19
 */
ELEMENTARY_API void elm_layout_mmap_get(Eo *obj, const Eina_File **file, const char **group);
 ...
 */
ELEMENTARY_API int elm_layout_freeze(Evas_Object *obj);
 ...
 */
ELEMENTARY_API int elm_layout_thaw(Evas_Object *obj);
 ...
 * @ingroup Elm_Layout
 */
ELEMENTARY_API Eina_Bool elm_layout_box_append(Evas_Object *obj, const char *part, Evas_Object *child);
 ...
 * @ingroup Elm_Layout
 */
ELEMENTARY_API Eina_Bool elm_layout_box_prepend(Evas_Object *obj, const char *part, Evas_Object *child);
 ...
 * @ingroup Elm_Layout
 */
ELEMENTARY_API Eina_Bool elm_layout_box_insert_before(Evas_Object *obj, const char *part, Evas_Object *child, const Evas_Object *reference);
 ...
 * @ingroup Elm_Layout
 */
ELEMENTARY_API Eina_Bool elm_layout_box_insert_at(Evas_Object *obj, const char *part, Evas_Object *child, unsigned int pos);
 ...
 * @ingroup Elm_Layout
 */
ELEMENTARY_API Evas_Object *elm_layout_box_remove(Evas_Object *obj, const char *part, Evas_Object *child);
 ...
 * @ingroup Elm_Layout
 */
ELEMENTARY_API Eina_Bool elm_layout_box_remove_all(Evas_Object *obj, const char *part, Eina_Bool clear);
 ...
 * @ingroup Elm_Layout
 */
ELEMENTARY_API Eina_Bool elm_layout_table_pack(Evas_Object *obj, const char *part, Evas_Object *child, unsigned short col, unsigned short row, unsigned short colspan, unsigned short rowspan);
 ...
 * @ingroup Elm_Layout
 */
ELEMENTARY_API Evas_Object *elm_layout_table_unpack(Evas_Object *obj, const char *part, Evas_Object *child);
 ...
 * @ingroup Elm_Layout
 */
ELEMENTARY_API Eina_Bool elm_layout_table_clear(Evas_Object *obj, const char *part, Eina_Bool clear);
 ...
 * @ingroup Elm_Layout
 */
ELEMENTARY_API Eina_Bool elm_layout_text_set(Evas_Object *obj, const char * part, const char *text);
 ...
 * @ingroup Elm_Layout
 */
ELEMENTARY_API const char *elm_layout_text_get(const Evas_Object *obj, const char * part);
 ...
 * @ingroup Elm_Layout
 */
ELEMENTARY_API Eina_Bool elm_layout_edje_object_can_access_set(Evas_Object *obj, Eina_Bool can_access);
 ...
 * @ingroup Elm_Layout
 */
ELEMENTARY_API Eina_Bool elm_layout_edje_object_can_access_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Layout
 */
ELEMENTARY_API Eina_Bool elm_layout_part_cursor_engine_only_set(Evas_Object *obj, const char *part_name, Eina_Bool engine_only);
 ...
 * @ingroup Elm_Layout
 */
ELEMENTARY_API Eina_Bool elm_layout_part_cursor_engine_only_get(const Evas_Object *obj, const char *part_name);
 ...
 * @ingroup Elm_Layout
 */
ELEMENTARY_API Eina_Bool elm_layout_part_cursor_set(Evas_Object *obj, const char *part_name, const char *cursor);
 ...
 * @ingroup Elm_Layout
 */
ELEMENTARY_API const char *elm_layout_part_cursor_get(const Evas_Object *obj, const char *part_name);
 ...
 * @ingroup Elm_Layout
 */
ELEMENTARY_API Eina_Bool elm_layout_part_cursor_style_set(Evas_Object *obj, const char *part_name, const char *style);
 ...
 * @ingroup Elm_Layout
 */
ELEMENTARY_API const char *elm_layout_part_cursor_style_get(const Evas_Object *obj, const char *part_name);
 ...
 * @ingroup Elm_Layout
 */
ELEMENTARY_API Eina_Bool elm_layout_part_cursor_unset(Evas_Object *obj, const char *part_name);
