 ...
 */
ELEMENTARY_API void elm_actionslider_indicator_pos_set(Elm_Actionslider *obj, Elm_Actionslider_Pos pos);
 ...
 * @ingroup Elm_Actionslider_Group
 */
ELEMENTARY_API Elm_Actionslider_Pos elm_actionslider_indicator_pos_get(const Elm_Actionslider *obj);
 ...
 * @ingroup Elm_Actionslider_Group
 */
ELEMENTARY_API void elm_actionslider_magnet_pos_set(Elm_Actionslider *obj, Elm_Actionslider_Pos pos);
 ...
 * @ingroup Elm_Actionslider_Group
 */
ELEMENTARY_API Elm_Actionslider_Pos elm_actionslider_magnet_pos_get(const Elm_Actionslider *obj);
 ...
 * @ingroup Elm_Actionslider_Group
 */
ELEMENTARY_API void elm_actionslider_enabled_pos_set(Elm_Actionslider *obj, Elm_Actionslider_Pos pos);
 ...
 * @ingroup Elm_Actionslider_Group
 */
ELEMENTARY_API Elm_Actionslider_Pos elm_actionslider_enabled_pos_get(const Elm_Actionslider *obj);
 ...
 * @ingroup Elm_Actionslider_Group
 */
ELEMENTARY_API const char *elm_actionslider_selected_label_get(const Elm_Actionslider *obj);
