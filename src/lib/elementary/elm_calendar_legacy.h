 ...
 */
ELEMENTARY_API Evas_Object         *elm_calendar_add(Evas_Object *parent);
 ...
 */
ELEMENTARY_API void                 elm_calendar_mark_del(Elm_Calendar_Mark *mark);
 ...
 */
ELEMENTARY_API void                 elm_calendar_min_max_year_set(Elm_Calendar *obj, int min, int max);
 ...
 */
ELEMENTARY_API void                 elm_calendar_min_max_year_get(const Elm_Calendar *obj, int *min, int *max);
