 ...
 * @ingroup Elm_General
 */
ELEMENTARY_API void                         elm_object_part_text_set(Evas_Object *obj, const char *part, const char *text);
 ...
 * @ingroup Elm_General
 */
ELEMENTARY_API const char                  *elm_object_part_text_get(const Evas_Object *obj, const char *part);
 ...
 * @ingroup Elm_General
 */
ELEMENTARY_API void      elm_object_domain_translatable_part_text_set(Evas_Object *obj, const char *part, const char *domain, const char *text);
 ...
 * @ingroup Elm_General
 */
ELEMENTARY_API const char *elm_object_translatable_part_text_get(const Evas_Object *obj, const char *part);
 ...
 * @ingroup Elm_General
 */
ELEMENTARY_API void elm_object_domain_part_text_translatable_set(Evas_Object *obj, const char *part, const char *domain, Eina_Bool translatable);
 ...
 * @ingroup Elm_General
 */
ELEMENTARY_API void                         elm_object_part_content_set(Evas_Object *obj, const char *part, Evas_Object *content);
 ...
 * @ingroup Elm_General
 */
ELEMENTARY_API Evas_Object                 *elm_object_part_content_get(const Evas_Object *obj, const char *part);
 ...
 * @ingroup Elm_General
 */
ELEMENTARY_API Evas_Object                 *elm_object_part_content_unset(Evas_Object *obj, const char *part);
 ...
 * @ingroup Elm_General
 */
ELEMENTARY_API void                         elm_object_access_info_set(Evas_Object *obj, const char *txt);
 ...
 * @since 1.14
 */
ELEMENTARY_API const char *elm_object_access_info_get(Evas_Object *obj);
 ...
 * @ingroup Elm_General
 */
ELEMENTARY_API Evas_Object                 *elm_object_name_find(const Evas_Object *obj, const char *name, int recurse);
 ...
 * @ingroup Elm_Styles
 */
ELEMENTARY_API Eina_Bool    elm_object_style_set(Evas_Object *obj, const char *style);
 ...
 * @ingroup Elm_Styles
 */
ELEMENTARY_API const char  *elm_object_style_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_General
 */
ELEMENTARY_API void         elm_object_disabled_set(Evas_Object *obj, Eina_Bool disabled);
 ...
 * @ingroup Elm_General
 */
ELEMENTARY_API Eina_Bool    elm_object_disabled_get(const Evas_Object *obj);
 ...
 */
ELEMENTARY_API Eina_Bool    elm_object_widget_check(const Evas_Object *obj);
 ...
 * @ingroup Elm_WidgetNavigation
 */
ELEMENTARY_API Evas_Object *elm_object_parent_widget_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_WidgetNavigation
 */
ELEMENTARY_API Evas_Object *elm_object_top_widget_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_WidgetNavigation
 */
ELEMENTARY_API const char  *elm_object_widget_type_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_General
 */
ELEMENTARY_API void         elm_object_signal_emit(Evas_Object *obj, const char *emission, const char *source);
 ...
 * @ingroup Elm_General
 */
ELEMENTARY_API void         elm_object_signal_callback_add(Evas_Object *obj, const char *emission, const char *source, Edje_Signal_Cb func, void *data);
 ...
 * @ingroup Elm_General
 */
ELEMENTARY_API void        *elm_object_signal_callback_del(Evas_Object *obj, const char *emission, const char *source, Edje_Signal_Cb func);
 ...
 * @ingroup Elm_General
 */
ELEMENTARY_API void         elm_object_event_callback_add(Evas_Object *obj, Elm_Event_Cb func, const void *data);
 ...
 * @ingroup Elm_General
 */
ELEMENTARY_API void        *elm_object_event_callback_del(Evas_Object *obj, Elm_Event_Cb func, const void *data);
 ...
 * @ingroup Elm_General
 */
ELEMENTARY_API void        elm_object_orientation_mode_disabled_set(Evas_Object *obj, Eina_Bool disabled);
 ...
 * @ingroup Elm_General
 */
ELEMENTARY_API Eina_Bool   elm_object_orientation_mode_disabled_get(const Evas_Object *obj);
