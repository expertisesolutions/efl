...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_diskselector_side_text_max_length_set, EFL_FUNC_CALL(len), int len);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_diskselector_side_text_max_length_get, int, 0);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_diskselector_round_enabled_set, EFL_FUNC_CALL(enabled), Eina_Bool enabled);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_diskselector_round_enabled_get, Eina_Bool, 0);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_diskselector_display_item_num_set, EFL_FUNC_CALL(num), int num);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_diskselector_display_item_num_get, int, 0);

Elm_Widget_Item *_elm_diskselector_first_item_get(const Eo *obj, Elm_Diskselector_Data *pd);

ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_diskselector_first_item_get, Elm_Widget_Item *, NULL);

const Eina_List *_elm_diskselector_items_get(const Eo *obj, Elm_Diskselector_Data *pd);

ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_diskselector_items_get, const Eina_List *, NULL);

Elm_Widget_Item *_elm_diskselector_last_item_get(const Eo *obj, Elm_Diskselector_Data *pd);

ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_diskselector_last_item_get, Elm_Widget_Item *, NULL);

Elm_Widget_Item *_elm_diskselector_selected_item_get(const Eo *obj, Elm_Diskselector_Data *pd);

ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_diskselector_selected_item_get, Elm_Widget_Item *, NULL);
...
ELM_API_WEAK EFL_FUNC_BODYV(elm_obj_diskselector_item_append, Elm_Widget_Item *, NULL, EFL_FUNC_CALL(label, icon, func, data), const char *label, Efl_Canvas_Object *icon, Evas_Smart_Cb func, const void *data);

void _elm_diskselector_clear(Eo *obj, Elm_Diskselector_Data *pd);

ELM_API_WEAK EFL_VOID_FUNC_BODY(elm_obj_diskselector_clear);
