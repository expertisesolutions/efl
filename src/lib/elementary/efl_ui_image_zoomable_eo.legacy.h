 ...
 */
ELEMENTARY_API void elm_photocam_gesture_enabled_set(Efl_Ui_Image_Zoomable *obj, Eina_Bool gesture);
 ...
 * @ingroup Elm_Photocam_Group
 */
ELEMENTARY_API Eina_Bool elm_photocam_gesture_enabled_get(const Efl_Ui_Image_Zoomable *obj);
