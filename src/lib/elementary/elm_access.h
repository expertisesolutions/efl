 ...
 * @ingroup Access
 */
ELEMENTARY_API Evas_Object *elm_access_object_register(Evas_Object *obj, Evas_Object *parent);
 ...
 * @ingroup Access
 */
ELEMENTARY_API void elm_access_object_unregister(Evas_Object *obj);
 ...
 * @ingroup Access
 */
ELEMENTARY_API Evas_Object *elm_access_object_get(const Evas_Object *obj);
 ...
 * @ingroup Access
 */
ELEMENTARY_API void elm_access_info_set(Evas_Object *obj, int type, const char *text);
 ...
 * @ingroup Access
 */
ELEMENTARY_API char *elm_access_info_get(const Evas_Object *obj, int type);
 ...
 * @ingroup Access
 */
ELEMENTARY_API void elm_access_info_cb_set(Evas_Object *obj, int type, Elm_Access_Info_Cb func, const void *data);
 ...
 * @ingroup Access
 */
ELEMENTARY_API void elm_access_activate_cb_set(Evas_Object *obj, Elm_Access_Activate_Cb func, void *data);
 ...
 * @ingroup Access
 */
ELEMENTARY_API void elm_access_say(const char *text);
 ...
 * @ingroup Access
 */
ELEMENTARY_API void elm_access_highlight_set(Evas_Object* obj);
 ...
 * @ingroup Access
 */
ELEMENTARY_API Eina_Bool elm_access_action(Evas_Object *obj, const Elm_Access_Action_Type type, Elm_Access_Action_Info *action_info);
 ...
 * @ingroup Access
 */
ELEMENTARY_API void elm_access_action_cb_set(Evas_Object *obj, const Elm_Access_Action_Type type, const Elm_Access_Action_Cb cb, const void *data);
