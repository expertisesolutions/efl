 ...
 * @ingroup Elm_Notify
 */
ELEMENTARY_API Evas_Object                 *elm_notify_add(Evas_Object *parent);
 ...
 * @ingroup Elm_Notify
 */
ELEMENTARY_API void                         elm_notify_parent_set(Evas_Object *obj, Evas_Object *parent);
 ...
 * @ingroup Elm_Notify
 */
ELEMENTARY_API Evas_Object                 *elm_notify_parent_get(const Evas_Object *obj);
