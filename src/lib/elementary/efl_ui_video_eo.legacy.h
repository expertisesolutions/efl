 ...
 */
ELEMENTARY_API void elm_video_remember_position_set(Efl_Ui_Video *obj, Eina_Bool remember);
 ...
 * @ingroup Elm_Video_Group
 */
ELEMENTARY_API Eina_Bool elm_video_remember_position_get(const Efl_Ui_Video *obj);
 ...
 * @ingroup Elm_Video_Group
 */
ELEMENTARY_API Efl_Canvas_Object *elm_video_emotion_get(const Efl_Ui_Video *obj);
 ...
 * @ingroup Elm_Video_Group
 */
ELEMENTARY_API const char *elm_video_title_get(const Efl_Ui_Video *obj);
