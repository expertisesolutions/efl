 ...
 * @ingroup Elm_Gengrid
 */
ELEMENTARY_API Elm_Gengrid_Item_Class *elm_gengrid_item_class_new(void);
 ...
 * @ingroup Elm_Gengrid
 */
ELEMENTARY_API void elm_gengrid_item_class_free(Elm_Gengrid_Item_Class *itc);
 ...
 * @ingroup Elm_Gengrid
 */
ELEMENTARY_API void elm_gengrid_item_class_ref(Elm_Gengrid_Item_Class *itc);
 ...
 * @ingroup Elm_Gengrid
 */
ELEMENTARY_API void elm_gengrid_item_class_unref(Elm_Gengrid_Item_Class *itc);
 ...
 * @ingroup Elm_Gengrid
 */
ELEMENTARY_API void                          elm_gengrid_item_tooltip_text_set(Elm_Object_Item *it, const char *text);
 ...
 * @ingroup Elm_Gengrid
 */
ELEMENTARY_API void                          elm_gengrid_item_tooltip_content_cb_set(Elm_Object_Item *it, Elm_Tooltip_Item_Content_Cb func, const void *data, Evas_Smart_Cb del_cb);
 ...
 * @ingroup Elm_Gengrid
 */
ELEMENTARY_API void                          elm_gengrid_item_tooltip_unset(Elm_Object_Item *it);
 ...
 * @ingroup Elm_Gengrid
 */
ELEMENTARY_API void                          elm_gengrid_item_tooltip_style_set(Elm_Object_Item *it, const char *style);
 ...
 * @ingroup Elm_Gengrid
 */
ELEMENTARY_API const char                   *elm_gengrid_item_tooltip_style_get(const Elm_Object_Item *it);
 ...
 */
ELEMENTARY_API Eina_Bool                     elm_gengrid_item_tooltip_window_mode_set(Elm_Object_Item *it, Eina_Bool disable);
 ...
 * It will instead be limited only by the size of the display.
 */
ELEMENTARY_API Eina_Bool                     elm_gengrid_item_tooltip_window_mode_get(const Elm_Object_Item *it);
 ...
 * @ingroup Elm_Gengrid
 */
ELEMENTARY_API void                          elm_gengrid_item_cursor_set(Elm_Object_Item *it, const char *cursor);
 ...
 * @ingroup Elm_Gengrid
 */
ELEMENTARY_API const char                   *elm_gengrid_item_cursor_get(const Elm_Object_Item *it);
 ...
 * @ingroup Elm_Gengrid
 */
ELEMENTARY_API void                          elm_gengrid_item_cursor_unset(Elm_Object_Item *it);
 ...
 * @ingroup Elm_Gengrid
 */
ELEMENTARY_API void                          elm_gengrid_item_cursor_style_set(Elm_Object_Item *it, const char *style);
 ...
 * @ingroup Elm_Gengrid
 */
ELEMENTARY_API const char                   *elm_gengrid_item_cursor_style_get(const Elm_Object_Item *it);
 ...
 * @ingroup Elm_Gengrid
 */
ELEMENTARY_API void                          elm_gengrid_item_cursor_engine_only_set(Elm_Object_Item *it, Eina_Bool engine_only);
 ...
 * @ingroup Elm_Gengrid
 */
ELEMENTARY_API Eina_Bool                     elm_gengrid_item_cursor_engine_only_get(const Elm_Object_Item *it);
 ...
 * @ingroup Elm_Gengrid
 */
ELEMENTARY_API void                          elm_gengrid_item_pos_get(const Elm_Object_Item *it, unsigned int *x, unsigned int *y);
 ...
 * @ingroup Elm_Gengrid
 */
ELEMENTARY_API void                          elm_gengrid_item_select_mode_set(Elm_Object_Item *it, Elm_Object_Select_Mode mode);
 ...
 * @ingroup Elm_Gengrid
 */
ELEMENTARY_API Elm_Object_Select_Mode        elm_gengrid_item_select_mode_get(const Elm_Object_Item *it);
