 ...
 * @ingroup Elm_General
 */
ELEMENTARY_API void *elm_object_item_data_get(const Elm_Object_Item *it);
 ...
 * @ingroup Elm_General
 */
ELEMENTARY_API void elm_object_item_data_set(Elm_Object_Item *it, void *data);

/** Delete the given item.
 *
 * @ingroup Elm_General
 */
ELEMENTARY_API void elm_object_item_del(Elm_Object_Item *obj);
