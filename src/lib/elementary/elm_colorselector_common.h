 ...
 */
ELEMENTARY_API void elm_colorselector_palette_item_color_get(const Elm_Object_Item *it, int *r, int *g, int *b, int *a);
 ...
 * @ingroup Elm_Colorselector
 */
ELEMENTARY_API void elm_colorselector_palette_item_color_set(Elm_Object_Item *it, int r, int g, int b, int a);
 ...
 * @ingroup Elm_Colorselector
 */
ELEMENTARY_API Eina_Bool elm_colorselector_palette_item_selected_get(const Elm_Object_Item *it);
 ...
 * @ingroup Elm_Colorselector
 */
ELEMENTARY_API void elm_colorselector_palette_item_selected_set(Elm_Object_Item *it, Eina_Bool selected);
