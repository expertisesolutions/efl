 ...
 * @ingroup Elm_Map
 */
ELEMENTARY_API Evas_Object          *elm_map_add(Evas_Object *parent);
 ...
 * @ingroup Elm_Map
 */
ELEMENTARY_API void elm_map_zoom_set(Evas_Object *obj, int zoom);
 ...
 * @ingroup Elm_Map
 */
ELEMENTARY_API int elm_map_zoom_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Map
 */
ELEMENTARY_API void elm_map_zoom_mode_set(Evas_Object *obj, Elm_Map_Zoom_Mode mode);
 ...
 * @ingroup Elm_Map
 */
ELEMENTARY_API Elm_Map_Zoom_Mode elm_map_zoom_mode_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Map
 */
ELEMENTARY_API void elm_map_wheel_disabled_set(Evas_Object *obj, Eina_Bool disabled);
 ...
 * @ingroup Elm_Map
 */
ELEMENTARY_API Eina_Bool elm_map_wheel_disabled_get(const Evas_Object *obj);
 ...
 */
ELEMENTARY_API void elm_map_paused_set(Evas_Object *obj, Eina_Bool paused);
 ...
 * @ingroup Elm_Map_Group
 */
ELEMENTARY_API Eina_Bool elm_map_paused_get(const Evas_Object *obj);
