 ...
 */
ELEMENTARY_API void elm_clock_show_am_pm_set(Elm_Clock *obj, Eina_Bool am_pm);
 ...
 * @ingroup Elm_Clock_Group
 */
ELEMENTARY_API Eina_Bool elm_clock_show_am_pm_get(const Elm_Clock *obj);
 ...
 * @ingroup Elm_Clock_Group
 */
ELEMENTARY_API void elm_clock_first_interval_set(Elm_Clock *obj, double interval);
 ...
 * @ingroup Elm_Clock_Group
 */
ELEMENTARY_API double elm_clock_first_interval_get(const Elm_Clock *obj);
 ...
 * @ingroup Elm_Clock_Group
 */
ELEMENTARY_API void elm_clock_show_seconds_set(Elm_Clock *obj, Eina_Bool seconds);
 ...
 * @ingroup Elm_Clock_Group
 */
ELEMENTARY_API Eina_Bool elm_clock_show_seconds_get(const Elm_Clock *obj);
 ...
 * @ingroup Elm_Clock_Group
 */
ELEMENTARY_API void elm_clock_edit_set(Elm_Clock *obj, Eina_Bool edit);
 ...
 * @ingroup Elm_Clock_Group
 */
ELEMENTARY_API Eina_Bool elm_clock_edit_get(const Elm_Clock *obj);
 ...
 * @ingroup Elm_Clock_Group
 */
ELEMENTARY_API void elm_clock_pause_set(Elm_Clock *obj, Eina_Bool paused);
 ...
 * @ingroup Elm_Clock_Group
 */
ELEMENTARY_API Eina_Bool elm_clock_pause_get(const Elm_Clock *obj);
 ...
 * @ingroup Elm_Clock_Group
 */
ELEMENTARY_API void elm_clock_time_set(Elm_Clock *obj, int hrs, int min, int sec);
 ...
 * @ingroup Elm_Clock_Group
 */
ELEMENTARY_API void elm_clock_time_get(const Elm_Clock *obj, int *hrs, int *min, int *sec);
 ...
 * @ingroup Elm_Clock_Group
 */
ELEMENTARY_API void elm_clock_edit_mode_set(Elm_Clock *obj, Elm_Clock_Edit_Mode digedit);
 ...
 * @ingroup Elm_Clock_Group
 */
ELEMENTARY_API Elm_Clock_Edit_Mode elm_clock_edit_mode_get(const Elm_Clock *obj);
