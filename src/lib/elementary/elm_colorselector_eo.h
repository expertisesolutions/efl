...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_COLORSELECTOR_EVENT_COLOR_ITEM_SELECTED;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_COLORSELECTOR_EVENT_COLOR_ITEM_LONGPRESSED;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_COLORSELECTOR_EVENT_CHANGED;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_COLORSELECTOR_EVENT_CHANGED_USER;
