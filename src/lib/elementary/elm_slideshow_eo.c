...
ELM_API EFL_VOID_FUNC_BODYV(elm_obj_slideshow_cache_after_set, EFL_FUNC_CALL(count), int count);
...
ELM_API EFL_FUNC_BODY_CONST(elm_obj_slideshow_cache_after_get, int, 0);
...
ELM_API EFL_VOID_FUNC_BODYV(elm_obj_slideshow_cache_before_set, EFL_FUNC_CALL(count), int count);
...
ELM_API EFL_FUNC_BODY_CONST(elm_obj_slideshow_cache_before_get, int, 0);
...
ELM_API EFL_VOID_FUNC_BODYV(elm_obj_slideshow_layout_set, EFL_FUNC_CALL(layout), const char *layout);
...
ELM_API EFL_FUNC_BODY_CONST(elm_obj_slideshow_layout_get, const char *, NULL);
...
ELM_API EFL_VOID_FUNC_BODYV(elm_obj_slideshow_transition_set, EFL_FUNC_CALL(transition), const char *transition);
...
ELM_API EFL_FUNC_BODY_CONST(elm_obj_slideshow_transition_get, const char *, NULL);
...
ELM_API EFL_VOID_FUNC_BODYV(elm_obj_slideshow_items_loop_set, EFL_FUNC_CALL(loop), Eina_Bool loop);
...
ELM_API EFL_FUNC_BODY_CONST(elm_obj_slideshow_items_loop_get, Eina_Bool, 0);
...
ELM_API EFL_VOID_FUNC_BODYV(elm_obj_slideshow_timeout_set, EFL_FUNC_CALL(timeout), double timeout);
...
ELM_API EFL_FUNC_BODY_CONST(elm_obj_slideshow_timeout_get, double, 0);

const Eina_List *_elm_slideshow_items_get(const Eo *obj, Elm_Slideshow_Data *pd);

ELM_API EFL_FUNC_BODY_CONST(elm_obj_slideshow_items_get, const Eina_List *, NULL);

const Eina_List *_elm_slideshow_transitions_get(const Eo *obj, Elm_Slideshow_Data *pd);

ELM_API EFL_FUNC_BODY_CONST(elm_obj_slideshow_transitions_get, const Eina_List *, NULL);

unsigned int _elm_slideshow_count_get(const Eo *obj, Elm_Slideshow_Data *pd);

ELM_API EFL_FUNC_BODY_CONST(elm_obj_slideshow_count_get, unsigned int, 0);

Elm_Widget_Item *_elm_slideshow_item_current_get(const Eo *obj, Elm_Slideshow_Data *pd);

ELM_API EFL_FUNC_BODY_CONST(elm_obj_slideshow_item_current_get, Elm_Widget_Item *, NULL);

const Eina_List *_elm_slideshow_layouts_get(const Eo *obj, Elm_Slideshow_Data *pd);

ELM_API EFL_FUNC_BODY_CONST(elm_obj_slideshow_layouts_get, const Eina_List *, NULL);

void _elm_slideshow_previous(Eo *obj, Elm_Slideshow_Data *pd);

ELM_API EFL_VOID_FUNC_BODY(elm_obj_slideshow_previous);

Elm_Widget_Item *_elm_slideshow_item_nth_get(const Eo *obj, Elm_Slideshow_Data *pd, unsigned int nth);

ELM_API EFL_FUNC_BODYV_CONST(elm_obj_slideshow_item_nth_get, Elm_Widget_Item *, NULL, EFL_FUNC_CALL(nth), unsigned int nth);

void _elm_slideshow_next(Eo *obj, Elm_Slideshow_Data *pd);

ELM_API EFL_VOID_FUNC_BODY(elm_obj_slideshow_next);

void _elm_slideshow_clear(Eo *obj, Elm_Slideshow_Data *pd);

ELM_API EFL_VOID_FUNC_BODY(elm_obj_slideshow_clear);

Elm_Widget_Item *_elm_slideshow_item_add(Eo *obj, Elm_Slideshow_Data *pd, const Elm_Slideshow_Item_Class *itc, const void *data);

ELM_API EFL_FUNC_BODYV(elm_obj_slideshow_item_add, Elm_Widget_Item *, NULL, EFL_FUNC_CALL(itc, data), const Elm_Slideshow_Item_Class *itc, const void *data);
...
ELM_API EFL_FUNC_BODYV(elm_obj_slideshow_item_sorted_insert, Elm_Widget_Item *, NULL, EFL_FUNC_CALL(itc, data, func), const Elm_Slideshow_Item_Class *itc, const void *data, Eina_Compare_Cb func);
