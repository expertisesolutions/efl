...
ELM_API_WEAK const Efl_Class *elm_scroller_class_get(void);
 ...
 * @ingroup Elm_Scroller
 */
ELM_API_WEAK void elm_obj_scroller_custom_widget_base_theme_set(Eo *obj, const char *klass, const char *group);
 ...
 * @ingroup Elm_Scroller
 */
ELM_API_WEAK void elm_obj_scroller_page_scroll_limit_set(const Eo *obj, int page_limit_h, int page_limit_v);
 ...
 * @ingroup Elm_Scroller
 */
ELM_API_WEAK void elm_obj_scroller_page_scroll_limit_get(const Eo *obj, int *page_limit_h, int *page_limit_v);

ELM_API_WEAK extern const Efl_Event_Description _ELM_SCROLLER_EVENT_SCROLL_PAGE_CHANGED;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_SCROLLER_EVENT_HBAR_UNPRESS;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_SCROLLER_EVENT_HBAR_PRESS;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_SCROLLER_EVENT_HBAR_DRAG;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_SCROLLER_EVENT_VBAR_UNPRESS;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_SCROLLER_EVENT_VBAR_PRESS;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_SCROLLER_EVENT_VBAR_DRAG;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_SCROLLER_EVENT_SCROLL_LEFT;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_SCROLLER_EVENT_SCROLL_RIGHT;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_SCROLLER_EVENT_SCROLL_UP;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_SCROLLER_EVENT_SCROLL_DOWN;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_SCROLLER_EVENT_EDGE_LEFT;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_SCROLLER_EVENT_EDGE_RIGHT;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_SCROLLER_EVENT_EDGE_TOP;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_SCROLLER_EVENT_EDGE_BOTTOM;
