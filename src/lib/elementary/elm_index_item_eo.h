 ...
 * @ingroup Elm_Index_Item
 */
ELM_API_WEAK void elm_obj_index_item_selected_set(Eo *obj, Eina_Bool selected);
 ...
 * @ingroup Elm_Index_Item
 */
ELM_API_WEAK void elm_obj_index_item_priority_set(Eo *obj, int priority);
 ...
 * @ingroup Elm_Index_Item
 */
ELM_API_WEAK const char *elm_obj_index_item_letter_get(const Eo *obj);
