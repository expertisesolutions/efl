...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_CTXPOPUP_EVENT_DISMISSED;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_CTXPOPUP_EVENT_GEOMETRY_UPDATE;
