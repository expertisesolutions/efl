...
ELM_API ELM_API_WEAK const Efl_Class *elm_menu_item_class_get(void);
 ...
 * @ingroup Elm_Menu_Item
 */
ELM_API void elm_obj_menu_item_icon_name_set(Eo *obj, const char *icon);
 ...
 * @ingroup Elm_Menu_Item
 */
ELM_API const char *elm_obj_menu_item_icon_name_get(const Eo *obj);
 ...
 * @ingroup Elm_Menu_Item
 */
ELM_API Elm_Widget_Item *elm_obj_menu_item_prev_get(const Eo *obj);
 ...
 * @ingroup Elm_Menu_Item
 */
ELM_API Elm_Widget_Item *elm_obj_menu_item_next_get(const Eo *obj);
 ...
 * @ingroup Elm_Menu_Item
 */
ELM_API void elm_obj_menu_item_selected_set(Eo *obj, Eina_Bool selected);
 ...
 * @ingroup Elm_Menu_Item
 */
ELM_API Eina_Bool elm_obj_menu_item_selected_get(const Eo *obj);
 ...
 * @ingroup Elm_Menu_Item
 */
ELM_API unsigned int elm_obj_menu_item_index_get(const Eo *obj);
 ...
 * @ingroup Elm_Menu_Item
 */
ELM_API void elm_obj_menu_item_subitems_clear(Eo *obj);
 ...
 * @ingroup Elm_Menu_Item
 */
ELM_API const Eina_List *elm_obj_menu_item_subitems_get(const Eo *obj);
 ...
 * @ingroup Elm_Menu_Item
 */
ELM_API Eina_Bool elm_obj_menu_item_is_separator(const Eo *obj);
 ...
 * @ingroup Elm_Menu_Item
 */
ELM_API Efl_Canvas_Object *elm_obj_menu_item_object_get(const Eo *obj);
