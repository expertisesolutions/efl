 ...
 * @ingroup Elm_Gengrid_Item
 */
ELM_API Elm_Widget_Item *elm_obj_gengrid_item_prev_get(const Eo *obj);
 ...
 * @ingroup Elm_Gengrid_Item
 */
ELM_API Elm_Widget_Item *elm_obj_gengrid_item_next_get(const Eo *obj);
 ...
 * @ingroup Elm_Gengrid_Item
 */
ELM_API void elm_obj_gengrid_item_selected_set(Eo *obj, Eina_Bool selected);
 ...
 * @ingroup Elm_Gengrid_Item
 */
ELM_API Eina_Bool elm_obj_gengrid_item_selected_get(const Eo *obj);
 ...
 * @ingroup Elm_Gengrid_Item
 */
ELM_API const Elm_Gengrid_Item_Class *elm_obj_gengrid_item_class_get(const Eo *obj);
 ...
 * @ingroup Elm_Gengrid_Item
 */
ELM_API int elm_obj_gengrid_item_index_get(const Eo *obj);
 ...
 * @ingroup Elm_Gengrid_Item
 */
ELM_API void elm_obj_gengrid_item_pos_get(const Eo *obj, unsigned int *x, unsigned int *y);
 ...
 * @ingroup Elm_Gengrid_Item
 */
ELM_API void elm_obj_gengrid_item_select_mode_set(Eo *obj, Elm_Object_Select_Mode mode);
 ...
 * @ingroup Elm_Gengrid_Item
 */
ELM_API Elm_Object_Select_Mode elm_obj_gengrid_item_select_mode_get(const Eo *obj);
 ...
 * @ingroup Elm_Gengrid_Item
 */
ELM_API void elm_obj_gengrid_item_custom_size_set(Eo *obj, int w, int h);
 ...
 * @ingroup Elm_Gengrid_Item
 */
ELM_API void elm_obj_gengrid_item_custom_size_get(const Eo *obj, int *w, int *h);
 ...
 * @ingroup Elm_Gengrid_Item
 */
ELM_API void elm_obj_gengrid_item_show(Eo *obj, Elm_Gengrid_Item_Scrollto_Type type);
 ...
 * @ingroup Elm_Gengrid_Item
 */
ELM_API void elm_obj_gengrid_item_bring_in(Eo *obj, Elm_Gengrid_Item_Scrollto_Type type);
 ...
 * @ingroup Elm_Gengrid_Item
 */
ELM_API void elm_obj_gengrid_item_update(Eo *obj);
 ...
 * @ingroup Elm_Gengrid_Item
 */
ELM_API void elm_obj_gengrid_item_fields_update(Eo *obj, const char *parts, Elm_Gengrid_Item_Field_Type itf);
 ...
 * @ingroup Elm_Gengrid_Item
 */
ELM_API void elm_obj_gengrid_item_class_update(Eo *obj, const Elm_Gengrid_Item_Class *itc);
 ...
 * @ingroup Elm_Gengrid_Item
 */
ELM_API void elm_obj_gengrid_item_all_contents_unset(Eo *obj, Eina_List **l);
