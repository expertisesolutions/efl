...
ELM_API_WEAK const Efl_Class *elm_gengrid_class_get(void);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK void elm_obj_gengrid_align_set(Eo *obj, double align_x, double align_y);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK void elm_obj_gengrid_align_get(const Eo *obj, double *align_x, double *align_y);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK void elm_obj_gengrid_filled_set(Eo *obj, Eina_Bool fill);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK Eina_Bool elm_obj_gengrid_filled_get(const Eo *obj);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK void elm_obj_gengrid_multi_select_set(Eo *obj, Eina_Bool multi);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK Eina_Bool elm_obj_gengrid_multi_select_get(const Eo *obj);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK void elm_obj_gengrid_group_item_size_set(Eo *obj, int w, int h);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK void elm_obj_gengrid_group_item_size_get(const Eo *obj, int *w, int *h);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK void elm_obj_gengrid_select_mode_set(Eo *obj, Elm_Object_Select_Mode mode);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK Elm_Object_Select_Mode elm_obj_gengrid_select_mode_get(const Eo *obj);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK void elm_obj_gengrid_reorder_mode_set(Eo *obj, Eina_Bool reorder_mode);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK Eina_Bool elm_obj_gengrid_reorder_mode_get(const Eo *obj);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK void elm_obj_gengrid_highlight_mode_set(Eo *obj, Eina_Bool highlight);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK Eina_Bool elm_obj_gengrid_highlight_mode_get(const Eo *obj);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK void elm_obj_gengrid_reorder_type_set(Eo *obj, Elm_Gengrid_Reorder_Type type);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK void elm_obj_gengrid_item_size_set(Eo *obj, int w, int h);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK void elm_obj_gengrid_item_size_get(const Eo *obj, int *w, int *h);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK void elm_obj_gengrid_multi_select_mode_set(Eo *obj, Elm_Object_Multi_Select_Mode mode);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK Elm_Object_Multi_Select_Mode elm_obj_gengrid_multi_select_mode_get(const Eo *obj);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK void elm_obj_gengrid_horizontal_set(Eo *obj, Eina_Bool horizontal);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK Eina_Bool elm_obj_gengrid_horizontal_get(const Eo *obj);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK Elm_Widget_Item *elm_obj_gengrid_selected_item_get(const Eo *obj);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK Eina_List *elm_obj_gengrid_realized_items_get(const Eo *obj) EINA_WARN_UNUSED_RESULT;
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK Elm_Widget_Item *elm_obj_gengrid_first_item_get(const Eo *obj);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK const Eina_List *elm_obj_gengrid_selected_items_get(const Eo *obj);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK Elm_Widget_Item *elm_obj_gengrid_last_item_get(const Eo *obj);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK Elm_Widget_Item *elm_obj_gengrid_item_insert_before(Eo *obj, const Elm_Gengrid_Item_Class *itc, const void *data, Elm_Widget_Item *relative, Evas_Smart_Cb func, const void *func_data);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK void elm_obj_gengrid_realized_items_update(Eo *obj);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK Elm_Widget_Item *elm_obj_gengrid_item_insert_after(Eo *obj, const Elm_Gengrid_Item_Class *itc, const void *data, Elm_Widget_Item *relative, Evas_Smart_Cb func, const void *func_data);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK unsigned int elm_obj_gengrid_items_count(const Eo *obj);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK Elm_Widget_Item *elm_obj_gengrid_at_xy_item_get(const Eo *obj, int x, int y, int *xposret, int *yposret);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK Elm_Widget_Item *elm_obj_gengrid_item_append(Eo *obj, const Elm_Gengrid_Item_Class *itc, const void *data, Evas_Smart_Cb func, const void *func_data);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK Elm_Widget_Item *elm_obj_gengrid_item_prepend(Eo *obj, const Elm_Gengrid_Item_Class *itc, const void *data, Evas_Smart_Cb func, const void *func_data);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK void elm_obj_gengrid_clear(Eo *obj);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK Elm_Widget_Item *elm_obj_gengrid_item_sorted_insert(Eo *obj, const Elm_Gengrid_Item_Class *itc, const void *data, Eina_Compare_Cb comp, Evas_Smart_Cb func, const void *func_data);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK Elm_Widget_Item *elm_obj_gengrid_search_by_text_item_get(Eo *obj, Elm_Widget_Item *item_to_search_from, const char *part_name, const char *pattern, Elm_Glob_Match_Flags flags);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK void elm_obj_gengrid_reorder_mode_start(Eo *obj, Ecore_Pos_Map tween_mode);
 ...
 * @ingroup Elm_Gengrid
 */
ELM_API_WEAK void elm_obj_gengrid_reorder_mode_stop(Eo *obj);

ELM_API_WEAK extern const Efl_Event_Description _ELM_GENGRID_EVENT_REALIZED;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_GENGRID_EVENT_UNREALIZED;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_GENGRID_EVENT_INDEX_UPDATE;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_GENGRID_EVENT_SCROLL_PAGE_CHANGED;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_GENGRID_EVENT_EDGE_BOTTOM;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_GENGRID_EVENT_EDGE_TOP;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_GENGRID_EVENT_EDGE_RIGHT;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_GENGRID_EVENT_EDGE_LEFT;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_GENGRID_EVENT_ITEM_FOCUSED;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_GENGRID_EVENT_ITEM_UNFOCUSED;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_GENGRID_EVENT_ITEM_REORDER_ANIM_START;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_GENGRID_EVENT_ITEM_REORDER_ANIM_STOP;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_GENGRID_EVENT_ACTIVATED;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_GENGRID_EVENT_HIGHLIGHTED;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_GENGRID_EVENT_UNHIGHLIGHTED;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_GENGRID_EVENT_RELEASED;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_GENGRID_EVENT_MOVED;
