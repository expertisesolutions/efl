...
ELM_API ELM_API_WEAK const Efl_Class *elm_calendar_class_get(void);
 ...
 * @ingroup Elm_Calendar
 */
ELM_API void elm_obj_calendar_first_day_of_week_set(Eo *obj, Elm_Calendar_Weekday day);
 ...
 * @ingroup Elm_Calendar
 */
ELM_API Elm_Calendar_Weekday elm_obj_calendar_first_day_of_week_get(const Eo *obj);
 ...
 * @ingroup Elm_Calendar
 */
ELM_API void elm_obj_calendar_selectable_set(Eo *obj, Elm_Calendar_Selectable selectable);
 ...
 * @ingroup Elm_Calendar
 */
ELM_API Elm_Calendar_Selectable elm_obj_calendar_selectable_get(const Eo *obj);
 ...
 * @ingroup Elm_Calendar
 */
ELM_API void elm_obj_calendar_interval_set(Eo *obj, double interval);
 ...
 * @ingroup Elm_Calendar
 */
ELM_API double elm_obj_calendar_interval_get(const Eo *obj);
 ...
 * @ingroup Elm_Calendar
 */
ELM_API void elm_obj_calendar_weekdays_names_set(Eo *obj, const char **weekdays);
 ...
 * @ingroup Elm_Calendar
 */
ELM_API const char **elm_obj_calendar_weekdays_names_get(const Eo *obj);
 ...
 * @ingroup Elm_Calendar
 */
ELM_API void elm_obj_calendar_select_mode_set(Eo *obj, Elm_Calendar_Select_Mode mode);
 ...
 * @ingroup Elm_Calendar
 */
ELM_API Elm_Calendar_Select_Mode elm_obj_calendar_select_mode_get(const Eo *obj);
 ...
 * @ingroup Elm_Calendar
 */
ELM_API void elm_obj_calendar_format_function_set(Eo *obj, Elm_Calendar_Format_Cb format_function);
 ...
 * @ingroup Elm_Calendar
 */
ELM_API const Eina_List *elm_obj_calendar_marks_get(const Eo *obj);
 ...
 * @ingroup Elm_Calendar
 */
ELM_API void elm_obj_calendar_date_min_set(Eo *obj, const Efl_Time *min);
 ...
 * @ingroup Elm_Calendar
 */
ELM_API const Efl_Time *elm_obj_calendar_date_min_get(const Eo *obj);
 ...
 * @ingroup Elm_Calendar
 */
ELM_API void elm_obj_calendar_date_max_set(Eo *obj, const Efl_Time *max);
 ...
 * @ingroup Elm_Calendar
 */
ELM_API const Efl_Time *elm_obj_calendar_date_max_get(const Eo *obj);
 ...
 * @ingroup Elm_Calendar
 */
ELM_API void elm_obj_calendar_selected_time_set(Eo *obj, Efl_Time *selected_time);
 ...
 * @ingroup Elm_Calendar
 */
ELM_API Eina_Bool elm_obj_calendar_selected_time_get(const Eo *obj, Efl_Time *selected_time);
 ...
 * @ingroup Elm_Calendar
 */
ELM_API Elm_Calendar_Mark *elm_obj_calendar_mark_add(Eo *obj, const char *mark_type, Efl_Time *mark_time, Elm_Calendar_Mark_Repeat_Type repeat);
 ...
 * @ingroup Elm_Calendar
 */
ELM_API void elm_obj_calendar_mark_del(Eo *obj, Elm_Calendar_Mark *mark);
 ...
 * @ingroup Elm_Calendar
 */
ELM_API void elm_obj_calendar_marks_clear(Eo *obj);
 ...
 * @ingroup Elm_Calendar
 */
ELM_API void elm_obj_calendar_marks_draw(Eo *obj);
