 ...
 * @ingroup Elm_Hover
 */
ELM_API_WEAK void elm_obj_hover_target_set(Eo *obj, Efl_Canvas_Object *target);
 ...
 * @ingroup Elm_Hover
 */
ELM_API_WEAK Efl_Canvas_Object *elm_obj_hover_target_get(const Eo *obj);
 ...
 * @ingroup Elm_Hover
 */
ELM_API_WEAK const char *elm_obj_hover_best_content_location_get(const Eo *obj, Elm_Hover_Axis pref_axis);

/** Dismiss a hover object
 *
 * @ingroup Elm_Hover
 */
ELM_API_WEAK void elm_obj_hover_dismiss(Eo *obj);
