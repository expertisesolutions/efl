 ...
 * @ingroup Elm_Index
 */
ELEMENTARY_API Evas_Object          *elm_index_add(Evas_Object *parent);
 ...
 * @ingroup Elm_Index
 */
ELEMENTARY_API void elm_index_horizontal_set(Evas_Object *obj, Eina_Bool horizontal);
 ...
 * @ingroup Elm_Index
 */
ELEMENTARY_API Eina_Bool elm_index_horizontal_get(const Evas_Object *obj);
