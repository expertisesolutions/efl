 ...
 * @see elm_map_overlay_bubble_add()
 */
ELEMENTARY_API void                  elm_map_overlay_del(Elm_Map_Overlay *overlay);
 ...
 * @see elm_map_overlay_bubble_add()
 */
ELEMENTARY_API Elm_Map_Overlay_Type  elm_map_overlay_type_get(const Elm_Map_Overlay *overlay);
 ...
 */
ELEMENTARY_API void                  elm_map_overlay_data_set(Elm_Map_Overlay *overlay, void *data);
 ...
 */
ELEMENTARY_API void *                elm_map_overlay_data_get(const Elm_Map_Overlay *overlay);
 ...
 */
ELEMENTARY_API void                  elm_map_overlay_hide_set(Elm_Map_Overlay *overlay, Eina_Bool hide);
 ...
 */
ELEMENTARY_API Eina_Bool             elm_map_overlay_hide_get(const Elm_Map_Overlay *overlay);
 ...
 */
ELEMENTARY_API void                  elm_map_overlay_displayed_zoom_min_set(Elm_Map_Overlay *overlay, int zoom);
 ...
 */
ELEMENTARY_API int                   elm_map_overlay_displayed_zoom_min_get(const Elm_Map_Overlay *overlay);
 ...
 */
ELEMENTARY_API void                  elm_map_overlay_paused_set(Elm_Map_Overlay *overlay, Eina_Bool paused);
 ...
 */
ELEMENTARY_API Eina_Bool             elm_map_overlay_paused_get(const Elm_Map_Overlay *overlay);
 ...
 * @since 1.7
 */
ELEMENTARY_API Eina_Bool             elm_map_overlay_visible_get(const Elm_Map_Overlay *overlay);
 ...
 */
ELEMENTARY_API void                  elm_map_overlay_content_set(Elm_Map_Overlay *overlay, Evas_Object *obj);
 ...
 */
ELEMENTARY_API const Evas_Object *   elm_map_overlay_content_get(const Elm_Map_Overlay *overlay);
 ...
 */
ELEMENTARY_API void                  elm_map_overlay_icon_set(Elm_Map_Overlay *overlay, Evas_Object *icon);
 ...
 */
ELEMENTARY_API const Evas_Object *   elm_map_overlay_icon_get(const Elm_Map_Overlay *overlay);
 ...
 */
ELEMENTARY_API void                  elm_map_overlay_region_set(Elm_Map_Overlay *overlay, double lon, double lat);
 ...
 */
ELEMENTARY_API void                  elm_map_overlay_region_get(const Elm_Map_Overlay *overlay, double *lon, double *lat);
 ...
 */
ELEMENTARY_API void                  elm_map_overlay_color_set(Elm_Map_Overlay *overlay, int r, int g, int b, int a);
 ...
 */
ELEMENTARY_API void                  elm_map_overlay_color_get(const Elm_Map_Overlay *overlay, int *r, int *g, int *b, int *a);
 ...
 */
ELEMENTARY_API void                  elm_map_overlay_show(Elm_Map_Overlay *overlay);
 ...
 */
ELEMENTARY_API void                  elm_map_overlays_show(Eina_List *overlays);
 ...
 */
ELEMENTARY_API void                  elm_map_overlay_get_cb_set(Elm_Map_Overlay *overlay, Elm_Map_Overlay_Get_Cb get_cb, void *data);
 ...
 * @since 1.7
 */
ELEMENTARY_API void                  elm_map_overlay_del_cb_set(Elm_Map_Overlay *overlay, Elm_Map_Overlay_Del_Cb del_cb, void *data);
 ...
 */
ELEMENTARY_API void                  elm_map_overlay_class_append(Elm_Map_Overlay *clas, Elm_Map_Overlay *overlay);
 ...
 */
ELEMENTARY_API void                  elm_map_overlay_class_remove(Elm_Map_Overlay *clas, Elm_Map_Overlay *overlay);
 ...
 */
ELEMENTARY_API void                  elm_map_overlay_class_zoom_max_set(Elm_Map_Overlay *clas, int zoom);
 ...
 */
ELEMENTARY_API int                   elm_map_overlay_class_zoom_max_get(const Elm_Map_Overlay *clas);
 ...
 * @see elm_map_overlay_class_add()
 */
ELEMENTARY_API Eina_List *           elm_map_overlay_group_members_get(const Elm_Map_Overlay *grp);
 ...
 * @see elm_map_overlay_bubble_add()
 */
ELEMENTARY_API void                  elm_map_overlay_bubble_follow(Elm_Map_Overlay *bubble, const Elm_Map_Overlay *parent);
 ...
 */
ELEMENTARY_API void                  elm_map_overlay_bubble_content_append(Elm_Map_Overlay *bubble, Evas_Object *content);
 ...
 */
ELEMENTARY_API void                  elm_map_overlay_bubble_content_clear(Elm_Map_Overlay *bubble);
 ...
 */
ELEMENTARY_API void                  elm_map_overlay_polygon_region_add(Elm_Map_Overlay *overlay, double lon, double lat);
 ...
 */
ELEMENTARY_API void                  elm_map_route_del(Elm_Map_Route *route);
 ...
 */
ELEMENTARY_API double                elm_map_route_distance_get(const Elm_Map_Route *route);
 ...
 */
ELEMENTARY_API const char           *elm_map_route_node_get(const Elm_Map_Route *route);
 ...
 */
ELEMENTARY_API const char           *elm_map_route_waypoint_get(const Elm_Map_Route *route);
 ...
 */
ELEMENTARY_API const char           *elm_map_name_address_get(const Elm_Map_Name *name);
 ...
 * @see elm_map_name_add()
 */
ELEMENTARY_API void                  elm_map_name_region_get(const Elm_Map_Name *name, double *lon, double *lat);
 ...
 * @see elm_map_name_add()
 */
ELEMENTARY_API void                  elm_map_name_del(Elm_Map_Name *name);
