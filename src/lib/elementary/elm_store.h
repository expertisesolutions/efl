 ...
 * @ingroup Store
 */
ELEMENTARY_API Elm_Store              *elm_store_filesystem_new(void);
/**
 ...
 * @ingroup Store
 */
ELEMENTARY_API void                    elm_store_free(Elm_Store *st);
 ...
 * @ingroup Store
 */
ELEMENTARY_API void                    elm_store_filesystem_directory_set(Elm_Store *st, const char *dir);
 ...
 * @ingroup Store
 */
ELEMENTARY_API const char             *elm_store_filesystem_directory_get(const Elm_Store *st);
 ...
 * @ingroup Store
 */
ELEMENTARY_API const char             *elm_store_item_filesystem_path_get(const Elm_Store_Item *sti);
 ...
 * @ingroup Store
 */
ELEMENTARY_API void                    elm_store_target_genlist_set(Elm_Store *st, Evas_Object *obj);
 ...
 * @ingroup Store
 */
ELEMENTARY_API void                    elm_store_cache_set(Elm_Store *st, int max);
 ...
 * @ingroup Store
 */
ELEMENTARY_API int                     elm_store_cache_get(const Elm_Store *st);
 ...
 * @ingroup Store
 */
ELEMENTARY_API void                    elm_store_list_func_set(Elm_Store *st, Elm_Store_Item_List_Cb func, const void *data);
 ...
 * @ingroup Store
 */
ELEMENTARY_API void                    elm_store_fetch_func_set(Elm_Store *st, Elm_Store_Item_Fetch_Cb func, const void *data);
 ...
 * @ingroup Store
 */
ELEMENTARY_API void                    elm_store_unfetch_func_set(Elm_Store *st, Elm_Store_Item_Unfetch_Cb func, const void *data);
 ...
 * @ingroup Store
 */
ELEMENTARY_API void                    elm_store_fetch_thread_set(Elm_Store *st, Eina_Bool use_thread);
 ...
 * @ingroup Store
 */
ELEMENTARY_API Eina_Bool               elm_store_fetch_thread_get(const Elm_Store *st);
 ...
 * @ingroup Store
 */
ELEMENTARY_API void                    elm_store_sorted_set(Elm_Store *st, Eina_Bool sorted);
 ...
 * @ingroup Store
 */
ELEMENTARY_API Eina_Bool               elm_store_sorted_get(const Elm_Store *st);
 ...
 * @ingroup Store
 */
ELEMENTARY_API void                    elm_store_item_data_set(Elm_Store_Item *sti, void *data);
 ...
 * @ingroup Store
 */
ELEMENTARY_API void                   *elm_store_item_data_get(Elm_Store_Item *sti);
 ...
 * @ingroup Store
 */
ELEMENTARY_API const Elm_Store        *elm_store_item_store_get(const Elm_Store_Item *sti);
 ...
 * @ingroup Store
 */
ELEMENTARY_API const Elm_Object_Item *elm_store_item_genlist_item_get(const Elm_Store_Item *sti);
