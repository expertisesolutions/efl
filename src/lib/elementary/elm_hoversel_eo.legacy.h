 ...
 */
ELEMENTARY_API void elm_hoversel_horizontal_set(Elm_Hoversel *obj, Eina_Bool horizontal);
 ...
 * @ingroup Elm_Hoversel_Group
 */
ELEMENTARY_API Eina_Bool elm_hoversel_horizontal_get(const Elm_Hoversel *obj);
 ...
 * @ingroup Elm_Hoversel_Group
 */
ELEMENTARY_API void elm_hoversel_hover_parent_set(Elm_Hoversel *obj, Efl_Canvas_Object *parent);
 ...
 * @ingroup Elm_Hoversel_Group
 */
ELEMENTARY_API Efl_Canvas_Object *elm_hoversel_hover_parent_get(const Elm_Hoversel *obj);
 ...
 * @ingroup Elm_Hoversel_Group
 */
ELEMENTARY_API Eina_Bool elm_hoversel_expanded_get(const Elm_Hoversel *obj);
 ...
 * @ingroup Elm_Hoversel_Group
 */
ELEMENTARY_API const Eina_List *elm_hoversel_items_get(const Elm_Hoversel *obj);
 ...
 * @ingroup Elm_Hoversel_Group
 */
ELEMENTARY_API void elm_hoversel_auto_update_set(Elm_Hoversel *obj, Eina_Bool auto_update);
 ...
 * @ingroup Elm_Hoversel_Group
 */
ELEMENTARY_API Eina_Bool elm_hoversel_auto_update_get(const Elm_Hoversel *obj);
 ...
 * @ingroup Elm_Hoversel_Group
 */
ELEMENTARY_API void elm_hoversel_hover_begin(Elm_Hoversel *obj);
 ...
 * @ingroup Elm_Hoversel_Group
 */
ELEMENTARY_API void elm_hoversel_clear(Elm_Hoversel *obj);
 ...
 * @ingroup Elm_Hoversel_Group
 */
ELEMENTARY_API void elm_hoversel_hover_end(Elm_Hoversel *obj);
 ...
 * @ingroup Elm_Hoversel_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_hoversel_item_add(Elm_Hoversel *obj, const char *label, const char *icon_file, Elm_Icon_Type icon_type, Evas_Smart_Cb func, const void *data);
