 ...
 * @since 1.23
 */
ELEMENTARY_API Elm_Animation_View     *elm_animation_view_add(Evas_Object *parent);
 ...
 * @since 1.23
*/
ELEMENTARY_API Eina_Bool        elm_animation_view_file_set(Elm_Animation_View *obj, const char *file, const char *key);
 ...
 * @since 1.23
 */
ELEMENTARY_API Elm_Animation_View_State elm_animation_view_state_get(Elm_Animation_View *obj);
