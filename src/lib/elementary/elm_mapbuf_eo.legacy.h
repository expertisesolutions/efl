 ...
 */
ELEMENTARY_API void elm_mapbuf_auto_set(Elm_Mapbuf *obj, Eina_Bool on);
 ...
 * @ingroup Elm_Mapbuf_Group
 */
ELEMENTARY_API Eina_Bool elm_mapbuf_auto_get(const Elm_Mapbuf *obj);
 ...
 * @ingroup Elm_Mapbuf_Group
 */
ELEMENTARY_API void elm_mapbuf_smooth_set(Elm_Mapbuf *obj, Eina_Bool smooth);
 ...
 * @ingroup Elm_Mapbuf_Group
 */
ELEMENTARY_API Eina_Bool elm_mapbuf_smooth_get(const Elm_Mapbuf *obj);
 ...
 * @ingroup Elm_Mapbuf_Group
 */
ELEMENTARY_API void elm_mapbuf_alpha_set(Elm_Mapbuf *obj, Eina_Bool alpha);
 ...
 * @ingroup Elm_Mapbuf_Group
 */
ELEMENTARY_API Eina_Bool elm_mapbuf_alpha_get(const Elm_Mapbuf *obj);
 ...
 * @ingroup Elm_Mapbuf_Group
 */
ELEMENTARY_API void elm_mapbuf_enabled_set(Elm_Mapbuf *obj, Eina_Bool enabled);
 ...
 * @ingroup Elm_Mapbuf_Group
 */
ELEMENTARY_API Eina_Bool elm_mapbuf_enabled_get(const Elm_Mapbuf *obj);
 ...
 * @ingroup Elm_Mapbuf_Group
 */
ELEMENTARY_API void elm_mapbuf_point_color_set(Elm_Mapbuf *obj, int idx, int r, int g, int b, int a);
 ...
 * @ingroup Elm_Mapbuf_Group
 */
ELEMENTARY_API void elm_mapbuf_point_color_get(const Elm_Mapbuf *obj, int idx, int *r, int *g, int *b, int *a);
