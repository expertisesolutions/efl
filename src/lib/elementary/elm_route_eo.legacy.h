 ...
 */
ELEMENTARY_API void elm_route_emap_set(Elm_Route *obj, void *emap);
 ...
 * @ingroup Elm_Route_Group
 */
ELEMENTARY_API void elm_route_longitude_min_max_get(const Elm_Route *obj, double *min, double *max);
 ...
 * @ingroup Elm_Route_Group
 */
ELEMENTARY_API void elm_route_latitude_min_max_get(const Elm_Route *obj, double *min, double *max);
