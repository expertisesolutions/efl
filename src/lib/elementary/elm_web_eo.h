 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK Eina_Bool elm_obj_web_text_matches_highlight_set(Eo *obj, Eina_Bool highlight);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK Eina_Bool elm_obj_web_text_matches_highlight_get(const Eo *obj);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK void elm_obj_web_useragent_set(Eo *obj, const char *user_agent);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK const char *elm_obj_web_useragent_get(const Eo *obj);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK Eina_Bool elm_obj_web_url_set(Eo *obj, const char *url);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK const char *elm_obj_web_url_get(const Eo *obj);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK void elm_obj_web_bg_color_set(Eo *obj, int r, int g, int b, int a);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK void elm_obj_web_bg_color_get(const Eo *obj, int *r, int *g, int *b, int *a);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK void elm_obj_web_inwin_mode_set(Eo *obj, Eina_Bool value);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK Eina_Bool elm_obj_web_inwin_mode_get(const Eo *obj);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK void elm_obj_web_tab_propagate_set(Eo *obj, Eina_Bool propagate);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK Eina_Bool elm_obj_web_tab_propagate_get(const Eo *obj);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK void elm_obj_web_history_enabled_set(Eo *obj, Eina_Bool enable);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK Eina_Bool elm_obj_web_history_enabled_get(const Eo *obj);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK void elm_obj_web_console_message_hook_set(Eo *obj, Elm_Web_Console_Message func, void *data);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK void elm_obj_web_window_create_hook_set(Eo *obj, Elm_Web_Window_Open func, void *data);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK void elm_obj_web_dialog_file_selector_hook_set(Eo *obj, Elm_Web_Dialog_File_Selector func, void *data);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK void elm_obj_web_dialog_confirm_hook_set(Eo *obj, Elm_Web_Dialog_Confirm func, void *data);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK void elm_obj_web_popup_selected_set(Eo *obj, int idx);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK void elm_obj_web_dialog_prompt_hook_set(Eo *obj, Elm_Web_Dialog_Prompt func, void *data);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK void elm_obj_web_dialog_alert_hook_set(Eo *obj, Elm_Web_Dialog_Alert func, void *data);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK Eina_Bool elm_obj_web_forward_possible_get(const Eo *obj);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK Efl_Canvas_Object *elm_obj_web_webkit_view_get(const Eo *obj);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK Eina_Bool elm_obj_web_back_possible_get(const Eo *obj);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK double elm_obj_web_load_progress_get(const Eo *obj);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK char *elm_obj_web_selection_get(const Eo *obj) EINA_WARN_UNUSED_RESULT;
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK Eina_Stringshare *elm_obj_web_title_get(const Eo *obj) EINA_WARN_UNUSED_RESULT;
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK Eina_Bool elm_obj_web_navigate(Eo *obj, int steps);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK Eina_Bool elm_obj_web_back(Eo *obj);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK Eina_Bool elm_obj_web_html_string_load(Eo *obj, const char *html, const char *base_url, const char *unreachable_url);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK Eina_Bool elm_obj_web_text_search(const Eo *obj, const char *string, Eina_Bool case_sensitive, Eina_Bool forward, Eina_Bool wrap);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK Eina_Bool elm_obj_web_popup_destroy(Eo *obj);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK void elm_obj_web_region_show(Eo *obj, int x, int y, int w, int h);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK Eina_Bool elm_obj_web_forward(Eo *obj);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK unsigned int elm_obj_web_text_matches_mark(Eo *obj, const char *string, Eina_Bool case_sensitive, Eina_Bool highlight, unsigned int limit);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK void elm_obj_web_region_bring_in(Eo *obj, int x, int y, int w, int h);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK Eina_Bool elm_obj_web_stop(Eo *obj);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK Eina_Bool elm_obj_web_navigate_possible_get(Eo *obj, int steps);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK Eina_Bool elm_obj_web_reload_full(Eo *obj);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK Eina_Bool elm_obj_web_text_matches_unmark_all(Eo *obj);
 ...
 * @ingroup Elm_Web
 */
ELM_API_WEAK Eina_Bool elm_obj_web_reload(Eo *obj);
