 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API Elm_Transit           *elm_transit_add(void);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API void                   elm_transit_del(Elm_Transit *transit);
 ...
 */
ELEMENTARY_API void                   elm_transit_effect_add(Elm_Transit *transit, Elm_Transit_Effect_Transition_Cb transition_cb, Elm_Transit_Effect *effect, Elm_Transit_Effect_End_Cb end_cb);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API void                   elm_transit_effect_del(Elm_Transit *transit, Elm_Transit_Effect_Transition_Cb transition_cb, Elm_Transit_Effect *effect);
 ...
 */
ELEMENTARY_API void                   elm_transit_object_add(Elm_Transit *transit, Evas_Object *obj);
 ...
 */
ELEMENTARY_API void                   elm_transit_object_remove(Elm_Transit *transit, Evas_Object *obj);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API const Eina_List       *elm_transit_objects_get(const Elm_Transit *transit);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API void                   elm_transit_objects_final_state_keep_set(Elm_Transit *transit, Eina_Bool state_keep);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API Eina_Bool              elm_transit_objects_final_state_keep_get(const Elm_Transit *transit);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API void                   elm_transit_event_enabled_set(Elm_Transit *transit, Eina_Bool enabled);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API Eina_Bool              elm_transit_event_enabled_get(const Elm_Transit *transit);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API void                   elm_transit_del_cb_set(Elm_Transit *transit, Elm_Transit_Del_Cb cb, void *data);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API void                   elm_transit_auto_reverse_set(Elm_Transit *transit, Eina_Bool reverse);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API Eina_Bool              elm_transit_auto_reverse_get(const Elm_Transit *transit);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API void                   elm_transit_repeat_times_set(Elm_Transit *transit, int repeat);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API int                    elm_transit_repeat_times_get(const Elm_Transit *transit);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API int                    elm_transit_current_repeat_times_get(const Elm_Transit *transit);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API void                   elm_transit_tween_mode_set(Elm_Transit *transit, Elm_Transit_Tween_Mode tween_mode);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API Elm_Transit_Tween_Mode elm_transit_tween_mode_get(const Elm_Transit *transit);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API void                   elm_transit_tween_mode_factor_set(Elm_Transit *transit, double v1, double v2);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API void                   elm_transit_tween_mode_factor_get(const Elm_Transit *transit, double *v1, double *v2);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API void                   elm_transit_tween_mode_factor_n_set(Elm_Transit *transit, unsigned int v_size, double *v);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API void                   elm_transit_duration_set(Elm_Transit *transit, double duration);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API double                 elm_transit_duration_get(const Elm_Transit *transit);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API void                   elm_transit_go(Elm_Transit *transit);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API Eina_Bool               elm_transit_revert(Elm_Transit *transit);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API void                   elm_transit_go_in(Elm_Transit *transit, double in);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API void                   elm_transit_paused_set(Elm_Transit *transit, Eina_Bool paused);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API Eina_Bool              elm_transit_paused_get(const Elm_Transit *transit);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API double                 elm_transit_progress_value_get(const Elm_Transit *transit);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API void                   elm_transit_progress_value_set(Elm_Transit *transit, double progress);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API void                   elm_transit_chain_transit_add(Elm_Transit *transit, Elm_Transit *chain_transit);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API void                   elm_transit_chain_transit_del(Elm_Transit *transit, Elm_Transit *chain_transit);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API Eina_List             *elm_transit_chain_transits_get(const Elm_Transit *transit);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API void                   elm_transit_smooth_set(Elm_Transit *transit, Eina_Bool enabled);
 ...
 *
 */
ELEMENTARY_API Eina_Bool              elm_transit_smooth_get(const Elm_Transit *transit);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API Elm_Transit_Effect    *elm_transit_effect_resizing_add(Elm_Transit *transit, Evas_Coord from_w, Evas_Coord from_h, Evas_Coord to_w, Evas_Coord to_h);
 ...
 */
ELEMENTARY_API Elm_Transit_Effect    *elm_transit_effect_translation_add(Elm_Transit *transit, Evas_Coord from_dx, Evas_Coord from_dy, Evas_Coord to_dx, Evas_Coord to_dy);
 ...
 * and if the window was not created yet, it can get a wrong information.
 */
ELEMENTARY_API Elm_Transit_Effect    *elm_transit_effect_zoom_add(Elm_Transit *transit, float from_rate, float to_rate);
 ...
 * and if the window was not created yet, it can get a wrong information.
 */
ELEMENTARY_API Elm_Transit_Effect    *elm_transit_effect_flip_add(Elm_Transit *transit, Elm_Transit_Effect_Flip_Axis axis, Eina_Bool cw);
 ...
 * and if the window was not created yet, it can get a wrong information.
 */
ELEMENTARY_API Elm_Transit_Effect    *elm_transit_effect_resizable_flip_add(Elm_Transit *transit, Elm_Transit_Effect_Flip_Axis axis, Eina_Bool cw);
 ...
 * and if the window was not created yet, it can get a wrong information.
 */
ELEMENTARY_API Elm_Transit_Effect    *elm_transit_effect_wipe_add(Elm_Transit *transit, Elm_Transit_Effect_Wipe_Type type, Elm_Transit_Effect_Wipe_Dir dir);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API Elm_Transit_Effect    *elm_transit_effect_color_add(Elm_Transit *transit, unsigned int from_r, unsigned int from_g, unsigned int from_b, unsigned int from_a, unsigned int to_r, unsigned int to_g, unsigned int to_b, unsigned int to_a);
 ...
 * and if the window was not created yet, it can get a wrong information.
 */
ELEMENTARY_API Elm_Transit_Effect    *elm_transit_effect_fade_add(Elm_Transit *transit);
 ...
 * and if the window was not created yet, it can get a wrong information.
 */
ELEMENTARY_API Elm_Transit_Effect    *elm_transit_effect_blend_add(Elm_Transit *transit);
 ...
 * and if the window was not created yet, it can get a wrong information.
 */
ELEMENTARY_API Elm_Transit_Effect    *elm_transit_effect_rotation_add(Elm_Transit *transit, float from_degree, float to_degree);
 ...
 * @ingroup Elm_Transit
 */
ELEMENTARY_API Elm_Transit_Effect    *elm_transit_effect_image_animation_add(Elm_Transit *transit, Eina_List *images);
/**
 * @}
 */
