 ...
 * @ingroup Elm_Route
 */
ELM_API void elm_obj_route_emap_set(Eo *obj, void *emap);
 ...
 * @ingroup Elm_Route
 */
ELM_API void elm_obj_route_longitude_min_max_get(const Eo *obj, double *min, double *max);
 ...
 * @ingroup Elm_Route
 */
ELM_API void elm_obj_route_latitude_min_max_get(const Eo *obj, double *min, double *max);
