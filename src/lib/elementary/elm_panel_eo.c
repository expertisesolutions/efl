...
ELM_API EFL_VOID_FUNC_BODYV(elm_obj_panel_orient_set, EFL_FUNC_CALL(orient), Elm_Panel_Orient orient);

Elm_Panel_Orient _elm_panel_orient_get(const Eo *obj, Elm_Panel_Data *pd);

ELM_API EFL_FUNC_BODY_CONST(elm_obj_panel_orient_get, Elm_Panel_Orient, 2 /* Elm.Panel.Orient.left */);
...
ELM_API EFL_VOID_FUNC_BODYV(elm_obj_panel_hidden_set, EFL_FUNC_CALL(hidden), Eina_Bool hidden);
...
ELM_API EFL_FUNC_BODY_CONST(elm_obj_panel_hidden_get, Eina_Bool, 0);
...
ELM_API EFL_VOID_FUNC_BODYV(elm_obj_panel_scrollable_set, EFL_FUNC_CALL(scrollable), Eina_Bool scrollable);
...
ELM_API EFL_FUNC_BODY_CONST(elm_obj_panel_scrollable_get, Eina_Bool, 0);
...
ELM_API EFL_VOID_FUNC_BODYV(elm_obj_panel_scrollable_content_size_set, EFL_FUNC_CALL(ratio), double ratio);
...
ELM_API EFL_FUNC_BODY_CONST(elm_obj_panel_scrollable_content_size_get, double, 0);

void _elm_panel_toggle(Eo *obj, Elm_Panel_Data *pd);

ELM_API EFL_VOID_FUNC_BODY(elm_obj_panel_toggle);
