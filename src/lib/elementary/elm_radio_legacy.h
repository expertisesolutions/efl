 ...
 * @ingroup Elm_Radio
 */
ELEMENTARY_API Evas_Object                 *elm_radio_add(Evas_Object *parent);
 ...
 * @ingroup Elm_Radio
 */
ELEMENTARY_API void                       elm_radio_value_set(Evas_Object *obj, int value);
 ...
 * @ingroup Elm_Radio
 */
ELEMENTARY_API int                        elm_radio_value_get(const Evas_Object *obj);
