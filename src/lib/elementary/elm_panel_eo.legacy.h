 ...
 */
ELEMENTARY_API void elm_panel_orient_set(Elm_Panel *obj, Elm_Panel_Orient orient);
 ...
 * @ingroup Elm_Panel_Group
 */
ELEMENTARY_API Elm_Panel_Orient elm_panel_orient_get(const Elm_Panel *obj);
 ...
 * @ingroup Elm_Panel_Group
 */
ELEMENTARY_API void elm_panel_hidden_set(Elm_Panel *obj, Eina_Bool hidden);
 ...
 * @ingroup Elm_Panel_Group
 */
ELEMENTARY_API Eina_Bool elm_panel_hidden_get(const Elm_Panel *obj);
 ...
 * @ingroup Elm_Panel_Group
 */
ELEMENTARY_API void elm_panel_scrollable_set(Elm_Panel *obj, Eina_Bool scrollable);
 ...
 * @ingroup Elm_Panel_Group
 */
ELEMENTARY_API Eina_Bool elm_panel_scrollable_get(const Elm_Panel *obj);
 ...
 * @ingroup Elm_Panel_Group
 */
ELEMENTARY_API void elm_panel_scrollable_content_size_set(Elm_Panel *obj, double ratio);
 ...
 * @ingroup Elm_Panel_Group
 */
ELEMENTARY_API double elm_panel_scrollable_content_size_get(const Elm_Panel *obj);

/** Toggle the hidden state of the panel from code
 *
 * @ingroup Elm_Panel_Group
 */
ELEMENTARY_API void elm_panel_toggle(Elm_Panel *obj);
