 ...
 */
ELEMENTARY_API Evas_Object          *elm_fileselector_add(Evas_Object *parent);
 ...
 * @ingroup Elm_Fileselector
 */
ELEMENTARY_API void                  elm_fileselector_is_save_set(Evas_Object *obj, Eina_Bool is_save);
 ...
 * @ingroup Elm_Fileselector
 */
ELEMENTARY_API Eina_Bool             elm_fileselector_is_save_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Fileselector
 */
ELEMENTARY_API void                  elm_fileselector_folder_only_set(Evas_Object *obj, Eina_Bool only);
 ...
 * @ingroup Elm_Fileselector
 */
ELEMENTARY_API Eina_Bool             elm_fileselector_folder_only_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Fileselector
 */
ELEMENTARY_API void                  elm_fileselector_expandable_set(Evas_Object *obj, Eina_Bool expand);
 ...
 * @ingroup Elm_Fileselector
 */
ELEMENTARY_API Eina_Bool             elm_fileselector_expandable_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Fileselector
 */
ELEMENTARY_API void                  elm_fileselector_path_set(Evas_Object *obj, const char *path);
 ...
 * @ingroup Elm_Fileselector
 */
ELEMENTARY_API const char           *elm_fileselector_path_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Fileselector
 */
ELEMENTARY_API void                  elm_fileselector_mode_set(Evas_Object *obj, Elm_Fileselector_Mode mode);
 ...
 * @ingroup Elm_Fileselector
 */
ELEMENTARY_API Elm_Fileselector_Mode elm_fileselector_mode_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Fileselector
 */
ELEMENTARY_API void                  elm_fileselector_multi_select_set(Evas_Object *obj, Eina_Bool multi);
 ...
 * @ingroup Elm_Fileselector
 */
ELEMENTARY_API Eina_Bool             elm_fileselector_multi_select_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Fileselector
 */
ELEMENTARY_API Eina_Bool             elm_fileselector_selected_set(Evas_Object *obj, const char *path);
 ...
 * @ingroup Elm_Fileselector
 */
ELEMENTARY_API const char           *elm_fileselector_selected_get(const Evas_Object *obj);

ELEMENTARY_API void                  elm_fileselector_current_name_set(Evas_Object *obj, const char *name);
ELEMENTARY_API const char           *elm_fileselector_current_name_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Fileselector
 */
ELEMENTARY_API const Eina_List      *elm_fileselector_selected_paths_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Fileselector
 */
ELEMENTARY_API Eina_Bool             elm_fileselector_mime_types_filter_append(Evas_Object *obj, const char *mime_types, const char *filter_name);
 ...
 * @ingroup Elm_Fileselector
 */
ELEMENTARY_API Eina_Bool             elm_fileselector_custom_filter_append(Evas_Object *obj, Elm_Fileselector_Filter_Func func, void *data, const char *filter_name);
 ...
 * @ingroup Elm_Fileselector
 */
ELEMENTARY_API void                  elm_fileselector_filters_clear(Evas_Object *obj);
 ...
 * @ingroup Elm_Fileselector
 */
ELEMENTARY_API void                  elm_fileselector_hidden_visible_set(Evas_Object *obj, Eina_Bool visible);
 ...
 * @ingroup Elm_Fileselector
 */
ELEMENTARY_API Eina_Bool             elm_fileselector_hidden_visible_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Fileselector
 */
ELEMENTARY_API void                  elm_fileselector_thumbnail_size_set(Evas_Object *obj, Evas_Coord w, Evas_Coord h);
 ...
 * @ingroup Elm_Fileselector
 */
ELEMENTARY_API void                  elm_fileselector_thumbnail_size_get(const Evas_Object *obj, Evas_Coord *w, Evas_Coord *h);
 ...
 * @ingroup Elm_Fileselector
 */
ELEMENTARY_API Elm_Fileselector_Sort elm_fileselector_sort_method_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Fileselector
 */
ELEMENTARY_API void                  elm_fileselector_sort_method_set(Evas_Object *obj, Elm_Fileselector_Sort sort);
