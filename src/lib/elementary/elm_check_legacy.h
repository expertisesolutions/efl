 ...
 * @ingroup Elm_Check
 */
ELEMENTARY_API Evas_Object *                elm_check_add(Evas_Object *parent);
 ...
 * @ingroup Elm_Check
 */
ELEMENTARY_API Eina_Bool                   elm_check_state_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Check
 */
ELEMENTARY_API void                        elm_check_state_set(Evas_Object *obj, Eina_Bool state);
 ...
 * @ingroup Elm_Check
 */
ELEMENTARY_API void                        elm_check_state_pointer_set(Evas_Object *obj, Eina_Bool *statep);
