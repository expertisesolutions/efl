...
ELM_API EFL_VOID_FUNC_BODYV(elm_obj_hoversel_horizontal_set, EFL_FUNC_CALL(horizontal), Eina_Bool horizontal);
...
ELM_API EFL_FUNC_BODY_CONST(elm_obj_hoversel_horizontal_get, Eina_Bool, 0);

void _elm_hoversel_hover_parent_set(Eo *obj, Elm_Hoversel_Data *pd, Efl_Canvas_Object *parent);

ELM_API EFL_VOID_FUNC_BODYV(elm_obj_hoversel_hover_parent_set, EFL_FUNC_CALL(parent), Efl_Canvas_Object *parent);

Efl_Canvas_Object *_elm_hoversel_hover_parent_get(const Eo *obj, Elm_Hoversel_Data *pd);

ELM_API EFL_FUNC_BODY_CONST(elm_obj_hoversel_hover_parent_get, Efl_Canvas_Object *, NULL);

Eina_Bool _elm_hoversel_expanded_get(const Eo *obj, Elm_Hoversel_Data *pd);

ELM_API EFL_FUNC_BODY_CONST(elm_obj_hoversel_expanded_get, Eina_Bool, 0);

const Eina_List *_elm_hoversel_items_get(const Eo *obj, Elm_Hoversel_Data *pd);

ELM_API EFL_FUNC_BODY_CONST(elm_obj_hoversel_items_get, const Eina_List *, NULL);
...
ELM_API EFL_VOID_FUNC_BODYV(elm_obj_hoversel_auto_update_set, EFL_FUNC_CALL(auto_update), Eina_Bool auto_update);
...
ELM_API EFL_FUNC_BODY_CONST(elm_obj_hoversel_auto_update_get, Eina_Bool, 0);

void _elm_hoversel_hover_begin(Eo *obj, Elm_Hoversel_Data *pd);

ELM_API EFL_VOID_FUNC_BODY(elm_obj_hoversel_hover_begin);

void _elm_hoversel_clear(Eo *obj, Elm_Hoversel_Data *pd);

ELM_API EFL_VOID_FUNC_BODY(elm_obj_hoversel_clear);

void _elm_hoversel_hover_end(Eo *obj, Elm_Hoversel_Data *pd);

ELM_API EFL_VOID_FUNC_BODY(elm_obj_hoversel_hover_end);
...
ELM_API EFL_FUNC_BODYV(elm_obj_hoversel_item_add, Elm_Widget_Item *, NULL, EFL_FUNC_CALL(label, icon_file, icon_type, func, data), const char *label, const char *icon_file, Elm_Icon_Type icon_type, Evas_Smart_Cb func, const void *data);
