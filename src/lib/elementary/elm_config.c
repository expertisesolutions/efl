...
int ELM_EVENT_CONFIG_ALL_CHANGED = 0;
void __efl_internal_elm_config_set(Efl_Config *cfg);
...
#define CONFIG_SETE(opt) do { \
   ...
   //elm_config.h:void             elm_config_font_overlay_unset(const char *text_class);
   ...
   //elm_config.h:void      elm_config_color_overlay_unset(const char *color_class);
