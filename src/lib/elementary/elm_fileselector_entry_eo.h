...
ELM_API_WEAK const Efl_Class *elm_fileselector_entry_class_get(void);

ELM_API_WEAK extern const Efl_Event_Description _ELM_FILESELECTOR_ENTRY_EVENT_CHANGED;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_FILESELECTOR_ENTRY_EVENT_ACTIVATED;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_FILESELECTOR_ENTRY_EVENT_FILE_CHOSEN;
...
ELM_API_WEAK extern const Efl_Event_Description _ELM_FILESELECTOR_ENTRY_EVENT_PRESS;
