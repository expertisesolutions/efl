 ...
 */
ELEMENTARY_API Elm_Widget_Item *elm_diskselector_item_prev_get(const Elm_Diskselector_Item *obj);
 ...
 * @ingroup Elm_Diskselector_Item_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_diskselector_item_next_get(const Elm_Diskselector_Item *obj);
 ...
 * @ingroup Elm_Diskselector_Item_Group
 */
ELEMENTARY_API void elm_diskselector_item_selected_set(Elm_Diskselector_Item *obj, Eina_Bool selected);
 ...
 * @ingroup Elm_Diskselector_Item_Group
 */
ELEMENTARY_API Eina_Bool elm_diskselector_item_selected_get(const Elm_Diskselector_Item *obj);
