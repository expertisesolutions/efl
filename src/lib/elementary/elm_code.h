 ...
 */
ELEMENTARY_API Elm_Code *elm_code_create(void);
 ...
 */
ELEMENTARY_API void elm_code_free(Elm_Code *code);
...
ELEMENTARY_API void elm_code_callback_fire(Elm_Code *code, const Efl_Event_Description *signal, void *data);
