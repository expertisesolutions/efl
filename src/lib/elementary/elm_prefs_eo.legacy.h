 ...
 */
ELEMENTARY_API Eina_Bool elm_prefs_data_set(Elm_Prefs *obj, Elm_Prefs_Data *data);
 ...
 * @ingroup Elm_Prefs_Group
 */
ELEMENTARY_API Elm_Prefs_Data *elm_prefs_data_get(const Elm_Prefs *obj);
 ...
 * @ingroup Elm_Prefs_Group
 */
ELEMENTARY_API void elm_prefs_autosave_set(Elm_Prefs *obj, Eina_Bool autosave);
 ...
 * @ingroup Elm_Prefs_Group
 */
ELEMENTARY_API Eina_Bool elm_prefs_autosave_get(const Elm_Prefs *obj);
 ...
 * @ingroup Elm_Prefs_Group
 */
ELEMENTARY_API void elm_prefs_reset(Elm_Prefs *obj, Elm_Prefs_Reset_Mode mode);
 ...
 * @ingroup Elm_Prefs_Group
 */
ELEMENTARY_API Eina_Bool elm_prefs_item_value_set(Elm_Prefs *obj, const char *name, const Eina_Value *value);
 ...
 * @ingroup Elm_Prefs_Group
 */
ELEMENTARY_API Eina_Bool elm_prefs_item_value_get(const Elm_Prefs *obj, const char *name, Eina_Value *value);
 ...
 * @ingroup Elm_Prefs_Group
 */
ELEMENTARY_API const Efl_Canvas_Object *elm_prefs_item_object_get(Elm_Prefs *obj, const char *name);
 ...
 * @ingroup Elm_Prefs_Group
 */
ELEMENTARY_API void elm_prefs_item_disabled_set(Elm_Prefs *obj, const char *name, Eina_Bool disabled);
 ...
 * @ingroup Elm_Prefs_Group
 */
ELEMENTARY_API Eina_Bool elm_prefs_item_disabled_get(const Elm_Prefs *obj, const char *name);
 ...
 * @ingroup Elm_Prefs_Group
 */
ELEMENTARY_API Eina_Bool elm_prefs_item_swallow(Elm_Prefs *obj, const char *name, Efl_Canvas_Object *child);
 ...
 * @ingroup Elm_Prefs_Group
 */
ELEMENTARY_API void elm_prefs_item_editable_set(Elm_Prefs *obj, const char *name, Eina_Bool editable);
 ...
 * @ingroup Elm_Prefs_Group
 */
ELEMENTARY_API Eina_Bool elm_prefs_item_editable_get(const Elm_Prefs *obj, const char *name);
 ...
 * @ingroup Elm_Prefs_Group
 */
ELEMENTARY_API Efl_Canvas_Object *elm_prefs_item_unswallow(Elm_Prefs *obj, const char *name);
 ...
 * @ingroup Elm_Prefs_Group
 */
ELEMENTARY_API void elm_prefs_item_visible_set(Elm_Prefs *obj, const char *name, Eina_Bool visible);
 ...
 * @ingroup Elm_Prefs_Group
 */
ELEMENTARY_API Eina_Bool elm_prefs_item_visible_get(const Elm_Prefs *obj, const char *name);
