...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_menu_item_icon_name_set, EFL_FUNC_CALL(icon), const char *icon);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_menu_item_icon_name_get, const char *, NULL);

Elm_Widget_Item *_elm_menu_item_prev_get(const Eo *obj, Elm_Menu_Item_Data *pd);

ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_menu_item_prev_get, Elm_Widget_Item *, NULL);

Elm_Widget_Item *_elm_menu_item_next_get(const Eo *obj, Elm_Menu_Item_Data *pd);

ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_menu_item_next_get, Elm_Widget_Item *, NULL);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_menu_item_selected_set, EFL_FUNC_CALL(selected), Eina_Bool selected);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_menu_item_selected_get, Eina_Bool, 0);

unsigned int _elm_menu_item_index_get(const Eo *obj, Elm_Menu_Item_Data *pd);

ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_menu_item_index_get, unsigned int, 0);

void _elm_menu_item_subitems_clear(Eo *obj, Elm_Menu_Item_Data *pd);

ELM_API_WEAK EFL_VOID_FUNC_BODY(elm_obj_menu_item_subitems_clear);

const Eina_List *_elm_menu_item_subitems_get(const Eo *obj, Elm_Menu_Item_Data *pd);

ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_menu_item_subitems_get, const Eina_List *, NULL);

Eina_Bool _elm_menu_item_is_separator(const Eo *obj, Elm_Menu_Item_Data *pd);

ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_menu_item_is_separator, Eina_Bool, 0);

Efl_Canvas_Object *_elm_menu_item_object_get(const Eo *obj, Elm_Menu_Item_Data *pd);

ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_menu_item_object_get, Efl_Canvas_Object *, NULL);
