...
ELEMENTARY_API void elm_pan_gravity_set(Elm_Pan *, double x, double) EINA_DEPRECATED;
ELEMENTARY_API void elm_pan_gravity_get(const Elm_Pan *, double *, double *) EINA_DEPRECATED;
#endif
