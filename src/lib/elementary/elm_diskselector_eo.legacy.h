 ...
 */
ELEMENTARY_API void elm_diskselector_side_text_max_length_set(Elm_Diskselector *obj, int len);
 ...
 * @ingroup Elm_Diskselector_Group
 */
ELEMENTARY_API int elm_diskselector_side_text_max_length_get(const Elm_Diskselector *obj);
 ...
 * @ingroup Elm_Diskselector_Group
 */
ELEMENTARY_API void elm_diskselector_round_enabled_set(Elm_Diskselector *obj, Eina_Bool enabled);
 ...
 * @ingroup Elm_Diskselector_Group
 */
ELEMENTARY_API Eina_Bool elm_diskselector_round_enabled_get(const Elm_Diskselector *obj);
 ...
 * @ingroup Elm_Diskselector_Group
 */
ELEMENTARY_API void elm_diskselector_display_item_num_set(Elm_Diskselector *obj, int num);
 ...
 * @ingroup Elm_Diskselector_Group
 */
ELEMENTARY_API int elm_diskselector_display_item_num_get(const Elm_Diskselector *obj);
 ...
 * @ingroup Elm_Diskselector_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_diskselector_first_item_get(const Elm_Diskselector *obj);
 ...
 * @ingroup Elm_Diskselector_Group
 */
ELEMENTARY_API const Eina_List *elm_diskselector_items_get(const Elm_Diskselector *obj);
 ...
 * @ingroup Elm_Diskselector_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_diskselector_last_item_get(const Elm_Diskselector *obj);
 ...
 * @ingroup Elm_Diskselector_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_diskselector_selected_item_get(const Elm_Diskselector *obj);
 ...
 * @ingroup Elm_Diskselector_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_diskselector_item_append(Elm_Diskselector *obj, const char *label, Efl_Canvas_Object *icon, Evas_Smart_Cb func, const void *data);
 ...
 * @ingroup Elm_Diskselector_Group
 */
ELEMENTARY_API void elm_diskselector_clear(Elm_Diskselector *obj);
