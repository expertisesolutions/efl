 ...
 */
ELEMENTARY_API void elm_index_autohide_disabled_set(Elm_Index *obj, Eina_Bool disabled);
 ...
 * @ingroup Elm_Index_Group
 */
ELEMENTARY_API Eina_Bool elm_index_autohide_disabled_get(const Elm_Index *obj);
 ...
 * @ingroup Elm_Index_Group
 */
ELEMENTARY_API void elm_index_omit_enabled_set(Elm_Index *obj, Eina_Bool enabled);
 ...
 * @ingroup Elm_Index_Group
 */
ELEMENTARY_API Eina_Bool elm_index_omit_enabled_get(const Elm_Index *obj);
 ...
 * @ingroup Elm_Index_Group
 */
ELEMENTARY_API void elm_index_standard_priority_set(Elm_Index *obj, int priority);
 ...
 * @ingroup Elm_Index_Group
 */
ELEMENTARY_API int elm_index_standard_priority_get(const Elm_Index *obj);
 ...
 * @ingroup Elm_Index_Group
 */
ELEMENTARY_API void elm_index_delay_change_time_set(Elm_Index *obj, double dtime);
 ...
 * @ingroup Elm_Index_Group
 */
ELEMENTARY_API double elm_index_delay_change_time_get(const Elm_Index *obj);
 ...
 * @ingroup Elm_Index_Group
 */
ELEMENTARY_API void elm_index_indicator_disabled_set(Elm_Index *obj, Eina_Bool disabled);
 ...
 * @ingroup Elm_Index_Group
 */
ELEMENTARY_API Eina_Bool elm_index_indicator_disabled_get(const Elm_Index *obj);
 ...
 * @ingroup Elm_Index_Group
 */
ELEMENTARY_API void elm_index_item_level_set(Elm_Index *obj, int level);
 ...
 * @ingroup Elm_Index_Group
 */
ELEMENTARY_API int elm_index_item_level_get(const Elm_Index *obj);
 ...
 * @ingroup Elm_Index_Group
 */
ELEMENTARY_API void elm_index_level_go(Elm_Index *obj, int level);
 ...
 * @ingroup Elm_Index_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_index_item_prepend(Elm_Index *obj, const char *letter, Evas_Smart_Cb func, const void *data);
 ...
 * @ingroup Elm_Index_Group
 */
ELEMENTARY_API void elm_index_item_clear(Elm_Index *obj);
 ...
 * @ingroup Elm_Index_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_index_item_insert_after(Elm_Index *obj, Elm_Widget_Item *after, const char *letter, Evas_Smart_Cb func, const void *data);
 ...
 * @ingroup Elm_Index_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_index_item_find(Elm_Index *obj, const void *data);
 ...
 * @ingroup Elm_Index_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_index_item_insert_before(Elm_Index *obj, Elm_Widget_Item *before, const char *letter, Evas_Smart_Cb func, const void *data);
 ...
 * @ingroup Elm_Index_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_index_item_append(Elm_Index *obj, const char *letter, Evas_Smart_Cb func, const void *data);
 ...
 * @ingroup Elm_Index_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_index_selected_item_get(const Elm_Index *obj, int level);
 ...
 * @ingroup Elm_Index_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_index_item_sorted_insert(Elm_Index *obj, const char *letter, Evas_Smart_Cb func, const void *data, Eina_Compare_Cb cmp_func, Eina_Compare_Cb cmp_data_func);
