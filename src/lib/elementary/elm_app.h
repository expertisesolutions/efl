 ...
 * @ingroup Elm_App
 */
ELEMENTARY_API void        elm_app_info_set(void *mainfunc, const char *dom, const char *checkfile);
 ...
 * @since 1.8
 */
ELEMENTARY_API void        elm_app_name_set(const char *name);
 ...
 * @since 1.8
 */
ELEMENTARY_API void        elm_app_desktop_entry_set(const char *path);
 ...
 * @ingroup Elm_App
 */
ELEMENTARY_API void        elm_app_compile_bin_dir_set(const char *dir);
 ...
 * @ingroup Elm_App
 */
ELEMENTARY_API void        elm_app_compile_lib_dir_set(const char *dir);
 ...
 * @ingroup Elm_App
 */
ELEMENTARY_API void        elm_app_compile_data_dir_set(const char *dir);
 ...
 * @ingroup Elm_App
 */
ELEMENTARY_API void        elm_app_compile_locale_set(const char *dir);
 ...
 * @since 1.8
 */
ELEMENTARY_API const char *elm_app_name_get(void);
 ...
 * @since 1.8
 */
ELEMENTARY_API const char *elm_app_desktop_entry_get(void);
 ...
 * @ingroup Elm_App
 */
ELEMENTARY_API const char *elm_app_prefix_dir_get(void);
 ...
 * @ingroup Elm_App
 */
ELEMENTARY_API const char *elm_app_bin_dir_get(void);
 ...
 * @ingroup Elm_App
 */
ELEMENTARY_API const char *elm_app_lib_dir_get(void);
 ...
 * @ingroup Elm_App
 */
ELEMENTARY_API const char *elm_app_data_dir_get(void);
 ...
 * @ingroup Elm_App
 */
ELEMENTARY_API const char *elm_app_locale_dir_get(void);
 ...
 * @since 1.12
 */
ELEMENTARY_API void elm_app_base_scale_set(double base_scale);
 ...
 * @since 1.12
 */
ELEMENTARY_API double elm_app_base_scale_get(void);
