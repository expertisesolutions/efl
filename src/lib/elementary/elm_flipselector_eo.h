...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_FLIPSELECTOR_EVENT_UNDERFLOWED;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_FLIPSELECTOR_EVENT_OVERFLOWED;
