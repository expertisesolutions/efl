...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_CONFORMANT_EVENT_VIRTUALKEYPAD_STATE_ON;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_CONFORMANT_EVENT_VIRTUALKEYPAD_STATE_OFF;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_CONFORMANT_EVENT_CLIPBOARD_STATE_ON;
...
EWAPI EFL_EXTERN const Efl_Event_Description _ELM_CONFORMANT_EVENT_CLIPBOARD_STATE_OFF;
