 ...
 *
 */
ELEMENTARY_API Evas_Object *elm_spinner_add(Evas_Object *parent);
 ...
 * @since 1.8
 */
ELEMENTARY_API void elm_spinner_special_value_del(Evas_Object *obj, double value);
 ...
 * @since 1.8
 */
ELEMENTARY_API const char *elm_spinner_special_value_get(Evas_Object *obj, double value);
 ...
 * @ingroup Elm_Spinner
 */
ELEMENTARY_API void elm_spinner_min_max_set(Evas_Object *obj, double min, double max);
 ...
 * @ingroup Elm_Spinner
 */
ELEMENTARY_API void elm_spinner_min_max_get(const Evas_Object *obj, double *min, double *max);
 ...
 * @ingroup Elm_Spinner
 */
ELEMENTARY_API void elm_spinner_step_set(Evas_Object *obj, double step);
 ...
 * @ingroup Elm_Spinner
 */
ELEMENTARY_API double elm_spinner_step_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Spinner
 */
ELEMENTARY_API void elm_spinner_value_set(Evas_Object *obj, double val);
 ...
 * @ingroup Elm_Spinner
 */
ELEMENTARY_API double elm_spinner_value_get(const Evas_Object *obj);
