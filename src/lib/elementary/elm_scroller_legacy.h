 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API Evas_Object                  *elm_scroller_add(Evas_Object *parent);
 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API void                          elm_scroller_content_min_limit(Evas_Object *obj, Eina_Bool w, Eina_Bool h);
 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API void                          elm_scroller_region_show(Evas_Object *obj, Evas_Coord x, Evas_Coord y, Evas_Coord w, Evas_Coord h);
 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API void                          elm_scroller_policy_set(Evas_Object *obj, Elm_Scroller_Policy policy_h, Elm_Scroller_Policy policy_v);
 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API void                          elm_scroller_policy_get(const Evas_Object *obj, Elm_Scroller_Policy *policy_h, Elm_Scroller_Policy *policy_v);
 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API void                          elm_scroller_single_direction_set(Evas_Object *obj, Elm_Scroller_Single_Direction single_dir);
 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API Elm_Scroller_Single_Direction elm_scroller_single_direction_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API void                          elm_scroller_region_get(const Evas_Object *obj, Evas_Coord *x, Evas_Coord *y, Evas_Coord *w, Evas_Coord *h);
 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API void                          elm_scroller_child_size_get(const Evas_Object *obj, Evas_Coord *w, Evas_Coord *h);
 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API void                          elm_scroller_page_snap_set(Evas_Object *obj, Eina_Bool page_h_snap, Eina_Bool page_v_snap);
 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API void                          elm_scroller_page_snap_get(const Evas_Object *obj, Eina_Bool *page_h_snap, Eina_Bool *page_v_snap);
 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API void                          elm_scroller_bounce_set(Evas_Object *obj, Eina_Bool h_bounce, Eina_Bool v_bounce);
 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API void                          elm_scroller_bounce_get(const Evas_Object *obj, Eina_Bool *h_bounce, Eina_Bool *v_bounce);
 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API void                          elm_scroller_page_relative_set(Evas_Object *obj, double h_pagerel, double v_pagerel);
 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API void                          elm_scroller_page_relative_get(const Evas_Object *obj, double *h_pagerel, double *v_pagerel);
 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API void                          elm_scroller_page_size_set(Evas_Object *obj, Evas_Coord h_pagesize, Evas_Coord v_pagesize);
 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API void                          elm_scroller_page_size_get(const Evas_Object *obj, Evas_Coord *h_pagesize, Evas_Coord *v_pagesize);
 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API void                          elm_scroller_current_page_get(const Evas_Object *obj, int *h_pagenumber, int *v_pagenumber);
 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API void                          elm_scroller_last_page_get(const Evas_Object *obj, int *h_pagenumber, int *v_pagenumber);
 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API void                          elm_scroller_page_show(Evas_Object *obj, int h_pagenumber, int v_pagenumber);
 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API void                          elm_scroller_page_bring_in(Evas_Object *obj, int h_pagenumber, int v_pagenumber);
 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API void                          elm_scroller_region_bring_in(Evas_Object *obj, Evas_Coord x, Evas_Coord y, Evas_Coord w, Evas_Coord h);
 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API void                          elm_scroller_gravity_set(Evas_Object *obj, double x, double y);
 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API void                          elm_scroller_gravity_get(const Evas_Object *obj, double *x, double *y);
 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API void                         elm_scroller_movement_block_set(Evas_Object *obj, Elm_Scroller_Movement_Block block);
 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API Elm_Scroller_Movement_Block  elm_scroller_movement_block_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API void                          elm_scroller_step_size_set(Evas_Object *obj, Evas_Coord x, Evas_Coord y);
 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API void                          elm_scroller_step_size_get(const Evas_Object *obj, Evas_Coord *x, Evas_Coord *y);
 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API void                          elm_scroller_loop_set(Evas_Object *obj, Eina_Bool loop_h, Eina_Bool loop_v);
 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API void                          elm_scroller_loop_get(const Evas_Object *obj, Eina_Bool *loop_h, Eina_Bool *loop_v);
 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API void                          elm_scroller_wheel_disabled_set(Evas_Object *obj, Eina_Bool disabled);
 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API Eina_Bool                     elm_scroller_wheel_disabled_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API void elm_scroller_propagate_events_set(Evas_Object *obj, Eina_Bool propagation);
 ...
 * @ingroup Elm_Scroller
 */
ELEMENTARY_API Eina_Bool elm_scroller_propagate_events_get(const Evas_Object *obj);
#endif
