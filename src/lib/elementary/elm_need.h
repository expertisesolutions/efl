 ...
 * @ingroup Efreet
 */
ELEMENTARY_API Eina_Bool elm_need_efreet(void);
 ...
 * @since 1.8
 */
ELEMENTARY_API Eina_Bool elm_need_systray(void);
 ...
 * @since 1.8
 */
ELEMENTARY_API Eina_Bool elm_need_sys_notify(void);
 ...
 * @ingroup E_dbus
 */
ELEMENTARY_API Eina_Bool elm_need_e_dbus(void) EINA_DEPRECATED;
 ...
 * @ingroup eldbus
 */
ELEMENTARY_API Eina_Bool elm_need_eldbus(void);
 ...
 * @ingroup Elm_Thumb
 */
ELEMENTARY_API Eina_Bool elm_need_ethumb(void);
 ...
 * @ingroup Elm_Web
 */
ELEMENTARY_API Eina_Bool elm_need_web(void);
