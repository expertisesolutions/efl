 ...
 */
ELEMENTARY_API int elm_segment_control_item_index_get(const Elm_Segment_Control_Item *obj);
 ...
 * @ingroup Elm_Segment_Control_Item_Group
 */
ELEMENTARY_API Efl_Canvas_Object *elm_segment_control_item_object_get(const Elm_Segment_Control_Item *obj);
 ...
 * @ingroup Elm_Segment_Control_Item_Group
 */
ELEMENTARY_API void elm_segment_control_item_selected_set(Elm_Segment_Control_Item *obj, Eina_Bool selected);
