 ...
 * @ingroup Elm_Video
 */
ELEMENTARY_API Evas_Object         *elm_player_add(Evas_Object *parent);
 ...
 * @ingroup Elm_Video
 */
ELEMENTARY_API Evas_Object         *elm_video_add(Evas_Object *parent);
 ...
 */
ELEMENTARY_API Eina_Bool elm_video_file_set(Eo *obj, const char *filename);
 ...
 * @since 1.14
 */
ELEMENTARY_API void elm_video_file_get(Eo *obj, const char **filename);
 ...
 * @ingroup Elm_Video
 */
ELEMENTARY_API void elm_video_audio_level_set(Evas_Object *obj, double volume);
 ...
 * @ingroup Elm_Video
 */
ELEMENTARY_API double elm_video_audio_level_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Video
 */
ELEMENTARY_API void elm_video_audio_mute_set(Evas_Object *obj, Eina_Bool mute);
 ...
 * @ingroup Elm_Video
 */
ELEMENTARY_API Eina_Bool elm_video_audio_mute_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Video
 */
ELEMENTARY_API double elm_video_play_length_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Video
 */
ELEMENTARY_API Eina_Bool elm_video_is_seekable_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Video
 */
ELEMENTARY_API void elm_video_play_position_set(Evas_Object *obj, double position);
 ...
 * @ingroup Elm_Video
 */
ELEMENTARY_API double elm_video_play_position_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Video
 */
ELEMENTARY_API Eina_Bool elm_video_is_playing_get(Evas_Object *obj);
 ...
 * @ingroup Elm_Video
 */
ELEMENTARY_API void elm_video_play(Evas_Object *obj);
 ...
 * @ingroup Elm_Video
 */
ELEMENTARY_API void elm_video_stop(Evas_Object *obj);
 ...
 * @ingroup Elm_Video
 */
ELEMENTARY_API void elm_video_pause(Evas_Object *obj);
