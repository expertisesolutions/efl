...
Elm_Version *elm_version = &_version;
...
int ELM_EVENT_POLICY_CHANGED = 0;
int ELM_EVENT_PROCESS_BACKGROUND = 0;
int ELM_EVENT_PROCESS_FOREGROUND = 0;
...
Eina_Error EFL_UI_THEME_APPLY_ERROR_NONE = 0;
