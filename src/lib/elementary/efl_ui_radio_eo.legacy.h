 ...
 */
ELEMENTARY_API void elm_radio_state_value_set(Efl_Ui_Radio *obj, int value);
 ...
 * @ingroup Elm_Radio_Group
 */
ELEMENTARY_API int elm_radio_state_value_get(const Efl_Ui_Radio *obj);
 ...
 * @ingroup Elm_Radio_Group
 */
ELEMENTARY_API void elm_radio_value_pointer_set(Efl_Ui_Radio *obj, int *valuep);
 ...
 * @ingroup Elm_Radio_Group
 */
ELEMENTARY_API Efl_Canvas_Object *elm_radio_selected_object_get(const Efl_Ui_Radio *obj);
 ...
 * @ingroup Elm_Radio_Group
 */
ELEMENTARY_API void elm_radio_group_add(Efl_Ui_Radio *obj, Efl_Ui_Radio *group);
