...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_list_item_separator_set, EFL_FUNC_CALL(setting), Eina_Bool setting);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_list_item_separator_get, Eina_Bool, 0);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_list_item_selected_set, EFL_FUNC_CALL(selected), Eina_Bool selected);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_list_item_selected_get, Eina_Bool, 0);

Efl_Canvas_Object *_elm_list_item_object_get(const Eo *obj, Elm_List_Item_Data *pd);

ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_list_item_object_get, Efl_Canvas_Object *, NULL);

Elm_Widget_Item *_elm_list_item_prev_get(const Eo *obj, Elm_List_Item_Data *pd);

ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_list_item_prev_get, Elm_Widget_Item *, NULL);

Elm_Widget_Item *_elm_list_item_next_get(const Eo *obj, Elm_List_Item_Data *pd);

ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_list_item_next_get, Elm_Widget_Item *, NULL);

void _elm_list_item_show(Eo *obj, Elm_List_Item_Data *pd);

ELM_API_WEAK EFL_VOID_FUNC_BODY(elm_obj_list_item_show);

void _elm_list_item_bring_in(Eo *obj, Elm_List_Item_Data *pd);

ELM_API_WEAK EFL_VOID_FUNC_BODY(elm_obj_list_item_bring_in);
