 ...
 */
ELEMENTARY_API void elm_map_zoom_min_set(Elm_Map *obj, int zoom);
 ...
 * @ingroup Elm_Map_Group
 */
ELEMENTARY_API int elm_map_zoom_min_get(const Elm_Map *obj);
 ...
 * @ingroup Elm_Map_Group
 */
ELEMENTARY_API void elm_map_rotate_set(Elm_Map *obj, double degree, int cx, int cy);
 ...
 * @ingroup Elm_Map_Group
 */
ELEMENTARY_API void elm_map_rotate_get(const Elm_Map *obj, double *degree, int *cx, int *cy);
 ...
 * @ingroup Elm_Map_Group
 */
ELEMENTARY_API void elm_map_user_agent_set(Elm_Map *obj, const char *user_agent);
 ...
 * @ingroup Elm_Map_Group
 */
ELEMENTARY_API const char *elm_map_user_agent_get(const Elm_Map *obj);
 ...
 * @ingroup Elm_Map_Group
 */
ELEMENTARY_API void elm_map_zoom_max_set(Elm_Map *obj, int zoom);
 ...
 * @ingroup Elm_Map_Group
 */
ELEMENTARY_API int elm_map_zoom_max_get(const Elm_Map *obj);
 ...
 * @ingroup Elm_Map_Group
 */
ELEMENTARY_API void elm_map_region_get(const Elm_Map *obj, double *lon, double *lat);
 ...
 * @ingroup Elm_Map_Group
 */
ELEMENTARY_API Eina_List *elm_map_overlays_get(const Elm_Map *obj);
 ...
 * @ingroup Elm_Map_Group
 */
ELEMENTARY_API void elm_map_tile_load_status_get(const Elm_Map *obj, int *try_num, int *finish_num);
 ...
 * @ingroup Elm_Map_Group
 */
ELEMENTARY_API void elm_map_source_set(Elm_Map *obj, Elm_Map_Source_Type type, const char *source_name);
 ...
 * @ingroup Elm_Map_Group
 */
ELEMENTARY_API const char *elm_map_source_get(const Elm_Map *obj, Elm_Map_Source_Type type);
 ...
 * @ingroup Elm_Map_Group
 */
ELEMENTARY_API Elm_Map_Route *elm_map_route_add(Elm_Map *obj, Elm_Map_Route_Type type, Elm_Map_Route_Method method, double flon, double flat, double tlon, double tlat, Elm_Map_Route_Cb route_cb, void *data);
 ...
 * @ingroup Elm_Map_Group
 */
ELEMENTARY_API Efl_Canvas_Object *elm_map_track_add(Elm_Map *obj, void *emap);
 ...
 * @ingroup Elm_Map_Group
 */
ELEMENTARY_API void elm_map_region_to_canvas_convert(const Elm_Map *obj, double lon, double lat, int *x, int *y);
 ...
 * @ingroup Elm_Map_Group
 */
ELEMENTARY_API Elm_Map_Overlay *elm_map_overlay_circle_add(Elm_Map *obj, double lon, double lat, double radius);
 ...
 * @ingroup Elm_Map_Group
 */
ELEMENTARY_API Elm_Map_Overlay *elm_map_overlay_class_add(Elm_Map *obj);
 ...
 * @ingroup Elm_Map_Group
 */
ELEMENTARY_API Elm_Map_Overlay *elm_map_overlay_bubble_add(Elm_Map *obj);
 ...
 * @ingroup Elm_Map_Group
 */
ELEMENTARY_API const char **elm_map_sources_get(const Elm_Map *obj, Elm_Map_Source_Type type);
 ...
 * @ingroup Elm_Map_Group
 */
ELEMENTARY_API Elm_Map_Overlay *elm_map_overlay_polygon_add(Elm_Map *obj);
 ...
 * @ingroup Elm_Map_Group
 */
ELEMENTARY_API Elm_Map_Overlay *elm_map_overlay_line_add(Elm_Map *obj, double flon, double flat, double tlon, double tlat);
 ...
 * @ingroup Elm_Map_Group
 */
ELEMENTARY_API void elm_map_region_show(Elm_Map *obj, double lon, double lat);
 ...
 * @ingroup Elm_Map_Group
 */
ELEMENTARY_API Elm_Map_Name *elm_map_name_add(const Elm_Map *obj, const char *address, double lon, double lat, Elm_Map_Name_Cb name_cb, void *data);
 ...
 * @ingroup Elm_Map_Group
 */
ELEMENTARY_API void elm_map_name_search(const Elm_Map *obj, const char *address, Elm_Map_Name_List_Cb name_cb, void *data);
 ...
 * @ingroup Elm_Map_Group
 */
ELEMENTARY_API void elm_map_region_bring_in(Elm_Map *obj, double lon, double lat);
 ...
 * @ingroup Elm_Map_Group
 */
ELEMENTARY_API void elm_map_region_zoom_bring_in(Elm_Map *obj, int zoom, double lon, double lat);
 ...
 * @ingroup Elm_Map_Group
 */
ELEMENTARY_API void elm_map_track_remove(Elm_Map *obj, Efl_Canvas_Object *route);
 ...
 * @ingroup Elm_Map_Group
 */
ELEMENTARY_API Elm_Map_Overlay *elm_map_overlay_route_add(Elm_Map *obj, const Elm_Map_Route *route);
 ...
 * @ingroup Elm_Map_Group
 */
ELEMENTARY_API Elm_Map_Overlay *elm_map_overlay_scale_add(Elm_Map *obj, int x, int y);
 ...
 * @ingroup Elm_Map_Group
 */
ELEMENTARY_API Elm_Map_Overlay *elm_map_overlay_add(Elm_Map *obj, double lon, double lat);
 ...
 * @ingroup Elm_Map_Group
 */
ELEMENTARY_API void elm_map_canvas_to_region_convert(const Elm_Map *obj, int x, int y, double *lon, double *lat);
