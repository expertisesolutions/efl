 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK void elm_obj_genlist_homogeneous_set(Eo *obj, Eina_Bool homogeneous);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK Eina_Bool elm_obj_genlist_homogeneous_get(const Eo *obj);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK void elm_obj_genlist_select_mode_set(Eo *obj, Elm_Object_Select_Mode mode);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK Elm_Object_Select_Mode elm_obj_genlist_select_mode_get(const Eo *obj);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK void elm_obj_genlist_focus_on_selection_set(Eo *obj, Eina_Bool enabled);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK Eina_Bool elm_obj_genlist_focus_on_selection_get(const Eo *obj);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK void elm_obj_genlist_longpress_timeout_set(Eo *obj, double timeout);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK double elm_obj_genlist_longpress_timeout_get(const Eo *obj);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK void elm_obj_genlist_multi_select_set(Eo *obj, Eina_Bool multi);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK Eina_Bool elm_obj_genlist_multi_select_get(const Eo *obj);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK void elm_obj_genlist_reorder_mode_set(Eo *obj, Eina_Bool reorder_mode);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK Eina_Bool elm_obj_genlist_reorder_mode_get(const Eo *obj);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK void elm_obj_genlist_decorate_mode_set(Eo *obj, Eina_Bool decorated);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK Eina_Bool elm_obj_genlist_decorate_mode_get(const Eo *obj);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK void elm_obj_genlist_multi_select_mode_set(Eo *obj, Elm_Object_Multi_Select_Mode mode);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK Elm_Object_Multi_Select_Mode elm_obj_genlist_multi_select_mode_get(const Eo *obj);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK void elm_obj_genlist_block_count_set(Eo *obj, int count);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK int elm_obj_genlist_block_count_get(const Eo *obj);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK void elm_obj_genlist_tree_effect_enabled_set(Eo *obj, Eina_Bool enabled);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK Eina_Bool elm_obj_genlist_tree_effect_enabled_get(const Eo *obj);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK void elm_obj_genlist_highlight_mode_set(Eo *obj, Eina_Bool highlight);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK Eina_Bool elm_obj_genlist_highlight_mode_get(const Eo *obj);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK void elm_obj_genlist_mode_set(Eo *obj, Elm_List_Mode mode);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK Elm_List_Mode elm_obj_genlist_mode_get(const Eo *obj);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK Elm_Widget_Item *elm_obj_genlist_decorated_item_get(const Eo *obj);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK Elm_Widget_Item *elm_obj_genlist_selected_item_get(const Eo *obj);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK Elm_Widget_Item *elm_obj_genlist_first_item_get(const Eo *obj);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK Eina_List *elm_obj_genlist_realized_items_get(const Eo *obj) EINA_WARN_UNUSED_RESULT;
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK const Eina_List *elm_obj_genlist_selected_items_get(const Eo *obj);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK Elm_Widget_Item *elm_obj_genlist_last_item_get(const Eo *obj);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK Elm_Widget_Item *elm_obj_genlist_item_insert_before(Eo *obj, const Elm_Genlist_Item_Class *itc, const void *data, Elm_Widget_Item *parent, Elm_Widget_Item *before_it, Elm_Genlist_Item_Type type, Evas_Smart_Cb func, const void *func_data);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK void elm_obj_genlist_realized_items_update(Eo *obj);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK Elm_Widget_Item *elm_obj_genlist_item_insert_after(Eo *obj, const Elm_Genlist_Item_Class *itc, const void *data, Elm_Widget_Item *parent, Elm_Widget_Item *after_it, Elm_Genlist_Item_Type type, Evas_Smart_Cb func, const void *func_data);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK Elm_Widget_Item *elm_obj_genlist_at_xy_item_get(const Eo *obj, int x, int y, int *posret);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK void elm_obj_genlist_filter_set(Eo *obj, void *key);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK Eina_Iterator *elm_obj_genlist_filter_iterator_new(Eo *obj);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK unsigned int elm_obj_genlist_filtered_items_count(const Eo *obj);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK unsigned int elm_obj_genlist_items_count(const Eo *obj);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK Elm_Widget_Item *elm_obj_genlist_item_prepend(Eo *obj, const Elm_Genlist_Item_Class *itc, const void *data, Elm_Widget_Item *parent, Elm_Genlist_Item_Type type, Evas_Smart_Cb func, const void *func_data);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK void elm_obj_genlist_clear(Eo *obj);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK Elm_Widget_Item *elm_obj_genlist_item_append(Eo *obj, const Elm_Genlist_Item_Class *itc, const void *data, Elm_Widget_Item *parent, Elm_Genlist_Item_Type type, Evas_Smart_Cb func, const void *func_data);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK Elm_Widget_Item *elm_obj_genlist_item_sorted_insert(Eo *obj, const Elm_Genlist_Item_Class *itc, const void *data, Elm_Widget_Item *parent, Elm_Genlist_Item_Type type, Eina_Compare_Cb comp, Evas_Smart_Cb func, const void *func_data);
 ...
 * @ingroup Elm_Genlist
 */
ELM_API_WEAK Elm_Widget_Item *elm_obj_genlist_search_by_text_item_get(Eo *obj, Elm_Widget_Item *item_to_search_from, const char *part_name, const char *pattern, Elm_Glob_Match_Flags flags);
