 ...
 * @see elm_box_layout_set
 */
ELEMENTARY_API void                elm_box_layout_transition(Evas_Object *obj, Evas_Object_Box_Data *priv, void *data);
 ...
 * @see elm_box_layout_transition
 */
ELEMENTARY_API void                elm_box_transition_free(void *data);
