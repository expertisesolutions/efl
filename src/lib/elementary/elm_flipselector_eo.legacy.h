 ...
 */
ELEMENTARY_API const Eina_List *elm_flipselector_items_get(const Elm_Flipselector *obj);
 ...
 * @ingroup Elm_Flipselector_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_flipselector_first_item_get(const Elm_Flipselector *obj);
 ...
 * @ingroup Elm_Flipselector_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_flipselector_last_item_get(const Elm_Flipselector *obj);
 ...
 * @ingroup Elm_Flipselector_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_flipselector_selected_item_get(const Elm_Flipselector *obj);
 ...
 * @ingroup Elm_Flipselector_Group
 */
ELEMENTARY_API void elm_flipselector_first_interval_set(Elm_Flipselector *obj, double interval);
 ...
 * @ingroup Elm_Flipselector_Group
 */
ELEMENTARY_API double elm_flipselector_first_interval_get(const Elm_Flipselector *obj);
 ...
 * @ingroup Elm_Flipselector_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_flipselector_item_prepend(Elm_Flipselector *obj, const char *label, Evas_Smart_Cb func, void *data);
 ...
 * @ingroup Elm_Flipselector_Group
 */
ELEMENTARY_API void elm_flipselector_flip_next(Elm_Flipselector *obj);
 ...
 * @ingroup Elm_Flipselector_Group
 */
ELEMENTARY_API Elm_Widget_Item *elm_flipselector_item_append(Elm_Flipselector *obj, const char *label, Evas_Smart_Cb func, const void *data);
 ...
 * @ingroup Elm_Flipselector_Group
 */
ELEMENTARY_API void elm_flipselector_flip_prev(Elm_Flipselector *obj);
