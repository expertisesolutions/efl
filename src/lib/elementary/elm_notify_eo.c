...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_notify_align_set, EFL_FUNC_CALL(horizontal, vertical), double horizontal, double vertical);

void _elm_notify_align_get(const Eo *obj, Elm_Notify_Data *pd, double *horizontal, double *vertical);

ELM_API_WEAK EFL_VOID_FUNC_BODYV_CONST(elm_obj_notify_align_get, EFL_FUNC_CALL(horizontal, vertical), double *horizontal, double *vertical);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_notify_allow_events_set, EFL_FUNC_CALL(allow), Eina_Bool allow);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_notify_allow_events_get, Eina_Bool, 0);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_notify_timeout_set, EFL_FUNC_CALL(timeout), double timeout);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_notify_timeout_get, double, 0);

void _elm_notify_dismiss(Eo *obj, Elm_Notify_Data *pd);

ELM_API_WEAK EFL_VOID_FUNC_BODY(elm_obj_notify_dismiss);
