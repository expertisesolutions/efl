 ...
 * @ingroup Elm_Datetime
 */
ELEMENTARY_API Evas_Object *elm_datetime_add(Evas_Object *parent);
 ...
 * @ingroup Elm_Datetime
 */
ELEMENTARY_API void elm_datetime_format_set(Evas_Object *obj, const char *fmt);
 ...
 * @ingroup Elm_Datetime
 */
ELEMENTARY_API const char *elm_datetime_format_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Datetime
 */
ELEMENTARY_API void elm_datetime_field_limit_set(Evas_Object *obj, Elm_Datetime_Field_Type type, int min, int max);
 ...
 * @ingroup Elm_Datetime
 */
ELEMENTARY_API void elm_datetime_field_limit_get(const Evas_Object *obj, Elm_Datetime_Field_Type fieldtype, int *min, int *max);
 ...
 * @ingroup Elm_Datetime
 */
ELEMENTARY_API Eina_Bool elm_datetime_value_min_set(Evas_Object *obj, const Efl_Time *mintime);
 ...
 * @ingroup Elm_Datetime
 */
ELEMENTARY_API Eina_Bool elm_datetime_value_min_get(const Evas_Object *obj, Efl_Time *mintime);
 ...
 * @ingroup Elm_Datetime
 */
ELEMENTARY_API Eina_Bool elm_datetime_value_set(Evas_Object *obj, const Efl_Time *newtime);
 ...
 * @ingroup Elm_Datetime
 */
ELEMENTARY_API Eina_Bool elm_datetime_value_get(const Evas_Object *obj, Efl_Time *currtime);
 ...
 * @ingroup Elm_Datetime
 */
ELEMENTARY_API void elm_datetime_field_visible_set(Evas_Object *obj, Elm_Datetime_Field_Type fieldtype, Eina_Bool visible);
 ...
 * @ingroup Elm_Datetime
 */
ELEMENTARY_API Eina_Bool elm_datetime_field_visible_get(const Evas_Object *obj, Elm_Datetime_Field_Type fieldtype);
 ...
 * @ingroup Elm_Datetime
 */
ELEMENTARY_API Eina_Bool elm_datetime_value_max_set(Evas_Object *obj, const Efl_Time *maxtime);
 ...
 * @ingroup Elm_Datetime
 */
ELEMENTARY_API Eina_Bool elm_datetime_value_max_get(const Evas_Object *obj, Efl_Time *maxtime);
