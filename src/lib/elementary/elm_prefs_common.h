 ...
 * @since 1.8
 */
ELEMENTARY_API Evas_Object       *elm_prefs_add(Evas_Object *parent);
 ...
 * @since 1.8
 */
ELEMENTARY_API void      elm_prefs_item_iface_register(const Elm_Prefs_Item_Iface_Info *array);
 ...
 * @since 1.8
 */
ELEMENTARY_API void      elm_prefs_item_iface_unregister(const Elm_Prefs_Item_Iface_Info *array);

ELEMENTARY_API Eina_Bool elm_prefs_item_widget_common_add(Evas_Object *prefs,
                                                Evas_Object *obj);
 ...
 * @since 1.8
 */
ELEMENTARY_API void      elm_prefs_page_iface_register(const Elm_Prefs_Page_Iface_Info *array);
 ...
 * @since 1.8
 */
ELEMENTARY_API void      elm_prefs_page_iface_unregister(const Elm_Prefs_Page_Iface_Info *array);
