...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_systray_id_set, EFL_FUNC_CALL(id), const char *id);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_systray_id_get, const char *, NULL);

void _elm_systray_category_set(Eo *obj, void *pd, Elm_Systray_Category cat);

ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_systray_category_set, EFL_FUNC_CALL(cat), Elm_Systray_Category cat);

Elm_Systray_Category _elm_systray_category_get(const Eo *obj, void *pd);

ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_systray_category_get, Elm_Systray_Category, 0);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_systray_icon_theme_path_set, EFL_FUNC_CALL(icon_theme_path), const char *icon_theme_path);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_systray_icon_theme_path_get, const char *, NULL);

void _elm_systray_menu_set(Eo *obj, void *pd, const Efl_Object *menu);

ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_systray_menu_set, EFL_FUNC_CALL(menu), const Efl_Object *menu);

const Efl_Object *_elm_systray_menu_get(const Eo *obj, void *pd);

ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_systray_menu_get, const Efl_Object *, NULL);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_systray_att_icon_name_set, EFL_FUNC_CALL(att_icon_name), const char *att_icon_name);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_systray_att_icon_name_get, const char *, NULL);

void _elm_systray_status_set(Eo *obj, void *pd, Elm_Systray_Status st);

ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_systray_status_set, EFL_FUNC_CALL(st), Elm_Systray_Status st);

Elm_Systray_Status _elm_systray_status_get(const Eo *obj, void *pd);

ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_systray_status_get, Elm_Systray_Status, 0);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_systray_icon_name_set, EFL_FUNC_CALL(icon_name), const char *icon_name);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_systray_icon_name_get, const char *, NULL);
...
ELM_API_WEAK EFL_VOID_FUNC_BODYV(elm_obj_systray_title_set, EFL_FUNC_CALL(title), const char *title);
...
ELM_API_WEAK EFL_FUNC_BODY_CONST(elm_obj_systray_title_get, const char *, NULL);

Eina_Bool _elm_systray_register(Eo *obj, void *pd);

ELM_API_WEAK EFL_FUNC_BODY(elm_obj_systray_register, Eina_Bool, 0);
