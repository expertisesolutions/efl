 ...
 * @since 1.8
 */
ELEMENTARY_API extern int ELM_EVENT_SYS_NOTIFY_NOTIFICATION_CLOSED;

/**
 * Emitted when the signal ActionInvoked is received.
 * @since 1.8
 */
ELEMENTARY_API extern int ELM_EVENT_SYS_NOTIFY_ACTION_INVOKED; /**< A Action has been invoked. */
 ...
 * @since 1.8
 */
ELEMENTARY_API void      elm_sys_notify_send(unsigned int replaces_id,
                                   const char *icon,
                                   const char *summary,
                                   const char *body,
 ...
 * @since 1.8
 */
ELEMENTARY_API void      elm_sys_notify_close(unsigned int id);
