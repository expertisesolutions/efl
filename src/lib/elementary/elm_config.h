 ...
 *
 */
ELEMENTARY_API Eina_Bool elm_config_save(void);
 ...
 *
 */
ELEMENTARY_API void      elm_config_reload(void);
 ...
 * @ingroup Elm_Config
 */
ELEMENTARY_API void      elm_config_all_flush(void);
 ...
 * @ingroup Elm_Profile
 */
ELEMENTARY_API const char *elm_config_profile_get(void);
 ...
 */
ELEMENTARY_API const char *elm_config_profile_dir_get(const char *profile, Eina_Bool is_user);
 ...
 *
 */
ELEMENTARY_API void        elm_config_profile_dir_free(const char *p_dir);
 ...
 */
ELEMENTARY_API Eina_List  *elm_config_profile_list_get(void);
 ...
 * @since 1.17
 */
ELEMENTARY_API Eina_List  *elm_config_profile_list_full_get(void);
 ...
 *
 */
ELEMENTARY_API void        elm_config_profile_list_free(Eina_List *l);
 ...
 * @since 1.17
 */
ELEMENTARY_API Eina_Bool   elm_config_profile_exists(const char *profile);
 ...
 *
 */
ELEMENTARY_API void        elm_config_profile_set(const char *profile);
 ...
 * @since 1.17
 */
ELEMENTARY_API void        elm_config_profile_save(const char *profile);
 ...
 * @since 1.17
 */
ELEMENTARY_API void        elm_config_profile_derived_add(const char *profile, const char *derive_options);
 ...
 * @since 1.17
 */
ELEMENTARY_API void        elm_config_profile_derived_del(const char *profile);
 ...
 */
ELEMENTARY_API Eina_Bool    elm_config_scroll_bounce_enabled_get(void);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API void         elm_config_scroll_bounce_enabled_set(Eina_Bool enabled);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API double       elm_config_scroll_bounce_friction_get(void);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API void         elm_config_scroll_bounce_friction_set(double friction);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API double       elm_config_scroll_page_scroll_friction_get(void);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API void         elm_config_scroll_page_scroll_friction_set(double friction);
 ...
 * @since 1.17
 */
ELEMENTARY_API Eina_Bool elm_config_context_menu_disabled_get(void);
 ...
 * @since 1.17
 */
ELEMENTARY_API void elm_config_context_menu_disabled_set(Eina_Bool disabled);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API double       elm_config_scroll_bring_in_scroll_friction_get(void);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API void         elm_config_scroll_bring_in_scroll_friction_set(double friction);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API double       elm_config_scroll_zoom_friction_get(void);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API void         elm_config_scroll_zoom_friction_set(double friction);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API Eina_Bool    elm_config_scroll_thumbscroll_enabled_get(void);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API void         elm_config_scroll_thumbscroll_enabled_set(Eina_Bool enabled);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API unsigned int elm_config_scroll_thumbscroll_threshold_get(void);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API void         elm_config_scroll_thumbscroll_threshold_set(unsigned int threshold);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API unsigned int elm_config_scroll_thumbscroll_hold_threshold_get(void);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API void         elm_config_scroll_thumbscroll_hold_threshold_set(unsigned int threshold);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API double       elm_config_scroll_thumbscroll_momentum_threshold_get(void);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API void         elm_config_scroll_thumbscroll_momentum_threshold_set(double threshold);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API unsigned int elm_config_scroll_thumbscroll_momentum_distance_max_get(void);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API void         elm_config_scroll_thumbscroll_momentum_distance_max_set(unsigned int distance);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API double       elm_config_scroll_thumbscroll_momentum_friction_get(void);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API void         elm_config_scroll_thumbscroll_momentum_friction_set(double friction);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API double       elm_config_scroll_thumbscroll_border_friction_get(void);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API void         elm_config_scroll_thumbscroll_border_friction_set(double friction);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API double       elm_config_scroll_thumbscroll_sensitivity_friction_get(void);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API void         elm_config_scroll_thumbscroll_sensitivity_friction_set(double friction);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API Eina_Bool    elm_config_scroll_thumbscroll_smooth_start_get(void);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API void         elm_config_scroll_thumbscroll_smooth_start_set(Eina_Bool enable);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API Eina_Bool    elm_config_scroll_animation_disabled_get(void);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API void         elm_config_scroll_animation_disabled_set(Eina_Bool enable);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API double       elm_config_scroll_accel_factor_get(void);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API void         elm_config_scroll_accel_factor_set(double factor);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API double       elm_config_scroll_thumbscroll_smooth_amount_get(void);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API void         elm_config_scroll_thumbscroll_smooth_amount_set(double amount);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API double       elm_config_scroll_thumbscroll_smooth_time_window_get(void);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API void         elm_config_scroll_thumbscroll_smooth_time_window_set(double amount);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API double       elm_config_scroll_thumbscroll_acceleration_threshold_get(void);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API void         elm_config_scroll_thumbscroll_acceleration_threshold_set(double threshold);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API double       elm_config_scroll_thumbscroll_acceleration_time_limit_get(void);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API void         elm_config_scroll_thumbscroll_acceleration_time_limit_set(double time_limit);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API double       elm_config_scroll_thumbscroll_acceleration_weight_get(void);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API void         elm_config_scroll_thumbscroll_acceleration_weight_set(double weight);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API double       elm_config_scroll_thumbscroll_momentum_animation_duration_min_limit_get(void);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API void         elm_config_scroll_thumbscroll_momentum_animation_duration_min_limit_set(double min);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API double       elm_config_scroll_thumbscroll_momentum_animation_duration_max_limit_get(void);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API void         elm_config_scroll_thumbscroll_momentum_animation_duration_max_limit_set(double max);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API double       elm_config_scroll_thumbscroll_min_friction_get(void);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API void         elm_config_scroll_thumbscroll_min_friction_set(double friction);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API double       elm_config_scroll_thumbscroll_friction_standard_get(void);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API void         elm_config_scroll_thumbscroll_friction_standard_set(double standard);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API unsigned int elm_config_scroll_thumbscroll_flick_distance_tolerance_get(void);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API void         elm_config_scroll_thumbscroll_flick_distance_tolerance_set(unsigned int distance);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API double       elm_config_scroll_thumbscroll_friction_get(void);
 ...
 * @ingroup Elm_Scrolling
 */
ELEMENTARY_API void         elm_config_scroll_thumbscroll_friction_set(double friction);
 ...
 * @since 1.10
 */
ELEMENTARY_API Elm_Focus_Autoscroll_Mode elm_config_focus_autoscroll_mode_get(void);
 ...
 * @since 1.10
 */
ELEMENTARY_API void         elm_config_focus_autoscroll_mode_set(Elm_Focus_Autoscroll_Mode mode);
 ...
 * @since 1.13
 */
ELEMENTARY_API void elm_config_slider_indicator_visible_mode_set(Elm_Slider_Indicator_Visible_Mode mode);
 ...
 * @since 1.13
 */
ELEMENTARY_API Elm_Slider_Indicator_Visible_Mode elm_config_slider_indicator_visible_mode_get(void);
 ...
 * @ingroup Longpress
 */
ELEMENTARY_API double       elm_config_longpress_timeout_get(void);
 ...
 * @ingroup Longpress
 */
ELEMENTARY_API void         elm_config_longpress_timeout_set(double longpress_timeout);
 ...
 * @since 1.7
 */
ELEMENTARY_API void         elm_config_softcursor_mode_set(Elm_Softcursor_Mode mode);
 ...
 * @since 1.7
 */
ELEMENTARY_API Elm_Softcursor_Mode elm_config_softcursor_mode_get(void);
 ...
 */
ELEMENTARY_API double      elm_config_tooltip_delay_get(void);
 ...
 */
ELEMENTARY_API void        elm_config_tooltip_delay_set(double delay);
 ...
 * @ingroup Elm_Cursors
 */
ELEMENTARY_API Eina_Bool   elm_config_cursor_engine_only_get(void);
 ...
 * @ingroup Elm_Cursors
 */
ELEMENTARY_API void        elm_config_cursor_engine_only_set(Eina_Bool engine_only);
 ...
 * @ingroup Elm_Scaling
 */
ELEMENTARY_API double elm_config_scale_get(void);
 ...
 * @ingroup Elm_Scaling
 */
ELEMENTARY_API void   elm_config_scale_set(double scale);
 ...
 * @since 1.18
 */
ELEMENTARY_API const char *elm_config_icon_theme_get(void);
 ...
 * @since 1.18
 */
ELEMENTARY_API void elm_config_icon_theme_set(const char *theme);
 ...
 */
ELEMENTARY_API Eina_Bool elm_config_password_show_last_get(void);
 ...
 * @ingroup Elm_Password_last_show
 */
ELEMENTARY_API void      elm_config_password_show_last_set(Eina_Bool password_show_last);
 ...
 * @ingroup Elm_Password_last_show
 */
ELEMENTARY_API double    elm_config_password_show_last_timeout_get(void);
 ...
 * @ingroup Elm_Password_last_show
 */
ELEMENTARY_API void      elm_config_password_show_last_timeout_set(double password_show_last_timeout);
 ...
 */
EINA_DEPRECATED ELEMENTARY_API const char *elm_config_engine_get(void);
 ...
 * @deprecated use elm_config_accel_preference_get() + elm_config_accel_preference_set()
 */
EINA_DEPRECATED ELEMENTARY_API void        elm_config_engine_set(const char *engine);
 ...
 */
ELEMENTARY_API const char *elm_config_preferred_engine_get(void);
 ...
 * @see elm_config_engine_set()
 */
ELEMENTARY_API void        elm_config_preferred_engine_set(const char *engine);
 ...
 * @since 1.10
 */
ELEMENTARY_API const char *elm_config_accel_preference_get(void);
 ...
 * @since 1.10
 */
ELEMENTARY_API void        elm_config_accel_preference_set(const char *pref);
 ...
 */
ELEMENTARY_API Eina_List *elm_config_text_classes_list_get(void);
 ...
 */
ELEMENTARY_API void elm_config_text_classes_list_free(Eina_List *list);
 ...
 */
ELEMENTARY_API const Eina_List *elm_config_font_overlay_list_get(void);
 ...
 */
ELEMENTARY_API void             elm_config_font_overlay_set(const char *text_class, const char *font, Evas_Font_Size size);
 ...
 */
ELEMENTARY_API Eina_Bool        elm_config_access_get(void);
 ...
 */
ELEMENTARY_API void             elm_config_access_set(Eina_Bool is_access);
 ...
 */
ELEMENTARY_API Eina_Bool        elm_config_selection_unfocused_clear_get(void);
 ...
 */
ELEMENTARY_API void             elm_config_selection_unfocused_clear_set(Eina_Bool enabled);
 ...
 */
ELEMENTARY_API void             elm_config_font_overlay_unset(const char *text_class);
 ...
 */
ELEMENTARY_API void             elm_config_font_overlay_apply(void);
 ...
 * @since 1.13
 */
ELEMENTARY_API void elm_config_font_hint_type_set(int type);
 ...
 * @ingroup Elm_Fingers
 */
ELEMENTARY_API Evas_Coord elm_config_finger_size_get(void);
 ...
 * @ingroup Elm_Fingers
 */
ELEMENTARY_API void       elm_config_finger_size_set(Evas_Coord size);
 ...
 */
ELEMENTARY_API int       elm_config_cache_flush_interval_get(void);
 ...
 * @see elm_cache_all_flush()
 */
ELEMENTARY_API void      elm_config_cache_flush_interval_set(int size);
 ...
 * @see elm_cache_all_flush()
 */
ELEMENTARY_API Eina_Bool elm_config_cache_flush_enabled_get(void);
 ...
 * @see elm_cache_all_flush()
 */
ELEMENTARY_API void      elm_config_cache_flush_enabled_set(Eina_Bool enabled);
 ...
 * @ingroup Elm_Caches
 */
ELEMENTARY_API int       elm_config_cache_font_cache_size_get(void);
 ...
 * @ingroup Elm_Caches
 */
ELEMENTARY_API void      elm_config_cache_font_cache_size_set(int size);
 ...
 * @ingroup Elm_Caches
 */
ELEMENTARY_API int       elm_config_cache_image_cache_size_get(void);
 ...
 * @ingroup Elm_Caches
 */
ELEMENTARY_API void       elm_config_cache_image_cache_size_set(int size);
 ...
 * @ingroup Elm_Caches
 */
ELEMENTARY_API int       elm_config_cache_edje_file_cache_size_get(void);
 ...
 * @ingroup Elm_Caches
 */
ELEMENTARY_API void       elm_config_cache_edje_file_cache_size_set(int size);
 ...
 * @ingroup Elm_Caches
 */
ELEMENTARY_API int       elm_config_cache_edje_collection_cache_size_get(void);
 ...
 * @ingroup Elm_Caches
 */
ELEMENTARY_API void       elm_config_cache_edje_collection_cache_size_set(int size);
 ...
 * @since 1.11
 */
ELEMENTARY_API Eina_Bool  elm_config_vsync_get(void);
 ...
 * @since 1.11
 */
ELEMENTARY_API void       elm_config_vsync_set(Eina_Bool enabled);
 ...
 * @since 1.21
 */
ELEMENTARY_API Eina_Bool elm_config_agressive_withdrawn_get(void);
 ...
 * @since 1.21
 */
ELEMENTARY_API void elm_config_agressive_withdrawn_set(Eina_Bool enabled);
 ...
 * @since 1.11
 */
ELEMENTARY_API Eina_Bool  elm_config_accel_preference_override_get(void);
 ...
 * @since 1.11
 */
ELEMENTARY_API void       elm_config_accel_preference_override_set(Eina_Bool enabled);
 ...
 * @ingroup Elm_Focus
 */
ELEMENTARY_API Eina_Bool            elm_config_focus_highlight_enabled_get(void);
 ...
 * @ingroup Elm_Focus
 */
ELEMENTARY_API void                 elm_config_focus_highlight_enabled_set(Eina_Bool enable);
 ...
 * @ingroup Elm_Focus
 */
ELEMENTARY_API Eina_Bool            elm_config_focus_highlight_animate_get(void);
 ...
 * @ingroup Elm_Focus
 */
ELEMENTARY_API void                 elm_config_focus_highlight_animate_set(Eina_Bool animate);
 ...
 * @ingroup Elm_Focus
 */
ELEMENTARY_API Eina_Bool elm_config_focus_highlight_clip_disabled_get(void);
 ...
 * @ingroup Elm_Focus
 */
ELEMENTARY_API void elm_config_focus_highlight_clip_disabled_set(Eina_Bool disable);
 ...
 * @ingroup Elm_Focus
 */
ELEMENTARY_API Elm_Focus_Move_Policy elm_config_focus_move_policy_get(void);
 ...
 * @ingroup Elm_Focus
 */
ELEMENTARY_API void elm_config_focus_move_policy_set(Elm_Focus_Move_Policy policy);
 ...
 * @ingroup Elm_Focus
 */
ELEMENTARY_API Eina_Bool elm_config_item_select_on_focus_disabled_get(void);
 ...
 * @ingroup Elm_Focus
 */
ELEMENTARY_API void elm_config_item_select_on_focus_disabled_set(Eina_Bool disabled);
 ...
 * @ingroup Elm_Focus
 */
ELEMENTARY_API Eina_Bool elm_config_first_item_focus_on_first_focusin_get(void);
 ...
 * @ingroup Elm_Focus
 */
ELEMENTARY_API void elm_config_first_item_focus_on_first_focusin_set(Eina_Bool enabled);
 ...
 */
ELEMENTARY_API Eina_Bool elm_config_mirrored_get(void);
 ...
 */
ELEMENTARY_API void      elm_config_mirrored_set(Eina_Bool mirrored);
 ...
 */
ELEMENTARY_API Eina_Bool elm_config_clouseau_enabled_get(void);
 ...
 */
ELEMENTARY_API void      elm_config_clouseau_enabled_set(Eina_Bool enabled);
 ...
 */
ELEMENTARY_API const char *elm_config_indicator_service_get(int rotation);
 ...
 * @since 1.8
 */
ELEMENTARY_API double   elm_config_glayer_long_tap_start_timeout_get(void);
 ...
 * @since 1.8
 */
ELEMENTARY_API void   elm_config_glayer_long_tap_start_timeout_set(double long_tap_timeout);
 ...
 * @since 1.8
 */
ELEMENTARY_API double   elm_config_glayer_double_tap_timeout_get(void);
 ...
 * @since 1.8
 */
ELEMENTARY_API void   elm_config_glayer_double_tap_timeout_set(double double_tap_timeout);
 ...
 */
ELEMENTARY_API Eina_List *elm_config_color_classes_list_get(void);
 ...
 */
ELEMENTARY_API void      elm_config_color_classes_list_free(Eina_List *list);
 ...
 */
ELEMENTARY_API const Eina_List *elm_config_color_overlay_list_get(void);
 ...
 */
ELEMENTARY_API void      elm_config_color_overlay_set(const char *color_class,
 ...
 */
ELEMENTARY_API void      elm_config_color_overlay_unset(const char *color_class);
 ...
 */
ELEMENTARY_API void      elm_config_color_overlay_apply(void);
 ...
 * @since 1.23
 */
ELEMENTARY_API Eina_Bool elm_config_desktop_entry_get(void);
 ...
 * @since 1.23
 */
ELEMENTARY_API void elm_config_desktop_entry_set(Eina_Bool enable);
 ...
 * @since 1.9
 */
ELEMENTARY_API Eina_Bool elm_config_magnifier_enable_get(void);
 ...
 * @since 1.9
 */
ELEMENTARY_API void      elm_config_magnifier_enable_set(Eina_Bool enable);
 ...
 * @since 1.9
 */
ELEMENTARY_API double    elm_config_magnifier_scale_get(void);
 ...
 * @since 1.9
 */
ELEMENTARY_API void      elm_config_magnifier_scale_set(double scale);
 ...
 * @since 1.9
 */
ELEMENTARY_API Eina_Bool elm_config_audio_mute_get(Edje_Channel channel);
 ...
 * @since 1.9
 */
ELEMENTARY_API void      elm_config_audio_mute_set(Edje_Channel channel, Eina_Bool mute);
 ...
 * @since 1.14
 */
ELEMENTARY_API Eina_Bool elm_config_window_auto_focus_enable_get(void);
 ...
 * @since 1.14
 */
ELEMENTARY_API void      elm_config_window_auto_focus_enable_set(Eina_Bool enable);
 ...
 * @since 1.14
 */
ELEMENTARY_API Eina_Bool elm_config_window_auto_focus_animate_get(void);
 ...
 * @since 1.14
 */
ELEMENTARY_API void      elm_config_window_auto_focus_animate_set(Eina_Bool enable);
 ...
 * @since 1.18
 */
ELEMENTARY_API Eina_Bool elm_config_popup_scrollable_get(void);
 ...
 * @since 1.18
 */
ELEMENTARY_API void      elm_config_popup_scrollable_set(Eina_Bool scrollable);
 ...
 */
ELEMENTARY_API Eina_Bool        elm_config_atspi_mode_get(void);
 ...
 */
ELEMENTARY_API void             elm_config_atspi_mode_set(Eina_Bool is_atspi);
 ...
 */
ELEMENTARY_API void elm_config_transition_duration_factor_set(double factor);
 ...
 * @since 1.15
 */
ELEMENTARY_API double elm_config_transition_duration_factor_get(void);
 ...
 */
ELEMENTARY_API void elm_config_web_backend_set(const char *backend);
 ...
 */
ELEMENTARY_API const char *elm_config_web_backend_get(void);
 ...
 */
ELEMENTARY_API Eina_Bool elm_config_offline_get(void);
 ...
 */
ELEMENTARY_API void elm_config_offline_set(Eina_Bool set);
 ...
 */
ELEMENTARY_API int elm_config_powersave_get(void);
 ...
 * @see elm_config_powersave_set()
 */
ELEMENTARY_API void elm_config_powersave_set(int set);
...
/**
  ...
  */
ELEMENTARY_API double elm_config_drag_anim_duration_get(void);
...
/**
  ...
  */
ELEMENTARY_API void elm_config_drag_anim_duration_set(double set);
