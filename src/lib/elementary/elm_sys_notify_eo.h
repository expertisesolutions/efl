 ...
 * @ingroup Elm_Sys_Notify
 */
ELM_API_WEAK Eina_Bool elm_obj_sys_notify_servers_set(Eo *obj, Elm_Sys_Notify_Server servers);
 ...
 * @ingroup Elm_Sys_Notify
 */
ELM_API_WEAK Elm_Sys_Notify_Server elm_obj_sys_notify_servers_get(const Eo *obj);
