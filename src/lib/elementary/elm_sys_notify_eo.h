 ...
 * @ingroup Elm_Sys_Notify
 */
ELM_API Eina_Bool elm_obj_sys_notify_servers_set(Eo *obj, Elm_Sys_Notify_Server servers);
 ...
 * @ingroup Elm_Sys_Notify
 */
ELM_API Elm_Sys_Notify_Server elm_obj_sys_notify_servers_get(const Eo *obj);
