 ...
 */
ELEMENTARY_API void elm_gesture_layer_zoom_step_set(Elm_Gesture_Layer *obj, double step);
 ...
 * @ingroup Elm_Gesture_Layer_Group
 */
ELEMENTARY_API double elm_gesture_layer_zoom_step_get(const Elm_Gesture_Layer *obj);
 ...
 * @ingroup Elm_Gesture_Layer_Group
 */
ELEMENTARY_API void elm_gesture_layer_tap_finger_size_set(Elm_Gesture_Layer *obj, int sz);
 ...
 * @ingroup Elm_Gesture_Layer_Group
 */
ELEMENTARY_API int elm_gesture_layer_tap_finger_size_get(const Elm_Gesture_Layer *obj);
 ...
 * @ingroup Elm_Gesture_Layer_Group
 */
ELEMENTARY_API void elm_gesture_layer_hold_events_set(Elm_Gesture_Layer *obj, Eina_Bool hold_events);
 ...
 * @ingroup Elm_Gesture_Layer_Group
 */
ELEMENTARY_API Eina_Bool elm_gesture_layer_hold_events_get(const Elm_Gesture_Layer *obj);
 ...
 * @ingroup Elm_Gesture_Layer_Group
 */
ELEMENTARY_API void elm_gesture_layer_rotate_step_set(Elm_Gesture_Layer *obj, double step);
 ...
 * @ingroup Elm_Gesture_Layer_Group
 */
ELEMENTARY_API double elm_gesture_layer_rotate_step_get(const Elm_Gesture_Layer *obj);
 ...
 * @ingroup Elm_Gesture_Layer_Group
 */
ELEMENTARY_API void elm_gesture_layer_cb_set(Elm_Gesture_Layer *obj, Elm_Gesture_Type idx, Elm_Gesture_State cb_type, Elm_Gesture_Event_Cb cb, void *data);
 ...
 * @ingroup Elm_Gesture_Layer_Group
 */
ELEMENTARY_API Eina_Bool elm_gesture_layer_attach(Elm_Gesture_Layer *obj, Efl_Canvas_Object *target);
 ...
 * @ingroup Elm_Gesture_Layer_Group
 */
ELEMENTARY_API void elm_gesture_layer_cb_del(Elm_Gesture_Layer *obj, Elm_Gesture_Type idx, Elm_Gesture_State cb_type, Elm_Gesture_Event_Cb cb, void *data);
 ...
 * @ingroup Elm_Gesture_Layer_Group
 */
ELEMENTARY_API void elm_gesture_layer_cb_add(Elm_Gesture_Layer *obj, Elm_Gesture_Type idx, Elm_Gesture_State cb_type, Elm_Gesture_Event_Cb cb, void *data);
