 ...
 * @ingroup Elm_Toolbar
 */
ELEMENTARY_API Evas_Object                 *elm_toolbar_add(Evas_Object *parent);
 ...
 * @ingroup Elm_Toolbar
 */
ELEMENTARY_API void                          elm_toolbar_reorder_mode_set(Evas_Object *obj, Eina_Bool reorder_mode);
 ...
 * @ingroup Elm_Toolbar
 */
ELEMENTARY_API Eina_Bool                     elm_toolbar_reorder_mode_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Toolbar
 */
ELEMENTARY_API void                         elm_toolbar_transverse_expanded_set(Evas_Object *obj, Eina_Bool transverse_expanded);
 ...
 * @ingroup Elm_Toolbar
 */
ELEMENTARY_API Eina_Bool                    elm_toolbar_transverse_expanded_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Toolbar
 */
ELEMENTARY_API void elm_toolbar_icon_order_lookup_set(Evas_Object *obj EINA_UNUSED, Elm_Icon_Lookup_Order order EINA_UNUSED);
 ...
 * @ingroup Elm_Toolbar
 */
ELEMENTARY_API Elm_Icon_Lookup_Order elm_toolbar_icon_order_lookup_get(const Evas_Object *obj EINA_UNUSED);
 ...
 * @ingroup Elm_Toolbar
 */
ELEMENTARY_API void elm_toolbar_horizontal_set(Evas_Object *obj, Eina_Bool horizontal);
 ...
 * @ingroup Elm_Toolbar
 */
ELEMENTARY_API Eina_Bool elm_toolbar_horizontal_get(const Evas_Object *obj);
