 ...
 */
ELEMENTARY_API Efl_Canvas_Object *elm_plug_image_object_get(const Elm_Plug *obj);
 ...
 * @ingroup Elm_Plug_Group
 */
ELEMENTARY_API Eina_Bool elm_plug_connect(Elm_Plug *obj, const char *svcname, int svcnum, Eina_Bool svcsys);
