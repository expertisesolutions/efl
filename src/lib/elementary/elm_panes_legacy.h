 ...
 * @ingroup Elm_Panes
 */
ELEMENTARY_API Evas_Object                 *elm_panes_add(Evas_Object *parent);
 ...
 * @ingroup Elm_Panes
 */
ELEMENTARY_API void elm_panes_horizontal_set(Evas_Object *obj, Eina_Bool horizontal);
 ...
 * @ingroup Elm_Panes
 */
ELEMENTARY_API Eina_Bool elm_panes_horizontal_get(const Evas_Object *obj);
 ...
 */
ELEMENTARY_API void elm_panes_content_left_min_size_set(Evas_Object *obj, int size);
 ...
 * @ingroup Efl_Ui_Panes
 */
ELEMENTARY_API int elm_panes_content_left_min_size_get(const Evas_Object *obj);
 ...
 * @ingroup Efl_Ui_Panes
 */
ELEMENTARY_API void elm_panes_content_right_min_size_set(Evas_Object *obj, int size);
 ...
 * @ingroup Efl_Ui_Panes
 */
ELEMENTARY_API int elm_panes_content_right_min_size_get(const Evas_Object *obj);
 ...
 * @ingroup Efl_Ui_Panes
 */
ELEMENTARY_API void elm_panes_content_right_size_set(Evas_Object *obj, double size);
 ...
 * @ingroup Efl_Ui_Panes
 */
ELEMENTARY_API double elm_panes_content_right_size_get(const Evas_Object *obj);
 ...
 * @ingroup Efl_Ui_Panes
 */
ELEMENTARY_API void elm_panes_content_left_size_set(Evas_Object *obj, double size);
 ...
 * @ingroup Efl_Ui_Panes
 */
ELEMENTARY_API double elm_panes_content_left_size_get(const Evas_Object *obj);
 ...
 * @ingroup Efl_Ui_Panes
 */
ELEMENTARY_API void elm_panes_content_left_min_relative_size_set(Evas_Object *obj, double size);
 ...
 * @ingroup Efl_Ui_Panes
 */
ELEMENTARY_API double elm_panes_content_left_min_relative_size_get(const Evas_Object *obj);
 ...
 * @ingroup Efl_Ui_Panes
 */
ELEMENTARY_API void elm_panes_content_right_min_relative_size_set(Evas_Object *obj, double size);
 ...
 * @ingroup Efl_Ui_Panes
 */
ELEMENTARY_API double elm_panes_content_right_min_relative_size_get(const Evas_Object *obj);
