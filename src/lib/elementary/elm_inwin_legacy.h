 ...
 * @ingroup Elm_Inwin
 */
ELEMENTARY_API Evas_Object *elm_win_inwin_add(Evas_Object *parent);
 ...
 * @ingroup Elm_Inwin
 */
ELEMENTARY_API void         elm_win_inwin_content_set(Evas_Object *obj, Evas_Object *content);
 ...
 * @ingroup Elm_Inwin
 */
ELEMENTARY_API Evas_Object *elm_win_inwin_content_get(const Evas_Object *obj);
 ...
 * @ingroup Elm_Inwin
 */
ELEMENTARY_API Evas_Object *elm_win_inwin_content_unset(Evas_Object *obj);
