 ...
 * @ingroup Elm_Interface_Fileselector
 */
ELM_API_WEAK void elm_interface_fileselector_folder_only_set(Eo *obj, Eina_Bool only);
 ...
 * @ingroup Elm_Interface_Fileselector
 */
ELM_API_WEAK Eina_Bool elm_interface_fileselector_folder_only_get(const Eo *obj);
 ...
 * @ingroup Elm_Interface_Fileselector
 */
ELM_API_WEAK void elm_interface_fileselector_thumbnail_size_set(Eo *obj, int w, int h);
 ...
 * @ingroup Elm_Interface_Fileselector
 */
ELM_API_WEAK void elm_interface_fileselector_thumbnail_size_get(const Eo *obj, int *w, int *h);
 ...
 * @ingroup Elm_Interface_Fileselector
 */
ELM_API_WEAK void elm_interface_fileselector_hidden_visible_set(Eo *obj, Eina_Bool hidden);
 ...
 * @ingroup Elm_Interface_Fileselector
 */
ELM_API_WEAK Eina_Bool elm_interface_fileselector_hidden_visible_get(const Eo *obj);
 ...
 * @ingroup Elm_Interface_Fileselector
 */
ELM_API_WEAK void elm_interface_fileselector_sort_method_set(Eo *obj, Elm_Fileselector_Sort sort);
 ...
 * @ingroup Elm_Interface_Fileselector
 */
ELM_API_WEAK Elm_Fileselector_Sort elm_interface_fileselector_sort_method_get(const Eo *obj);
 ...
 * @ingroup Elm_Interface_Fileselector
 */
ELM_API_WEAK void elm_interface_fileselector_multi_select_set(Eo *obj, Eina_Bool multi);
 ...
 * @ingroup Elm_Interface_Fileselector
 */
ELM_API_WEAK Eina_Bool elm_interface_fileselector_multi_select_get(const Eo *obj);
 ...
 * @ingroup Elm_Interface_Fileselector
 */
ELM_API_WEAK void elm_interface_fileselector_expandable_set(Eo *obj, Eina_Bool expand);
 ...
 * @ingroup Elm_Interface_Fileselector
 */
ELM_API_WEAK Eina_Bool elm_interface_fileselector_expandable_get(const Eo *obj);
 ...
 * @ingroup Elm_Interface_Fileselector
 */
ELM_API_WEAK void elm_interface_fileselector_mode_set(Eo *obj, Elm_Fileselector_Mode mode);
 ...
 * @ingroup Elm_Interface_Fileselector
 */
ELM_API_WEAK Elm_Fileselector_Mode elm_interface_fileselector_mode_get(const Eo *obj);
 ...
 * @ingroup Elm_Interface_Fileselector
 */
ELM_API_WEAK void elm_interface_fileselector_is_save_set(Eo *obj, Eina_Bool is_save);
 ...
 * @ingroup Elm_Interface_Fileselector
 */
ELM_API_WEAK Eina_Bool elm_interface_fileselector_is_save_get(const Eo *obj);
 ...
 * @ingroup Elm_Interface_Fileselector
 */
ELM_API_WEAK const Eina_List *elm_interface_fileselector_selected_models_get(const Eo *obj);
 ...
 * @ingroup Elm_Interface_Fileselector
 */
ELM_API_WEAK void elm_interface_fileselector_current_name_set(Eo *obj, const char *name);
 ...
 * @ingroup Elm_Interface_Fileselector
 */
ELM_API_WEAK const char *elm_interface_fileselector_current_name_get(const Eo *obj);
 ...
 * @ingroup Elm_Interface_Fileselector
 */
ELM_API_WEAK Eina_Bool elm_interface_fileselector_selected_model_set(Eo *obj, Efl_Io_Model *model);
 ...
 * @ingroup Elm_Interface_Fileselector
 */
ELM_API_WEAK Efl_Io_Model *elm_interface_fileselector_selected_model_get(const Eo *obj);
#endif /* EFL_BETA_API_SUPPORT */
 ...
 * @ingroup Elm_Interface_Fileselector
 */
ELM_API_WEAK Eina_Bool elm_interface_fileselector_custom_filter_append(Eo *obj, Elm_Fileselector_Filter_Func func, void *data, const char *filter_name);

/** Clear all filters registered
 *
 * @ingroup Elm_Interface_Fileselector
 */
ELM_API_WEAK void elm_interface_fileselector_filters_clear(Eo *obj);
 ...
 * @ingroup Elm_Interface_Fileselector
 */
ELM_API_WEAK Eina_Bool elm_interface_fileselector_mime_types_filter_append(Eo *obj, const char *mime_types, const char *filter_name);
