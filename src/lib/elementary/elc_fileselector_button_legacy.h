 ...
 */
ELEMENTARY_API Evas_Object                *elm_fileselector_button_add(Evas_Object *parent);
 ...
 */
ELEMENTARY_API void elm_fileselector_button_inwin_mode_set(Elm_Fileselector_Button *obj, Eina_Bool value);
 ...
 * @ingroup Elm_Fileselector_Button
 */
ELEMENTARY_API Eina_Bool elm_fileselector_button_inwin_mode_get(const Elm_Fileselector_Button *obj);
 ...
 * @ingroup Elm_Fileselector_Button
 */
ELEMENTARY_API void elm_fileselector_button_window_size_set(Elm_Fileselector_Button *obj, Evas_Coord width, Evas_Coord height);
 ...
 * @ingroup Elm_Fileselector_Button
 */
ELEMENTARY_API void elm_fileselector_button_window_size_get(const Elm_Fileselector_Button *obj, Evas_Coord *width, Evas_Coord *height);
 ...
 * @ingroup Elm_Fileselector_Button
 */
ELEMENTARY_API void elm_fileselector_button_window_title_set(Elm_Fileselector_Button *obj, const char *title);
 ...
 * @ingroup Elm_Fileselector_Button
 */
ELEMENTARY_API const char *elm_fileselector_button_window_title_get(const Elm_Fileselector_Button *obj);
