...
ELM_API_WEAK const Efl_Class *elm_fileselector_button_class_get(void);

ELM_API_WEAK extern const Efl_Event_Description _ELM_FILESELECTOR_BUTTON_EVENT_FILE_CHOSEN;
