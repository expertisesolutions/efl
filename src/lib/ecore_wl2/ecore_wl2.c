...
int ECORE_WL2_EVENT_CONNECT = 0;
int ECORE_WL2_EVENT_DISCONNECT = 0;
int ECORE_WL2_EVENT_GLOBAL_ADDED = 0;
int ECORE_WL2_EVENT_GLOBAL_REMOVED = 0;
int ECORE_WL2_EVENT_FOCUS_IN = 0;
int ECORE_WL2_EVENT_FOCUS_OUT = 0;
int ECORE_WL2_EVENT_DND_ENTER = 0;
int ECORE_WL2_EVENT_DND_LEAVE = 0;
int ECORE_WL2_EVENT_DND_MOTION = 0;
int ECORE_WL2_EVENT_DND_DROP = 0;
int ECORE_WL2_EVENT_DND_END = 0;
int ECORE_WL2_EVENT_DATA_SOURCE_END = 0;
int ECORE_WL2_EVENT_DATA_SOURCE_DROP = 0;
int ECORE_WL2_EVENT_DATA_SOURCE_ACTION = 0;
int ECORE_WL2_EVENT_DATA_SOURCE_TARGET = 0;
int ECORE_WL2_EVENT_DATA_SOURCE_SEND = 0;
int ECORE_WL2_EVENT_WINDOW_CONFIGURE = 0;
int ECORE_WL2_EVENT_SYNC_DONE = 0;
int ECORE_WL2_EVENT_OFFER_DATA_READY = 0;
int ECORE_WL2_EVENT_SEAT_NAME_CHANGED = 0;
int ECORE_WL2_EVENT_SEAT_CAPABILITIES_CHANGED = 0;
int ECORE_WL2_EVENT_DEVICE_ADDED = 0;
int ECORE_WL2_EVENT_DEVICE_REMOVED = 0;
int ECORE_WL2_EVENT_WINDOW_CONFIGURE_COMPLETE = 0;
int ECORE_WL2_EVENT_SEAT_KEYMAP_CHANGED = 0;
int ECORE_WL2_EVENT_SEAT_KEYBOARD_REPEAT_CHANGED = 0;
int ECORE_WL2_EVENT_SEAT_SELECTION = 0;
int ECORE_WL2_EVENT_OUTPUT_TRANSFORM = 0;
int ECORE_WL2_EVENT_WINDOW_ROTATE = 0;
int ECORE_WL2_EVENT_WINDOW_ROTATION_CHANGE_PREPARE = 0;
int ECORE_WL2_EVENT_WINDOW_ROTATION_CHANGE_PREPARE_DONE = 0;
int ECORE_WL2_EVENT_WINDOW_ROTATION_CHANGE_REQUEST = 0;
int ECORE_WL2_EVENT_WINDOW_ROTATION_CHANGE_DONE = 0;
int ECORE_WL2_EVENT_AUX_HINT_ALLOWED = 0;
int ECORE_WL2_EVENT_AUX_HINT_SUPPORTED = 0;
int ECORE_WL2_EVENT_AUX_MESSAGE = 0;
int ECORE_WL2_EVENT_WINDOW_SHOW = 0;
int ECORE_WL2_EVENT_WINDOW_HIDE = 0;
int ECORE_WL2_EVENT_WINDOW_ACTIVATE = 0;
int ECORE_WL2_EVENT_WINDOW_DEACTIVATE = 0;
int ECORE_WL2_EVENT_WINDOW_ICONIFY_STATE_CHANGE = 0;
int ECORE_WL2_EVENT_WINDOW_OFFSCREEN = 0;

int _ecore_wl2_event_window_www = -1;
int _ecore_wl2_event_window_www_drag = -1;
