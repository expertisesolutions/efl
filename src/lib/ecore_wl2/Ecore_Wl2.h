...
EAPI EFL_EXTERN int ECORE_WL2_EVENT_DISCONNECT; /** @since 1.18 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_CONNECT; /** @since 1.18 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_GLOBAL_ADDED; /** @since 1.17 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_GLOBAL_REMOVED; /** @since 1.17 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_FOCUS_IN; /** @since 1.17 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_FOCUS_OUT; /** @since 1.17 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_DND_ENTER; /** @since 1.17 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_DND_LEAVE; /** @since 1.17 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_DND_MOTION; /** @since 1.17 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_DND_DROP; /** @since 1.17 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_DND_END; /** @since 1.17 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_DATA_SOURCE_END; /** @since 1.18 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_DATA_SOURCE_DROP; /** @since 1.18 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_DATA_SOURCE_ACTION; /** @since 1.18 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_DATA_SOURCE_TARGET; /** @since 1.17 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_DATA_SOURCE_SEND; /** @since 1.17 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_WINDOW_CONFIGURE; /** @since 1.17 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_SYNC_DONE; /** @since 1.17 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_OFFER_DATA_READY; /** @since 1.19 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_SEAT_NAME_CHANGED; /** @since 1.19 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_SEAT_CAPABILITIES_CHANGED; /** @since 1.19 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_DEVICE_ADDED; /** @since 1.19 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_DEVICE_REMOVED; /** @since 1.19 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_WINDOW_CONFIGURE_COMPLETE; /** @since 1.19 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_SEAT_KEYMAP_CHANGED; /** @since 1.20 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_SEAT_KEYBOARD_REPEAT_CHANGED; /** @since 1.20 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_SEAT_SELECTION; /** @since 1.20 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_OUTPUT_TRANSFORM; /** @since 1.20 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_WINDOW_ROTATE; /** @since 1.20 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_AUX_HINT_ALLOWED; /** @since 1.20 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_AUX_HINT_SUPPORTED; /** @since 1.20 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_AUX_MESSAGE; /** @since 1.20 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_WINDOW_SHOW; /** @since 1.20 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_WINDOW_HIDE; /** @since 1.20 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_WINDOW_ACTIVATE; /** @since 1.20 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_WINDOW_DEACTIVATE; /** @since 1.20 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_WINDOW_ICONIFY_STATE_CHANGE; /** @since 1.21 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_WINDOW_OFFSCREEN; /** @since 1.21 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_WINDOW_CREATE; /** @since 1.25 */
EAPI EFL_EXTERN int ECORE_WL2_EVENT_WINDOW_DESTROY; /** @since 1.25 */
