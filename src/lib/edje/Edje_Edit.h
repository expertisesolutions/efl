...
EAPI EFL_EXTERN Eina_Error EDJE_EDIT_ERROR_GROUP_CURRENTLY_USED;
EAPI EFL_EXTERN Eina_Error EDJE_EDIT_ERROR_GROUP_REFERENCED;
EAPI EFL_EXTERN Eina_Error EDJE_EDIT_ERROR_GROUP_DOES_NOT_EXIST;
