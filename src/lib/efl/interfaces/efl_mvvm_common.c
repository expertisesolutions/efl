...
Eina_Error EFL_MODEL_ERROR_UNKNOWN = 0;
Eina_Error EFL_MODEL_ERROR_NOT_SUPPORTED = 0;
Eina_Error EFL_MODEL_ERROR_NOT_FOUND = 0;
Eina_Error EFL_MODEL_ERROR_READ_ONLY = 0;
Eina_Error EFL_MODEL_ERROR_INIT_FAILED = 0;
Eina_Error EFL_MODEL_ERROR_PERMISSION_DENIED = 0;
Eina_Error EFL_MODEL_ERROR_INCORRECT_VALUE = 0;
Eina_Error EFL_MODEL_ERROR_INVALID_OBJECT = 0;

Eina_Error EFL_FACTORY_ERROR_NOT_SUPPORTED = 0;
Eina_Error EFL_PROPERTY_ERROR_INVALID_KEY = 0;
