...
int ECORE_IMF_EVENT_PREEDIT_START = 0;
int ECORE_IMF_EVENT_PREEDIT_END = 0;
int ECORE_IMF_EVENT_PREEDIT_CHANGED = 0;
int ECORE_IMF_EVENT_COMMIT = 0;
int ECORE_IMF_EVENT_DELETE_SURROUNDING = 0;
