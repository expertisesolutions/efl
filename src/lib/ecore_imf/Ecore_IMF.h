...
EAPI EFL_EXTERN int ECORE_IMF_EVENT_PREEDIT_START;
EAPI EFL_EXTERN int ECORE_IMF_EVENT_PREEDIT_END;
EAPI EFL_EXTERN int ECORE_IMF_EVENT_PREEDIT_CHANGED;
EAPI EFL_EXTERN int ECORE_IMF_EVENT_COMMIT;
EAPI EFL_EXTERN int ECORE_IMF_EVENT_DELETE_SURROUNDING;
