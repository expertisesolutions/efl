...
EWAPI EFL_EXTERN const Efl_Event_Description _EVAS_CANVAS_EVENT_RENDER_FLUSH_PRE;
#define EVAS_CANVAS_EVENT_RENDER_FLUSH_PRE (&(_EVAS_CANVAS_EVENT_RENDER_FLUSH_PRE))

EWAPI EFL_EXTERN const Efl_Event_Description _EVAS_CANVAS_EVENT_RENDER_FLUSH_POST;
#define EVAS_CANVAS_EVENT_RENDER_FLUSH_POST (&(_EVAS_CANVAS_EVENT_RENDER_FLUSH_POST))

EWAPI EFL_EXTERN const Efl_Event_Description _EVAS_CANVAS_EVENT_AXIS_UPDATE;
#define EVAS_CANVAS_EVENT_AXIS_UPDATE (&(_EVAS_CANVAS_EVENT_AXIS_UPDATE))

EWAPI EFL_EXTERN const Efl_Event_Description _EVAS_CANVAS_EVENT_VIEWPORT_RESIZE;
...
EWAPI EFL_EXTERN const Efl_Event_Description _EFL_ANIMATION_PLAYER_EVENT_PRE_STARTED;
