 ...
 * @ingroup Evas_Box
 */
EVAS_API void evas_obj_box_align_set(Eo *obj, double horizontal, double vertical);
 ...
 * @ingroup Evas_Box
 */
EVAS_API void evas_obj_box_align_get(const Eo *obj, double *horizontal, double *vertical);
 ...
 * @ingroup Evas_Box
 */
EVAS_API void evas_obj_box_padding_set(Eo *obj, int horizontal, int vertical);
 ...
 * @ingroup Evas_Box
 */
EVAS_API void evas_obj_box_padding_get(const Eo *obj, int *horizontal, int *vertical);
 ...
 * @ingroup Evas_Box
 */
EVAS_API void evas_obj_box_layout_set(Eo *obj, Evas_Object_Box_Layout cb, const void *data, Eina_Free_Cb free_data) EINA_ARG_NONNULL(2);
 ...
 * @ingroup Evas_Box
 */
EVAS_API void evas_obj_box_layout_horizontal(Eo *obj, Evas_Object_Box_Data *priv, void *data);
 ...
 * @ingroup Evas_Box
 */
EVAS_API void evas_obj_box_layout_vertical(Eo *obj, Evas_Object_Box_Data *priv, void *data);
 ...
 * @ingroup Evas_Box
 */
EVAS_API Efl_Canvas_Object *evas_obj_box_internal_remove(Eo *obj, Efl_Canvas_Object *child);
 ...
 * @ingroup Evas_Box
 */
EVAS_API void evas_obj_box_internal_option_free(Eo *obj, Evas_Object_Box_Option *opt);
 ...
 * @ingroup Evas_Box
 */
EVAS_API Evas_Object_Box_Option *evas_obj_box_insert_after(Eo *obj, Efl_Canvas_Object *child, const Efl_Canvas_Object *reference) EINA_ARG_NONNULL(2, 3);
 ...
 * @ingroup Evas_Box
 */
EVAS_API Eina_Bool evas_obj_box_remove_all(Eo *obj, Eina_Bool clear);
 ...
 * @ingroup Evas_Box
 */
EVAS_API Eina_Iterator *evas_obj_box_iterator_new(const Eo *obj) EINA_WARN_UNUSED_RESULT;
 ...
 * @ingroup Evas_Box
 */
EVAS_API Efl_Canvas_Object *evas_obj_box_add_to(Eo *obj) EINA_WARN_UNUSED_RESULT;
 ...
 * @ingroup Evas_Box
 */
EVAS_API Evas_Object_Box_Option *evas_obj_box_append(Eo *obj, Efl_Canvas_Object *child) EINA_ARG_NONNULL(2);
 ...
 * @ingroup Evas_Box
 */
EVAS_API int evas_obj_box_option_property_id_get(const Eo *obj, const char *name) EINA_WARN_UNUSED_RESULT EINA_ARG_NONNULL(2);
 ...
 * @ingroup Evas_Box
 */
EVAS_API Evas_Object_Box_Option *evas_obj_box_prepend(Eo *obj, Efl_Canvas_Object *child) EINA_ARG_NONNULL(2);
 ...
 * @ingroup Evas_Box
 */
EVAS_API Evas_Object_Box_Option *evas_obj_box_internal_append(Eo *obj, Efl_Canvas_Object *child);
 ...
 * @ingroup Evas_Box
 */
EVAS_API Efl_Canvas_Object *evas_obj_box_internal_remove_at(Eo *obj, unsigned int pos);
 ...
 * @ingroup Evas_Box
 */
EVAS_API Eina_Bool evas_obj_box_remove_at(Eo *obj, unsigned int pos);
 ...
 * @ingroup Evas_Box
 */
EVAS_API Evas_Object_Box_Option *evas_obj_box_internal_insert_at(Eo *obj, Efl_Canvas_Object *child, unsigned int pos);
 ...
 * @ingroup Evas_Box
 */
EVAS_API Evas_Object_Box_Option *evas_obj_box_insert_before(Eo *obj, Efl_Canvas_Object *child, const Efl_Canvas_Object *reference) EINA_ARG_NONNULL(2, 3);
 ...
 * @ingroup Evas_Box
 */
EVAS_API Evas_Object_Box_Option *evas_obj_box_internal_insert_before(Eo *obj, Efl_Canvas_Object *child, const Efl_Canvas_Object *reference);
 ...
 * @ingroup Evas_Box
 */
EVAS_API Evas_Object_Box_Option *evas_obj_box_internal_option_new(Eo *obj, Efl_Canvas_Object *child);
 ...
 * @ingroup Evas_Box
 */
EVAS_API Evas_Object_Box_Option *evas_obj_box_internal_insert_after(Eo *obj, Efl_Canvas_Object *child, const Efl_Canvas_Object *reference);
 ...
 * @ingroup Evas_Box
 */
EVAS_API Evas_Object_Box_Option *evas_obj_box_internal_prepend(Eo *obj, Efl_Canvas_Object *child);
 ...
 * @ingroup Evas_Box
 */
EVAS_API Eina_Bool evas_obj_box_remove(Eo *obj, Efl_Canvas_Object *child) EINA_ARG_NONNULL(2);
 ...
 * @ingroup Evas_Box
 */
EVAS_API void evas_obj_box_layout_stack(Eo *obj, Evas_Object_Box_Data *priv, void *data);
 ...
 * @ingroup Evas_Box
 */
EVAS_API void evas_obj_box_layout_homogeneous_vertical(Eo *obj, Evas_Object_Box_Data *priv, void *data);
 ...
 * @ingroup Evas_Box
 */
EVAS_API void evas_obj_box_layout_flow_horizontal(Eo *obj, Evas_Object_Box_Data *priv, void *data);
