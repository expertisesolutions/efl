...
EVAS_API EVAS_WEAK_API const Efl_Class *evas_text_class_get(void);
 ...
 * @ingroup Evas_Text
 */
EVAS_API void evas_obj_text_shadow_color_set(Eo *obj, int r, int g, int b, int a);
 ...
 * @ingroup Evas_Text
 */
EVAS_API void evas_obj_text_shadow_color_get(const Eo *obj, int *r, int *g, int *b, int *a);
 ...
 * @ingroup Evas_Text
 */
EVAS_API void evas_obj_text_ellipsis_set(Eo *obj, double ellipsis);
 ...
 * @ingroup Evas_Text
 */
EVAS_API double evas_obj_text_ellipsis_get(const Eo *obj);
 ...
 * @ingroup Evas_Text
 */
EVAS_API void evas_obj_text_bidi_delimiters_set(Eo *obj, const char *delim);
 ...
 * @ingroup Evas_Text
 */
EVAS_API const char *evas_obj_text_bidi_delimiters_get(const Eo *obj);
 ...
 * @ingroup Evas_Text
 */
EVAS_API void evas_obj_text_outline_color_set(Eo *obj, int r, int g, int b, int a);
 ...
 * @ingroup Evas_Text
 */
EVAS_API void evas_obj_text_outline_color_get(const Eo *obj, int *r, int *g, int *b, int *a);
 ...
 * @ingroup Evas_Text
 */
EVAS_API void evas_obj_text_glow2_color_set(Eo *obj, int r, int g, int b, int a);
 ...
 * @ingroup Evas_Text
 */
EVAS_API void evas_obj_text_glow2_color_get(const Eo *obj, int *r, int *g, int *b, int *a);
 ...
 * @ingroup Evas_Text
 */
EVAS_API void evas_obj_text_style_set(Eo *obj, Evas_Text_Style_Type style);
 ...
 * @ingroup Evas_Text
 */
EVAS_API Evas_Text_Style_Type evas_obj_text_style_get(const Eo *obj);
 ...
 * @ingroup Evas_Text
 */
EVAS_API void evas_obj_text_glow_color_set(Eo *obj, int r, int g, int b, int a);
 ...
 * @ingroup Evas_Text
 */
EVAS_API void evas_obj_text_glow_color_get(const Eo *obj, int *r, int *g, int *b, int *a);
 ...
 * @ingroup Evas_Text
 */
EVAS_API int evas_obj_text_max_descent_get(const Eo *obj);
 ...
 * @ingroup Evas_Text
 */
EVAS_API void evas_obj_text_style_pad_get(const Eo *obj, int *l, int *r, int *t, int *b);
 ...
 * @ingroup Evas_Text
 */
EVAS_API Efl_Text_Bidirectional_Type evas_obj_text_direction_get(const Eo *obj);
 ...
 * @ingroup Evas_Text
 */
EVAS_API int evas_obj_text_ascent_get(const Eo *obj);
 ...
 * @ingroup Evas_Text
 */
EVAS_API int evas_obj_text_horiz_advance_get(const Eo *obj);
 ...
 * @ingroup Evas_Text
 */
EVAS_API int evas_obj_text_inset_get(const Eo *obj);
 ...
 * @ingroup Evas_Text
 */
EVAS_API int evas_obj_text_max_ascent_get(const Eo *obj);
 ...
 * @ingroup Evas_Text
 */
EVAS_API int evas_obj_text_vert_advance_get(const Eo *obj);
 ...
 * @ingroup Evas_Text
 */
EVAS_API int evas_obj_text_descent_get(const Eo *obj);
 ...
 * @ingroup Evas_Text
 */
EVAS_API int evas_obj_text_last_up_to_pos(const Eo *obj, int x, int y);
 ...
 * @ingroup Evas_Text
 */
EVAS_API int evas_obj_text_char_coords_get(const Eo *obj, int x, int y, int *cx, int *cy, int *cw, int *ch);
 ...
 * @ingroup Evas_Text
 */
EVAS_API Eina_Bool evas_obj_text_char_pos_get(const Eo *obj, int pos, int *cx, int *cy, int *cw, int *ch);
