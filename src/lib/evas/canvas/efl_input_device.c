...
EVAS_API EFL_FUNC_BODY_CONST(efl_input_device_children_get, const Eina_List *, NULL);
...
EVAS_API EFL_FUNC_BODY_CONST(efl_input_device_evas_get, Evas *, NULL);
...
EVAS_API EFL_VOID_FUNC_BODYV(efl_input_device_evas_set, EFL_FUNC_CALL(e), Evas *e);
...
EVAS_API EFL_FUNC_BODY_CONST(efl_input_device_subclass_get, Evas_Device_Subclass, 0);
...
EVAS_API EFL_VOID_FUNC_BODYV(efl_input_device_subclass_set, EFL_FUNC_CALL(sub_clas), Evas_Device_Subclass sub_clas);
...
EVAS_API EFL_VOID_FUNC_BODYV(efl_input_device_grab_register, EFL_FUNC_CALL(grab, pdata),
                          Efl_Canvas_Object *grab, Evas_Object_Pointer_Data *pdata);
...
EVAS_API EFL_VOID_FUNC_BODYV(efl_input_device_grab_unregister, EFL_FUNC_CALL(grab, pdata),
                          Efl_Canvas_Object *grab, Evas_Object_Pointer_Data *pdata);
