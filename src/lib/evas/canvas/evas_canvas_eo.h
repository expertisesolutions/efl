 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_image_cache_set(Eo *obj, int size);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API int evas_canvas_image_cache_get(const Eo *obj);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_event_default_flags_set(Eo *obj, Evas_Event_Flags flags);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API Evas_Event_Flags evas_canvas_event_default_flags_get(const Eo *obj);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_font_cache_set(Eo *obj, int size);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API int evas_canvas_font_cache_get(const Eo *obj);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_data_attach_set(Eo *obj, void *data);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void *evas_canvas_data_attach_get(const Eo *obj);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API Efl_Canvas_Object *evas_canvas_focus_get(const Eo *obj) EINA_WARN_UNUSED_RESULT;
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API Efl_Canvas_Object *evas_canvas_seat_focus_get(const Eo *obj, Evas_Device *seat);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API Efl_Canvas_Object *evas_canvas_object_top_get(const Eo *obj) EINA_WARN_UNUSED_RESULT;
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_pointer_canvas_xy_by_device_get(const Eo *obj, Evas_Device *dev, int *x, int *y);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_pointer_canvas_xy_get(const Eo *obj, int *x, int *y);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API int evas_canvas_event_down_count_get(const Eo *obj);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API int evas_canvas_smart_objects_calculate_count_get(const Eo *obj);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API Eina_Bool evas_canvas_focus_state_get(const Eo *obj);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API Eina_Bool evas_canvas_seat_focus_state_get(const Eo *obj, Evas_Device *seat);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API Eina_Bool evas_canvas_changed_get(const Eo *obj);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_pointer_output_xy_by_device_get(const Eo *obj, Evas_Device *dev, int *x, int *y);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_pointer_output_xy_get(const Eo *obj, int *x, int *y);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API Efl_Canvas_Object *evas_canvas_object_bottom_get(const Eo *obj) EINA_WARN_UNUSED_RESULT;
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API unsigned int evas_canvas_pointer_button_down_mask_by_device_get(const Eo *obj, Evas_Device *dev);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API unsigned int evas_canvas_pointer_button_down_mask_get(const Eo *obj) EINA_WARN_UNUSED_RESULT;
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API Eina_List *evas_canvas_tree_objects_at_xy_get(Eo *obj, Efl_Canvas_Object *stop, int x, int y) EINA_WARN_UNUSED_RESULT;
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_key_lock_on(Eo *obj, const char *keyname) EINA_ARG_NONNULL(2);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_seat_key_lock_on(Eo *obj, const char *keyname, Evas_Device *seat) EINA_ARG_NONNULL(2);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_seat_key_lock_off(Eo *obj, const char *keyname, Evas_Device *seat) EINA_ARG_NONNULL(2);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_key_modifier_add(Eo *obj, const char *keyname) EINA_ARG_NONNULL(2);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_key_modifier_off(Eo *obj, const char *keyname) EINA_ARG_NONNULL(2);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API Eina_Bool evas_canvas_render_async(Eo *obj);

/** Inform the evas that it lost the focus from the default seat.
 *
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_focus_out(Eo *obj);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_norender(Eo *obj);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_nochange_pop(Eo *obj);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_key_lock_off(Eo *obj, const char *keyname) EINA_ARG_NONNULL(2);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_nochange_push(Eo *obj);

/** Force the given evas and associated engine to flush its font cache.
 *
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_font_cache_flush(Eo *obj);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_key_modifier_on(Eo *obj, const char *keyname) EINA_ARG_NONNULL(2);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_seat_key_modifier_on(Eo *obj, const char *keyname, Evas_Device *seat) EINA_ARG_NONNULL(2);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_seat_key_modifier_off(Eo *obj, const char *keyname, Evas_Device *seat) EINA_ARG_NONNULL(2);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API Eina_List *evas_canvas_font_available_list(const Eo *obj) EINA_WARN_UNUSED_RESULT;
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API Efl_Canvas_Object *evas_canvas_object_name_find(const Eo *obj, const char *name) EINA_WARN_UNUSED_RESULT;
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_font_path_append(Eo *obj, const char *path) EINA_ARG_NONNULL(2);

/** Removes all font paths loaded into memory for the given evas.
 *
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_font_path_clear(Eo *obj);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_key_lock_del(Eo *obj, const char *keyname) EINA_ARG_NONNULL(2);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_damage_rectangle_add(Eo *obj, int x, int y, int w, int h);

/** Sync evas canvas
 *
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_sync(Eo *obj);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API const Eina_List *evas_canvas_font_path_list(const Eo *obj) EINA_WARN_UNUSED_RESULT;
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_image_cache_reload(Eo *obj);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API int evas_canvas_coord_world_x_to_screen(const Eo *obj, int x) EINA_WARN_UNUSED_RESULT;
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API Eina_List *evas_canvas_render_updates(Eo *obj) EINA_WARN_UNUSED_RESULT;
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_image_cache_flush(Eo *obj);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API int evas_canvas_coord_screen_y_to_world(const Eo *obj, int y) EINA_WARN_UNUSED_RESULT;
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_key_modifier_del(Eo *obj, const char *keyname) EINA_ARG_NONNULL(2);

/** Inform to the evas that it got the focus from the default seat.
 *
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_focus_in(Eo *obj);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_seat_focus_in(Eo *obj, Evas_Device *seat);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_seat_focus_out(Eo *obj, Evas_Device *seat);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_obscured_rectangle_add(Eo *obj, int x, int y, int w, int h);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_render_dump(Eo *obj);

/** Force renderization of the given canvas.
 *
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_render(Eo *obj);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_font_path_prepend(Eo *obj, const char *path) EINA_ARG_NONNULL(2);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_obscured_clear(Eo *obj);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API int evas_canvas_coord_screen_x_to_world(const Eo *obj, int x) EINA_WARN_UNUSED_RESULT;
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_key_lock_add(Eo *obj, const char *keyname) EINA_ARG_NONNULL(2);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API void evas_canvas_render_idle_flush(Eo *obj);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API Evas_Device *evas_canvas_default_device_get(const Eo *obj, Evas_Device_Class type);
 ...
 * @ingroup Evas_Canvas
 */
EVAS_API int evas_canvas_coord_world_y_to_screen(const Eo *obj, int y) EINA_WARN_UNUSED_RESULT;
