...
EVAS_API EVAS_WEAK_API const Efl_Event_Description _EFL_GFX_ENTITY_EVENT_SHOW =
   EFL_EVENT_DESCRIPTION("show");
EVAS_API EVAS_WEAK_API const Efl_Event_Description _EFL_GFX_ENTITY_EVENT_HIDE =
   EFL_EVENT_DESCRIPTION("hide");
EVAS_API EVAS_WEAK_API const Efl_Event_Description _EFL_GFX_ENTITY_EVENT_IMAGE_PRELOAD =
   EFL_EVENT_DESCRIPTION("preload");
EVAS_API EVAS_WEAK_API const Efl_Event_Description _EFL_GFX_ENTITY_EVENT_IMAGE_UNLOAD =
