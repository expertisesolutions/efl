...
EAPI EFL_EXTERN int ECORE_SDL_EVENT_GOT_FOCUS;
EAPI EFL_EXTERN int ECORE_SDL_EVENT_LOST_FOCUS;
EAPI EFL_EXTERN int ECORE_SDL_EVENT_RESIZE;
EAPI EFL_EXTERN int ECORE_SDL_EVENT_EXPOSE;
