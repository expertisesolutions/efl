...
#define EFL_EINA_BOOST_PLATFORM "Mac OS"
...
#  if !defined(EFL_EINA_BOOST_HAS_PTHREADS)
// MPTasks support is deprecated/removed from Boost:
//#    define EFL_EINA_BOOST_HAS_MPTASKS
...
#ifdef EFL_EINA_BOOST_HAS_PTHREADS
#  define EFL_EINA_BOOST_HAS_THREADS
#endif

// The remote call manager depends on this.
#    define EFL_EINA_BOOST_BIND_ENABLE_PASCAL
