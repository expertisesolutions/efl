...
#if !__has_feature(cxx_exceptions) && !defined(EFL_EINA_BOOST_NO_EXCEPTIONS)
#  define EFL_EINA_BOOST_NO_EXCEPTIONS
#endif

#if !__has_feature(cxx_rtti) && !defined(EFL_EINA_BOOST_NO_RTTI)
#  define EFL_EINA_BOOST_NO_RTTI
#endif

#if !__has_feature(cxx_rtti) && !defined(EFL_EINA_BOOST_NO_TYPEID)
...
//
// The EFL_EINA_BOOST_FALLTHROUGH macro can be used to annotate implicit fall-through
// between switch labels.
//
#if __cplusplus >= 201103L && defined(__has_warning)
#  if __has_feature(cxx_attributes) && __has_warning("-Wimplicit-fallthrough")
#    define EFL_EINA_BOOST_FALLTHROUGH [[clang::fallthrough]]
#  endif
#endif
...
#  define EFL_EINA_BOOST_COMPILER "Clang version " __clang_version__
#endif

// Macro used to identify the Clang compiler.
#define EFL_EINA_BOOST_CLANG 1
