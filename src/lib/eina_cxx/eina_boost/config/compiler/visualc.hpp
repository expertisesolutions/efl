...
//
// Helper macro EFL_EINA_BOOST_MSVC_FULL_VER for use in Boost code:
//
#if _MSC_FULL_VER > 100000000
#  define EFL_EINA_BOOST_MSVC_FULL_VER _MSC_FULL_VER
#else
#  define EFL_EINA_BOOST_MSVC_FULL_VER (_MSC_FULL_VER * 10)
#endif
...
#  define EFL_EINA_BOOST_NO_MEMBER_TEMPLATE_FRIENDS
   ...
   // A bug in VC9:
#  define EFL_EINA_BOOST_NO_ADL_BARRIER
#endif
...
#if !defined(_WIN32_WCE) && !defined(UNDER_CE)
#  define EFL_EINA_BOOST_HAS_THREADEX
...
// turned off:
//
#if !defined(_MSC_EXTENSIONS) && !defined(EFL_EINA_BOOST_DISABLE_WIN32)
#  define EFL_EINA_BOOST_DISABLE_WIN32
#endif
#if !defined(_CPPRTTI) && !defined(EFL_EINA_BOOST_NO_RTTI)
...
//
#if _MSC_VER >= 1700
// # define EFL_EINA_BOOST_HAS_TR1_HASH			// don't know if this is true yet.
// # define EFL_EINA_BOOST_HAS_TR1_TYPE_TRAITS	// don't know if this is true yet.
...
#  define EFL_EINA_BOOST_ABI_PREFIX "eina_boost/config/abi/msvc_prefix.hpp"
#endif
#ifndef EFL_EINA_BOOST_ABI_SUFFIX
#  define EFL_EINA_BOOST_ABI_SUFFIX "eina_boost/config/abi/msvc_suffix.hpp"
#endif
...
#      endif
#   elif _MSC_VER < 1500
#     define EFL_EINA_BOOST_COMPILER_VERSION evc8
#   elif _MSC_VER < 1600
#     define EFL_EINA_BOOST_COMPILER_VERSION evc9
#   elif _MSC_VER < 1700
#     define EFL_EINA_BOOST_COMPILER_VERSION evc10
#   elif _MSC_VER < 1800 
#     define EFL_EINA_BOOST_COMPILER_VERSION evc11 
#   elif _MSC_VER < 1900 
#     define EFL_EINA_BOOST_COMPILER_VERSION evc12
#   else
#      if defined(EFL_EINA_BOOST_ASSERT_CONFIG)
#         error "Unknown EVC++ compiler version - please run the configure tests and report the results"
#      else
...
#     define EFL_EINA_BOOST_COMPILER_VERSION 5.0
#   elif _MSC_VER < 1300
#     define EFL_EINA_BOOST_COMPILER_VERSION 6.0
#   elif _MSC_VER < 1310
#     define EFL_EINA_BOOST_COMPILER_VERSION 7.0
#   elif _MSC_VER < 1400
#     define EFL_EINA_BOOST_COMPILER_VERSION 7.1
#   elif _MSC_VER < 1500
#     define EFL_EINA_BOOST_COMPILER_VERSION 8.0
#   elif _MSC_VER < 1600
#     define EFL_EINA_BOOST_COMPILER_VERSION 9.0
#   elif _MSC_VER < 1700
#     define EFL_EINA_BOOST_COMPILER_VERSION 10.0
#   elif _MSC_VER < 1800 
#     define EFL_EINA_BOOST_COMPILER_VERSION 11.0
#   elif _MSC_VER < 1900
#     define EFL_EINA_BOOST_COMPILER_VERSION 12.0
#   else
#     define EFL_EINA_BOOST_COMPILER_VERSION _MSC_VER
#   endif
# endif

#  define EFL_EINA_BOOST_COMPILER "Microsoft Visual C++ version " EFL_EINA_BOOST_STRINGIZE(EFL_EINA_BOOST_COMPILER_VERSION)
#endif
