...
//
// Define EFL_EINA_BOOST_GCC so we know this is "real" GCC and not some pretender:
//
#if !defined(__CUDACC__)
#define EFL_EINA_BOOST_GCC (__GNUC__ * 10000 + __GNUC_MINOR__ * 100 + __GNUC_PATCHLEVEL__)
#endif
...
#if !defined(__EXCEPTIONS) && !defined(EFL_EINA_BOOST_NO_EXCEPTIONS)
...
#    define EFL_EINA_BOOST_SYMBOL_EXPORT __attribute__((__dllexport__))
#    define EFL_EINA_BOOST_SYMBOL_IMPORT __attribute__((__dllimport__))
#  else
#    define EFL_EINA_BOOST_SYMBOL_EXPORT __attribute__((__visibility__("default")))
#    define EFL_EINA_BOOST_SYMBOL_IMPORT
#  endif
#  define EFL_EINA_BOOST_SYMBOL_VISIBLE __attribute__((__visibility__("default")))
#else
...
#  ifndef __GXX_RTTI
#     ifndef EFL_EINA_BOOST_NO_TYPEID
#        define EFL_EINA_BOOST_NO_TYPEID
#     endif
#     ifndef EFL_EINA_BOOST_NO_RTTI
...
#if !defined(EFL_EINA_BOOST_NO_CXX11_DEFAULTED_FUNCTIONS) && (__GNUC__ == 4 && __GNUC_MINOR__ <= 5)
#  define EFL_EINA_BOOST_NO_CXX11_NON_PUBLIC_DEFAULTED_FUNCTIONS
#endif
...
// scoped enums have a serious bug in 4.4.0, so define EFL_EINA_BOOST_NO_CXX11_SCOPED_ENUMS before 4.5.1
...
#  define EFL_EINA_BOOST_COMPILER "GNU C++ version " __VERSION__
#endif

// ConceptGCC compiler:
//   http://www.generic-programming.org/software/ConceptGCC/
#ifdef __GXX_CONCEPTS__
#  define EFL_EINA_BOOST_HAS_CONCEPTS
#  define EFL_EINA_BOOST_COMPILER "ConceptGCC version " __VERSION__
#endif
