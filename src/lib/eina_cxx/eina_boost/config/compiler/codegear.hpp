...
#if !defined( EFL_EINA_BOOST_WITH_CODEGEAR_WARNINGS )
...
#if (__CODEGEARC__ <= 0x621)
#  define EFL_EINA_BOOST_NO_TYPENAME_WITH_CTOR    // Cannot use typename keyword when making temporaries of a dependant type
#  define EFL_EINA_BOOST_FUNCTION_SCOPE_USING_DECLARATION_BREAKS_ADL
#  define EFL_EINA_BOOST_NO_MEMBER_TEMPLATE_FRIENDS
#  define EFL_EINA_BOOST_NO_NESTED_FRIENDSHIP     // TC1 gives nested classes access rights as any other member
...
#define EFL_EINA_BOOST_HAS_SCOPED_ENUM
// #define EFL_EINA_BOOST_HAS_STATIC_ASSERT
#define EFL_EINA_BOOST_HAS_STD_TYPE_TRAITS
...
#define EFL_EINA_BOOST_HAS_TR1_TYPE_TRAITS
...
#define EFL_EINA_BOOST_COMPILER "CodeGear C++ version " EFL_EINA_BOOST_STRINGIZE(__CODEGEARC__)
