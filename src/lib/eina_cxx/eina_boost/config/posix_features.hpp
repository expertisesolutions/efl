...
#  if defined(EFL_EINA_BOOST_HAS_UNISTD_H)
#     include <unistd.h>
...
#     if defined(_POSIX_THREADS) && (_POSIX_THREADS+0 >= 0) && !defined(EFL_EINA_BOOST_HAS_WINTHREADS) && !defined(EFL_EINA_BOOST_HAS_MPTASKS)
#        define EFL_EINA_BOOST_HAS_PTHREADS
#     endif

      // EFL_EINA_BOOST_HAS_NANOSLEEP:
...
#     endif
      ...
      // EFL_EINA_BOOST_HAS_CLOCK_GETTIME:
...
#     endif
      ...
      // EFL_EINA_BOOST_HAS_SCHED_YIELD:
...
#     endif
      ...
      // EFL_EINA_BOOST_HAS_GETTIMEOFDAY:
      // EFL_EINA_BOOST_HAS_PTHREAD_MUTEXATTR_SETTYPE:
