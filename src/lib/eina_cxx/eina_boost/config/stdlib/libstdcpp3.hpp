...
#define EFL_EINA_BOOST_GNU_STDLIB 1

#ifdef __GLIBCXX__
#define EFL_EINA_BOOST_STDLIB "GNU libstdc++ version " EFL_EINA_BOOST_STRINGIZE(__GLIBCXX__)
#else
#define EFL_EINA_BOOST_STDLIB "GNU libstdc++ version " EFL_EINA_BOOST_STRINGIZE(__GLIBCPP__)
#endif
...
#  define EFL_EINA_BOOST_HAS_THREADS
    ...
    && defined(EFL_EINA_BOOST_HAS_LONG_LONG)
...
#  define EFL_EINA_BOOST_STD_EXTENSION_NAMESPACE __gnu_cxx
#  define EFL_EINA_BOOST_HAS_SLIST
#  define EFL_EINA_BOOST_HAS_HASH
#  define EFL_EINA_BOOST_SLIST_HEADER <ext/slist>
# if !defined(__GNUC__) || __GNUC__ < 4 || (__GNUC__ == 4 && __GNUC_MINOR__ < 3)
#   define EFL_EINA_BOOST_HASH_SET_HEADER <ext/hash_set>
#   define EFL_EINA_BOOST_HASH_MAP_HEADER <ext/hash_map>
# else
#   define EFL_EINA_BOOST_HASH_SET_HEADER <backward/hash_set>
#   define EFL_EINA_BOOST_HASH_MAP_HEADER <backward/hash_map>
# endif
#endif
...
#else
#  define EFL_EINA_BOOST_HAS_TR1_COMPLEX_INVERSE_TRIG 
#  define EFL_EINA_BOOST_HAS_TR1_COMPLEX_OVERLOADS 
#endif

#if (!defined(_GLIBCXX_HAS_GTHREADS) || !defined(_GLIBCXX_USE_C99_STDINT_TR1)) && (!defined(EFL_EINA_BOOST_NO_CXX11_HDR_CONDITION_VARIABLE) || !defined(EFL_EINA_BOOST_NO_CXX11_HDR_MUTEX))
#  define EFL_EINA_BOOST_NO_CXX11_HDR_CONDITION_VARIABLE
#  define EFL_EINA_BOOST_NO_CXX11_HDR_MUTEX
#endif
