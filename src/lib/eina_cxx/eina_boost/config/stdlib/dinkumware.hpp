...
#  endif
#  if !(defined(_HAS_MEMBER_TEMPLATES_REBIND) && (_HAS_MEMBER_TEMPLATES_REBIND+0 > 0)) && !(defined(_MSC_VER) && (_MSC_VER > 1300)) && defined(EFL_EINA_BOOST_MSVC)
...
// and no <slist> at all
#else
#  define EFL_EINA_BOOST_MSVC_STD_ITERATOR 1
...
#     ifndef __MTA__ 
#        define EFL_EINA_BOOST_NO_STD_MIN_MAX
#     endif
#     define EFL_EINA_BOOST_NO_MS_INT64_NUMERIC_LIMITS
#  endif
#endif
...
#  define EFL_EINA_BOOST_STD_EXTENSION_NAMESPACE stdext
#endif
...
#  define EFL_EINA_BOOST_NO_STD_TYPEINFO    
#endif  
...
#if ((!defined(_HAS_TR1_IMPORTS) || (_HAS_TR1_IMPORTS+0 == 0)) && !defined(EFL_EINA_BOOST_NO_CXX11_HDR_TUPLE)) \
...
#ifdef _CPPLIB_VER
#  define EFL_EINA_BOOST_DINKUMWARE_STDLIB _CPPLIB_VER
#else
#  define EFL_EINA_BOOST_DINKUMWARE_STDLIB 1
#endif

#ifdef _CPPLIB_VER
#  define EFL_EINA_BOOST_STDLIB "Dinkumware standard library version " EFL_EINA_BOOST_STRINGIZE(_CPPLIB_VER)
#else
#  define EFL_EINA_BOOST_STDLIB "Dinkumware standard library version 1.x"
#endif
