...
#ifndef EFL_EINA_BOOST_TYPE_TRAITS_MSVC_REMOVE_BOUNDS_HOLT_2004_0827
#define EFL_EINA_BOOST_TYPE_TRAITS_MSVC_REMOVE_BOUNDS_HOLT_2004_0827
...
namespace efl_eina_boost {
    ...
    struct remove_bounds {
        typedef typename efl_eina_boost::detail::remove_bounds_impl_typeof<
            efl_eina_boost::is_array<T>::value                
        >::template inner<T,remove_bounds<T> >::type type;
        EFL_EINA_BOOST_MPL_AUX_LAMBDA_SUPPORT(1,remove_bounds,T)
    };
} //namespace efl_eina_boost

#endif //EFL_EINA_BOOST_TYPE_TRAITS_MSVC_REMOVE_BOUNDS_HOLT_2004_0827
