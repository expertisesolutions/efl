...
#ifndef EFL_EINA_BOOST_TYPE_TRAITS_MSVC_REMOVE_CONST_HOLT_2004_0828
#define EFL_EINA_BOOST_TYPE_TRAITS_MSVC_REMOVE_CONST_HOLT_2004_0828
...
namespace efl_eina_boost {
    namespace detail {
        ...
        struct remove_const_impl_typeof<true,false,true,false> {
            ...
            struct inner {
                ...
                static msvc_register_type<T,ID> test(...);
                EFL_EINA_BOOST_STATIC_CONSTANT(unsigned,register_test=sizeof(test( (void(*)(T))(NULL) ) ));
                typedef typename msvc_extract_type<ID>::id2type::type type;
            };
            template<typename T>
            struct transform_type {
        ...
        struct remove_const_impl_typeof<false,true,true,false> {
            template<typename T,typename ID>
            struct inner {
                EFL_EINA_BOOST_STATIC_CONSTANT(unsigned,value=(sizeof(T)/sizeof((*((T*)NULL))[0])));
    ...
    template<typename T>
    struct remove_const {
        typedef efl_eina_boost::detail::remove_const_impl_typeof<
            efl_eina_boost::is_pointer<T>::value,
            efl_eina_boost::is_array<T>::value,
            efl_eina_boost::is_const<T>::value,
        ...
        typedef typename 
            ...
            >::type
        type;
        EFL_EINA_BOOST_MPL_AUX_LAMBDA_SUPPORT(1,remove_const,T)
    };
}//namespace efl_eina_boost

#endif //EFL_EINA_BOOST_TYPE_TRAITS_MSVC_REMOVE_CONST_HOLT_2004_0828
