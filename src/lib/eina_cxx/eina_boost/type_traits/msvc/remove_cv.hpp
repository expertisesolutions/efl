...
#ifndef EFL_EINA_BOOST_TYPE_TRAITS_MSVC_REMOVE_CV_HOLT_2004_0901
#define EFL_EINA_BOOST_TYPE_TRAITS_MSVC_REMOVE_CV_HOLT_2004_0901
...
namespace efl_eina_boost {
    ...
    template<typename T>
    struct remove_cv {
        typedef efl_eina_boost::detail::remove_cv_impl_typeof<
        ...
        typedef typename 
            ...
            >::type
        type;
        EFL_EINA_BOOST_MPL_AUX_LAMBDA_SUPPORT(1,remove_cv,T)
    };
}//namespace efl_eina_boost

#endif //EFL_EINA_BOOST_TYPE_TRAITS_MSVC_REMOVE_CV_HOLT_2004_0901
