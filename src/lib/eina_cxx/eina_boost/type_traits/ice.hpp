...
#ifndef EFL_EINA_BOOST_TT_ICE_HPP_INCLUDED
#define EFL_EINA_BOOST_TT_ICE_HPP_INCLUDED
...
#include <eina_boost/type_traits/detail/ice_eq.hpp>

#endif // EFL_EINA_BOOST_TT_ICE_HPP_INCLUDED
