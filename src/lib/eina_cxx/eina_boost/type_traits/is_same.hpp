...
#ifndef EFL_EINA_BOOST_TT_IS_SAME_HPP_INCLUDED
#define EFL_EINA_BOOST_TT_IS_SAME_HPP_INCLUDED
...
EFL_EINA_BOOST_TT_AUX_BOOL_TRAIT_DEF2(is_same,T,U,false)
EFL_EINA_BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC2_1(typename T,is_same,T,T,true)
...
struct is_same_impl
{
    enum { value = efl_eina_boost::detail::is_same_part_1<T1>::template part_2<T2>::value };
};

#else // generic "no-partial-specialization" version

template <typename T>
::efl_eina_boost::type_traits::yes_type
EFL_EINA_BOOST_TT_DECL is_same_tester(T*, T*);

::efl_eina_boost::type_traits::no_type
EFL_EINA_BOOST_TT_DECL is_same_tester(...);
...
struct is_same_impl
{
   ...
   EFL_EINA_BOOST_STATIC_CONSTANT(bool, value =
      (::efl_eina_boost::type_traits::ice_and<
         (sizeof(type_traits::yes_type) == sizeof(efl_eina_boost::detail::is_same_tester(&t,&u))),
         (::efl_eina_boost::is_reference<T>::value == ::efl_eina_boost::is_reference<U>::value),
         (sizeof(T) == sizeof(U))
        >::value));
};
...
EFL_EINA_BOOST_TT_AUX_BOOL_TRAIT_DEF2(is_same,T,U,(::efl_eina_boost::detail::is_same_impl<T,U>::value))
...
#endif  // EFL_EINA_BOOST_TT_IS_SAME_HPP_INCLUDED
