...
#ifndef EFL_EINA_BOOST_TT_ADD_POINTER_HPP_INCLUDED
#define EFL_EINA_BOOST_TT_ADD_POINTER_HPP_INCLUDED
...
EFL_EINA_BOOST_TT_AUX_TYPE_TRAIT_DEF1(add_pointer,T,typename efl_eina_boost::detail::add_pointer_impl<T>::type)

} // namespace efl_eina_boost

#include <eina_boost/type_traits/detail/type_trait_undef.hpp>

#endif // EFL_EINA_BOOST_TT_ADD_POINTER_HPP_INCLUDED
