...
#ifndef EFL_EINA_BOOST_TT_IS_BASE_AND_DERIVED_HPP_INCLUDED
#define EFL_EINA_BOOST_TT_IS_BASE_AND_DERIVED_HPP_INCLUDED

#include <eina_boost/type_traits/intrinsics.hpp>
#ifndef EFL_EINA_BOOST_IS_BASE_OF
...
#ifndef EFL_EINA_BOOST_IS_BASE_OF
#if !EFL_EINA_BOOST_WORKAROUND(__BORLANDC__, EFL_EINA_BOOST_TESTED_AT(0x581)) \
 && !EFL_EINA_BOOST_WORKAROUND(__SUNPRO_CC , <= 0x540) \
 && !EFL_EINA_BOOST_WORKAROUND(__EDG_VERSION__, <= 243) \
...
#pragma warning(disable:6334)
    ...
    //
    EFL_EINA_BOOST_STATIC_ASSERT(sizeof(B) != 0);
    EFL_EINA_BOOST_STATIC_ASSERT(sizeof(D) != 0);
...
{
    EFL_EINA_BOOST_STATIC_CONSTANT(bool, value =
        (::efl_eina_boost::is_convertible<D*,B*>::value));
};

#define EFL_EINA_BOOST_BROKEN_IS_BASE_AND_DERIVED
...
struct is_base_and_derived_impl
{
    ...
    typedef is_base_and_derived_select<
       ::efl_eina_boost::is_class<B>::value,
       ::efl_eina_boost::is_class<D>::value,
       ::efl_eina_boost::is_same<ncvB,ncvD>::value> selector;
    typedef typename selector::template rebind<ncvB,ncvD> binder;
    typedef typename binder::type bound_type;

    EFL_EINA_BOOST_STATIC_CONSTANT(bool, value = bound_type::value);
};
#else
template <typename B, typename D>
struct is_base_and_derived_impl
{
    ...
    EFL_EINA_BOOST_STATIC_CONSTANT(bool, value = (EFL_EINA_BOOST_IS_BASE_OF(B,D) && ! ::efl_eina_boost::is_same<ncvB,ncvD>::value));
};
#endif
} // namespace detail

EFL_EINA_BOOST_TT_AUX_BOOL_TRAIT_DEF2(
      is_base_and_derived
    , Base
    , Derived
    , (::efl_eina_boost::detail::is_base_and_derived_impl<Base,Derived>::value)
    )

#ifndef EFL_EINA_BOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION
EFL_EINA_BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC2_2(typename Base,typename Derived,is_base_and_derived,Base&,Derived,false)
EFL_EINA_BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC2_2(typename Base,typename Derived,is_base_and_derived,Base,Derived&,false)
EFL_EINA_BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC2_2(typename Base,typename Derived,is_base_and_derived,Base&,Derived&,false)
#endif

#if EFL_EINA_BOOST_WORKAROUND(__CODEGEARC__, EFL_EINA_BOOST_TESTED_AT(0x610))
EFL_EINA_BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC2_1(typename Base,is_base_and_derived,Base,Base,false)
#endif
...
#endif // EFL_EINA_BOOST_TT_IS_BASE_AND_DERIVED_HPP_INCLUDED
