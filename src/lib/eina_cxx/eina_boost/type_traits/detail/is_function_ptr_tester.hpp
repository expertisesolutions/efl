...
#ifndef EFL_EINA_BOOST_TT_DETAIL_IS_FUNCTION_PTR_TESTER_HPP_INCLUDED
#define EFL_EINA_BOOST_TT_DETAIL_IS_FUNCTION_PTR_TESTER_HPP_INCLUDED
...
no_type EFL_EINA_BOOST_TT_DECL is_function_ptr_tester(...);
...
#endif // EFL_EINA_BOOST_TT_DETAIL_IS_FUNCTION_PTR_TESTER_HPP_INCLUDED
...
yes_type is_function_ptr_tester(R (*)(EFL_EINA_BOOST_PP_ENUM_PARAMS(EFL_EINA_BOOST_PP_COUNTER,T)));
@#ifndef EFL_EINA_BOOST_TT_NO_ELLIPSIS_IN_FUNC_TESTING
template <class R EFL_EINA_BOOST_PP_COMMA_IF(EFL_EINA_BOOST_PP_COUNTER) EFL_EINA_BOOST_PP_ENUM_PARAMS(EFL_EINA_BOOST_PP_COUNTER,class T) >
yes_type is_function_ptr_tester(R (*)(EFL_EINA_BOOST_PP_ENUM_PARAMS(EFL_EINA_BOOST_PP_COUNTER,T) ...));
@#endif
@#ifdef EFL_EINA_BOOST_TT_TEST_MS_FUNC_SIGS
template <class R EFL_EINA_BOOST_PP_COMMA_IF(EFL_EINA_BOOST_PP_COUNTER) EFL_EINA_BOOST_PP_ENUM_PARAMS(EFL_EINA_BOOST_PP_COUNTER,class T) >
yes_type is_function_ptr_tester(R (__stdcall*)(EFL_EINA_BOOST_PP_ENUM_PARAMS(EFL_EINA_BOOST_PP_COUNTER,T)));
template <class R EFL_EINA_BOOST_PP_COMMA_IF(EFL_EINA_BOOST_PP_COUNTER) EFL_EINA_BOOST_PP_ENUM_PARAMS(EFL_EINA_BOOST_PP_COUNTER,class T) >
yes_type is_function_ptr_tester(R (__stdcall*)(EFL_EINA_BOOST_PP_ENUM_PARAMS(EFL_EINA_BOOST_PP_COUNTER,T) ...));
@#ifndef _MANAGED
template <class R EFL_EINA_BOOST_PP_COMMA_IF(EFL_EINA_BOOST_PP_COUNTER) EFL_EINA_BOOST_PP_ENUM_PARAMS(EFL_EINA_BOOST_PP_COUNTER,class T) >
yes_type is_function_ptr_tester(R (__fastcall*)(EFL_EINA_BOOST_PP_ENUM_PARAMS(EFL_EINA_BOOST_PP_COUNTER,T)));
template <class R EFL_EINA_BOOST_PP_COMMA_IF(EFL_EINA_BOOST_PP_COUNTER) EFL_EINA_BOOST_PP_ENUM_PARAMS(EFL_EINA_BOOST_PP_COUNTER,class T) >
yes_type is_function_ptr_tester(R (__fastcall*)(EFL_EINA_BOOST_PP_ENUM_PARAMS(EFL_EINA_BOOST_PP_COUNTER,T) ...));
@#endif
template <class R EFL_EINA_BOOST_PP_COMMA_IF(EFL_EINA_BOOST_PP_COUNTER) EFL_EINA_BOOST_PP_ENUM_PARAMS(EFL_EINA_BOOST_PP_COUNTER,class T) >
yes_type is_function_ptr_tester(R (__cdecl*)(EFL_EINA_BOOST_PP_ENUM_PARAMS(EFL_EINA_BOOST_PP_COUNTER,T)));
template <class R EFL_EINA_BOOST_PP_COMMA_IF(EFL_EINA_BOOST_PP_COUNTER) EFL_EINA_BOOST_PP_ENUM_PARAMS(EFL_EINA_BOOST_PP_COUNTER,class T) >
yes_type is_function_ptr_tester(R (__cdecl*)(EFL_EINA_BOOST_PP_ENUM_PARAMS(EFL_EINA_BOOST_PP_COUNTER,T) ...));
@#endif
