...
#ifndef EFL_EINA_BOOST_TT_IS_CLASS_HPP_INCLUDED
#define EFL_EINA_BOOST_TT_IS_CLASS_HPP_INCLUDED

#include <eina_boost/type_traits/config.hpp>
#include <eina_boost/type_traits/intrinsics.hpp>
#ifndef EFL_EINA_BOOST_IS_CLASS
...
template <class U> ::efl_eina_boost::type_traits::yes_type is_class_tester(void(U::*)(void));
template <class U> ::efl_eina_boost::type_traits::no_type is_class_tester(...);
...
struct is_class_impl
{
    ...
    EFL_EINA_BOOST_STATIC_CONSTANT(bool, value =
        (::efl_eina_boost::type_traits::ice_and<
            sizeof(is_class_tester<T>(0)) == sizeof(::efl_eina_boost::type_traits::yes_type),
            ::efl_eina_boost::type_traits::ice_not< ::efl_eina_boost::is_union<T>::value >::value
        >::value)
        );
};
...
struct is_class_impl
{
    template <class U> static ::efl_eina_boost::type_traits::yes_type is_class_tester(void(U::*)(void));
    template <class U> static ::efl_eina_boost::type_traits::no_type is_class_tester(...);
...
#   ifndef EFL_EINA_BOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION
    ...
    (::efl_eina_boost::type_traits::ice_and<
        ::efl_eina_boost::type_traits::ice_not< ::efl_eina_boost::is_union<T>::value >::value,
        ::efl_eina_boost::type_traits::ice_not< ::efl_eina_boost::is_scalar<T>::value >::value,
        ...
        ::efl_eina_boost::type_traits::ice_not< ::efl_eina_boost::is_function<T>::value >::value
        >::value));
#   else
    EFL_EINA_BOOST_STATIC_CONSTANT(bool, value =
    (::efl_eina_boost::type_traits::ice_and<
...
# else // EFL_EINA_BOOST_IS_CLASS
template <typename T>
struct is_class_impl
{
    EFL_EINA_BOOST_STATIC_CONSTANT(bool, value = EFL_EINA_BOOST_IS_CLASS(T));
};
# endif // EFL_EINA_BOOST_IS_CLASS
...
EFL_EINA_BOOST_TT_AUX_BOOL_TRAIT_DEF1(
   is_class,T, efl_eina_boost::detail::is_class_impl<typename efl_eina_boost::remove_cv<T>::type>::value)
# else 
EFL_EINA_BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_class,T,::efl_eina_boost::detail::is_class_impl<T>::value)
# endif
...
#endif // EFL_EINA_BOOST_TT_IS_CLASS_HPP_INCLUDED
