...
#ifndef EFL_EINA_BOOST_MPL_FOLD_HPP_INCLUDED
#define EFL_EINA_BOOST_MPL_FOLD_HPP_INCLUDED
...
#include <eina_boost/mpl/aux_/fold_impl.hpp>
...
struct fold
{
    ...
    EFL_EINA_BOOST_MPL_AUX_LAMBDA_SUPPORT(3,fold,(Sequence,State,ForwardOp))
};

EFL_EINA_BOOST_MPL_AUX_NA_SPEC(3, fold)

}}

#endif // EFL_EINA_BOOST_MPL_FOLD_HPP_INCLUDED
