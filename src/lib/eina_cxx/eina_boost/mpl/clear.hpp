...
#ifndef EFL_EINA_BOOST_MPL_CLEAR_HPP_INCLUDED
#define EFL_EINA_BOOST_MPL_CLEAR_HPP_INCLUDED
...
#include <eina_boost/mpl/aux_/clear_impl.hpp>
...
{
    EFL_EINA_BOOST_MPL_AUX_LAMBDA_SUPPORT(1,clear,(Sequence))
};

EFL_EINA_BOOST_MPL_AUX_NA_SPEC(1, clear)

}}

#endif // EFL_EINA_BOOST_MPL_CLEAR_HPP_INCLUDED
