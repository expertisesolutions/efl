...
#ifndef EFL_EINA_BOOST_MPL_SEQUENCE_TAG_HPP_INCLUDED
#define EFL_EINA_BOOST_MPL_SEQUENCE_TAG_HPP_INCLUDED
...
struct sequence_tag
    : aux::sequence_tag_impl<
          ::efl_eina_boost::mpl::aux::has_tag<Sequence>::value
        , ::efl_eina_boost::mpl::aux::has_begin<Sequence>::value
...
EFL_EINA_BOOST_MPL_AUX_NA_SPEC(1, sequence_tag)

}}

#endif // EFL_EINA_BOOST_MPL_SEQUENCE_TAG_HPP_INCLUDED
