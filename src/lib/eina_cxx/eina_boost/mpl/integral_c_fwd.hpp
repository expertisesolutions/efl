...
#ifndef EFL_EINA_BOOST_MPL_INTEGRAL_C_FWD_HPP_INCLUDED
#define EFL_EINA_BOOST_MPL_INTEGRAL_C_FWD_HPP_INCLUDED
...
EFL_EINA_BOOST_MPL_AUX_ADL_BARRIER_DECL(integral_c)

#endif // EFL_EINA_BOOST_MPL_INTEGRAL_C_FWD_HPP_INCLUDED
