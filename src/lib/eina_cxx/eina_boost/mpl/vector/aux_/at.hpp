...
#ifndef EFL_EINA_BOOST_MPL_VECTOR_AUX_AT_HPP_INCLUDED
#define EFL_EINA_BOOST_MPL_VECTOR_AUX_AT_HPP_INCLUDED
...
#include <eina_boost/mpl/at_fwd.hpp>
...
struct at_impl< aux::vector_tag >
{
    template< typename Vector, typename N > struct apply
        : v_at<
              Vector
            , EFL_EINA_BOOST_MPL_AUX_VALUE_WKND(N)::value
            >
    {
    };
};
...
template< typename Vector, EFL_EINA_BOOST_MPL_AUX_NTTP_DECL(long, n_) > struct v_at;
...
template< EFL_EINA_BOOST_MPL_AUX_NTTP_DECL(long, n_) > struct v_at_impl
{
...
template< typename T, EFL_EINA_BOOST_MPL_AUX_NTTP_DECL(long, n_) >
struct v_at
...
#endif // EFL_EINA_BOOST_MPL_VECTOR_AUX_AT_HPP_INCLUDED
