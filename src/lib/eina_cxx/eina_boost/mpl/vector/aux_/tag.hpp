...
#ifndef EFL_EINA_BOOST_MPL_VECTOR_AUX_TAG_HPP_INCLUDED
#define EFL_EINA_BOOST_MPL_VECTOR_AUX_TAG_HPP_INCLUDED
...
struct vector_tag;
#else
template< EFL_EINA_BOOST_MPL_AUX_NTTP_DECL(long, N) > struct vector_tag;
#endif

}}}

#endif // EFL_EINA_BOOST_MPL_VECTOR_AUX_TAG_HPP_INCLUDED
