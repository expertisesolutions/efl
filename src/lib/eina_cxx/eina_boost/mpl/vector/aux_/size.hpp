...
#ifndef EFL_EINA_BOOST_MPL_VECTOR_AUX_SIZE_HPP_INCLUDED
#define EFL_EINA_BOOST_MPL_VECTOR_AUX_SIZE_HPP_INCLUDED
...
#endif // EFL_EINA_BOOST_MPL_VECTOR_AUX_SIZE_HPP_INCLUDED
