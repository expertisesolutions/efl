...
#ifndef EFL_EINA_BOOST_MPL_AUX_VECTOR_ITERATOR_HPP_INCLUDED
#define EFL_EINA_BOOST_MPL_AUX_VECTOR_ITERATOR_HPP_INCLUDED
...
#include <eina_boost/mpl/iterator_tags.hpp>
...
template<
      typename Vector
    , EFL_EINA_BOOST_MPL_AUX_NTTP_DECL(long, n_)
    >
struct v_iter
{
...
struct advance< v_iter<Vector,n_>,Distance>
{
    typedef v_iter<
          Vector
        , (n_ + EFL_EINA_BOOST_MPL_AUX_NESTED_VALUE_WKND(long, Distance))
        > type;
};
...
template< 
      typename Vector
    , EFL_EINA_BOOST_MPL_AUX_NTTP_DECL(long, n_)
    , EFL_EINA_BOOST_MPL_AUX_NTTP_DECL(long, m_)
    > 
...
template<> struct distance_impl<aux::v_iter_tag>
{
    template< typename Iter1, typename Iter2 > struct apply
    {
        ...
        EFL_EINA_BOOST_STATIC_CONSTANT(long, value = ( pos2_ - pos1_ ));
    };
};
...
#endif // EFL_EINA_BOOST_MPL_AUX_VECTOR_ITERATOR_HPP_INCLUDED
