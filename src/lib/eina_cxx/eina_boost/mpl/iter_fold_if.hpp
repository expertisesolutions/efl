...
#ifndef EFL_EINA_BOOST_MPL_ITER_FOLD_IF_HPP_INCLUDED
#define EFL_EINA_BOOST_MPL_ITER_FOLD_IF_HPP_INCLUDED
...
template<
    ...
    , typename EFL_EINA_BOOST_MPL_AUX_NA_PARAM(ForwardPredicate)
    , typename EFL_EINA_BOOST_MPL_AUX_NA_PARAM(BackwardOp)
    , typename EFL_EINA_BOOST_MPL_AUX_NA_PARAM(BackwardPredicate)
    >
struct iter_fold_if
{
...
#if !EFL_EINA_BOOST_WORKAROUND(__MWERKS__, EFL_EINA_BOOST_TESTED_AT(0x3003)) && !EFL_EINA_BOOST_WORKAROUND(__IBMCPP__, EFL_EINA_BOOST_TESTED_AT(600))
    struct result_ :
#else
    typedef
#endif
...
EFL_EINA_BOOST_MPL_AUX_NA_SPEC(6, iter_fold_if)

}}

#endif // EFL_EINA_BOOST_MPL_ITER_FOLD_IF_HPP_INCLUDED
