...
#ifndef EFL_EINA_BOOST_MPL_EMPTY_BASE_HPP_INCLUDED
#define EFL_EINA_BOOST_MPL_EMPTY_BASE_HPP_INCLUDED
...
EFL_EINA_BOOST_TT_AUX_BOOL_TRAIT_SPEC1(is_empty, mpl::empty_base, true)
}

#include <eina_boost/type_traits/detail/bool_trait_undef.hpp>

#endif // EFL_EINA_BOOST_MPL_EMPTY_BASE_HPP_INCLUDED
