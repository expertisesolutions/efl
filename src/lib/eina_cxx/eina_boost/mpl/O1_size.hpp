...
#ifndef EFL_EINA_BOOST_MPL_O1_SIZE_HPP_INCLUDED
#define EFL_EINA_BOOST_MPL_O1_SIZE_HPP_INCLUDED
...
#include <eina_boost/mpl/aux_/O1_size_impl.hpp>
...
{
    EFL_EINA_BOOST_MPL_AUX_LAMBDA_SUPPORT(1, O1_size, (Sequence))
};

EFL_EINA_BOOST_MPL_AUX_NA_SPEC(1, O1_size)

}}

#endif // EFL_EINA_BOOST_MPL_O1_SIZE_HPP_INCLUDED
