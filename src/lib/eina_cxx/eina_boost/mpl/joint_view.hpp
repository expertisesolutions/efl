...
#ifndef EFL_EINA_BOOST_MPL_JOINT_VIEW_HPP_INCLUDED
#define EFL_EINA_BOOST_MPL_JOINT_VIEW_HPP_INCLUDED
...
#include <eina_boost/mpl/aux_/joint_iter.hpp>
#include <eina_boost/mpl/plus.hpp>
#include <eina_boost/mpl/size_fwd.hpp>
...
template<
      typename EFL_EINA_BOOST_MPL_AUX_NA_PARAM(Sequence1_)
    , typename EFL_EINA_BOOST_MPL_AUX_NA_PARAM(Sequence2_)
    >
struct joint_view
{
...
EFL_EINA_BOOST_MPL_AUX_NA_SPEC(2, joint_view)

}}

#endif // EFL_EINA_BOOST_MPL_JOINT_VIEW_HPP_INCLUDED
