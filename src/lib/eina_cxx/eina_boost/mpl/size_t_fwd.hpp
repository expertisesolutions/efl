...
#ifndef EFL_EINA_BOOST_MPL_SIZE_T_FWD_HPP_INCLUDED
#define EFL_EINA_BOOST_MPL_SIZE_T_FWD_HPP_INCLUDED
...
EFL_EINA_BOOST_MPL_AUX_ADL_BARRIER_DECL(size_t)

#endif // EFL_EINA_BOOST_MPL_SIZE_T_FWD_HPP_INCLUDED
