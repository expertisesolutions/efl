...
#ifndef EFL_EINA_BOOST_MPL_VOID_FWD_HPP_INCLUDED
#define EFL_EINA_BOOST_MPL_VOID_FWD_HPP_INCLUDED
...
EFL_EINA_BOOST_MPL_AUX_ADL_BARRIER_DECL(void_)

#endif // EFL_EINA_BOOST_MPL_VOID_FWD_HPP_INCLUDED
