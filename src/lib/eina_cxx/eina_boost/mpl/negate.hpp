...
#ifndef EFL_EINA_BOOST_MPL_NEGATE_HPP_INCLUDED
#define EFL_EINA_BOOST_MPL_NEGATE_HPP_INCLUDED
...
#endif
{
    EFL_EINA_BOOST_MPL_AUX_LAMBDA_SUPPORT(1, negate, (N))
};

EFL_EINA_BOOST_MPL_AUX_NA_SPEC(1, negate)
...
{
    EFL_EINA_BOOST_STATIC_CONSTANT(T, value = -n);
...
#endif // EFL_EINA_BOOST_MPL_NEGATE_HPP_INCLUDED
