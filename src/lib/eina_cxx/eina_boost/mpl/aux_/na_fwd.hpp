...
#ifndef EFL_EINA_BOOST_MPL_AUX_NA_FWD_HPP_INCLUDED
#define EFL_EINA_BOOST_MPL_AUX_NA_FWD_HPP_INCLUDED
...
EFL_EINA_BOOST_MPL_AUX_ADL_BARRIER_DECL(na)

#endif // EFL_EINA_BOOST_MPL_AUX_NA_FWD_HPP_INCLUDED
