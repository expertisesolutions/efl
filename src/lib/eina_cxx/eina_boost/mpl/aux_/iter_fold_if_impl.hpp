...
#ifndef EFL_EINA_BOOST_MPL_AUX_ITER_FOLD_IF_IMPL_HPP_INCLUDED
#define EFL_EINA_BOOST_MPL_AUX_ITER_FOLD_IF_IMPL_HPP_INCLUDED
...
#   define EFL_EINA_BOOST_MPL_PREPROCESSED_HEADER iter_fold_if_impl.hpp
...
struct iter_fold_if_forward_step
{
    ...
    typedef typename iter_fold_if_step_impl<
          EFL_EINA_BOOST_MPL_AUX_MSVC_VALUE_WKND(not_last)::value
...
#   define AUX_ITER_FOLD_FORWARD_STEP(unused, i, unused2) \
    typedef iter_fold_if_forward_step< \
          typename EFL_EINA_BOOST_PP_CAT(forward_step,i)::iterator \
        , typename EFL_EINA_BOOST_PP_CAT(forward_step,i)::state \
        , ForwardOp \
        , ForwardPredicate \
        > EFL_EINA_BOOST_PP_CAT(forward_step, EFL_EINA_BOOST_PP_INC(i)); \
    /**/

#   define AUX_ITER_FOLD_BACKWARD_STEP_FUNC(i) \
    typedef iter_fold_if_backward_step< \
          typename EFL_EINA_BOOST_PP_CAT(forward_step,EFL_EINA_BOOST_PP_DEC(i))::iterator \
        , typename EFL_EINA_BOOST_PP_CAT(backward_step,i)::state \
        , BackwardOp \
        , BackwardPredicate \
        > EFL_EINA_BOOST_PP_CAT(backward_step,EFL_EINA_BOOST_PP_DEC(i)); \
    /**/

#   define AUX_ITER_FOLD_BACKWARD_STEP(unused, i, unused2) \
    AUX_ITER_FOLD_BACKWARD_STEP_FUNC( \
        EFL_EINA_BOOST_PP_SUB_D(1,EFL_EINA_BOOST_MPL_LIMIT_UNROLLING,i) \
        ) \
    /**/

#   define AUX_LAST_FORWARD_STEP \
    EFL_EINA_BOOST_PP_CAT(forward_step, EFL_EINA_BOOST_MPL_LIMIT_UNROLLING) \
    /**/

#   define AUX_LAST_BACKWARD_STEP \
    EFL_EINA_BOOST_PP_CAT(backward_step, EFL_EINA_BOOST_MPL_LIMIT_UNROLLING) \
    /**/
...
#endif // EFL_EINA_BOOST_MPL_AUX_ITER_FOLD_IF_IMPL_HPP_INCLUDED
