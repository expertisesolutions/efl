...
#ifndef EFL_EINA_BOOST_MPL_AUX_CONFIG_HAS_APPLY_HPP_INCLUDED
#define EFL_EINA_BOOST_MPL_AUX_CONFIG_HAS_APPLY_HPP_INCLUDED
...
#include <eina_boost/mpl/aux_/config/workaround.hpp>
    ...
    && (   defined(EFL_EINA_BOOST_MPL_CFG_NO_HAS_XXX) \
        || EFL_EINA_BOOST_WORKAROUND(__EDG_VERSION__, < 300) \
        || EFL_EINA_BOOST_WORKAROUND(EFL_EINA_BOOST_MSVC, <= 1300) \
        || EFL_EINA_BOOST_WORKAROUND(__MWERKS__, EFL_EINA_BOOST_TESTED_AT(0x3202)) \
        )

#   define EFL_EINA_BOOST_MPL_CFG_NO_HAS_APPLY

#endif

#endif // EFL_EINA_BOOST_MPL_AUX_CONFIG_HAS_APPLY_HPP_INCLUDED
