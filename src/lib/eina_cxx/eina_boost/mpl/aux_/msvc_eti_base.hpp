...
#ifndef EFL_EINA_BOOST_MPL_AUX_MSVC_ETI_BASE_HPP_INCLUDED
#define EFL_EINA_BOOST_MPL_AUX_MSVC_ETI_BASE_HPP_INCLUDED
...
#include <eina_boost/mpl/aux_/is_msvc_eti_arg.hpp>
...
#else // !EFL_EINA_BOOST_MPL_CFG_MSVC_70_ETI_BUG

template< typename T > struct msvc_eti_base
    : T
{
#if EFL_EINA_BOOST_WORKAROUND(EFL_EINA_BOOST_MPL_CFG_GCC, EFL_EINA_BOOST_TESTED_AT(0x0304))
    msvc_eti_base();
#endif
    typedef T type;
};
...
#endif // EFL_EINA_BOOST_MPL_AUX_MSVC_ETI_BASE_HPP_INCLUDED
