...
#ifndef EFL_EINA_BOOST_MPL_AUX_BEGIN_END_IMPL_HPP_INCLUDED
#define EFL_EINA_BOOST_MPL_AUX_BEGIN_END_IMPL_HPP_INCLUDED
...
EFL_EINA_BOOST_MPL_ALGORITM_TRAITS_LAMBDA_SPEC_IMPL(1,begin_impl)
EFL_EINA_BOOST_MPL_ALGORITM_TRAITS_LAMBDA_SPEC_IMPL(1,end_impl)

}}

#endif // EFL_EINA_BOOST_MPL_AUX_BEGIN_END_IMPL_HPP_INCLUDED
