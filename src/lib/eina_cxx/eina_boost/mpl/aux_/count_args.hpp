...
#include <eina_boost/preprocessor/expr_if.hpp>
...
#   define AUX778076_COUNT_ARGS_REPEAT EFL_EINA_BOOST_MPL_PP_REPEAT
...
#   define AUX778076_COUNT_ARGS_REPEAT EFL_EINA_BOOST_PP_REPEAT
#   define AUX778076_COUNT_ARGS_PARAMS(param) \
    EFL_EINA_BOOST_PP_ENUM_SHIFTED_PARAMS( \
          EFL_EINA_BOOST_PP_INC(AUX778076_COUNT_ARGS_ARITY) \
        , param \
        ) \
    /**/
...
#define AUX778076_IS_ARG_TEMPLATE_NAME \
    EFL_EINA_BOOST_PP_CAT(is_,EFL_EINA_BOOST_PP_CAT(AUX778076_COUNT_ARGS_PREFIX,_arg)) \
/**/

#define AUX778076_COUNT_ARGS_FUNC(unused, i, param) \
    EFL_EINA_BOOST_PP_EXPR_IF(i, +) \
    AUX778076_IS_ARG_TEMPLATE_NAME<EFL_EINA_BOOST_PP_CAT(param,EFL_EINA_BOOST_PP_INC(i))>::value \
/**/
...
template<
    ...
    >
struct EFL_EINA_BOOST_PP_CAT(AUX778076_COUNT_ARGS_PREFIX,_count_args)
{
    EFL_EINA_BOOST_STATIC_CONSTANT(int, value = AUX778076_COUNT_ARGS_REPEAT(
          AUX778076_COUNT_ARGS_ARITY
