...
#ifndef EFL_EINA_BOOST_MPL_AUX_TYPE_WRAPPER_HPP_INCLUDED
#define EFL_EINA_BOOST_MPL_AUX_TYPE_WRAPPER_HPP_INCLUDED
...
#endif // EFL_EINA_BOOST_MPL_AUX_TYPE_WRAPPER_HPP_INCLUDED
