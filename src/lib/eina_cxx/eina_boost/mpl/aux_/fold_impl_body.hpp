...
#   define AUX778076_ITER_FOLD_STEP(unused, i, unused2) \
    typedef typename apply2< \
          ForwardOp \
        , EFL_EINA_BOOST_PP_CAT(state,i) \
        , AUX778076_FOLD_IMPL_OP(EFL_EINA_BOOST_PP_CAT(iter,i)) \
        >::type EFL_EINA_BOOST_PP_CAT(state,EFL_EINA_BOOST_PP_INC(i)); \
    typedef typename mpl::next<EFL_EINA_BOOST_PP_CAT(iter,i)>::type \
        EFL_EINA_BOOST_PP_CAT(iter,EFL_EINA_BOOST_PP_INC(i)); \
    /**/
...
/// forward declaration
template<
      EFL_EINA_BOOST_MPL_AUX_NTTP_DECL(int, N)
    , typename First
    , typename Last
    , typename State
    , typename ForwardOp
...
#   define EFL_EINA_BOOST_PP_ITERATION_PARAMS_1 \
    (3,(0, EFL_EINA_BOOST_MPL_LIMIT_UNROLLING, <boost/mpl/aux_/fold_impl_body.hpp>))
...
#   else // EFL_EINA_BOOST_WORKAROUND(__BORLANDC__, < 0x600)
...
#   endif // EFL_EINA_BOOST_WORKAROUND(__BORLANDC__, < 0x600)
...
struct AUX778076_FOLD_CHUNK_NAME<-1>
{
    ...
    struct result_
    {
        typedef typename if_<
            ...
            , EFL_EINA_BOOST_PP_CAT(AUX778076_FOLD_IMPL_NAME_PREFIX,_step)<First,Last,State,ForwardOp>
            >::type res_;
...
struct AUX778076_FOLD_IMPL_NAME<n_,First,Last,State,ForwardOp>
{
    ...
    EFL_EINA_BOOST_MPL_PP_REPEAT(n_, AUX778076_ITER_FOLD_STEP, unused)

    typedef EFL_EINA_BOOST_PP_CAT(state,n_) state;
