...
{
    EFL_EINA_BOOST_MPL_AUX_LAMBDA_SUPPORT(2, greater_equal, (N1, N2))

};

EFL_EINA_BOOST_MPL_AUX_NA_SPEC2(2, 2, greater_equal)
...
struct greater_equal_impl< integral_c_tag,integral_c_tag >
{
    template< typename N1, typename N2 > struct apply
        ...
        : bool_< ( EFL_EINA_BOOST_MPL_AUX_VALUE_WKND(N1)::value >= EFL_EINA_BOOST_MPL_AUX_VALUE_WKND(N2)::value ) >
    {
    };
};
