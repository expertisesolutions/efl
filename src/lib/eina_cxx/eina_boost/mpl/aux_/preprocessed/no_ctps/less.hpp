...
{
    EFL_EINA_BOOST_MPL_AUX_LAMBDA_SUPPORT(2, less, (N1, N2))

};

EFL_EINA_BOOST_MPL_AUX_NA_SPEC2(2, 2, less)
...
struct less_impl< integral_c_tag,integral_c_tag >
{
    template< typename N1, typename N2 > struct apply
        ...
        : bool_< ( EFL_EINA_BOOST_MPL_AUX_VALUE_WKND(N2)::value > EFL_EINA_BOOST_MPL_AUX_VALUE_WKND(N1)::value ) >
    {
    };
};
