...
EFL_EINA_BOOST_MPL_AUX_NA_SPEC(3, inherit3)
...
EFL_EINA_BOOST_MPL_AUX_NA_SPEC(4, inherit4)
...
EFL_EINA_BOOST_MPL_AUX_NA_SPEC(5, inherit5)
...
EFL_EINA_BOOST_MPL_AUX_NA_SPEC_LAMBDA(5, inherit)
EFL_EINA_BOOST_MPL_AUX_NA_SPEC_ARITY(5, inherit)
EFL_EINA_BOOST_MPL_AUX_NA_SPEC_TEMPLATE_ARITY(5, 5, inherit)
}}
