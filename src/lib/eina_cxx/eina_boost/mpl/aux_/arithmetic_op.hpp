...
#   include <eina_boost/mpl/aux_/largest_int.hpp>
...
struct EFL_EINA_BOOST_PP_CAT(AUX778076_OP_PREFIX,_wknd)
{
    EFL_EINA_BOOST_STATIC_CONSTANT(T, value = (n1 AUX778076_OP_TOKEN n2));
...
struct AUX778076_OP_IMPL_NAME<integral_c_tag,integral_c_tag>
{
    template< typename N1, typename N2 > struct apply
        ...
        : integral_c<
            ...
            >
#else
        : aux::EFL_EINA_BOOST_PP_CAT(AUX778076_OP_PREFIX,_wknd)<
              typename aux::largest_int<
                  typename N1::value_type
                , typename N2::value_type
                >::type
