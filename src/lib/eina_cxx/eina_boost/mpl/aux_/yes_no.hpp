...
#ifndef EFL_EINA_BOOST_MPL_AUX_YES_NO_HPP_INCLUDED
#define EFL_EINA_BOOST_MPL_AUX_YES_NO_HPP_INCLUDED
...
#include <eina_boost/mpl/aux_/config/arrays.hpp>
...
template< EFL_EINA_BOOST_MPL_AUX_NTTP_DECL(long, n) > struct weighted_tag
{
...
#endif // EFL_EINA_BOOST_MPL_AUX_YES_NO_HPP_INCLUDED
