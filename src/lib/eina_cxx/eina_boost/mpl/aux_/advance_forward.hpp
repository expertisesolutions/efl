...
#ifndef EFL_EINA_BOOST_MPL_AUX_ADVANCE_FORWARD_HPP_INCLUDED
#define EFL_EINA_BOOST_MPL_AUX_ADVANCE_FORWARD_HPP_INCLUDED
...
#   define EFL_EINA_BOOST_MPL_PREPROCESSED_HEADER advance_forward.hpp
...
// forward declaration
template< EFL_EINA_BOOST_MPL_AUX_NTTP_DECL(long, N) > struct advance_forward;

#   define EFL_EINA_BOOST_PP_ITERATION_PARAMS_1 \
    (3,(0, EFL_EINA_BOOST_MPL_LIMIT_UNROLLING, <boost/mpl/aux_/advance_forward.hpp>))
...
struct advance_forward
{
    template< typename Iterator > struct apply
    {
        typedef typename apply_wrap1<
              advance_forward<EFL_EINA_BOOST_MPL_LIMIT_UNROLLING>
            , Iterator
            >::type chunk_result_;
...
#endif // EFL_EINA_BOOST_MPL_AUX_ADVANCE_FORWARD_HPP_INCLUDED
...
template<>
struct advance_forward< EFL_EINA_BOOST_PP_FRAME_ITERATION(1) >
{
    template< typename Iterator > struct apply
    {
...
#   include EFL_EINA_BOOST_PP_ITERATE()
#endif
        typedef EFL_EINA_BOOST_PP_CAT(iter,i_) type;
    };
