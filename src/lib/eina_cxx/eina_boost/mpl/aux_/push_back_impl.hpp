...
#ifndef EFL_EINA_BOOST_MPL_AUX_PUSH_BACK_IMPL_HPP_INCLUDED
#define EFL_EINA_BOOST_MPL_AUX_PUSH_BACK_IMPL_HPP_INCLUDED
...
struct push_back_impl
{
    template< typename Sequence, typename T > struct apply
    {
        ...
        EFL_EINA_BOOST_MPL_ASSERT_MSG(
              ( efl_eina_boost::is_same< T, has_push_back_arg >::value )
...
EFL_EINA_BOOST_MPL_ALGORITM_TRAITS_LAMBDA_SPEC(2, push_back_impl)
EFL_EINA_BOOST_MPL_ALGORITM_TRAITS_LAMBDA_SPEC(1, has_push_back_impl)

}}

#endif // EFL_EINA_BOOST_MPL_AUX_PUSH_BACK_IMPL_HPP_INCLUDED
