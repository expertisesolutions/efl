...
#ifndef EFL_EINA_BOOST_MPL_AUX_MSVC_TYPE_HPP_INCLUDED
#define EFL_EINA_BOOST_MPL_AUX_MSVC_TYPE_HPP_INCLUDED
...
#endif // EFL_EINA_BOOST_MPL_AUX_MSVC_TYPE_HPP_INCLUDED
