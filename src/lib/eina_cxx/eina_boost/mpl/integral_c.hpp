...
#ifndef EFL_EINA_BOOST_MPL_INTEGRAL_C_HPP_INCLUDED
#define EFL_EINA_BOOST_MPL_INTEGRAL_C_HPP_INCLUDED
...
#include <eina_boost/mpl/integral_c_fwd.hpp>
...
#if EFL_EINA_BOOST_WORKAROUND(__HP_aCC, <= 53800)
...
#include <eina_boost/mpl/aux_/integral_wrapper.hpp>


#if !defined(EFL_EINA_BOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION) \
 && !EFL_EINA_BOOST_WORKAROUND(__BORLANDC__, <= 0x551)
...
#endif // EFL_EINA_BOOST_MPL_INTEGRAL_C_HPP_INCLUDED
