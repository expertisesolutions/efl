...
#ifndef EFL_EINA_BOOST_MPL_AT_HPP_INCLUDED
#define EFL_EINA_BOOST_MPL_AT_HPP_INCLUDED
...
#include <eina_boost/mpl/aux_/at_impl.hpp>
...
{
    EFL_EINA_BOOST_MPL_AUX_LAMBDA_SUPPORT(2,at,(Sequence,N))
};
...
EFL_EINA_BOOST_MPL_AUX_NA_SPEC(2, at)

}}

#endif // EFL_EINA_BOOST_MPL_AT_HPP_INCLUDED
