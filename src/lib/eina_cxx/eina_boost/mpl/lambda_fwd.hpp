...
#ifndef EFL_EINA_BOOST_MPL_LAMBDA_FWD_HPP_INCLUDED
#define EFL_EINA_BOOST_MPL_LAMBDA_FWD_HPP_INCLUDED
...
template< 
      typename T = na
    , typename Tag = void_
    EFL_EINA_BOOST_MPL_AUX_LAMBDA_ARITY_PARAM(
...
#endif // EFL_EINA_BOOST_MPL_LAMBDA_FWD_HPP_INCLUDED
