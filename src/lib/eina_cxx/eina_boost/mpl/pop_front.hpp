...
#ifndef EFL_EINA_BOOST_MPL_POP_FRONT_HPP_INCLUDED
#define EFL_EINA_BOOST_MPL_POP_FRONT_HPP_INCLUDED
...
#include <eina_boost/mpl/aux_/pop_front_impl.hpp>
...
{
    EFL_EINA_BOOST_MPL_AUX_LAMBDA_SUPPORT(1,pop_front,(Sequence))
};

EFL_EINA_BOOST_MPL_AUX_NA_SPEC(1, pop_front)

}}

#endif // EFL_EINA_BOOST_MPL_POP_FRONT_HPP_INCLUDED
