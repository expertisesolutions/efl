...
==============================================================================*/
#if !defined(EFL_EINA_BOOST_FUSION_VECTOR50_FWD_HPP_INCLUDED)
#define EFL_EINA_BOOST_FUSION_VECTOR50_FWD_HPP_INCLUDED
...
#include <eina_boost/fusion/container/vector/detail/preprocessed/vector50_fwd.hpp>
#else
...
namespace efl_eina_boost { namespace fusion
{
    ...
    #define EFL_EINA_BOOST_PP_FILENAME_1 <eina_boost/fusion/container/vector/vector50_fwd.hpp>
    #define EFL_EINA_BOOST_PP_ITERATION_LIMITS (41, 50)
