...
==============================================================================*/
#if !defined(EFL_EINA_BOOST_FUSION_SEGMENTED_BEGIN_IMPL_HPP_INCLUDED)
#define EFL_EINA_BOOST_FUSION_SEGMENTED_BEGIN_IMPL_HPP_INCLUDED
...
#include <eina_boost/fusion/sequence/intrinsic/detail/segmented_end_impl.hpp>
#include <eina_boost/fusion/support/detail/segmented_fold_until_impl.hpp>
