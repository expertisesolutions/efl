...
#include <eina_boost/fusion/view/joint_view/detail/deref_impl.hpp>
#include <eina_boost/fusion/view/joint_view/detail/next_impl.hpp>
#include <eina_boost/fusion/view/joint_view/detail/value_of_impl.hpp>
#include <eina_boost/fusion/view/joint_view/detail/deref_data_impl.hpp>
#include <eina_boost/fusion/view/joint_view/detail/value_of_data_impl.hpp>
#include <eina_boost/fusion/view/joint_view/detail/key_of_impl.hpp>
...
namespace efl_eina_boost { namespace fusion
{
        ...
        : iterator_base<joint_view_iterator<Category, First, Last, Concat> >
    {
        ...
        EFL_EINA_BOOST_STATIC_ASSERT((!result_of::equal_to<first_type, last_type>::value));
