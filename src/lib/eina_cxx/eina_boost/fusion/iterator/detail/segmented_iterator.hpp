...
==============================================================================*/
#if !defined(EFL_EINA_BOOST_FUSION_SEGMENTED_ITERATOR_SEGMENTED_ITERATOR_HPP_INCLUDED)
#define EFL_EINA_BOOST_FUSION_SEGMENTED_ITERATOR_SEGMENTED_ITERATOR_HPP_INCLUDED

#include <eina_boost/mpl/bool.hpp>
#include <eina_boost/fusion/sequence/intrinsic_fwd.hpp>
#include <eina_boost/fusion/iterator/iterator_facade.hpp>
#include <eina_boost/fusion/iterator/deref.hpp>
#include <eina_boost/fusion/iterator/deref_data.hpp>
#include <eina_boost/fusion/iterator/key_of.hpp>
#include <eina_boost/fusion/iterator/value_of.hpp>
#include <eina_boost/fusion/iterator/value_of_data.hpp>
#include <eina_boost/fusion/iterator/detail/segmented_equal_to.hpp>
