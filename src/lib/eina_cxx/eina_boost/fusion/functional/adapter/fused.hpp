...
#if !defined(EFL_EINA_BOOST_FUSION_FUNCTIONAL_ADAPTER_FUSED_HPP_INCLUDED)
#define EFL_EINA_BOOST_FUSION_FUNCTIONAL_ADAPTER_FUSED_HPP_INCLUDED

#include <eina_boost/type_traits/add_reference.hpp>
#include <eina_boost/config.hpp>

#include <eina_boost/fusion/functional/adapter/detail/access.hpp>
#include <eina_boost/fusion/functional/invocation/invoke.hpp>
    ...
    public:
        ...
        struct result< Self const (Seq) >
            : result_of::invoke<func_const_fwd_t,
                typename efl_eina_boost::remove_reference<Seq>::type >
        { };
