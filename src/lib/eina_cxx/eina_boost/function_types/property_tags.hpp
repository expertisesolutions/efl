...
#ifndef EFL_EINA_BOOST_FT_DETAIL_TAGS_HPP_INCLUDED
#define EFL_EINA_BOOST_FT_DETAIL_TAGS_HPP_INCLUDED

#include <cstddef>

#include <eina_boost/type_traits/integral_constant.hpp>
#include <eina_boost/mpl/bitxor.hpp>
...
namespace detail 
{
  ...
  template<bits_t Value> struct constant 
    : efl_eina_boost::integral_constant<bits_t,Value> 
  { };
  ...
  template<bits_t Bits, bits_t CCID> struct encode_bits
    : constant< 
        ::efl_eina_boost::function_types::detail::encode_bits_impl<Bits,CCID>::value 
      >
  { };
  ...
  {
    typedef constant<
      ::efl_eina_boost::function_types::detail::tag_ice
        < ::efl_eina_boost::function_types::detail::bits<LHS>::value
        , ::efl_eina_boost::function_types::detail::mask<LHS>::value
        , ::efl_eina_boost::function_types::detail::bits<RHS>::value
        , ::efl_eina_boost::function_types::detail::mask<RHS>::value
        >::combined_bits 
    > bits;
  ...
  template<class Tag, class QueryTag> struct represents_impl
    : efl_eina_boost::integral_constant<bool,
        ::efl_eina_boost::function_types::detail::tag_ice
          < ::efl_eina_boost::function_types::detail::bits<Tag>::value
          , ::efl_eina_boost::function_types::detail::mask<Tag>::value
          , ::efl_eina_boost::function_types::detail::bits<QueryTag>::value
          , ::efl_eina_boost::function_types::detail::mask<QueryTag>::value
          >::match
      >
  { };
...
#include <eina_boost/function_types/detail/pp_tags/preprocessed.hpp>

namespace efl_eina_boost { namespace function_types {
#define EFL_EINA_BOOST_FT_cc_file <eina_boost/function_types/detail/pp_tags/cc_tag.hpp>
