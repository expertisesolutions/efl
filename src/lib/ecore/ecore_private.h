...
void _ecore_signal_pid_register(ecore_pid_t pid, int fd);
void _ecore_signal_pid_unregister(ecore_pid_t pid, int fd);
...
#ifndef _WIN32
Ecore_Exe *_ecore_exe_find(ecore_pid_t pid);
