...
EAPI EFL_EXTERN Ecore_Version *ecore_version;
...
EAPI EFL_EXTERN int ECORE_EXE_EVENT_ADD;     /**< A child process has been added */
EAPI EFL_EXTERN int ECORE_EXE_EVENT_DEL;     /**< A child process has been deleted (it exited, naming consistent with the rest of ecore). */
EAPI EFL_EXTERN int ECORE_EXE_EVENT_DATA;    /**< Data from a child process. */
EAPI EFL_EXTERN int ECORE_EXE_EVENT_ERROR;    /**< Errors from a child process. */
 ...
 */
EAPI ECORE_PID ecore_exe_pid_get(const Ecore_Exe *exe);
