...
int EEZE_SENSOR_EVENT_ACCELEROMETER;
int EEZE_SENSOR_EVENT_GRAVITY;
int EEZE_SENSOR_EVENT_LINEAR_ACCELERATION;
int EEZE_SENSOR_EVENT_DEVICE_ORIENTATION;
int EEZE_SENSOR_EVENT_MAGNETIC;
int EEZE_SENSOR_EVENT_ORIENTATION;
int EEZE_SENSOR_EVENT_GYROSCOPE;
int EEZE_SENSOR_EVENT_LIGHT;
int EEZE_SENSOR_EVENT_PROXIMITY;
int EEZE_SENSOR_EVENT_SNAP;
int EEZE_SENSOR_EVENT_SHAKE;
int EEZE_SENSOR_EVENT_DOUBLETAP;
int EEZE_SENSOR_EVENT_PANNING;
int EEZE_SENSOR_EVENT_PANNING_BROWSE;
int EEZE_SENSOR_EVENT_TILT;
int EEZE_SENSOR_EVENT_FACEDOWN;
int EEZE_SENSOR_EVENT_DIRECT_CALL;
int EEZE_SENSOR_EVENT_SMART_ALERT;
int EEZE_SENSOR_EVENT_NO_MOVE;
int EEZE_SENSOR_EVENT_BAROMETER;
int EEZE_SENSOR_EVENT_TEMPERATURE;
