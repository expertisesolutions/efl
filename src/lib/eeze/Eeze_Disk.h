...
EAPI EFL_EXTERN int EEZE_EVENT_DISK_MOUNT;
EAPI EFL_EXTERN int EEZE_EVENT_DISK_UNMOUNT;
EAPI EFL_EXTERN int EEZE_EVENT_DISK_EJECT;
EAPI EFL_EXTERN int EEZE_EVENT_DISK_ERROR;
