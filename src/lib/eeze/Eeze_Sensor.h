 ...
 * @{
 */
EAPI EFL_EXTERN int EEZE_SENSOR_EVENT_ACCELEROMETER;
EAPI EFL_EXTERN int EEZE_SENSOR_EVENT_GRAVITY;
EAPI EFL_EXTERN int EEZE_SENSOR_EVENT_LINEAR_ACCELERATION;
EAPI EFL_EXTERN int EEZE_SENSOR_EVENT_DEVICE_ORIENTATION;
EAPI EFL_EXTERN int EEZE_SENSOR_EVENT_MAGNETIC;
EAPI EFL_EXTERN int EEZE_SENSOR_EVENT_ORIENTATION;
EAPI EFL_EXTERN int EEZE_SENSOR_EVENT_GYROSCOPE;
EAPI EFL_EXTERN int EEZE_SENSOR_EVENT_LIGHT;
EAPI EFL_EXTERN int EEZE_SENSOR_EVENT_PROXIMITY;
EAPI EFL_EXTERN int EEZE_SENSOR_EVENT_SNAP;
EAPI EFL_EXTERN int EEZE_SENSOR_EVENT_SHAKE;
EAPI EFL_EXTERN int EEZE_SENSOR_EVENT_DOUBLETAP;
EAPI EFL_EXTERN int EEZE_SENSOR_EVENT_PANNING;
EAPI EFL_EXTERN int EEZE_SENSOR_EVENT_PANNING_BROWSE;
EAPI EFL_EXTERN int EEZE_SENSOR_EVENT_TILT;
EAPI EFL_EXTERN int EEZE_SENSOR_EVENT_FACEDOWN;
EAPI EFL_EXTERN int EEZE_SENSOR_EVENT_DIRECT_CALL;
EAPI EFL_EXTERN int EEZE_SENSOR_EVENT_SMART_ALERT;
EAPI EFL_EXTERN int EEZE_SENSOR_EVENT_NO_MOVE;
EAPI EFL_EXTERN int EEZE_SENSOR_EVENT_BAROMETER;
EAPI EFL_EXTERN int EEZE_SENSOR_EVENT_TEMPERATURE;
/**@}*/
