...
int ECORE_WL_EVENT_MOUSE_IN = 0;
int ECORE_WL_EVENT_MOUSE_OUT = 0;
int ECORE_WL_EVENT_FOCUS_IN = 0;
int ECORE_WL_EVENT_FOCUS_OUT = 0;
int ECORE_WL_EVENT_WINDOW_CONFIGURE = 0;
int ECORE_WL_EVENT_DND_ENTER = 0;
int ECORE_WL_EVENT_DND_POSITION = 0;
int ECORE_WL_EVENT_DND_LEAVE = 0;
int ECORE_WL_EVENT_DND_DROP = 0;
int ECORE_WL_EVENT_DND_OFFER = 0;
int ECORE_WL_EVENT_DND_END = 0;
int ECORE_WL_EVENT_DATA_SOURCE_TARGET = 0;
int ECORE_WL_EVENT_DATA_SOURCE_SEND = 0;
int ECORE_WL_EVENT_SELECTION_DATA_READY = 0;
int ECORE_WL_EVENT_DATA_SOURCE_CANCELLED = 0;
int ECORE_WL_EVENT_INTERFACES_BOUND = 0;
