...
EAPI EFL_EXTERN int ECORE_WL_EVENT_MOUSE_IN;
EAPI EFL_EXTERN int ECORE_WL_EVENT_MOUSE_OUT;
EAPI EFL_EXTERN int ECORE_WL_EVENT_FOCUS_IN;
EAPI EFL_EXTERN int ECORE_WL_EVENT_FOCUS_OUT;
EAPI EFL_EXTERN int ECORE_WL_EVENT_WINDOW_CONFIGURE;
EAPI EFL_EXTERN int ECORE_WL_EVENT_DND_ENTER;
EAPI EFL_EXTERN int ECORE_WL_EVENT_DND_POSITION;
EAPI EFL_EXTERN int ECORE_WL_EVENT_DND_LEAVE;
EAPI EFL_EXTERN int ECORE_WL_EVENT_DND_DROP;
EAPI EFL_EXTERN int ECORE_WL_EVENT_DND_OFFER; /** @since 1.8 */
EAPI EFL_EXTERN int ECORE_WL_EVENT_DND_END; /** @since 1.8 */
EAPI EFL_EXTERN int ECORE_WL_EVENT_DATA_SOURCE_TARGET; /** @since 1.7 */
EAPI EFL_EXTERN int ECORE_WL_EVENT_DATA_SOURCE_SEND; /** @since 1.7 */
EAPI EFL_EXTERN int ECORE_WL_EVENT_DATA_SOURCE_CANCELLED; /** @since 1.7 */
EAPI EFL_EXTERN int ECORE_WL_EVENT_SELECTION_DATA_READY; /** @since 1.7 */
EAPI EFL_EXTERN int ECORE_WL_EVENT_INTERFACES_BOUND;
