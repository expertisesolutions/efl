 ...
 * @internal
 */
EAPI EFL_EXTERN Eina_Lock _efl_class_creation_lock;
 ...
 * @internal
 */
EAPI EFL_EXTERN unsigned int _efl_object_init_generation;
 ...
 */
EAPI EFL_EXTERN const Eina_Value_Type *EFL_DBG_INFO_TYPE;
...
EOAPI EFL_EXTERN const Eina_Value_Type *EINA_VALUE_TYPE_OBJECT;
...
EAPI EFL_EXTERN const Efl_Event_Description _EFL_EVENT_CALLBACK_ADD;

/**
 * @brief Event triggered when a callback was removed from the object
 */
#define EFL_EVENT_CALLBACK_DEL (&(_EFL_EVENT_CALLBACK_DEL))
EAPI EFL_EXTERN const Efl_Event_Description _EFL_EVENT_CALLBACK_DEL;
