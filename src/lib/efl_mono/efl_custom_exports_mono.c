...
EINA_SET_WRAPPER(int64, int64_t)
EINA_SET_WRAPPER(uint64, uint64_t)
...
EINA_CONTAINER_SET_WRAPPER(int64, int64_t)
EINA_CONTAINER_SET_WRAPPER(uint64, uint64_t)
...
EINA_CONTAINER_APPEND_WRAPPER(int64, int64_t)
EINA_CONTAINER_APPEND_WRAPPER(uint64, uint64_t)
...
EINA_CONTAINER_INSERT_WRAPPER(int64, int64_t)
EINA_CONTAINER_INSERT_WRAPPER(uint64, uint64_t)
