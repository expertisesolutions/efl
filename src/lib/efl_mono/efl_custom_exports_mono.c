...
const char *efl_mono_wrapper_supervisor_key_get()
{
   return "__c#_wrapper_supervisor";
}

void *efl_mono_wrapper_supervisor_get(Eo *eo)
{
   return efl_key_data_get(eo, efl_mono_wrapper_supervisor_key_get());
}

void efl_mono_wrapper_supervisor_set(Eo *eo, void *ws)
{
...
void efl_mono_wrapper_supervisor_callbacks_set(Efl_Mono_Free_Wrapper_Supervisor_Cb free_wrapper_supervisor_cb)
{
   _efl_mono_free_wrapper_supervisor_call = free_wrapper_supervisor_cb;
}

void efl_mono_native_dispose(Eo *obj)
{
   _efl_mono_free_wrapper_supervisor_call(obj);
}

void efl_mono_thread_safe_native_dispose(Eo *obj)
{
...
void efl_mono_thread_safe_efl_unref(Eo* obj)
{
   ecore_main_loop_thread_safe_call_async(_efl_mono_unref_cb, obj);
}

void efl_mono_thread_safe_free_cb_exec(Eina_Free_Cb free_cb, void* cb_data)
{
...
void efl_mono_thread_safe_eina_list_free(Eina_List* list)
{
...
void efl_mono_thread_safe_promise_reject(Eina_Promise *p, Eina_Error err)
{
...
void *efl_mono_native_alloc(unsigned int size)
{
   return malloc(size);
}

void efl_mono_native_memset(void *ptr, unsigned int fill, unsigned int count)
{
   memset(ptr, fill, count);
}

void efl_mono_native_free(void *ptr)
{
   free(ptr);
}

void efl_mono_native_free_ref(void **ptr)
{
   if (!ptr) return;
   free(*ptr);
}

void efl_mono_native_stringshare_del_ref(void **str)
{
   if (!str) return;
   eina_stringshare_del(*str);
}

void *efl_mono_native_alloc_copy(const void *val, unsigned int size)
{
    if (!val) return NULL;
    void *r = malloc(size);
    memcpy(r, val, size);
...
const char *efl_mono_native_strdup(const char *str)
{
    if (!str) return NULL;
    return strdup(str);
}

int efl_mono_native_ptr_compare(const void *ptr1, const void *ptr2)
{
...
Eina_Compare_Cb efl_mono_native_ptr_compare_addr_get()
{
    return efl_mono_native_ptr_compare;
}

Eina_Compare_Cb efl_mono_native_str_compare_addr_get()
{
    return (Eina_Compare_Cb)strcmp;
}

Eina_Free_Cb efl_mono_native_free_addr_get()
{
    return (Eina_Free_Cb)free;
}

Eina_Free_Cb efl_mono_native_stringshare_del_addr_get()
{
    return (Eina_Free_Cb)eina_stringshare_del;
}

Eina_Free_Cb efl_mono_native_efl_unref_addr_get()
{
...
Efl_Substitute_Ctor_Cb efl_mono_avoid_top_level_constructor_callback_addr_get()
{
   return &_efl_mono_avoid_top_level_constructor_cb;
}

// Environment wrappers //
const char *efl_mono_native_getenv(const char *name)
{
   return getenv(name);
}

Eina_Error efl_mono_native_setenv(const char *name, const char *value, int overwrite)
{
...
void eina_array_clean_custom_export_mono(Eina_Array *array) EINA_ARG_NONNULL(1)
{
   eina_array_clean(array);
}

Eina_Bool eina_array_push_custom_export_mono(Eina_Array *array, const void *data) EINA_ARG_NONNULL(1, 2)
{
   return eina_array_push(array, data);
}

void *eina_array_pop_custom_export_mono(Eina_Array *array) EINA_ARG_NONNULL(1)
{
   return eina_array_pop(array);
}

void *eina_array_data_get_custom_export_mono(const Eina_Array *array, unsigned int idx) EINA_ARG_NONNULL(1)
{
   return eina_array_data_get(array, idx);
}

void eina_array_data_set_custom_export_mono(const Eina_Array *array, unsigned int idx, const void *data) EINA_ARG_NONNULL(1)
{
   eina_array_data_set(array, idx, data);
}

unsigned int eina_array_count_custom_export_mono(const Eina_Array *array) EINA_ARG_NONNULL(1)
{
   return eina_array_count(array);
}

Eina_Bool eina_array_foreach_custom_export_mono(Eina_Array *array, Eina_Each_Cb cb, void *fdata)
{
   return eina_array_foreach(array, cb, fdata);
}

void eina_array_insert_at_custom_export_mono(Eina_Array* array, unsigned int index, void* const data)
{
...
Eina_List *eina_list_last_custom_export_mono(const Eina_List *list)
{
   return eina_list_last(list);
}

Eina_List *eina_list_next_custom_export_mono(const Eina_List *list)
{
   return eina_list_next(list);
}

Eina_List *eina_list_prev_custom_export_mono(const Eina_List *list)
{
   return eina_list_prev(list);
}

void *eina_list_data_get_custom_export_mono(const Eina_List *list)
{
   return eina_list_data_get(list);
}

void *eina_list_data_set_custom_export_mono(Eina_List *list, const void *data)
{
   return eina_list_data_set(list, data);
}

unsigned int eina_list_count_custom_export_mono(const Eina_List *list)
{
   return eina_list_count(list);
}

void *eina_list_last_data_get_custom_export_mono(const Eina_List *list)
{
...
Eina_Iterator *eina_inlist_iterator_wrapper_new_custom_export_mono(const Eina_Inlist *in_list)
{
...
Eina_Inlist *eina_inlist_first_custom_export_mono(const Eina_Inlist *list)
{
   return eina_inlist_first(list);
}

Eina_Inlist *eina_inlist_last_custom_export_mono(const Eina_Inlist *list)
{
   return eina_inlist_last(list);
}

Eina_Inlist *eina_inlist_next_custom_export_mono(const Eina_Inlist *list)
{
   if (list)
     return list->next;
   return NULL;
...
Eina_Inlist *eina_inlist_prev_custom_export_mono(const Eina_Inlist *list)
{
   if (list)
     return list->prev;
   return NULL;
...
Eina_Iterator *eina_hash_iterator_ptr_key_wrapper_new_custom_export_mono(const Eina_Hash *hash)
{
...
// Eina Value //
const Eina_Value_Type *type_byte() {
   return EINA_VALUE_TYPE_UCHAR;
}
const Eina_Value_Type *type_sbyte() {
   return EINA_VALUE_TYPE_CHAR;
}
const Eina_Value_Type *type_short() {
   return EINA_VALUE_TYPE_SHORT;
}
const Eina_Value_Type *type_ushort() {
   return EINA_VALUE_TYPE_USHORT;
}
const Eina_Value_Type *type_int32() {
   return EINA_VALUE_TYPE_INT;
}
const Eina_Value_Type *type_uint32() {
   return EINA_VALUE_TYPE_UINT;
}
const Eina_Value_Type *type_long() {
   return EINA_VALUE_TYPE_LONG;
}
const Eina_Value_Type *type_ulong() {
   return EINA_VALUE_TYPE_ULONG;
}
const Eina_Value_Type *type_int64() {
   return EINA_VALUE_TYPE_INT64;
}
const Eina_Value_Type *type_uint64() {
   return EINA_VALUE_TYPE_UINT64;
}
const Eina_Value_Type *type_string() {
   return EINA_VALUE_TYPE_STRING;
}
const Eina_Value_Type *type_float() {
   return EINA_VALUE_TYPE_FLOAT;
}
const Eina_Value_Type *type_double() {
   return EINA_VALUE_TYPE_DOUBLE;
}
const Eina_Value_Type *type_array() {
   return EINA_VALUE_TYPE_ARRAY;
}
const Eina_Value_Type *type_list() {
   return EINA_VALUE_TYPE_LIST;
}
const Eina_Value_Type *type_hash() {
   return EINA_VALUE_TYPE_HASH;
}
const Eina_Value_Type *type_error() {
   return EINA_VALUE_TYPE_ERROR;
}
const Eina_Value_Type *type_object() {
   return EINA_VALUE_TYPE_OBJECT;
}

const Eina_Value_Type *type_optional() {
   return EINA_VALUE_TYPE_OPTIONAL;
}

size_t eina_value_sizeof()
{
   return sizeof(Eina_Value);
}

#define EINA_SET_WRAPPER(N, T) Eina_Bool eina_value_set_wrapper_##N(Eina_Value *value, T new_value) \
{ \
...
#define EINA_CONTAINER_SET_WRAPPER(N, T) Eina_Bool eina_value_container_set_wrapper_##N(Eina_Value *value, int i, T new_value) \
{ \
...
#define EINA_CONTAINER_APPEND_WRAPPER(N, T) Eina_Bool eina_value_container_append_wrapper_##N(Eina_Value *value, T new_value) \
{ \
    const Eina_Value_Type *tp = eina_value_type_get(value); \
    if (tp == EINA_VALUE_TYPE_ARRAY) \
...
#define EINA_CONTAINER_INSERT_WRAPPER(N, T) Eina_Bool eina_value_container_insert_wrapper_##N(Eina_Value *value, unsigned int position, T new_value) \
{ \
    const Eina_Value_Type *tp = eina_value_type_get(value); \
    if (tp == EINA_VALUE_TYPE_ARRAY) \
...
void eina_value_container_get_wrapper(const Eina_Value *value, int i, void *output)
{
    const Eina_Value_Type *tp = eina_value_type_get(value);
    if (tp == EINA_VALUE_TYPE_ARRAY)
...
Eina_Bool eina_value_setup_wrapper(Eina_Value *value,
                                   const Eina_Value_Type *type)
{
   return eina_value_setup(value, type);
}

void eina_value_flush_wrapper(Eina_Value *value)
{
   eina_value_flush(value);
}

const Eina_Value_Type *eina_value_type_get_wrapper(const Eina_Value *value)
{
...
Eina_Bool eina_value_get_wrapper(const Eina_Value *value, void *output)
{
   return eina_value_get(value, output);
}

int eina_value_compare_wrapper(const Eina_Value *this, const Eina_Value *other)
{
   return eina_value_compare(this, other);
}

Eina_Bool eina_value_array_setup_wrapper(Eina_Value *array, const Eina_Value_Type *subtype, unsigned int step)
{
   return eina_value_array_setup(array, subtype, step);
}

Eina_Bool eina_value_list_setup_wrapper(Eina_Value *list, const Eina_Value_Type *subtype)
{
   return eina_value_list_setup(list, subtype);
}

Eina_Bool eina_value_array_append_wrapper(Eina_Value *array, va_list argp)
{
   return eina_value_array_append(array, argp);
}

Eina_Bool eina_value_list_append_wrapper(Eina_Value *list, va_list argp)
{
   return eina_value_list_append(list, argp);
}

Eina_Bool eina_value_array_get_wrapper(const Eina_Value *array, int i, void *output)
{
   return eina_value_array_get(array, i, output);
}

Eina_Bool eina_value_list_get_wrapper(const Eina_Value *list, int i, void *output)
{
   return eina_value_list_get(list, i, output);
}

Eina_Bool eina_value_array_set_wrapper(Eina_Value *array, int i, void *value)
{
   return eina_value_array_set(array, i, value);
}

Eina_Bool eina_value_list_set_wrapper(Eina_Value *list, int i, void *value)
{
...
const Eina_Value_Type* eina_value_array_subtype_get_wrapper(const Eina_Value *array)
{
...
const Eina_Value_Type* eina_value_list_subtype_get_wrapper(const Eina_Value *list)
{
...
unsigned int eina_value_array_count_wrapper(const Eina_Value *array)
{
   return eina_value_array_count(array);
}

unsigned int eina_value_list_count_wrapper(const Eina_Value *list)
{
   return eina_value_list_count(list);
}

Eina_Bool eina_value_optional_empty_is_wrapper(const Eina_Value *value, Eina_Bool *empty)
{
   return eina_value_optional_empty_is(value, empty);
}

const Eina_Value_Type *eina_value_optional_type_get_wrapper(Eina_Value *value)
{
   return eina_value_optional_type_get(value);
}

Eina_Bool eina_value_pset_wrapper(Eina_Value *value, void *ptr)
{
