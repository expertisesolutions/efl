 ...
 *@{
 */
   EAPI EFL_EXTERN int ECORE_EVENT_KEY_DOWN;
   EAPI EFL_EXTERN int ECORE_EVENT_KEY_UP;
   EAPI EFL_EXTERN int ECORE_EVENT_MOUSE_BUTTON_DOWN;
   EAPI EFL_EXTERN int ECORE_EVENT_MOUSE_BUTTON_UP;
   EAPI EFL_EXTERN int ECORE_EVENT_MOUSE_MOVE;
   EAPI EFL_EXTERN int ECORE_EVENT_MOUSE_WHEEL;
   EAPI EFL_EXTERN int ECORE_EVENT_MOUSE_IN;
   EAPI EFL_EXTERN int ECORE_EVENT_MOUSE_OUT;
   EAPI EFL_EXTERN int ECORE_EVENT_AXIS_UPDATE; /**< @since 1.13 */
   EAPI EFL_EXTERN int ECORE_EVENT_MOUSE_BUTTON_CANCEL; /**< @since 1.15 */
   EAPI EFL_EXTERN int ECORE_EVENT_JOYSTICK; /**< @since 1.18 */
