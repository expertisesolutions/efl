...
EAPI EFL_EXTERN int ECORE_IPC_EVENT_CLIENT_ADD;
EAPI EFL_EXTERN int ECORE_IPC_EVENT_CLIENT_DEL;
EAPI EFL_EXTERN int ECORE_IPC_EVENT_SERVER_ADD;
EAPI EFL_EXTERN int ECORE_IPC_EVENT_SERVER_DEL;
EAPI EFL_EXTERN int ECORE_IPC_EVENT_CLIENT_DATA;
EAPI EFL_EXTERN int ECORE_IPC_EVENT_SERVER_DATA;
