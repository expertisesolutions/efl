 ...
 * @since 1.21
 */
EAPI const Eina_Value_Type *EINA_VALUE_TYPE_BOOL;
 ...
 * @since 1.2
 */
EAPI const Eina_Value_Type *EINA_VALUE_TYPE_TIMEVAL;
...
EAPI Eina_Error EINA_ERROR_VALUE_FAILED;
 ...
 * @since 1.17
 */
EAPI const Eina_Value_Type *EINA_VALUE_TYPE_OPTIONAL;
 ...
 * @since 1.21
 */
EAPI const Eina_Value_Type *EINA_VALUE_TYPE_FILE;
 ...
 * @since 1.21
 */
EAPI const Eina_Value_Type *EINA_VALUE_TYPE_RECTANGLE;
