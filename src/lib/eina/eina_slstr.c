...
Eina_Rw_Slice eina_slslice_new(size_t length); // alloc
Eina_Rw_Slice eina_slslice_copy(Eina_Slice slice); // copies
Eina_Rw_Slice eina_slslice_free(Eina_Rw_Slice slice); // steals
#endif
