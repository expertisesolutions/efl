...
EAPI EFL_EXTERN Ecore_X_Version *ecore_x_version;
...
EAPI EFL_EXTERN int ECORE_X_EVENT_ANY; /**< low level event dependent on
                                        backend in use, will be XEvent.
                                        @warning avoid using it.
                                    */
EAPI EFL_EXTERN int ECORE_X_EVENT_MOUSE_IN;
EAPI EFL_EXTERN int ECORE_X_EVENT_MOUSE_OUT;
EAPI EFL_EXTERN int ECORE_X_EVENT_WINDOW_FOCUS_IN;
EAPI EFL_EXTERN int ECORE_X_EVENT_WINDOW_FOCUS_OUT;
EAPI EFL_EXTERN int ECORE_X_EVENT_WINDOW_KEYMAP;
EAPI EFL_EXTERN int ECORE_X_EVENT_WINDOW_DAMAGE;
EAPI EFL_EXTERN int ECORE_X_EVENT_WINDOW_VISIBILITY_CHANGE;
EAPI EFL_EXTERN int ECORE_X_EVENT_WINDOW_CREATE;
EAPI EFL_EXTERN int ECORE_X_EVENT_WINDOW_DESTROY;
EAPI EFL_EXTERN int ECORE_X_EVENT_WINDOW_HIDE;
EAPI EFL_EXTERN int ECORE_X_EVENT_WINDOW_SHOW;
EAPI EFL_EXTERN int ECORE_X_EVENT_WINDOW_SHOW_REQUEST;
EAPI EFL_EXTERN int ECORE_X_EVENT_WINDOW_REPARENT;
EAPI EFL_EXTERN int ECORE_X_EVENT_WINDOW_CONFIGURE;
EAPI EFL_EXTERN int ECORE_X_EVENT_WINDOW_CONFIGURE_REQUEST;
EAPI EFL_EXTERN int ECORE_X_EVENT_WINDOW_GRAVITY;
EAPI EFL_EXTERN int ECORE_X_EVENT_WINDOW_RESIZE_REQUEST;
EAPI EFL_EXTERN int ECORE_X_EVENT_WINDOW_STACK;
EAPI EFL_EXTERN int ECORE_X_EVENT_WINDOW_STACK_REQUEST;
EAPI EFL_EXTERN int ECORE_X_EVENT_WINDOW_PROPERTY;
EAPI EFL_EXTERN int ECORE_X_EVENT_WINDOW_COLORMAP;
EAPI EFL_EXTERN int ECORE_X_EVENT_WINDOW_MAPPING;
EAPI EFL_EXTERN int ECORE_X_EVENT_MAPPING_CHANGE;
EAPI EFL_EXTERN int ECORE_X_EVENT_SELECTION_CLEAR;
EAPI EFL_EXTERN int ECORE_X_EVENT_SELECTION_REQUEST;
EAPI EFL_EXTERN int ECORE_X_EVENT_SELECTION_NOTIFY;
EAPI EFL_EXTERN int ECORE_X_EVENT_FIXES_SELECTION_NOTIFY;
EAPI EFL_EXTERN int ECORE_X_EVENT_CLIENT_MESSAGE;
EAPI EFL_EXTERN int ECORE_X_EVENT_WINDOW_SHAPE;
EAPI EFL_EXTERN int ECORE_X_EVENT_SCREENSAVER_NOTIFY;
EAPI EFL_EXTERN int ECORE_X_EVENT_GESTURE_NOTIFY_FLICK;
EAPI EFL_EXTERN int ECORE_X_EVENT_GESTURE_NOTIFY_PAN;
EAPI EFL_EXTERN int ECORE_X_EVENT_GESTURE_NOTIFY_PINCHROTATION;
EAPI EFL_EXTERN int ECORE_X_EVENT_GESTURE_NOTIFY_TAP;
EAPI EFL_EXTERN int ECORE_X_EVENT_GESTURE_NOTIFY_TAPNHOLD;
EAPI EFL_EXTERN int ECORE_X_EVENT_GESTURE_NOTIFY_HOLD;
EAPI EFL_EXTERN int ECORE_X_EVENT_GESTURE_NOTIFY_GROUP;
EAPI EFL_EXTERN int ECORE_X_EVENT_SYNC_COUNTER;
EAPI EFL_EXTERN int ECORE_X_EVENT_SYNC_ALARM;
EAPI EFL_EXTERN int ECORE_X_EVENT_SCREEN_CHANGE;
EAPI EFL_EXTERN int ECORE_X_EVENT_RANDR_CRTC_CHANGE;
EAPI EFL_EXTERN int ECORE_X_EVENT_RANDR_OUTPUT_CHANGE;
EAPI EFL_EXTERN int ECORE_X_EVENT_RANDR_OUTPUT_PROPERTY_NOTIFY;
EAPI EFL_EXTERN int ECORE_X_EVENT_DAMAGE_NOTIFY;

EAPI EFL_EXTERN int ECORE_X_EVENT_WINDOW_DELETE_REQUEST;

EAPI EFL_EXTERN int ECORE_X_EVENT_WINDOW_MOVE_RESIZE_REQUEST;
EAPI EFL_EXTERN int ECORE_X_EVENT_WINDOW_STATE_REQUEST;
EAPI EFL_EXTERN int ECORE_X_EVENT_FRAME_EXTENTS_REQUEST;
EAPI EFL_EXTERN int ECORE_X_EVENT_PING;
EAPI EFL_EXTERN int ECORE_X_EVENT_DESKTOP_CHANGE;

EAPI EFL_EXTERN int ECORE_X_EVENT_STARTUP_SEQUENCE_NEW;
EAPI EFL_EXTERN int ECORE_X_EVENT_STARTUP_SEQUENCE_CHANGE;
EAPI EFL_EXTERN int ECORE_X_EVENT_STARTUP_SEQUENCE_REMOVE;
EAPI EFL_EXTERN int ECORE_X_EVENT_XKB_STATE_NOTIFY; /** @since 1.7 */
EAPI EFL_EXTERN int ECORE_X_EVENT_XKB_NEWKBD_NOTIFY; /** @since 1.7 */

EAPI EFL_EXTERN int ECORE_X_EVENT_GENERIC;

EAPI EFL_EXTERN int ECORE_X_EVENT_PRESENT_CONFIGURE; /**< @since 1.9 */
EAPI EFL_EXTERN int ECORE_X_EVENT_PRESENT_COMPLETE; /**< @since 1.9 */
EAPI EFL_EXTERN int ECORE_X_EVENT_PRESENT_IDLE; /**< @since 1.9 */

EAPI EFL_EXTERN int ECORE_X_EVENT_XDND_ENTER;
EAPI EFL_EXTERN int ECORE_X_EVENT_XDND_POSITION;
EAPI EFL_EXTERN int ECORE_X_EVENT_XDND_STATUS;
EAPI EFL_EXTERN int ECORE_X_EVENT_XDND_LEAVE;
EAPI EFL_EXTERN int ECORE_X_EVENT_XDND_DROP;
EAPI EFL_EXTERN int ECORE_X_EVENT_XDND_FINISHED;

EAPI EFL_EXTERN int ECORE_X_MODIFIER_SHIFT; /**< @since 1.7 */
EAPI EFL_EXTERN int ECORE_X_MODIFIER_CTRL;  /**< @since 1.7 */
EAPI EFL_EXTERN int ECORE_X_MODIFIER_ALT;   /**< @since 1.7 */
EAPI EFL_EXTERN int ECORE_X_MODIFIER_WIN;   /**< @since 1.7 */
EAPI EFL_EXTERN int ECORE_X_MODIFIER_ALTGR; /**< @since 1.7 */

EAPI EFL_EXTERN int ECORE_X_LOCK_SCROLL;
EAPI EFL_EXTERN int ECORE_X_LOCK_NUM;
EAPI EFL_EXTERN int ECORE_X_LOCK_CAPS;
EAPI EFL_EXTERN int ECORE_X_LOCK_SHIFT;

EAPI EFL_EXTERN int ECORE_X_RAW_BUTTON_PRESS;   /**< @since 1.8 */
EAPI EFL_EXTERN int ECORE_X_RAW_BUTTON_RELEASE; /**< @since 1.8 */
EAPI EFL_EXTERN int ECORE_X_RAW_MOTION;         /**< @since 1.8 */

EAPI EFL_EXTERN int ECORE_X_DEVICES_CHANGE; /**< @since 1.24 */
