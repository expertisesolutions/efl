...
Ecore_X_Version *ecore_x_version = &_version;
...
int ECORE_X_EVENT_XKB_STATE_NOTIFY = 0;
int ECORE_X_EVENT_XKB_NEWKBD_NOTIFY = 0;


int ECORE_X_EVENT_GENERIC = 0;

int ECORE_X_EVENT_PRESENT_CONFIGURE = 0;
int ECORE_X_EVENT_PRESENT_COMPLETE = 0;
int ECORE_X_EVENT_PRESENT_IDLE = 0;

int ECORE_X_MODIFIER_SHIFT = 0;
int ECORE_X_MODIFIER_CTRL = 0;
int ECORE_X_MODIFIER_ALT = 0;
int ECORE_X_MODIFIER_WIN = 0;
int ECORE_X_MODIFIER_ALTGR = 0;
...
int ECORE_X_RAW_BUTTON_PRESS = 0;
int ECORE_X_RAW_BUTTON_RELEASE = 0;
int ECORE_X_RAW_MOTION = 0;

int ECORE_X_DEVICES_CHANGE = 0;
