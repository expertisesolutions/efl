...
EAPI EFL_EXTERN int _ecore_evas_log_dom;

EAPI EFL_EXTERN Eina_Error ecore_evas_no_matching_type;
EAPI EFL_EXTERN Eina_Error ecore_evas_no_selection;
EAPI EFL_EXTERN Eina_Error ecore_evas_request_replaced;
...
EAPI EFL_EXTERN Eina_Bool _ecore_evas_app_comp_sync;
