...
EAPI EFL_EXTERN int ELPUT_EVENT_SEAT_CAPS;
EAPI EFL_EXTERN int ELPUT_EVENT_SEAT_FRAME;
EAPI EFL_EXTERN int ELPUT_EVENT_MODIFIERS_SEND;
EAPI EFL_EXTERN int ELPUT_EVENT_DEVICE_CHANGE;
EAPI EFL_EXTERN int ELPUT_EVENT_SESSION_ACTIVE;

/** @since 1.19 */
EAPI EFL_EXTERN int ELPUT_EVENT_POINTER_MOTION;

/** @since 1.21 */
EAPI EFL_EXTERN int ELPUT_EVENT_SWITCH;
