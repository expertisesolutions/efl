...
int ELPUT_EVENT_SEAT_CAPS = 0;
int ELPUT_EVENT_SEAT_FRAME = 0;
int ELPUT_EVENT_KEYMAP_SEND = 0;
int ELPUT_EVENT_MODIFIERS_SEND = 0;
int ELPUT_EVENT_DEVICE_CHANGE = 0;
int ELPUT_EVENT_SESSION_ACTIVE = 0;
int ELPUT_EVENT_POINTER_MOTION = 0;
int ELPUT_EVENT_SWITCH = 0;
