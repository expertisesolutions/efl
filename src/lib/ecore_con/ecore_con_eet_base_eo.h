...
ECORE_CON_API ECORE_CON_WEAK_API const Efl_Class *ecore_con_eet_base_class_get(void);
 ...
 * @ingroup Ecore_Con_Eet_Base
 */
ECORE_CON_API void ecore_con_eet_base_server_set(Eo *obj, Ecore_Con_Server *data);
 ...
 * @ingroup Ecore_Con_Eet_Base
 */
ECORE_CON_API Ecore_Con_Server *ecore_con_eet_base_server_get(const Eo *obj);
 ...
 * @ingroup Ecore_Con_Eet_Base
 */
ECORE_CON_API void ecore_con_eet_base_data_callback_set(Eo *obj, const char *name, Ecore_Con_Eet_Data_Cb func, const void *data);
 ...
 * @ingroup Ecore_Con_Eet_Base
 */
ECORE_CON_API void ecore_con_eet_base_raw_data_callback_set(Eo *obj, const char *name, Ecore_Con_Eet_Raw_Data_Cb func, const void *data);
 ...
 * @ingroup Ecore_Con_Eet_Base
 */
ECORE_CON_API void ecore_con_eet_base_data_callback_del(Eo *obj, const char *name);
 ...
 * @ingroup Ecore_Con_Eet_Base
 */
ECORE_CON_API void ecore_con_eet_base_raw_data_callback_del(Eo *obj, const char *name);
 ...
 * @ingroup Ecore_Con_Eet_Base
 */
ECORE_CON_API void ecore_con_eet_base_register(Eo *obj, const char *name, Eet_Data_Descriptor *edd);
 ...
 * @ingroup Ecore_Con_Eet_Base
 */
ECORE_CON_API void ecore_con_eet_base_send(Eo *obj, Ecore_Con_Reply *reply, const char *name, void *value);
 ...
 * @ingroup Ecore_Con_Eet_Base
 */
ECORE_CON_API void ecore_con_eet_base_raw_send(Eo *obj, Ecore_Con_Reply *reply, const char *protocol_name, const char *section, Eina_Binbuf *section_data);
