...
int ECORE_CON_EVENT_SERVER_ERROR = 0;
...
int ECORE_CON_EVENT_SERVER_WRITE = 0;
int ECORE_CON_EVENT_PROXY_BIND = 0; /* we're not supporting proxy bind, keep only for ABI */
int ECORE_CON_EVENT_SERVER_UPGRADE = 0;
/* for each client from ECORE_CON_EVENT_CLIENT_ADD */
int ECORE_CON_EVENT_CLIENT_DATA = 0;
int ECORE_CON_EVENT_CLIENT_WRITE = 0;
int ECORE_CON_EVENT_CLIENT_ERROR = 0;
int ECORE_CON_EVENT_CLIENT_UPGRADE = 0;
